...
> Hold on, let's not jump to conclusions. I should confirm guideline positions. GOLD 2025 explicitly recommends systemic corticosteroids for acute exacerbations, typically no more than 5 days, citing improvements in FEV1, oxygenation, and recovery time. The VA/DoD guideline similarly recommends 30–40 mg prednisone equivalent daily for 5–7 days, noting no benefit to higher doses or longer durations. ATS/ERS guidance allows up to 14 days but aligns with the principle of using the shortest effective course, and contemporary practice has shifted toward 5 days as standard [^006a2899] [^006a2899] [^d4d0182f] [^f2e8d2f0] [^89aa9f94] [^baac830f].
