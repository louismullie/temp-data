...
Two trials reported change in oxygenation for ARDS patients (Figure 3). The WMD in change in PaO 2 /FiO 2 significantly increased after albumin therapy in the first 24 h (WMD = 56 mmHg, 95% CI 47, 66, P <0.001, I 2 = 0%) and 48 h (WMD = 62 mmHg, 95% CI 47, 77, P <0.001, I 2 = 0%) as well as after 7 days (WMD = 20 mmHg, 95% CI 4, 36, P = 0.017, I 2 = 0%). However, after 72 h, oxygenation did not differ between patients receiving albumin compared to crystalloids (WMD = 10 mmHg, 95% CI −3 - 23, p = 0.131, I 2 = 86%).
...
All adult (>or=18 years), mechanically ventilated patients with acute onset (within 48 hour) of acute lung injury/acute respiratory distress syndrome were included.
