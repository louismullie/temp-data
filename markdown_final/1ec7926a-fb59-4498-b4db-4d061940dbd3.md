...
> Wait, let me verify the outpatient first-line regimen and dosing. The 2021 CDC STI Treatment Guidelines recommend ceftriaxone 500 mg IM once (use 1 g if body weight is ≥ 150 kg) plus doxycycline 100 mg orally twice daily for 14 days, and they explicitly recommend adding metronidazole 500 mg orally twice daily for 14 days to enhance anaerobic coverage and treat bacterial vaginosis when present, which is a change from prior guidance where metronidazole was optional rather than routinely included [^113wDu1j] [^113wDu1j].
