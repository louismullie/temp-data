...
> Hold on, I should verify the magnitude and certainty of these effects. Meta-analytic data show early headgear reduces overjet by about 1 mm and ANB by about 0.7 degrees during phase one, but these gains dissipate by the end of comprehensive care; the trauma reduction signal is consistent across trials, which strengthens its clinical relevance even if skeletal endpoints converge later [^a30f92a0] [^15b4b116].
