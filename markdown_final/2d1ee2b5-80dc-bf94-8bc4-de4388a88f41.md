...
> Hold on, I should verify renal dosing because accumulation increases bleeding risk. In severe renal impairment with creatinine clearance less than 30 mL/min, the dose should be reduced to 1 mg/kg once daily for treatment indications, and for prophylaxis 30 mg once daily is recommended; anti-Xa monitoring can be considered in this setting, though routine monitoring is not required for most patients with normal renal function [^effa651e] [^71b2f658] [^4fc2f5d1].
