...
After repeated subcutaneous 1.5 mg/kg once-daily dosing, mean AUC of anti-Factor Xa activity is marginally higher at steady state in obese healthy volunteers (BMI 30–48 kg/m²) compared to non-obese control subjects, while Amaxis not increased.
...
ASH 2021 anticoagulation in COVID-19 — Table 3 classifies anticoagulant regimens by intensity and lists representative dosing across agents. Prophylactic examples include apixaban 2.5 mg, PO BID (within intent for VTE prophylaxis), enoxaparin 40 mg (4000 U), SC QD, and unfractionated heparin 5000 U, SC BID or SC TID; higher-dose prophylaxis is noted with enoxaparin 40 mg (4000 U), SC BID (for CrCl > 30 mL/min and BMI ≥ 40 kg/m²). Therapeutic-intensity options include enoxaparin 1 mg/kg (100 U/kg), SC BID (for CrCl > 30 mL/min) or 1.5 mg/kg (150 U/kg), SC QD (for CrCl > 30 mL/min), tinzaparin 175 U/kg, SC QD, vitamin K antagonist therapy such as warfarin, PO (target INR 2.0–3.0 or greater), and parenteral direct thrombin inhibitors dosed to target aPTT, including argatroban and bivalirudin.
