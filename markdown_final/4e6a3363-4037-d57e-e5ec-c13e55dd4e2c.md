...
> For acute uncomplicated cystitis in women with rUTI, I need to check first-line agents and resistance thresholds. The AUA/CUA/SUFU guideline recommends nitrofurantoin, TMP-SMX, or fosfomycin as first-line choices, selected according to local antibiograms and patient-specific factors; I should avoid TMP-SMX if local resistance exceeds about 20%, and I should preferentially avoid fluoroquinolones given resistance, cost, and safety concerns, reserving them for limited scenarios [^115fXgm6] [^113zoJEq] [^1164EvA5].
