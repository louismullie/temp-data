...
> I need to check the role of adjuncts carefully; high-flow oxygen for respiratory distress, early isotonic IV fluids for distributive shock, and inhaled beta-agonists for persistent wheeze are reasonable, but they must not delay epinephrine, and I should remember that beta-agonists treat lower airway symptoms only and do not address upper airway edema or hypotension, so they are adjuncts after epinephrine, not substitutes [^116K3kga] [^111dosrc] [^1157MQJ9].
