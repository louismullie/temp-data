...
> I need to ensure prevention and follow-up are addressed. Primary prophylaxis with PPIs is reasonable for high-risk NSAID users, and H. pylori should be eradicated before initiating long-term NSAID therapy; after successful eradication or ulcer healing, routine surveillance endoscopy is not required unless symptoms persist or complications arise; in refractory cases, repeat endoscopy is warranted to reassess healing and exclude alternative etiologies such as malignancy or Zollinger–Ellison syndrome [^116whgjT] [^113ymyha] [^115Hz7Y5].
