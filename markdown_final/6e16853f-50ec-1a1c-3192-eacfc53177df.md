...
### Integration of growth and specification in chick wing digit-patterning [^114WNNcU]. Nature (2008). Excellent credibility.
...
### Electronic application to improve management of infections in low-income neonatal units: pilot implementation of the neoTree beta app in a public sector hospital in Zimbabwe [^115hNHCs]. BMJ Open Quality (2021). High credibility.
...
### An interdigit signalling centre instructs coordinate phalanx-joint formation governed by 5' hoxd-gli3 antagonism [^1113Agq6]. Nature Communications (2016). Medium credibility.
...
### Symbrachydactyly-diagnosis, function, and treatment [^114xMFcC]. The Journal of Hand Surgery (2016). Low credibility.
...
### A number-form area in the blind [^114CcM2t]. Nature Communications (2015). Medium credibility.
...
### Lateralized neural responses to letters and digits in first graders [^11776nED]. Child Development (2019). Medium credibility.
...
### Nonlocal photonic quantum gates over 7.0 km [^1147c89s]. Nature Communications (2024). High credibility.
...
### Large-scale capture of hidden fluorescent labels for training generalizable markerless motion capture models [^111Sdeya]. Nature Communications (2023). High credibility.
...
### Single neurons in the human brain encode numbers [^113K5fCa]. Neuron (2018). Low credibility.
...
### Molecular basis of positional memory in limb regeneration [^113b5Mzh]. Nature (2025). Excellent credibility.
...
### Brief international cognitive assessment for MS (BICAMS) and NEDA maintenance in MS patients: a 2-year follow-up longitudinal study [^113LvVTM]. European Journal of Neurology (2025). Medium credibility.
...
### Association between hand digit ratio (2D: 4D) and nonsyndromic orofacial clefts [^115bVzEv]. The Cleft Palate-Craniofacial Journal (2017). Low credibility.
...
### Fifteen years and counting: looking towards the future [^115TP82U]. Insights Into Imaging (2025). Medium credibility.
...
### Pseudo-linear summation explains neural geometry of multi-finger movements in human premotor cortex [^115gr3b6]. Nature Communications (2025). High credibility.
...
### Neural representations of the perception of handwritten digits and visual objects from a convolutional neural network compared to humans [^115pSxA8]. Human Brain Mapping (2023). Medium credibility.
...
### Digits and fin rays share common developmental histories [^115sZAc3]. Nature (2016). Excellent credibility.
...
### Sheet1… [^115KKLgb]. ftp.cdc.gov (2025). Medium credibility.
...
### Left-digit price effects on smoking cessation motivation [^113ETPiN]. Tobacco Control (2014). Low credibility.
...
### Variation in surgeon proficiency scores and association with digit replantation outcomes [^112oL8dD]. JAMA Network Open (2021). High credibility.
...
### Treprostinil (Orenitram) [^113q1Pz7]. FDA (2024). Medium credibility.
...
### An iterative approach for estimating domain-specific cognitive abilities from large scale online cognitive data [^114Q7oqV]. NPJ Digital Medicine (2024). Medium credibility.
...
### Low molecular weight heparin for prevention of microvascular occlusion in digital replantation [^116H1ANm]. The Cochrane Database of Systematic Reviews (2020). Medium credibility.
...
### The impact of digit-related radiographic osteoarthritis of the hand on grip-strength and upper extremity disability [^111NsUVN]. Clinical Orthopaedics and Related Research (2012). Low credibility.
...
### Update on eCTD submissions… [^112TnpEN]. FDA (2025). Medium credibility.
...
### A scoping review of outcome selection and accuracy of conclusions in complex digital health interventions for young people (2017–2023): methodological proposals for population health intervention research [^115ZFY4y]. BMC Medicine (2025). Medium credibility.
...
### Oxcarbazepine (Trileptal) [^114HsQti]. FDA (2025). Medium credibility.
