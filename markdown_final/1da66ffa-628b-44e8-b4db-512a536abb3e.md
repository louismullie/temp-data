...
> Let me first confirm the drug class and labeling signal. Abacavir is a nucleoside reverse transcriptase inhibitor, and the FDA labeling for abacavir and its fixed-dose combinations repeatedly warns about lactic acidosis and severe hepatomegaly with steatosis as a class toxicity of nucleoside analogues, including abacavir, so the risk is recognized at the class level rather than unique to abacavir per se [^115komXg] [^115ARcia] [^117WPAEe].
