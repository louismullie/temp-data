...
Hypertension treatment centers on **lifestyle modification for all patients** [^117DKjSW] and **pharmacotherapy when BP is ≥ 140/90 mmHg** or ≥ 130/80 mmHg with high cardiovascular risk [^1177dRHK] [^116K17V8]. First-line drugs include **thiazide-like diuretics, ACE inhibitors, ARBs, and calcium channel blockers** [^113u9ZD3]; beta-blockers are reserved for specific indications [^notfound]. Most patients require **combination therapy** to reach targets, with single-pill combinations preferred to improve adherence [^111rJjTU] [^112XTFfx]. Targets are generally **< 130/80 mmHg** for most adults [^114K5RMJ] if tolerated, with **< 140/90 mmHg** for older or frail patients [^114FFvZw] [^113a1pp9]. Regular monitoring, adherence support, and addressing resistant hypertension are essential to reduce cardiovascular risk [^114ugJqL] [^114PEfYz].
