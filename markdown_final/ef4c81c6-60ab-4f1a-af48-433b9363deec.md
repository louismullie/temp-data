...
> Let me first confirm the pharmacologic basics and absorption profile. Topical tretinoin is a retinoid applied to the skin for acne; systemic absorption is generally low but not zero, and it is influenced by skin integrity, surface area treated, and formulation, which means I should not assume negligible exposure even with local use [^113yutJi] [^notfound].
