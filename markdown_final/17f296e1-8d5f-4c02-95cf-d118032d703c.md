...
> Let me first confirm the clinical problem and its burden. Uterine fibroids are the most common benign pelvic tumors in reproductive-age women, with lifetime prevalence estimates ranging from about 20% to 80% depending on ascertainment method, and they are the leading benign indication for hysterectomy in the United States and globally, accounting for roughly one-third to one-half of hysterectomies, which underscores their substantial morbidity and economic impact [^113mHfya] [^117NRG8V] [^1178JKKK].
