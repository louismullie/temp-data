...
> Let me first confirm the clinical frame. Most sore throats are viral and self-limited, so symptomatic relief is the primary goal, whereas antibiotics are reserved for confirmed or high-likelihood bacterial pharyngitis, typically group A streptococcus, where benefits are modest and complication prevention is the key rationale rather than dramatic symptom relief [^d230c660] [^2d54ac5a].

> I will now examine corticosteroids because multiple high-quality meta-analyses suggest a modest but clinically meaningful benefit. Wait, let me verify the magnitude and timing. Single low-dose dexamethasone increases the likelihood of complete pain resolution at 24 hours by about 2.2-fold and at 48 hours by about 1.5-fold, and accelerates onset of pain relief by roughly 4–6 hours and complete resolution by about 11 hours, with an absolute pain reduction around 1.3 points on a 0–10 scale at 24 hours, which exceeds the minimal clinically important difference of about 1 point [^8deb9c41] [^9165f8f2] [^5d82f6c0]. Hold on, I should confirm applicability. The effect appears consistent across adults and children 5 years and older, in primary care and emergency settings, and regardless of whether antibiotics are given, though the absolute benefit is smaller in milder disease, which supports selective use rather than routine administration [^798d6aab] [^6accebef].

> Next, I should review NSAIDs and acetaminophen. Guidelines consistently recommend ibuprofen or acetaminophen as first-line symptomatic therapy for acute sore throat, and although acetaminophen helps some cold symptoms, evidence for direct improvement in sore throat is limited and inconsistent, so I need to be cautious not to overstate its effect on throat pain specifically [^4de74f63] [^5a337339]. Let me reconsider NSAIDs. Systemic NSAIDs reduce pain and fever in acute infections, and locally delivered flurbiprofen 8.75 mg provides rapid, clinically meaningful relief with onset within minutes and duration up to 4–6 hours, which can be particularly useful when patients need fast relief without systemic exposure, though I should note that much of the flurbiprofen data are from narrative reviews and non-inferiority trials rather than Cochrane-grade syntheses [^d0b5ca45] [^3816675f] [^c769b434].

> Now, antibiotics. I should double-check the size of benefit. Antibiotics shorten sore throat symptoms by about 16 hours on average and reduce the risk of some suppurative complications, with the clearest signal for acute otitis media and quinsy, but the absolute symptom benefit is modest and the number needed to treat for early pain relief is around 5–6, rising to about 18–21 by one week as most patients improve spontaneously, so antibiotics should be reserved for confirmed or high-likelihood GAS pharyngitis or when complications are a concern [^d230c660] [^a04ed56d] [^2d54ac5a]. Hold on, let's not jump to conclusions. In patients with negative testing or low pretest probability, the benefit is smaller and the harms of overtreatment, including resistance and adverse effects, outweigh the gains, reinforcing a test-and-treat or delayed prescribing approach in primary care [^d230c660] [^6589bf93].

> Let me synthesize a practical hierarchy. First-line should be simple analgesics such as ibuprofen or acetaminophen for all patients, with consideration of a single low-dose corticosteroid in those with moderate to severe pain after shared decision-making, and local flurbiprofen as an adjunct for rapid relief, while antibiotics are reserved for confirmed or high-likelihood GAS infection or when complications are a concern, ideally guided by Centor/McIsaac criteria and rapid testing to avoid unnecessary prescribing [^4de74f63] [^e1343971] [^6589bf93] [^2d54ac5a]. I should confirm dosing. Dexamethasone 10 mg orally or intramuscularly once, or 0.6 mg/kg up to 10 mg in children, is the typical regimen studied, and flurbiprofen 8.75 mg lozenge or spray can be used every 3–6 hours as needed, with attention to NSAID precautions in those with contraindications [^a394fded] [^d0b5ca45].

> But wait, what about safety and special populations. I need to ensure I flag contraindications to corticosteroids such as uncontrolled diabetes, active tuberculosis, systemic fungal infection, or immunosuppression, and counsel that repeated steroid bursts for recurrent sore throat are discouraged due to cumulative risks, which is why guidelines frame this as a weak recommendation for selective use rather than routine care [^e1343971] [^a394fded]. For children under 5, evidence is limited and corticosteroids are not routinely recommended, so I should avoid extrapolating adult data to very young children and prioritize acetaminophen or ibuprofen with careful clinical judgment [^798d6aab].

> Finally, I should double-check that my bottom line aligns with the evidence. Effective options with the best balance of benefit and safety include NSAIDs and acetaminophen for all, single-dose corticosteroids for moderate to severe pain after shared decision-making, and local flurbiprofen for rapid relief, while antibiotics are reserved for confirmed or high-likelihood bacterial pharyngitis given their modest symptom benefit and important role in complication prevention in the right patients [^77842d28] [^8deb9c41] [^d0b5ca45] [^d230c660] [^2d54ac5a].

---

Effective medications for sore throat include **NSAIDs (ibuprofen)** [^77842d28] and **acetaminophen** for pain and fever relief [^934bddda], with **corticosteroids (single-dose dexamethasone)** as an adjunct for severe pain or dysphagia [^8deb9c41] [^e1343971]. Antibiotics are **not routinely recommended** [^d230c660] because most sore throats are viral; reserve them for confirmed or high-risk bacterial cases (e.g. GAS) [^2d54ac5a] [^6589bf93]. Local flurbiprofen 8.75 mg (lozenge or spray) provides rapid, short-term relief [^d0b5ca45] [^3816675f] and is a useful alternative when systemic NSAIDs are unsuitable. Avoid routine corticosteroids in mild cases due to limited benefit and potential harms [^896897cc].

---

## Analgesics and antipyretics

Analgesics and antipyretics are **first-line** for symptomatic relief of sore throat, reducing pain and fever [^77842d28].
...
Corticosteroids provide **modest, short-term relief** of severe sore throat, particularly with dysphagia or odynophagia [^8deb9c41] [^e1343971].

- **Efficacy**: Single low-dose dexamethasone (oral or intramuscular) increases the likelihood of complete pain resolution at 24–48 hours and reduces time to pain relief by ~4–6 hours [^8deb9c41] [^9165f8f2].
- **Safety**: Short-term use is generally safe; avoid in immunocompromised patients, those with systemic infections, or recurrent episodes due to potential cumulative effects [^a394fded].
- **Guidelines**: Weak recommendation for adjunctive use in severe cases; not routine for mild sore throat [^e1343971] [^896897cc].

---

## Antibiotics

Antibiotics are **not routinely recommended** for sore throat because most cases are viral [^d230c660]; reserve for confirmed or high-risk bacterial infections, such as group A streptococcus (GAS) [^2d54ac5a].

- **Efficacy**: Modest symptom reduction (~16 hours) and reduced risk of complications (e.g. acute otitis media, peritonsillar abscess, rheumatic fever) in bacterial cases [^d230c660] [^a04ed56d].
- **Guidelines**: Use only with positive rapid antigen test or high clinical suspicion (e.g. Centor/McIsaac score ≥ 3) [^ed6dc241] [^6589bf93].
- **First-line antibiotics**: Penicillin V or amoxicillin; alternatives for penicillin allergy include cephalosporins, macrolides, or clindamycin [^2d54ac5a] [^7bd28471].

---

## Local anesthetics and topical agents

Local anesthetics and topical agents provide **short-term relief** of sore throat symptoms [^d0b5ca45].

- **Flurbiprofen 8.75 mg (lozenge or spray)**: Rapid onset (1–2 minutes), duration 3–4 hours; effective for pain, dysphagia, and swollen throat sensation [^d0b5ca45] [^3816675f].
- **Lidocaine-containing products**: Short-term numbing relief; limited evidence for significant clinical benefit [^82f454e8].
...
Effective medications for sore throat include **NSAIDs and acetaminophen** for pain and fever, with corticosteroids as adjuncts for severe symptoms [^77842d28] [^8deb9c41]. Antibiotics are reserved for confirmed bacterial cases, and local flurbiprofen offers rapid, short-term relief [^d230c660] [^d0b5ca45].
...
### Corticosteroids for sore throat: a clinical practice guideline [^a394fded]. BMJ (2017). Excellent credibility.
...
### Antibiotics for sore throat [^a04ed56d]. The Cochrane Database of Systematic Reviews (2013). Low credibility.
...
### Effect of oral dexamethasone without immediate antibiotics vs placebo on acute sore throat in adults: a randomized clinical trial [^a86dee3a]. JAMA (2017). Excellent credibility.
...
### Antibiotics for the treatment of sore throat… [^9c1318f6]. AAFP (2022). Medium credibility.
...
### Antibiotics for sore throat… [^ca7c9d29]. AAFP (2014). Low credibility.
...
### Corticosteroids for pain relief in sore throat: systematic review and meta-analysis [^5d8210fa]. BMJ (2009). Excellent credibility.
...
### Corticosteroids for pain relief in sore throat: systematic review and meta-analysis [^1011ce03]. BMJ (2009). Excellent credibility.
...
### Corticosteroids for pain relief in sore throat: systematic review and meta-analysis [^81111393]. BMJ (2009). Excellent credibility.
...
### Effect of oral dexamethasone without immediate antibiotics vs placebo on acute sore throat in adults: a randomized clinical trial [^623a593a]. JAMA (2017). Excellent credibility.
...
### Corticosteroids for treatment of sore throat: systematic review and meta-analysis of randomised trials [^5ae1746d]. BMJ (2017). Excellent credibility.
...
### Corticosteroids for treatment of sore throat: systematic review and meta-analysis of randomised trials [^d096636a]. BMJ (2017). Excellent credibility.
...
### Ear acupuncture for acute sore throat: a randomized controlled trial [^0f1b3b02]. Journal of the American Board of Family Medicine (2015). Low credibility.
...
### Comparative efficacy of 6 topical pharmacological agents for preventive interventions of postoperative sore throat after tracheal intubation: a systematic review and network meta-analysis [^3c1cc9a2]. Anesthesia and Analgesia (2021). Medium credibility.
...
### Locally delivered flurbiprofen 8.75 mg for treatment and prevention of sore throat: a narrative review of clinical studies [^990f05ea]. Journal of Pain Research (2019). Medium credibility.
...
### Corticosteroids for pain relief in sore throat: systematic review and meta-analysis [^1e37d7fe]. BMJ (2009). Excellent credibility.
...
### Efficacy of flurbiprofen 8.75 mg delivered as a spray or lozenge in patients with sore throat due to upper respiratory tract infection: a randomized, non-inferiority trial in the Russian Federation [^c769b434]. Journal of Pain Research (2017). Low credibility.
...
### Corticosteroids for pain relief in sore throat: systematic review and meta-analysis [^ed980b7c]. BMJ (2009). Excellent credibility.
...
### Comparative efficacy of 6 topical pharmacological agents for preventive interventions of postoperative sore throat after tracheal intubation: a systematic review and network meta-analysis [^d5f7acc5]. Anesthesia and Analgesia (2021). Medium credibility.
...
### Corticosteroids for pain relief in sore throat: systematic review and meta-analysis [^d1039ccb]. BMJ (2009). Excellent credibility.
...
### Are sore throat patients who hope for antibiotics actually asking for pain relief? [^db574fd9]. Annals of Family Medicine (2006). Low credibility.
...
### Efficacy of flurbiprofen 8.75 mg delivered as a spray or lozenge in patients with sore throat due to upper respiratory tract infection: a randomized, non-inferiority trial in the Russian Federation [^cd842495]. Journal of Pain Research (2017). Low credibility.
...
### Effects of acetylsalicylic acid on sore throat pain and other pain symptoms associated with acute upper respiratory tract infection [^bf976738]. Pain Medicine (2003). Low credibility.
...
### Recommendations for prevention and control of influenza in children, 2023–2024 [^db677bcd]. Pediatrics (2023). Medium credibility.
...
### Corticosteroids for pain relief in sore throat: systematic review and meta-analysis [^78ca2f24]. BMJ (2009). Excellent credibility.
...
### Tonsillectomy: a cost-effective option for childhood sore throat? Further analysis of a randomized controlled trial [^f64693ce]. Otolaryngology — Head and Neck Surgery (2012). Low credibility.
...
### Postoperative sore throat after tracheal intubation: an updated narrative review and call for action [^fc0690f8]. Journal of Pain Research (2025). Medium credibility.
...
### Corticosteroids for pain relief in sore throat: systematic review and meta-analysis [^3e1a43e0]. BMJ (2009). Excellent credibility.
...
### Lidocaine for preventing postoperative sore throat [^0adfc9eb]. The Cochrane Database of Systematic Reviews (2009). Low credibility.
...
### The impact of national guidelines on the diagnostics of sore throat in children [^fdc41e31]. BMC Pediatrics (2024). Medium credibility.
...
### Acetaminophen (paracetamol) for the common cold in adults [^5a337339]. The Cochrane Database of Systematic Reviews (2013). Low credibility.
...
### Efficacy of flurbiprofen 8.75 mg delivered as a spray or lozenge in patients with sore throat due to upper respiratory tract infection: a randomized, non-inferiority trial in the Russian Federation [^a3a1b80e]. Journal of Pain Research (2017). Low credibility.
...
### Recommendations for prevention and control of influenza in children, 2024–2025: policy statement [^a24bb924]. Pediatrics (2024). Medium credibility.
