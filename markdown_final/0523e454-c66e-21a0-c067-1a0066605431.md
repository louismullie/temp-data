...
> Next, I should review NSAIDs and acetaminophen. Guidelines consistently recommend ibuprofen or acetaminophen as first-line symptomatic therapy for acute sore throat, and although acetaminophen helps some cold symptoms, evidence for direct improvement in sore throat is limited and inconsistent, so I need to be cautious not to overstate its effect on throat pain specifically [^77842d28] [^5a337339]. Let me reconsider NSAIDs. Systemic NSAIDs reduce pain and fever in acute infections, and locally delivered flurbiprofen 8.75 mg provides rapid, clinically meaningful relief with onset within minutes and duration up to 4–6 hours, which can be particularly useful when patients need fast relief without systemic exposure, though I should note that much of the flurbiprofen data are from narrative reviews and non-inferiority trials rather than Cochrane-grade syntheses [^d0b5ca45] [^3816675f] [^c769b434].
...
> Let me synthesize a practical hierarchy. First-line should be simple analgesics such as ibuprofen or acetaminophen for all patients, with consideration of a single low-dose corticosteroid in those with moderate to severe pain after shared decision-making, and local flurbiprofen as an adjunct for rapid relief, while antibiotics are reserved for confirmed or high-likelihood GAS infection or when complications are a concern, ideally guided by Centor/McIsaac criteria and rapid testing to avoid unnecessary prescribing [^77842d28] [^e1343971] [^6589bf93] [^2d54ac5a]. I should confirm dosing. Dexamethasone 10 mg orally or intramuscularly once, or 0.6 mg/kg up to 10 mg in children, is the typical regimen studied, and flurbiprofen 8.75 mg lozenge or spray can be used every 3–6 hours as needed, with attention to NSAID precautions in those with contraindications [^a394fded] [^d0b5ca45].
