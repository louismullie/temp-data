...
> Let me first confirm the clinical frame and why "sinus pressure pain" is often misattributed. Many patients with facial pain or pressure are actually experiencing primary headache disorders, particularly migraine, rather than true rhinosinusitis; misdiagnosis rates of 50–80% are reported, and migraine frequently co-occurs with nasal symptoms, which can mislead clinicians and patients alike [^3e91bcf5] [^751966e0]. Hold on, let's not jump to conclusions; I should verify objective findings before labeling a case as sinus disease, because facial pain without purulent discharge or obstruction is insufficient for a rhinosinusitis diagnosis and should prompt consideration of neurologic etiologies [^7621a19e] [^1c9682af].
...
> For acute bacterial rhinosinusitis, I should confirm that antibiotics are indicated when symptoms persist beyond 10 days or worsen after initial improvement, and then choose an agent with narrow coverage. Amoxicillin or amoxicillin-clavulanate remains first-line in most adults, with doxycycline as an alternative in penicillin allergy, and I should avoid unnecessary broad-spectrum agents or prolonged courses [^notfound]. Wait, I initially thought a 10–14 day course was standard, but I should double-check; many contemporary guidelines endorse 5–7 days for uncomplicated ABRS, balancing efficacy and stewardship, so I will correct to a 5–7 day course unless there are complicating factors [^notfound]. I need to ensure symptomatic relief is addressed in parallel with analgesics, saline irrigation, and optional intranasal steroids, and I should arrange follow-up to reassess at 3–5 days if not improving [^64b07c1a] [^3345f048].
...
> I need to ensure I address red flags and complications. Severe unilateral pain with ophthalmoplegia, visual changes, or altered mental status suggests orbital or intracranial extension and mandates urgent imaging and specialty referral, as delays can lead to significant morbidity [^notfound]. Persistent, severe facial pain with normal sinus imaging should trigger evaluation for alternative etiologies such as trigeminal neuralgia, temporomandibular joint disorders, or atypical migraines, preventing unnecessary sinus procedures [^e742f916]. Hold on, I should verify that I am not anchoring on sinus disease when the clinical course is atypical; interdisciplinary care improves diagnostic accuracy and outcomes in complex facial pain presentations [^d082d1ad].
