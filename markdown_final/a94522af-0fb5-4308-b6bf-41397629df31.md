...
> Next, I should review the son's risk. For each son of a carrier mother, there is a 50% chance he inherits the maternal X with the mutation and has hemophilia, and a 50% chance he inherits the maternal X without the mutation and is unaffected. I should double-check that probability: yes, it is 1 in 2 for sons of a known carrier, independent of the grandfather's phenotype severity [^115pX1DZ] [^notfound].
