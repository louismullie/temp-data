...
> Let me first confirm the definition and core mechanism. Extrapyramidal reactions are drug-induced movement disorders caused predominantly by dopamine D2 receptor blockade in the nigrostriatal pathway, disrupting motor control circuits and producing parkinsonism, dystonia, akathisia, and tardive dyskinesia. This mechanism explains why antipsychotics and dopamine-blocking antiemetics are frequent culprits, and why the risk rises with higher D2 occupancy beyond roughly 75–85% in many agents, though partial agonists behave differently due to retained intrinsic activity [^111EaoTy] [^113ammhh] [^1167y5C4].
