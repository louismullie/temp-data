...
> Next, I should review the clinical scenarios that trigger isotretinoin to ensure I'm not missing a primary care pathway. Isotretinoin is indicated for severe nodular acne and for moderate acne that is treatment-resistant or causing scarring or significant psychosocial burden; in these situations, guidelines emphasize timely referral for specialist evaluation rather than primary care initiation, given the risk profile and the need for experienced counseling and monitoring [^116eoULC] [^115FZBzG] [^11722LS1]. Hmm, wait a minute, I almost implied that primary care could start isotretinoin for moderate scarring acne; I should correct that — guidelines recommend isotretinoin in these cases but still situate initiation within specialist care due to safety and REMS requirements [^116eoULC] [^11722LS1].

> I will now examine whether any economic analyses suggest a primary care role. Cost-effectiveness studies of acne treatments within NHS pathways model isotretinoin use in secondary care contexts and incorporate specialist monitoring and iPLEDGE-like processes, reinforcing that the resource use and accountability structures are not aligned with routine primary care initiation. Let me reconsider if any of these models explicitly allow GP-led initiation; I do not see evidence supporting primary care initiation in these analyses, which assume dermatology-led prescribing and follow-up [^111smCSK].
