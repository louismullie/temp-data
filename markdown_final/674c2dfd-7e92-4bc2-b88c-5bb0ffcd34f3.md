...
> I will now examine whether any economic analyses suggest a primary care role. Cost-effectiveness studies of acne treatments within NHS pathways model isotretinoin use in secondary care contexts and incorporate specialist monitoring and iPLEDGE-like processes, reinforcing that the resource use and accountability structures are not aligned with routine primary care initiation. Let me reconsider if any of these models explicitly allow GP-led initiation; I do not see evidence supporting primary care initiation in these analyses, which assume dermatology-led prescribing and follow-up [^notfound].
