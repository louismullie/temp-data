...
> Let me first confirm the drug identity and core pharmacology. Formoterol is a long-acting beta2-agonist with rapid onset, typically within 1–3 minutes, and a duration around 12 hours, which underpins its use both as maintenance bronchodilation and as a reliever when combined with an inhaled corticosteroid in single-inhaler regimens [^4adef1d0] [^9ea85ba7]. Wait, let me verify the receptor selectivity claim; in vitro data show more than 200-fold greater beta2 versus beta1 activity, which aligns with the clinical bronchodilator profile and relatively lower cardiac signal at therapeutic doses, though clinical extrapolation should be cautious [^59045867].
