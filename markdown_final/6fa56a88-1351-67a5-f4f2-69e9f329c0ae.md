...
Let the three-digit number be represented as N = 100a + 10b + c, where a, b, and c are the digits, with a ∈ {1, 2, …, 9} and b, c ∈ {0, 1, …, 9}. The sum of the digits is S = a + b + c. The ratio to maximize is:
