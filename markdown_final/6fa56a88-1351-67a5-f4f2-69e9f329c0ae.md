...
### Evaluation of changes in prices and purchases following implementation of sugar-sweetened beverage taxes across the US [^116RLW7s]. JAMA Health Forum (2024). High credibility.
...
### Explainable automated evaluation of the clock drawing task for memory impairment screening [^116qLSJJ]. Alzheimer's & Dementia (2023). Medium credibility.
...
### Spontaneous sparse learning for PCM-based memristor neural networks [^112TxTQj]. Nature Communications (2021). High credibility.
...
### Perceiving numbers causes spatial shifts of attention [^116GyDAn]. Nature Neuroscience (2003). Medium credibility.
...
### An optical neural network using less than 1 photon per multiplication [^115iCgLP]. Nature Communications (2022). High credibility.
...
### Increased ratio of 2nd to 4th digit (2D: 4D) in schizophrenia [^111eCvXS]. Psychiatry Research (2010). Low credibility.
...
### Investigating the synergistic effects of hormone replacement therapy, apolipoprotein E and age on brain health in the UK biobank [^1179nrnZ]. Human Brain Mapping (2024). Medium credibility.
...
### Remote digital cognitive assessment reveals cognitive deficits related to hippocampal atrophy in autoimmune limbic encephalitis: a cross-sectional validation study [^111gS3cL]. EClinicalMedicine (2024). Medium credibility.
...
### Relationships between cognitive performance, clinical insight and regional brain volumes in schizophrenia [^112R1cAC]. Schizophrenia (2022). Medium credibility.
...
### Findings of addition and subtraction in infants are robust and consistent: reply to wakeley, rivera, and langer [^116AA1B8]. Child Development (2001). Low credibility.
...
### Network analysis of stroke systems of care in Korea [^111TBP8m]. BMJ Neurology Open (2024). High credibility.
...
### Serum neurofilament light chain levels are associated with all-cause mortality in the general US population [^111EeDXM]. Journal of Neurology (2023). Medium credibility.
...
### An analog-AI chip for energy-efficient speech recognition and transcription [^114i7P49]. Nature (2023). Excellent credibility.
...
### Assessing accuracy in linkage analysis by means of confidence regions [^112jWz6D]. Genetic Epidemiology (2003). Low credibility.
...
### Cell-specific proteome analyses of human bone marrow reveal molecular features of age-dependent functional decline [^112Ld5WJ]. Nature Communications (2018). Medium credibility.
...
### Investigation of the association of the second-to-fourth digit ratio with skin sebum levels in females with acne vulgaris [^11616T5B]. American Journal of Clinical Dermatology (2015). Low credibility.
...
### Deciphering neuronal variability across States reveals dynamic sensory encoding [^113Z8E9n]. Nature Communications (2025). High credibility.
...
### The eighty five percent rule for optimal learning [^112npN2B]. Nature Communications (2019). High credibility.
...
### Social capital and health among older adults in South Africa [^1173tuik]. BMC Geriatrics (2013). Low credibility.
...
### The Nebraska nomogram for autograft planning (NNAP) a surgical planning tool for ipsilateral rotational autokeratoplasty [^112MUg9o]. NPJ Digital Medicine (2025). Medium credibility.
...
### An iterative approach for estimating domain-specific cognitive abilities from large scale online cognitive data [^116j5ing]. NPJ Digital Medicine (2024). Medium credibility.
...
### NCCN guidelines® insights: Hodgkin lymphoma, version 2.2022 [^116mDm1e]. Journal of the National Comprehensive Cancer Network (2022). High credibility.
...
### Digit-tracking as a new tactile interface for visual perception analysis [^1168oZwa]. Nature Communications (2019). High credibility.
...
### Altered brain metabolism contributes to executive function deficits in school-aged children born very preterm [^113R4F4Y]. Pediatric Research (2020). Medium credibility.
...
### Digital immunoassay for biomarker concentration quantification using solid-state nanopores [^114EfTt7]. Nature Communications (2021). High credibility.
...
### Treatment for executive dysfunction in adult survivors of childhood… [^116MZaCp]. ClinicalTrials (2018). Low credibility.
...
### Hand pain and sensory deficits: carpal tunnel syndrome [^117U2VUF]. The Journal of Orthopaedic and Sports Physical Therapy (2019). High credibility.
...
### Comprehensive cell type decomposition of circulating cell-free DNA with celFiE [^114UxrB1]. Nature Communications (2021). High credibility.
...
### An iterative approach for estimating domain-specific cognitive abilities from large scale online cognitive data [^113u3QSD]. NPJ Digital Medicine (2024). Medium credibility.
...
### Augmented manipulation ability in humans with six-fingered hands [^111uKPD1]. Nature Communications (2019). High credibility.
...
### Optimization of diffusion measurements using cramer-rao lower bound theory and its application to articular cartilage [^116oB5RK]. Magnetic Resonance in Medicine (2003). Low credibility.
...
### A computational study on the optimization of transcranial temporal interfering stimulation with high-definition electrodes using unsupervised neural networks [^116uqwNf]. Human Brain Mapping (2023). Medium credibility.
...
### HER2 testing and clinical decision making in gastroesophageal adenocarcinoma: guideline from the college of American pathologists, American Society for Clinical Pathology, and American Society of Clinical Oncology [^115Nn7GV]. American Journal of Clinical Pathology (2016). Medium credibility.
...
### 2018 ACC / HRS / NASCI / SCAI / SCCT expert consensus document on optimal use of ionizing radiation in cardiovascular imaging: best practices for safety and effectiveness [^115CNXDd]. Catheterization and Cardiovascular Interventions (2018). Medium credibility.
...
### Explainable automated evaluation of the clock drawing task for memory impairment screening [^116xvfAx]. Alzheimer's & Dementia (2023). Medium credibility.
...
### Cystic Fibrosis Foundation position paper: redefining the cystic fibrosis care team [^116LiMQ2]. Journal of Cystic Fibrosis (2024). High credibility.
...
### 2022 ASNC / AAPM / SCCT / SNMMI guideline for the use of CT in hybrid nuclear / CT cardiac imaging [^115Ksuu3]. Journal of Nuclear Cardiology (2022). High credibility.
