...
> Let me first confirm the algebraic setup. A three-digit number can be written as 100a + 10b + c, where a is the hundreds digit (1–9), and b and c are the tens and units digits (0–9). The sum of the digits is a + b + c, so the ratio we want to maximize is (100a + 10b + c)/(a + b + c) [^notfound].
