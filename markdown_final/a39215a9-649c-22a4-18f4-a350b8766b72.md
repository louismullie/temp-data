...
> Hold on, I should verify the clinical patterns and latency because they guide vigilance: amoxicillin-clavulanate classically produces a cholestatic or mixed pattern, often with delayed onset, with symptoms arising during therapy or several weeks after completion. Mean time to jaundice is about 16 days, and late presentations after therapy ends are not rare, which is why clinicians should maintain suspicion even after the course is finished [^114JJ9Jw] [^117Y19x3].
