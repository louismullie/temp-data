...
> I should confirm the routine target age. ACIP recommends routine HPV vaccination at age 11 or 12 years, but vaccination can start at age 9 years; the ACS explicitly encourages initiation between ages 9 and 12 years to maximize on-time completion and population impact, and this early start is supported by higher series completion rates and durable immunogenicity when given before age 13 years [^116cr7qi] [^116Uyo7b] [^112DsrR6] [^1114msT4].
...
> Wait, let me verify the vaccine formulation landscape. In the U.S., only the 9-valent HPV vaccine (Gardasil 9) is currently distributed; it covers HPV 6, 11, 16, 18, 31, 33, 45, 52, and 58, expanding protection beyond the quadrivalent formulation; historical bivalent and quadrivalent products are no longer available, though prior series with those products are considered valid and need not be repeated if already complete [^117GtUtk] [^114mwdj3].
