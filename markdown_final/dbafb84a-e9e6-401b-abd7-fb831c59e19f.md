...
**Sample ID**: dbafb84a-e9e6-401b-abd7-fb831c59e19f
**Dataset Index**: 2057
...
> Let's see… What do we have here? The user is asking for current HPV vaccination recommendations. Let's break this down step-by-step. First, I need to think about the overarching goals and scope of HPV vaccination programs. Then, I should verify the routine target age and the rationale for starting early. Next, I will examine the catch-up age range and the harmonized adult policy. After that, I need to check the dosing schedules by age at initiation and immunocompromise status. I will then review vaccine formulations and special populations, including pregnancy and HIV. Finally, I should consider implementation strategies, safety, and screening implications, and close with a concise, clinically actionable summary that aligns with ACIP, CDC, and ACS guidance [^116cr7qi] [^115bJgXr].

> Let me first confirm the core public health objective: HPV vaccination aims to prevent HPV infections and HPV-associated diseases, notably cervical, anal, oropharyngeal, vaginal, vulvar, and penile cancers, as well as anogenital warts, with the 9-valent vaccine covering the types responsible for about 92% of HPV-attributable cancers in the U.S., which anchors the emphasis on early adolescent vaccination before sexual exposure [^117GtUtk] [^116N9XwR].

> I should confirm the routine target age. ACIP recommends routine HPV vaccination at age 11 or 12 years, but vaccination can start at age 9 years; the ACS explicitly encourages initiation between ages 9 and 12 years to maximize on-time completion and population impact, and this early start is supported by higher series completion rates and durable immunogenicity when given before age 13 years [^116cr7qi] [^115bJgXr] [^112DsrR6] [^1114msT4].

> Hold on, let's not jump to conclusions about catch-up; I need to verify the harmonized adult recommendation. ACIP updated catch-up vaccination to include all persons through age 26 years who are not adequately vaccinated, regardless of gender, aligning previously disparate catch-up windows for males and females; the ACS endorses catch-up through 26 years but emphasizes that effectiveness wanes with age and does not endorse routine vaccination beyond 26 years due to low incremental benefit [^116cr7qi] [^117V4vuf] [^115bJgXr].

> Next, I should review dosing by age at initiation and immune status. For immunocompetent adolescents who initiate the series before the 15th birthday, a 2-dose schedule at 0 and 6–12 months is recommended; if the interval between dose 1 and dose 2 is less than 5 months, a third dose is required to ensure adequate immunogenicity; for those who start at age 15 years or older, and for immunocompromised persons of any age, a 3-dose schedule at 0, 1–2, and 6 months is recommended; I should double-check that this applies to all 9–26-year-olds starting at 15, which it does per ACIP and CDC schedules [^113gXKx3] [^117DYJpC] [^111GqQsK] [^112Mmfqf].

> Wait, let me verify the vaccine formulation landscape. In the U.S., only the 9-valent HPV vaccine (Gardasil 9) is currently distributed; it covers HPV 6, 11, 16, 18, 31, 33, 45, 52, and 58, expanding protection beyond the quadrivalent formulation; historical bivalent and quadrivalent products are no longer available, though prior series with those products are considered valid and need not be repeated if already complete [^117GtUtk] [^112mfPVk].

> I need to ensure special population nuances are addressed. For pregnancy, HPV vaccination should be delayed until after pregnancy; no pregnancy test is required before vaccination, and inadvertent administration during pregnancy does not require intervention beyond deferring remaining doses; for people with HIV or other immunocompromising conditions, a 3-dose schedule is recommended regardless of age at initiation because immunogenicity may be attenuated; for adults aged 27–45 years, ACIP supports shared clinical decision-making, but the ACS does not endorse routine vaccination in this group due to low effectiveness and limited cancer prevention potential, so clinicians should individualize discussions based on risk and likelihood of new exposure [^1118JDtB] [^114JH6B7] [^115VTLKr] [^115bJgXr].

> Let me consider implementation and operational strategies. Starting at age 9–10 years can improve series completion by age 13, and presumptive, same-day recommendations alongside other adolescent vaccines increase uptake; school-based programs and multi-age catch-up campaigns are particularly impactful in LMIC settings and can be adapted to U.S. community strategies; cost-effectiveness modeling supports 2-dose schedules for 9–14-year-olds as operationally simpler with population-level impact comparable to 3-dose schedules in many contexts [^112DsrR6] [^112m4261] [^1157Bdan] [^117LcwCV].

> I should confirm safety and monitoring. HPV vaccines have an excellent safety profile with > 120 million doses administered in the U.S.; serious adverse events are rare and comparable to controls in trials, though long-term comparative harms data are limited and rely on post-marketing surveillance; common adverse effects are local injection-site reactions, and no safety signals have emerged that alter the risk–benefit calculus for recommended ages [^1145Eq4P] [^1125ySnB] [^113VutRk].

> But wait, what about screening implications after vaccination; I need to check that guidance. Vaccinated individuals should continue routine cervical cancer screening according to age-based guidelines because vaccination does not obviate the need for screening, and the impact of vaccination on screening algorithms is still evolving as vaccinated cohorts mature; USPSTF and ACS screening recommendations remain in force for vaccinated women [^115fo61P] [^117FvKr1].

> Let me reconsider the key messages to ensure internal consistency. Routine vaccination at 11–12 years, allow initiation at 9 years, catch-up through 26 years for all, 2 doses if starting before age 15, 3 doses if starting at 15 or older or if immunocompromised, use 9-valent vaccine exclusively in the U.S., avoid vaccination in pregnancy, and apply shared decision-making cautiously for ages 27–45 years; this synthesis aligns with ACIP, CDC, and ACS positions and reflects the evidence on immunogenicity, effectiveness, and public health impact [^116cr7qi] [^111GqQsK] [^115bJgXr].
...
- **Routine age**: 11–12 years [^113gXKx3], but can start at 9 years [^115bJgXr].
- **2-dose schedule**: for those starting before age 15; doses at 0 and 6–12 months [^1145Eq4P]; if the interval is < 5 months, give a third dose [^111GqQsK].
- **3-dose schedule**: for those starting at age 15 or older, or for immunocompromised individuals; doses at 0, 1–2, and 6 months [^113gXKx3] [^114JH6B7].

---

## Catch-up vaccination

Catch-up vaccination is recommended through **age 26** for all who are not adequately vaccinated [^116cr7qi]. For ages 27–45, use **shared clinical decision-making** because of lower effectiveness [^116BC19n] [^115bJgXr].

---

## Special populations

- **Immunocompromised individuals**: 3-dose schedule regardless of age at initiation [^1145Eq4P].
- **Pregnancy**: delay vaccination until after pregnancy; no routine pregnancy testing before vaccination [^1118JDtB].
- **Breastfeeding**: vaccination is safe [^115y46MR].

---

## Vaccine types

The **9-valent vaccine (Gardasil 9)** is preferred and covers HPV types 6, 11, 16, 18, 31, 33, 45, 52, and 58 [^113sYPjh] [^112mfPVk].

---

## Clinical evidence supporting recommendations

- **Effectiveness**: HPV vaccination significantly reduces HPV infections, genital warts, and cervical precancers [^1131haP8] [^116N9XwR].
- **Safety**: HPV vaccines have a strong safety record with no serious safety signals identified [^1145Eq4P] [^111GqQsK].

---

## Implementation strategies

Implementation strategies include **provider recommendations** — clinicians should give a strong, routine recommendation — and **school-based programs**, which improve uptake and completion [^112m4261] [^117Q5KtZ] [^1131haP8].

---

HPV vaccination is **recommended for all adolescents at 11–12 years** [^113gXKx3], with a 2-dose schedule if started before age 15 and a 3-dose schedule if started at 15 or older or for immunocompromised individuals [^111GqQsK] [^114JH6B7]. Catch-up vaccination is recommended through age 26 [^116cr7qi], with shared clinical decision-making for ages 27–45 [^116BC19n]. The 9-valent vaccine is preferred [^notfound], and vaccination should occur before sexual debut for optimal protection [^116Uyo7b].
...
### Public health opportunities resulting from sufficient HPV vaccine supply and a single-dose vaccination schedule [^1157Bdan]. Journal of the National Cancer Institute (2023). Medium credibility.
...
### FIGO position statement on the effectiveness and safety of the HPV vaccine [^116nCMSk]. International Journal of Gynaecology and Obstetrics (2025). Medium credibility.

5 VACCINATION SCHEDULES

Current vaccination schedules vary by country and region. The primary target group for HPV vaccination for the prevention of cervical cancer is girls aged 9–14 years, before sexual activity begins. Two‐ and three‐dose schedules were found to result in comparable immune responses in young females in a 2019 Cochrane systematic review. The same review reported that a longer interval (up to 12 months) between doses resulted in a stronger immune response than doses administered at shorter intervals. Although originally recommended as a three‐dose schedule, the demonstration of a comparable immune response and protective benefit from two doses has prompted most guidelines to change to a two‐dose schedule, with a minimum of a 6‐month interval between doses.

Several countries and jurisdictions have updated their HPV vaccination recommendations to include a single‐dose schedule, with a growing body of evidence supporting its effectiveness, especially when administered at a young age. These include not only LMICs but also high‐income countries such as Australia, Canada, the UK and several others. A single‐dose HPV vaccine has efficacy similar to that of two‐ or three‐dose schedules in studies evaluating short‐term protection. The longest follow‐up to date was the India IARC trial, in which an average follow‐up of 12 years showed comparable effectiveness. Further studies and long‐term follow‐ups of single‐dose vaccination schedules are ongoing to ensure that similar efficacies persist. Vaccine availability, adherence, and budget limitations are just some of the vaccine implementation challenges, and a single‐dose schedule is a potential solution to this, allowing rapid and broader coverage and expediting achievement of the elimination goal. The WHO recommends a single dose as an option for those up to 20 years of age and a two‐dose recommendation for those aged over 21 years. Three doses are recommended for immunocompromised individuals.
...
### Persistence of immunity when using different human papillomavirus vaccination schedules and booster-dose effects 5 years after primary vaccination [^111wkEeC]. The Journal of Infectious Diseases (2019). Medium credibility.

Evidence from human papillomavirus (HPV) vaccines continues to emerge, demonstrating their high immunogenicity and efficacy against HPV infection, cervical precancer, and invasive cancer. While the first HPV vaccine recommendations suggested a 3-dose scheme, in 2014, the World Health Organization (WHO) recommended the 2-dose regimen for immunocompetent girls between 9 and 14 years old. This decision was based on immunogenicity studies that showed noninferiority of 2 doses of either HPV vaccine in girls aged 9–14 years as compared to 3 doses in young women.

However, several questions about this decision have been voiced in the recent literature. The main concern is that the WHO recommendation is based on comparison of the immune response between girls and women, which could be clouded by differences in immune maturation. A recent meta-analysis suggests that this could be a possibility; pooling results of 2 studies of same-age girls revealed that the 2-dose schedule was inferior to the 3-dose schedule. Similar concerns have been raised about long-term immunogenicity under the 2-dose regimen. A recent randomized clinical trial showed that the 2-dose regimen in girls aged 9–14 years produced an immunogenic response noninferior to that observed with 3 doses in young women after 5 years of follow-up; thus, age differences could still influence this finding. To solve this limitation, further noninferiority trials conducted in immunologically comparable age groups are needed.
...
### Acting on the call: a framework for action for rapid acceleration of access to the HPV vaccination in low-and lower-middle-income countries [^112w1kWR]. International Journal of Gynaecology and Obstetrics (2021). Medium credibility.

5.3 Innovation in dosing and schedule

For the priority target population of girls aged 9–14 years, the HPV vaccine is currently delivered under a two‐dose regimen, at intervals of at least 6 months. 28 LICs/LMICs are challenged to finance two doses of a relatively expensive vaccine, and institute tracking and follow‐up to ensure good coverage of the second dose. 28 A single dose schedule, if effective, thus offers many gains in both cost and simplicity of delivery. Some existing studies show that a single dose of the HPV vaccine may potentially be protective against HPV infection for healthy young girls 29 but the quality of existing evidence is not robust enough for a global recommendation. 30 Randomized controlled trials, observational studies, and modeling analyses are underway to evaluate the efficacy, immunogenicity, effectiveness, and cost‐effectiveness of a single‐dose HPV vaccination. 31 These randomized controlled trials and observational studies, along with ecological studies from Australia, Denmark, Scotland, USA, and Mongolia, will be reporting in the near future and the evidence is expected to be evolving rapidly.

The WHO Strategic Advisory Group of Experts on Immunization (SAGE) will continue to review evidence on the single dose as it becomes available, 30 such that global policy may change in some years. A single dose could be a game changer, by reducing the financial cost of the vaccine, increasing the ease of delivery, and balancing the supply‐versus‐demand scenario.
...
### FIGO position statement on the effectiveness and safety of the HPV vaccine [^113VDQ69]. International Journal of Gynaecology and Obstetrics (2025). Medium credibility.
...
### Use of 9-valent human papillomavirus (HPV) vaccine: updated HPV vaccination recommendations of the advisory committee on immunization practices [^114mwdj3]. MMWR: Morbidity and Mortality Weekly Report (2015). Low credibility.

Administration

2vHPV, 4vHPV, and 9vHPV are each administered in a 3-dose schedule. The second dose is administered at least 1 to 2 months after the first dose, and the third dose at least 6 months after the first dose §. If the vaccine schedule is interrupted, the vaccination series does not need to be restarted.
...
HPV vaccination is recommended through age 26 years for men who have sex with men and for immunocompromised persons (including those with HIV infection) who have not been vaccinated previously or have not completed the 3-dose series.
...
HPV vaccines are not recommended for use in pregnant women. If a woman is found to be pregnant after initiating the vaccination series, the remainder of the 3-dose series should be delayed until completion of pregnancy. Pregnancy testing is not needed before vaccination. If a vaccine dose has been administered during pregnancy, no intervention is needed. A new pregnancy registry has been established for 9vHPV. Pregnancy registries for 4vHPV and 2vHPV have been closed with concurrence from FDA. Exposure during pregnancy can be reported to the respective manufacturer. Patients and health care providers can report an exposure to HPV vaccine during pregnancy to the Vaccine Adverse Event Reporting System (VAERS).

Adverse events occurring after administration of any vaccine should be reported to VAERS. Additional information about VAERS is available by telephone (1–800–822–7967) or online at.

Cervical Cancer Screening

Cervical cancer screening is recommended beginning at age 21 years and continuing through age 65 years for both vaccinated and unvaccinated women. Recommendations will continue to be evaluated as further postlicensure monitoring data become available.
...
### HPV vaccines – A review of the first decade [^113qK8Rs]. Gynecologic Oncology (2017). Low credibility.
...
### Vaccine effectiveness following routine immunization with bivalent human papillomavirus (HPV) vaccine: protection against incident genital HPV infections from a reduced-dosing schedule [^117P4WM3]. The Journal of Infectious Diseases (2022). Medium credibility.

Persistent infections with human papillomavirus (HPV) are associated with development of clinical disease, including anogenital or oropharyngeal cancers (in case of high-risk HPV type infections) and anogenital or laryngeal warts (in case of low-risk HPV type infections). From 2006 onward, 3 vaccines targeting different combinations of HPV types have been registered, which were initially licensed and offered according to a 3-dose (3D) schedule (recommended schedule: 0, 1, and 6 months). The European Medicines Agency licensed a 2-dose (2D) schedule (0 and 6 months) for all available HPV vaccines in 2014 for vaccine recipients aged 9–14 years. Immunobridging studies demonstrated comparable immunogenicity between 9- to 14-year-old 2D-vaccinated and 15- to 26-year-old 3D-vaccinated individuals. As efficacy of vaccination was already shown among 3D vaccine recipients, comparable efficacy was expected after 2 doses in case of noninferior immunogenicity. When comparing girls vaccinated at similarly young age, antibody levels against HPV vaccine types following 2 doses are within acceptable ranges compared to 3 doses, although noninferiority of HPV-18 antibodies is still inconclusive.
...
### Comparison of two dose and three dose human papillomavirus vaccine schedules: cost effectiveness analysis based on transmission model [^117LcwCV]. BMJ (2015). Excellent credibility.
...
### Potential benefit of extended dose schedules of human papillomavirus vaccination in the context of scarce resources and COVID-19 disruptions in low-income and middle-income countries: a mathematical modelling analysis [^111g76X3]. The Lancet: Global Health (2023). High credibility.

Introduction

In 2019, the WHO Strategic Advisory Group of Experts recommended that an extended interval of 3–5 years between the two doses of the human papillomavirus (HPV) vaccine (first dose given around ages 9–10 years and the second dose around ages 13–14 years) could be considered when introducing HPV vaccination in a country to alleviate HPV vaccine supply shortage. The recommendation was based on studies indicating that geometrical mean IgG antibody titres were similar when the second dose of the HPV vaccine was given 6 months or 3–8 years after the first dose, and on a modelling study showing that an extended schedule could provide similar population-level impact against cervical cancer as the current two-dose schedule, while minimising short-term vaccine demand and costs. Based on these results, the UK and Québec, Canada, have implemented extended HPV vaccination schedules. Furthermore, the recommendation of an extended schedule is particularly relevant during the COVID-19 pandemic. Globally, HPV vaccination programmes have been severely disrupted due to physical distancing measures (eg, lockdowns and school closures), health system constraints (eg, reassignment of health-care workers), and worries of risk of transmission during immunisation visits.
...
### Comparison of two dose and three dose human papillomavirus vaccine schedules: cost effectiveness analysis based on transmission model [^114dQ8ED]. BMJ (2015). Excellent credibility.
...
### Comparison of two dose and three dose human papillomavirus vaccine schedules: cost effectiveness analysis based on transmission model [^113RGQgC]. BMJ (2015). Excellent credibility.
...
### Human papillomavirus vaccine administration trends among commercially insured US adults aged 27–45 years before and after advisory committee on immunization practices recommendation change, 2007–2020 [^115dXYXQ]. JAMA Health Forum (2022). High credibility.

Discussion

In this population-based cohort study, we found that there was a statistically significant increase in the HPV vaccine administration rate after 2018 among adults aged 27 to 45 years. Women and men showed distinct patterns before 2018, majorly due to the different timings of HPV vaccine recommendations. In this hypothesis-driven analysis, the results showed that the ACIP recommendation change was statistically significantly associated with the increase in HPV vaccine administration rate in this population.

The HPV vaccination rate among those aged 9 to 26 years showed considerable disparities across racial and ethnic groups. However, this study did not find statistically significant differences in administration trends among newly recommended ages. Evidence suggests racial and ethnic disparities in HPV-associated cancer incidence. Further research is needed on how catch-up vaccination in this age group can help reduce these existing disparities.

In 2019 and 2020, those aged 31 to 45 years made up the majority of the vaccinated adults aged 27 to 45 years. This makeup was the opposite until 2018, whereas the majority of the cases were among the age group of 27- to 30-year-olds. These individuals might have missed their vaccination schedule when they were still eligible and now have received catch-up vaccination as they became eligible again. On the other hand, many of these individuals aged up to 45 years who received the vaccine were never eligible for the initial ACIP HPV-vaccine recommendation (ie, women born in 1979 or before and men born in 1984 or before). Shared decision-making may have been effective for those who were never eligible but had perceived benefits of the HPV vaccine.

The dose-specific proportions can be explained by the availability of the vaccine and the ACIP recommendation. In the US, all 2-, 4-, and 9-valent types are approved for use among women, while only 4 valent and 9 valent are approved for use in men. The 4-valent HPV vaccine has been available and recommended since 2006, and as of late 2016, only the 9-valent vaccine has been distributed in the US. Because some adults without adequate vaccination might be at risk for a new HPV infection targeted by the 9-valent vaccine, HPV vaccination may benefit these individuals.
...
### Guidelines for the prevention and treatment of opportunistic infections among HIV-exposed and HIV-infected children: recommendations from CDC, the National Institutes of Health, the HIV Medicine Association of the Infectious Diseases Society of America, the Pediatric Infectious Diseases Society, and the American Academy of Pediatrics [^117HVwzP]. MMWR: Recommendations and Reports (2009). Medium credibility.

Human papillomavirus (HPV) primary prophylaxis lists HPV vaccine and refers clinicians to additional guidance for dosing and schedules: "See Figure 2 for detailed vaccine recommendations".
...
### Advisory committee on immunization practices recommended immunization schedule for children and adolescents aged 18 years or younger-United States, 2017 [^111H5Cqr]. MMWR: Morbidity and Mortality Weekly Report (2017). Low credibility.

Changes in the 2017 Child and Adolescent Immunization Schedule
...
### Human papillomavirus vaccine administration trends among commercially insured US adults aged 27–45 years before and after advisory committee on immunization practices recommendation change, 2007–2020 [^112CiYe3]. JAMA Health Forum (2022). High credibility.

Previous studies that surveyed adults aged 27 to 45 years after the ACIP recommendation update found that the majority of these adults were likely to ask health care professionals about HPV vaccination and willing to get a vaccine if recommended by their clinician. The likelihood of receiving the HPV vaccine was highly associated with the perceived likelihood of benefiting from the vaccine. Similarly, according to a study that surveyed primary care physicians, the majority of physicians reported that they would be more likely to recommend HPV vaccination to adults aged 27 to 45 years due to the new ACIP recommendation. Evidence also supports the substantial effectiveness of patient-clinician shared decision-making in vaccination, cancer prevention, and other health outcomes in general. Especially because the HPV vaccine has been available for more than a decade, shared decision-making may benefit those interested in vaccination based on their perceived benefit but who missed their vaccination schedule or were not eligible. However, also the majority of the physician respondents were unsure of what to emphasize during the shared clinical decision-making regarding HPV vaccination. The present findings showed a statistically significant increase in HPV vaccination in this age group after the ACIP update, yet they make up very low rates. These studies together represent the great interest in HPV vaccination among both adults aged 27 to 45 years and health care professionals, as well as the potential effectiveness of their shared decision-making, though there remains a need for further research on enhancing this process (eg, decision aids).
...
### Update from the advisory committee on immunization practices [^114AnAtk]. Journal of the Pediatric Infectious Diseases Society (2016). Low credibility.
...
### Guidelines for prevention and treatment of opportunistic infections in HIV-infected adults and adolescents: recommendations from CDC, the National Institutes of Health, and the HIV Medicine Association of the Infectious Diseases Society of America [^1138HaAL]. MMWR: Recommendations and Reports (2009). Medium credibility.

Human papillomavirus (HPV) prevention in HIV — vaccination indications and schedule: Indications for HPV vaccination list "HIV-infected; aged 13 to 26 years (AIII)". The schedule specifies "HPV recombinant vaccine 9 valent (Types 6, 11, 16, 18, 31, 33, 45, 52, 58) 0.5 mL IM at 0, 1 to 2, and 6 months (AIII)", with the note "Please refer to Pediatric OI Guidelines for vaccination of boys and girls younger than age 13 years". For persons who previously completed bivalent or quadrivalent vaccination, "many experts would give additional full series of vaccination with recombinant 9-valent vaccine, but there are no data to define who might benefit or how cost effective this approach might be (CIII)".
...
### ASCCP committee opinion: adjuvant human papillomavirus vaccine for patients undergoing treatment for cervical intraepithelial neoplasia [^111h5HK2]. Journal of Lower Genital Tract Disease (2023). Medium credibility.

ASCCP RECOMMENDATIONS FOR CONSIDERATION OF ADJUVANT VACCINATION IN PREVIOUSLY UNVACCINATED INDIVIDUALS UNDERGOING TREATMENT FOR CIN2+

Based on these findings, ASCCP recommends consideration of the possible benefit of adjuvant HPV vaccination in shared decision making regarding HPV vaccination for previously unvaccinated, immunocompetent individuals aged 27 to 45 years who are undergoing treatment for CIN2+ (Figure 1). The optimal timing of HPV vaccination in these individuals is not known. These individuals should be well counseled that the prophylactic vaccine will not treat existing HPV disease or prevent all future HPV-related disease. All individuals treated for CIN2+ are at risk for persistent or recurrent disease and require continued surveillance and management as per the 2019 risk-based management guidelines. The ASCCP recommendations may change based on findings from ongoing and future clinical trials.

FIGURE 1
Recommendations for HPV vaccination based on age and shared clinical decision making.
...
### Variation in human papillomavirus vaccination effectiveness in the US by age at vaccination [^1166Xf8L]. JAMA Network Open (2022). High credibility.

Introduction

The Centers for Disease Control and Prevention Advisory Committee on Immunization Practices (ACIP) recommends routine human papillomavirus (HPV) vaccination at ages 9 to 12 yearsas protection against HPV types 16 and 18 (HPV-16/18), the genotypes in 70% of cervical cancers. Although the importance of vaccination uptake is well known, vaccination often occurs later than recommended. Recent studies have documented the effectiveness of early-age vaccination for reducing cervical precancer and cancer incidence. We used data from the National Health and Nutrition Examination Survey (NHANES)to estimate the proportion of female individuals who were vaccinated before sexual debut, assess the association of delayed vaccination with HPV-16/18 prevalence, and quantify potential racial and ethnic disparities in timely vaccination.
...
- Three doses are recommended for immunocompromised persons aged 9 through 26 years. Vaccine Safety HPV vaccines are very safe.
...
### HPV vaccine recommendations… [^116XxH76]. CDC (2025). Medium credibility.
...
- HPV vaccination can be started at age 9 and is recommended through age 26 years for those who weren't vaccinated earlier. Introduction More than 15 years of data show that HPV vaccination provides safe, effective, and long-lasting protection against cancers caused by HPV infections. Research shows that healthcare professionals are parents' most trusted source of information about the HPV vaccine. CDC encourages healthcare professionals to recommend HPV vaccination in the same way and on the same day that they recommend other vaccines for adolescents. This page summarizes CDC's current HPV vaccine recommendations. Access the official, full text below: Routine recommendations
- HPV vaccine is recommended for routine vaccination at 11 or 12 years old. Vaccination can be started at age 9.
- ACIP also recommends vaccination for everyone through age 26 years if not adequately vaccinated when younger. HPV vaccination is given as a series of either two or three doses, depending on age at initial vaccination. Routine vaccination Age 11–12 years; can be started at age 9 years Catch-up vaccination Age 13–26 years, if not adequately vaccinated Shared clinical decision-making Some adults ages 27–45 years, if not adequately vaccinated. Dosing schedule Two doses of HPV vaccine are recommended for most people starting the series before their 15th birthday.
- The second dose of HPV vaccine should be given 6 to 12 months after the first dose.
- Adolescents who receive two doses less than 5 months apart will require a third dose of HPV vaccine. Three doses of HPV vaccine are recommended for teens and young adults who start the series at ages 15 through 26 years, and for immunocompromised persons.
- The recommended three-dose schedule is 0, 1–2 months, and 6 months.
- Three doses are recommended for immunocompromised persons aged 9 through 26 years. Keep Reading: About HPV Vaccines. Contraindications and precautions Contraindications and precautions to vaccination generally dictate circumstances when vaccines will not be given. HPV vaccine contraindications.
...
- Teens and young adults through age 26 years who didn't start or finish the HPV vaccine series also need HPV vaccination. The vaccine is safe and effective HPV vaccination works extremely well. HPV vaccine has the potential to prevent more than 90% of cancers caused by HPV.
