...
> Wait, let me verify the vaccine formulation landscape. In the U.S., only the 9-valent HPV vaccine (Gardasil 9) is currently distributed; it covers HPV 6, 11, 16, 18, 31, 33, 45, 52, and 58, expanding protection beyond the quadrivalent formulation; historical bivalent and quadrivalent products are no longer available, though prior series with those products are considered valid and need not be repeated if already complete [^117GtUtk] [^115mkCpx].
