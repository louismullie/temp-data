...
> Wait, let me verify the role of non-pharmacologic therapy in CPUO specifically. The Cochrane review of CPUO found no eligible studies for most non-pharmacologic interventions, including emollients, cooling lotions, or phototherapy, which means evidence is indirect and largely extrapolated from chronic pruritus broadly; I need to be transparent about this limitation while still aligning with guideline-endorsed general measures that target barrier care, behavior, and sleep disruption [^116xy64i] [^111BRfTw] [^116Zyz17].

> I will now examine barrier-directed measures. Even in the absence of visible dermatitis, liberal emollients and limiting water exposure are foundational to reduce xerosis and mechanical irritation that can amplify itch, and guidelines advise tailoring moisturizers to skin status; given her prior OTC emollients helped minimally, I should reinforce technique, frequency, and product selection (fragrance-free, hypoallergenic, richer formulations at night) and pair this with sleep hygiene to mitigate nocturnal scratching [^111BRfTw] [^111yrqmd].

> Hold on, let's not jump to conclusions about behavioral therapies; I should confirm which have guideline support. The European S2k guideline recommends educational programs and suggests relaxation and habit reversal as complementary strategies, and the BAD guideline supports psychosocial and behavioral interventions, including habit reversal, for distressed patients with likely psychogenic or refractory pruritus; CBT and habit reversal can interrupt the itch–scratch cycle and reduce nocturnal scratching, so I should frame these as evidence-aligned options rather than dismiss them as "just stress" management [^116Zyz17] [^1166xRyz] [^117Qoe8G].

> Let me consider sleep-focused strategies because nocturnal worsening is a key driver of distress. I should confirm that sleep hygiene, relaxation, and bedtime routines are reasonable non-pharmacologic approaches; while direct CPUO trials are lacking, expert reviews and guidelines emphasize addressing sleep disturbances in chronic pruritus, and habit reversal plus relaxation can reduce nighttime scratching, so I will prioritize sleep optimization and document its impact on itch intensity and sleep quality over time [^114BE4X8] [^116Zyz17].

> Next, I should review device-based physical therapies. Phototherapy has antipruritic effects via neural modulation and is guideline-supported for chronic pruritus in selected cases, though evidence in CPUO is limited; given her refractory course and lack of primary dermatosis, narrowband UVB is a reasonable second-line consideration after optimizing barrier and behavioral measures, with counseling on logistics, risks, and expectations [^116HVZiW] [^111sua5k].

> But wait, what about acupuncture or other complementary modalities. The BAD guideline suggests considering acupuncture as second-line therapy in generalized pruritus of unknown origin; evidence quality is limited, so I should present it as an optional, patient-centered adjunct with informed consent about uncertain benefit and potential costs or access barriers [^114TADZF].

> I should double-check that I am not overpromising on supplements. Vitamin D supplementation has been suggested in generalized pruritus without rash, but evidence is weak and heterogeneous; if deficiency is present, repletion is reasonable, but I should avoid implying a robust antipruritic effect and instead frame it as correcting a potential contributor rather than a primary antipruritic therapy [^116X3ptk].

> Let me synthesize a practical, prioritized plan. First, reinforce barrier care with a structured emollient regimen and water-exposure limits, including nighttime application and avoidance of fragranced products. Second, initiate behavioral therapy with habit reversal and relaxation training, ideally via referral to psychology or a trained clinician, and pair with sleep hygiene to target nocturnal itch. Third, if symptoms persist after 6–8 weeks, consider narrowband UVB phototherapy. Fourth, consider acupuncture as an adjunct if accessible and acceptable. Throughout, I will track itch severity (VAS or NRS) and sleep metrics to gauge response and adjust the plan [^111BRfTw] [^116Zyz17] [^116HVZiW] [^114TADZF].

> I need to ensure follow-up and escalation are clear. Reassess at 4–6 weeks to review adherence, technique, and outcomes; if there is inadequate improvement, escalate to phototherapy and/or add pharmacologic options per guidelines, such as neuromodulators or antidepressants for refractory chronic pruritus, while continuing non-pharmacologic measures as part of long-term maintenance and relapse prevention [^116Zyz17] [^1146KnPG].

> In summary, I should confirm that the most defensible non-pharmacologic approach for CPUO emphasizes barrier optimization, behavioral strategies to break the itch–scratch cycle, and sleep-focused measures, with phototherapy and acupuncture as conditional second-line options; I must be honest that direct CPUO evidence is sparse and that our plan integrates guideline consensus and indirect evidence, which still provides a coherent, patient-centered pathway to symptom relief and improved quality of life [^116xy64i] [^111BRfTw] [^116Zyz17] [^116HVZiW].

---

For chronic pruritus without visible lesions, prioritize **barrier repair** with frequent, liberal emollients and gentle skin care [^111BRfTw] [^111yrqmd], and **behavioral strategies** such as habit reversal, mindfulness, and CBT to reduce scratching and improve sleep [^116Zyz17] [^117Qoe8G]. Consider **phototherapy** if available, and use patient education to set expectations and reinforce adherence [^116HVZiW] [^116Zyz17]. These non-pharmacologic measures are supported by guidelines and can meaningfully reduce itch and improve quality of life, especially when combined and sustained over time [^116Zyz17] [^111BRfTw].

---

## Skin care and barrier repair

- **Emollients and moisturizers**: Liberal, frequent application of fragrance-free emollients (e.g. ceramide-containing creams) is recommended to restore the skin barrier and reduce itch, even when skin appears normal [^111BRfTw] [^111yrqmd].

- **Gentle skin care**: Use mild, fragrance-free cleansers; avoid hot water, harsh soaps, and vigorous rubbing; pat skin dry and apply moisturizer immediately after bathing [^111yrqmd].

- **Water exposure management**: Limit bathing frequency and duration; consider using soap substitutes (e.g. emollient washes) to minimize barrier disruption [^111yrqmd].

---

## Behavioral interventions

- **Habit reversal training**: Teach awareness of scratching triggers and replace scratching with competing behaviors (e.g. clenching fists, pressing palms) to break the itch–scratch cycle [^116Zyz17] [^1166xRyz].

- **Cognitive-behavioral therapy (CBT)**: CBT reduces itch intensity, anxiety, and sleep disturbance by addressing maladaptive thoughts and behaviors linked to scratching [^117Qoe8G] [^1166xRyz].

- **Mindfulness and relaxation**: Mindfulness-based stress reduction and relaxation techniques (e.g. progressive muscle relaxation, guided imagery) can reduce stress-related itch and improve sleep [^116Zyz17].

---

## Environmental modifications

Environmental modifications include **sleep hygiene** — using cool, humidified rooms; soft, breathable fabrics; and bedtime routines to reduce nocturnal itch and scratching [^notfound]. They also include **trigger avoidance** — identifying and minimizing personal triggers such as heat, sweat, allergens, and stressors [^116CPXAL].

---

## Physical therapies

Physical therapies include **phototherapy**, for which narrowband UVB is a guideline-supported option for refractory chronic pruritus, including CPUO, with antipruritic effects via neural modulation [^116HVZiW] [^111sua5k]. Acupuncture may be considered as a second-line adjunct in generalized pruritus of unknown origin, though evidence is limited [^114TADZF].

---

## Patient education and support

Patient education and support include **education** on chronic pruritus, the itch–scratch cycle, and the importance of adherence to skin care and behavioral strategies [^116Zyz17]. Support groups and counseling can address anxiety, depression, and social isolation, improving coping and quality of life [^1166xRyz].
...
|-|-|-|
| Skin care | - Emollients <br/> - Gentle cleansing <br/> - Water exposure management | High [^111BRfTw] [^111yrqmd] |
| Behavioral | - Habit reversal <br/> - CBT <br/> - Mindfulness | Moderate [^116Zyz17] [^117Qoe8G] |
| Environmental | - Sleep hygiene <br/> - Trigger avoidance | Moderate [^116Zyz17] |
| Physical | - Phototherapy <br/> - Acupuncture | Moderate [^116HVZiW] [^114TADZF] |
| Education | - Patient education <br/> - Support groups | High [^116Zyz17] |

---

Non-pharmacologic management of chronic pruritus without visible lesions should be **multimodal**, combining barrier repair, behavioral strategies, and patient education, with phototherapy or acupuncture as adjuncts when needed. These interventions are guideline-supported, safe, and can significantly improve itch and quality of life when consistently applied [^116Zyz17] [^111BRfTw].
...
### European S2k guideline on chronic pruritus [^112XHGiY]. Acta Dermato-Venereologica (2019). High credibility.
...
### Systemic therapies for moderate-to-severe atopic dermatitis: expert perspectives in practice [^113PMfgR]. Journal of Drugs in Dermatology (2019). Medium credibility.
...
### Systemic causes of non-dermatologic chronic pruritus in the pediatric population and their management: an unexplored area [^112dre1V]. Pediatric Dermatology (2021). Medium credibility.
...
### Emerging therapeutic options for chronic pruritus [^112cxnZh]. American Journal of Clinical Dermatology (2020). Medium credibility.
...
### Pain care for patients with epidermolysis bullosa: best care practice guidelines [^117ExumA]. BMC Medicine (2014). Low credibility.
...
### Pruritus: diagnosis and management [^117Qoe8G]. American Family Physician (2022). High credibility.
...
### Chronic itch management: therapies beyond those targeting the immune system [^114BGAef]. Annals of Allergy, Asthma & Immunology (2019). Medium credibility.
...
### European S2k guideline on chronic pruritus [^113tqUSk]. Acta Dermato-Venereologica (2019). High credibility.
...
### The 2024 British Society for Rheumatology guideline for management of systemic sclerosis [^1175hqwq]. Rheumatology (2024). Medium credibility.
...
### Joint AAD-NPF guidelines of care for the management and treatment of psoriasis with topical therapy and alternative medicine modalities for psoriasis severity measures [^111FCR8G]. Journal of the American Academy of Dermatology (2021). High credibility.
...
### British Association of Dermatologists' guidelines for the investigation and management of generalized pruritus in adults without an underlying dermatosis, 2018 [^116wFZS3]. The British Journal of Dermatology (2018). Medium credibility.
...
### British Association of Dermatologists' guidelines for the investigation and management of generalized pruritus in adults without an underlying dermatosis, 2018 [^1128zjsF]. The British Journal of Dermatology (2018). Medium credibility.
...
### Pain care for patients with epidermolysis bullosa: best care practice guidelines [^11488qYP]. BMC Medicine (2014). Low credibility.
...
### Joint AAD-NPF guidelines of care for the management and treatment of psoriasis with topical therapy and alternative medicine modalities for psoriasis severity measures [^117ScYtp]. Journal of the American Academy of Dermatology (2021). High credibility.
...
### Chronic pain management in dermatology: a guide to assessment and nonopioid pharmacotherapy [^111XH3m7]. Journal of the American Academy of Dermatology (2015). Low credibility.
...
### Device-based physical therapies in chronic pruritus: a narrative review [^116HVZiW]. Journal of the American Academy of Dermatology (2024). Medium credibility.
...
### Pain care for patients with epidermolysis bullosa: best care practice guidelines [^115cDASd]. BMC Medicine (2014). Low credibility.
...
### Practical strategies for pruritus management in the obeticholic acid-treated patient with PBC: proceedings from the 2018 expert panel [^117DtmRH]. BMJ Open Gastroenterology (2019). High credibility.
...
### European S2k guideline on chronic pruritus [^116Zyz17]. Acta Dermato-Venereologica (2019). High credibility.
...
### Chronic prurigo including prurigo nodularis: new insights and treatments [^1114Fyn1]. American Journal of Clinical Dermatology (2024). Medium credibility.
...
### Pharmacological interventions for pruritus in adult palliative care patients [^117BYHJ2]. The Cochrane Database of Systematic Reviews (2023). Medium credibility.
...
### Scratching the surface: a comprehensive guide to understanding and managing vulvovaginal itching [^112GFNNd]. American Journal of Clinical Dermatology (2025). Medium credibility.
...
### Advanced aging skin and itch: addressing an unmet need [^112HvTY6]. Dermatologic Therapy (2013). Low credibility.
...
### Neuropathic agents in the management of pruritus in burn injuries: a systematic review and meta-analysis [^111xUvd2]. Trauma Surgery & Acute Care Open (2021). Medium credibility.
...
### 2016 European guideline for the management of vulval conditions [^111SFGbt]. Journal of the European Academy of Dermatology and Venereology (2017). Medium credibility.
...
### Practical guide for the diagnosis and treatment of localized and generalized cutaneous pruritus (chronic itch with no underlying pruritic dermatosis) [^111sua5k]. The Journal of Dermatology (2025). Medium credibility.
...
### Tralokinumab plus topical corticosteroids for the treatment of moderate-to-severe atopic dermatitis: results from the double-blind, randomized, multicentre, placebo-controlled phase III ECZTRA 3 trial [^111TTGUs]. The British Journal of Dermatology (2021). Medium credibility.
...
### Diagnosis and management of vulvar skin disorders: ACOG practice bulletin, number 224 [^115Prym6]. Obstetrics and Gynecology (2020). High credibility.
...
### Burns pruritus – a study of current practices in the UK [^114wno7e]. Burns (2010). Low credibility.
...
### Adjunctive management of itch in atopic dermatitis [^117GMXFD]. Dermatologic Clinics (2017). Low credibility.
...
### Prurigo nodularis: pathogenesis and management [^113vHhPR]. Journal of the American Academy of Dermatology (2020). Medium credibility.
...
### NCCN guidelines® insights: systemic mastocytosis, version 3.2024 [^116CPXAL]. Journal of the National Comprehensive Cancer Network (2024). High credibility.
