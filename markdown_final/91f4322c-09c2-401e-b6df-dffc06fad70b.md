...
> Let me first confirm the regulatory and evidence-quality context, because that shapes how confident we can be about any risk estimate. Methylphenidate carries boxed warnings for abuse, misuse, and addiction, and for serious cardiovascular events, which immediately flags these as top-tier safety concerns that must be screened for and monitored in all patients. Hold on, I should verify the certainty of benefit–harm data: multiple high-quality systematic reviews and guideline appraisals conclude that the certainty of evidence for both benefits and harms is very low, largely due to high risk of bias, short durations, and selective reporting, which means true risk magnitudes remain uncertain and may be underestimated in trials [^117NtF7x] [^1124UCwg] [^112tnJo1] [^115BuZ5J].
