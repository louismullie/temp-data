...
The maximum number of regions formed by (n) lines in a plane, with no two parallel and no three concurrent, is given by the formula (R(n) = [(n² + n + 2)/2]). Setting (R(n) = 56), we solve ([(n² + n + 2)/2] = 56), which simplifies to (n^2 + n - 110 = 0). The positive solution is (n = 10), so **10 lines** are needed to divide the plane into 56 regions under the given conditions.
...
[
n = [(-1 ± √(1² − 4(1)(−110)))/(2(1))] = [(-1 ± √(1 + 440))/2] = [(-1 ± √441)/2] = [(-1 ± 21)/2]
]

This gives two solutions:

[
n = [(-1 + 21)/2] = 10 and n = [(-1 − 21)/2] = −11
]
...
[
R(10) = [(10² + 10 + 2)/2] = [(100 + 10 + 2)/2] = [112/2] = 56
]
