...
### Scutoids are a geometrical solution to three-dimensional packing of epithelia [^1111wTNC]. Nature Communications (2018). Medium credibility.
...
### Closed-loop two-photon functional imaging in a freely moving animal [^1173CU9H]. Nature Communications (2025). High credibility.
...
### Connectome-driven neural inventory of a complete visual system [^113vEWST]. Nature (2025). Excellent credibility.
...
### Chirality encoding in resonant metasurfaces governed by lattice symmetries [^115W8pHt]. Nature Communications (2025). High credibility.
...
### Reassessment of the distinctive geometry of Staphylococcus aureus cell division [^114dWwAg]. Nature Communications (2020). High credibility.
...
### A spatially resolved timeline of the human maternal-fetal interface [^114j8o3R]. Nature (2023). Excellent credibility.
...
### Young children intuitively organize numbers on straight, horizontal lines from left to right before the onset of formal instruction [^113T8tfP]. Child Development (2023). Medium credibility.
...
### Rigidly flat-foldable class of lockable origami-inspired metamaterials with topological stiff States [^113PGUXt]. Nature Communications (2022). High credibility.
...
### EAE / ASE recommendations for image acquisition and display using three-dimensional echocardiography [^111ef33r]. Journal of the American Society of Echocardiography (2012). Medium credibility.
...
### Relative, local and global dimension in complex networks [^114bQrgg]. Nature Communications (2022). High credibility.
...
### No inherent left and right side in human' mental number line': evidence from right brain damage [^112kiTSc]. Brain (2012). Low credibility.
...
### Lung ultrasound is a reliable method for evaluating extravascular lung water volume in rodents [^113PsLBQ]. BMC Anesthesiology (2015). Low credibility.
...
### Double-layer geodesic and gradient-index lenses [^111gQQCE]. Nature Communications (2022). High credibility.
...
### Molecular architecture of the G α-bound TRPC5 ion channel [^1138qgHd]. Nature Communications (2023). High credibility.
...
### Researcher's guide for the preparation of tables [^112wqMVP]. The Journal of Surgical Research (2025). Medium credibility.
...
### Development of a comprehensive and clinically applicable novel projection classification system for anterior communicating artery aneurysms [^117ApNgT]. Neurosurgical Review (2024). Medium credibility.
...
### Retinoic acid promotes the endogenous repair of lung stem / progenitor cells in combined with simvastatin after acute lung injury: a stereological analysis [^112bbqGp]. Respiratory Research (2015). Low credibility.
...
### Alternative methods for intensity-modulated radiation therapy inverse planning and dose delivery [^112Gb7VX]. Seminars in Radiation Oncology (2006). Low credibility.
...
### A geometrical solution underlies general neural principle for serial ordering [^112ESH74]. Nature Communications (2024). High credibility.
...
### Parallel window decoding enables scalable fault tolerant quantum computation [^117PoAL7]. Nature Communications (2023). High credibility.
...
### Analysis of the thickness characteristics of the left atrial posterior wall and its correlation with the low and no voltage areas of the left atrial posterior wall in patients with atrial fibrillation [^111tjsvn]. Journal of Cardiothoracic Surgery (2024). Medium credibility.
...
### Morphology of travel routes and the organization of cities [^116HETAZ]. Nature Communications (2017). Medium credibility.
...
### Clinical efficacy and safety of focused-image ultrasonography: a 2-year experience [^116H5nHB]. Aesthetic Surgery Journal (2012). Low credibility.
...
### A left-to-right bias in number-space mapping across ages and cultures [^113nzpiw]. Nature Communications (2025). High credibility.
...
### Arbitrary starting point of separation affects morphology of the 2 bundles of anterior cruciate ligament at insertion sites [^113bGCMo]. Arthroscopy (2010). Low credibility.
...
### Correcting for imaging gradients-related bias of trelaxation times at high-resolution MRI [^115mwbFs]. Magnetic Resonance in Medicine (2022). Medium credibility.
...
### Action plan co-optimization reveals the parallel encoding of competing reach movements [^111LV2dK]. Nature Communications (2015). Medium credibility.
...
### An update of comprehensive evidence-based guidelines for interventional techniques in chronic spinal pain. part II: guidance and recommendations [^11428iax]. Pain Physician (2013). Medium credibility.
...
### A geometrical solution underlies general neural principle for serial ordering [^1172GuPM]. Nature Communications (2024). High credibility.
...
### A structured framework for standardized 3D leg alignment analysis: an international Delphi consensus study [^115ZeHzY]. Knee Surgery, Sports Traumatology, Arthroscopy (2025). Medium credibility.
...
### Effects of episodic slow slip on seismicity and stress near a subduction-zone megathrust [^1175XZMH]. Nature Communications (2021). High credibility.
...
### Facial contouring by using dermal fillers and botulinum toxin A: a practical approach [^115QTWvJ]. Aesthetic Plastic Surgery (2019). Medium credibility.
...
### Cardiac computed tomography for prosthetic heart valve assessment: an expert consensus document of the Society of Cardiovascular Computed Tomography (SCCT), the American college of cardiology (ACC), the European society of cardiovascular radiology (ESCR), the north American society of cardiovascular imaging (NASCI), the radiological society of north America (RSNA), the society for cardiovascular angiography&interventions (SCAI) and Society of Thoracic Surgeons (STS) [^111vhXaV]. Journal of the American College of Cardiology (2025). High credibility.
...
### Establishing the customized occlusal plane in systemized surgical treatment objectives of class III [^112GhwYd]. The Journal of Craniofacial Surgery (2011). Low credibility.
...
### Shear rate gradients promote a bi-phasic thrombus formation on weak adhesive proteins, such as fibrinogen in a VWF-dependent manner [^116fE5uL]. Haematologica (2020). Medium credibility.
...
### Magneto-ionic vortices: voltage-reconfigurable swirling-spin analog-memory nanomagnets [^116WC8pR]. Nature Communications (2025). High credibility.
...
### ACFAS scoring scale user guide [^11734tFB]. The Journal of Foot and Ankle Surgery (2005). Medium credibility.
...
### Monolithic 3D integration of 2D transistors and vertical RRAMs in 1T-4R structure for high-density memory [^111Si6d2]. Nature Communications (2023). High credibility.
...
### Correlation of modic changes with sagittal lumbopelvic parameters [^114PouL9]. Journal of Pain Research (2021). Medium credibility.
...
### Parallel processing of negative feedback: E unum pluribus [^116YRjmH]. Neuron (2018). Low credibility.
...
### Miniature origami robot for various biological micromanipulations [^111x5mXA]. Nature Communications (2025). High credibility.
...
### Two-phase analysis in consensus genetic mapping [^113YMbHu]. G3 (2012). Low credibility.
...
### A comparison of skeletal muscle diffusion tensor imaging tractography seeding methods [^111ghPzR]. NMR in Biomedicine (2025). Medium credibility.
...
### The first mitotic division of human embryos is highly error prone [^112P84iX]. Nature Communications (2022). High credibility.
...
### Striatal dopaminergic loss and dysphagia in parkinson disease [^112cDy3W]. Clinical Nuclear Medicine (2023). Medium credibility.
...
### The rate and effects of spontaneous mutation on fitness traits in the social amoeba, dictyostelium discoideum [^1163hvTN]. G3 (2013). Low credibility.
...
### Radiological indicators to predict the application of assistant intubation techniques for patients undergoing cervical surgery [^116fkeWW]. BMC Anesthesiology (2020). Medium credibility.
...
### Foot deformity correction planning in the sagittal plane based on the vitruvian foot first metatarsal anatomic axis [^114zTDom]. The Journal of Foot and Ankle Surgery (2020). Medium credibility.
...
### A.S.P.E.N. parenteral nutrition safety consensus recommendations [^116D8Egj]. JPEN: Journal of Parenteral and Enteral Nutrition (2013). Medium credibility.
...
### A.S.P.E.N. parenteral nutrition safety consensus recommendations [^113DFwBP]. JPEN: Journal of Parenteral and Enteral Nutrition (2013). Medium credibility.
...
### X-ray micro-computed tomography for nondestructive three-dimensional (3D) X-ray histology [^111DdWCb]. The American Journal of Pathology (2019). Medium credibility.
...
### The parasagittal line: an anatomic landmark for axial imaging [^117EoEZV]. AJNR: American Journal of Neuroradiology (2001). Low credibility.
