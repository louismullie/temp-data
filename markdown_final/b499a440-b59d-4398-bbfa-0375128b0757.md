...
We used R version 3.5.0 to perform the statistical analyses. The following packages were used: Metafor and Forestplot. We extracted and pooled proportions using fixed-effects models. To quantify the heterogeneity of the collected data, I 2 was calculated for each item under investigation.
