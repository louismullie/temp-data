...
> I should double-check the epidemiology because prevalence estimates vary with diagnostic thresholds. In adults with cirrhosis, HPS is reported in roughly 5–32%, with most contemporary series clustering around 10–20%, and in children the prevalence appears lower but nontrivial, with pediatric cohorts showing up to about 20% in those with cirrhosis or severe portal hypertension; importantly, HPS can occur even with relatively preserved liver function, so severity of liver disease does not strictly track with HPS risk [^fa3bfa31] [^f5c36928] [^17a32b6e] [^17a32b6e] [^ef23b2a6].
