...
### A reprogrammable mechanical metamaterial with origami functional-group transformation and ring reconfiguration [^111GwvtB]. Nature Communications (2023). High credibility.
...
### Single pixel imaging at megahertz switching rates via cyclic hadamard masks [^111c9MZr]. Nature Communications (2021). High credibility.
...
### A topological mechanism for robust and efficient global oscillations in biological networks [^114mdFdF]. Nature Communications (2024). High credibility.
...
### A reprogrammable mechanical metamaterial with origami functional-group transformation and ring reconfiguration [^114KykHS]. Nature Communications (2023). High credibility.
...
### Engineering zero modes in transformable mechanical metamaterials [^113vy3Zb]. Nature Communications (2023). High credibility.
...
### Cyclopentolate hydrochloride [^1168CoeZ]. FDA (2022). Medium credibility.
...
### Shaping the topology of folding pathways in mechanical systems [^1171ofGz]. Nature Communications (2018). Medium credibility.
...
### PLANET: an ellipse fitting approach for simultaneous tand tmapping using phase-cycled balanced steady-state free precession [^116u9noc]. Magnetic Resonance in Medicine (2018). Low credibility.
...
### Optical quantum nondemolition measurement of a single rare earth ion qubit [^115CuJN2]. Nature Communications (2020). High credibility.
...
### Algebraic method to synthesize specified modal currents in ladder resonators: application to noncircular birdcage coils [^117EQP2T]. Magnetic Resonance in Medicine (2015). Low credibility.
...
### The free energy of mechanically unstable phases [^117WQDQj]. Nature Communications (2015). Medium credibility.
...
### Mapping of 238 quadrilateral plate fractures with three-dimensional computed tomography [^11599w7x]. Injury (2018). Low credibility.
...
### Cyclopentolate hydrochloride [^112tB2HJ]. FDA (2022). Medium credibility.
...
### The XZZX surface code [^117KH2Sm]. Nature Communications (2021). High credibility.
...
### Giant regular polyhedra from calixarene carboxylates and uranyl [^117CW5Bm]. Nature Communications (2012). Medium credibility.
...
### Exploring multistability in prismatic metamaterials through local actuation [^111BTHTR]. Nature Communications (2019). High credibility.
...
### Designing a biomechanics investigation: choosing the right model [^112s5p1x]. Journal of Orthopaedic Trauma (2012). Low credibility.
...
### Tisagenlecleucel (autologous) [^115ksfYC]. FDA. Low credibility.
...
### Arbitrary lattice symmetries via block copolymer nanomeshes [^114YqCMh]. Nature Communications (2015). Medium credibility.
...
### Tisagenlecleucel (autologous) [^11638Lj8]. FDA. Low credibility.
...
### Invariant and smooth limit of discrete geometry folded from bistable origami leading to multistable metasurfaces [^117EaRcg]. Nature Communications (2019). High credibility.
...
### Use of multi-perturbation shapley analysis in lesion studies of functional networks: the case of upper limb paresis [^114F92eA]. Human Brain Mapping (2023). Medium credibility.
...
### Vincristine sulfate [^113ffz3w]. FDA. Low credibility.
...
### A blind benchmark of analysis tools to infer kinetic rate constants from single-molecule FRET trajectories [^112w4834]. Nature Communications (2022). High credibility.
...
### Methotrexate sodium (methotrexate) [^114BJiQm]. FDA (2025). Medium credibility.
...
### Modeling control strategies of respiratory pathogens [^113VZDxC]. Emerging Infectious Diseases (2005). Low credibility.
...
### Brexucabtagene autoleucel (autologous) [^115NBWDP]. FDA. Low credibility.
...
### Venetoclax (Venclexta) [^111cPQrs]. FDA (2024). Medium credibility.
...
### Nanoalignment by critical casimir torques [^113DRvw8]. Nature Communications (2024). High credibility.
...
### 2021 ESC guidelines on cardiac pacing and cardiac resynchronization therapy [^115Kt9Ma]. European Heart Journal (2021). High credibility.
...
### Towards a complete coil array [^1117FWCM]. Magnetic Resonance Imaging (2008). Low credibility.
...
### Activation of C-src tyrosine kinase mediated the degradation of occludin in ventilator-induced lung injury [^113p8Lxg]. Respiratory Research (2014). Low credibility.
...
### Tetracycline hydrochloride [^113pqq7h]. FDA (2025). Medium credibility.

The drug Tetracycline hydrochloride.

---

### Single-shot quantum error correction with the three-dimensional subsystem toric code [^115FX5m7]. Nature Communications (2022). High credibility.
...
### Discovery of a maximally charged weyl point [^116vfeQE]. Nature Communications (2022). High credibility.
...
### Recommendations for noninvasive evaluation of native valvular regurgitation: a report from the American Society of Echocardiography developed in collaboration with the Society for Cardiovascular Magnetic Resonance [^115zgv1Y]. Journal of the American Society of Echocardiography (2017). Medium credibility.
...
### European Respiratory Society and American Thoracic Society guidelines for the diagnosis of primary ciliary dyskinesia [^116VZPWn]. The European Respiratory Journal (2025). High credibility.
...
### Octreotide acetate (octreotide) [^112nEf32]. FDA (2024). Medium credibility.
...
### Three-dimensional magnetic nanotextures with high-order vorticity in soft magnetic wireframes [^115G8gya]. Nature Communications (2024). High credibility.
...
### Multiple endpoints in clinical trials guidance for industry… [^113HTgJ9]. FDA (2025). Medium credibility.
...
### Deformation characteristics of solid-state benzene as a step towards understanding planetary geology [^1154wNwk]. Nature Communications (2022). High credibility.
...
### Letrozole (Femara) [^115fhvGd]. FDA (2025). Medium credibility.
...
### Recommendations for noninvasive evaluation of native valvular regurgitation: a report from the American Society of Echocardiography developed in collaboration with the Society for Cardiovascular Magnetic Resonance [^117PDWaX]. Journal of the American Society of Echocardiography (2017). Medium credibility.
...
### Non-native three-dimensional block copolymer morphologies [^112GmzkW]. Nature Communications (2016). Medium credibility.
...
### Imatinib mesylate (Gleevec) [^115miC6i]. FDA (2025). Medium credibility.
...
### How to assess motor impairment in writer's cramp [^112NEozh]. Movement Disorders (2007). Low credibility.
...
### Doravirine, lamivudine, and tenofovir disoproxil fumarate (Delstrigo) [^112ffrsu]. FDA (2025). Medium credibility.
