...
> Let me first confirm the regulatory status, because I need to ensure we are not overextending beyond what is supported. Hydroquinone 6% is not an FDA-approved concentration; the FDA-labeled prescription strength is 4%, and 6% products are typically compounded and marketed as unapproved drugs, as explicitly noted in the DailyMed entry for a 6% emulsion that carries a disclaimer that FDA has not found this drug to be safe and effective and that the labeling is not FDA-approved [^113FesXU] [^115i9c3o].
