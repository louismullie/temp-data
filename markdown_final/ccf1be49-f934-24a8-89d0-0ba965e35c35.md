...
> Let me first confirm the clinical construct. Snoring in infants sits on a spectrum from primary snoring to obstructive sleep apnea, and the latter carries risks for growth, neurodevelopment, and cardiopulmonary complications, so I should not dismiss habitual snoring as benign without evaluation, even though many infants snore intermittently [^600741b9] [^51cc087d] [^370ec02e].

> Wait, let me verify prevalence and why this matters. Habitual snoring is common in infants, with studies suggesting around 11.8% snore at least 2 days per week and 5.3% at least 3 days per week, and infant OSA prevalence is estimated around 1–4% in pediatrics overall, though neonatal data are limited and definitions differ by age, so I need to be cautious about thresholds and context [^600741b9] [^51cc087d] [^78370473].
...
Infant snoring is common and often benign, but persistent or loud snoring warrants evaluation for **obstructive sleep apnea (OSA)** [^600741b9] or other causes [^a6ebea67]. Management is cause-specific: treat **congestion** with saline and suction, **allergies** with intranasal steroids or antihistamines, and **anatomical issues** (e.g. laryngomalacia, craniofacial anomalies) with ENT referral and possible surgery [^e3370090] [^04d9210f]. CPAP is reserved for **severe or refractory OSA** [^07c76a8c] [^c2e30b52]. Most infants improve with conservative care, but persistent snoring or red flags (apnea, poor growth, feeding difficulty) need polysomnography [^e0a46e09] and specialist input [^d00be0c0].
