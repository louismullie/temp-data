...
> Next, I should review COPD exacerbations, because this is where antibiotics can be clearly indicated. I need to check the cardinal symptom criteria. Guidelines recommend antibiotics when there is increased dyspnea, increased sputum volume, and/or increased sputum purulence, with typical outpatient durations of 5 days, which achieve comparable outcomes to longer courses and reduce early relapse and treatment failure in appropriately selected patients [^112Smz9Q] [^1159Zckd]. Hold on, I should verify that this applies to outpatients with mild to moderate exacerbations; yes, the evidence and recommendations are strongest for patients meeting the Anthonisen-type symptom complex during exacerbations, not for stable chronic bronchitis [^112Smz9Q] [^115KNG56].
