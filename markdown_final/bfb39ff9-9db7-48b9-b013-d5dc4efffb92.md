...
> But wait, what about safety signals that could temper enthusiasm. I should double-check key adverse effects. Gastrointestinal intolerance is common and drives discontinuation in a minority, resting heart rate increases by about 1–4 bpm on average warranting monitoring, and in patients with diabetes there is a recognized risk of worsening retinopathy with rapid glycemic improvement; pancreatitis and gallbladder disease remain rare but important warnings, so patient selection and counseling are essential [^114FuZH2] [^111TYqRH].
