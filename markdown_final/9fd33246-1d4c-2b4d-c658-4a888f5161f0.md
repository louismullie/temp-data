...
### [ PDF ] 7th international conference on malignancies in AIDS and other (...) [^e1860207]. NCI (2025). Medium credibility.
...
An examination of the individual variables revealed that students in the control group had significantly higher scores, a mean of 10.6 (3.7) points above the intervention group (P =.001). Grade point average also had a significant positive association, where each 1-unit increase was associated with a 0.9-point increase in the neuroanatomy score (P =.002). Conversely, gender and previous anatomy grade did not have a statistically significant association with scores.
