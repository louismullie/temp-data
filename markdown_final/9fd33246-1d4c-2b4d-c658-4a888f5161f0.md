...
> Let me first confirm the formula so I don't jump to conclusions: the arithmetic mean equals the sum of all scores divided by the number of scores, which in this case is six tests, so average = (76 + 80 + 83 + 71 + 80 + 78) ÷ 6.

> Wait, let me verify the sum before dividing. Adding the scores stepwise: 76 + 80 = 156, 156 + 83 = 239, 239 + 71 = 310, 310 + 80 = 390, 390 + 78 = 468. So the total is 468, not 467 or 469, which I briefly worried about, but the math checks out to 468.

> Now I will divide the total by 6 to get the average: 468 ÷ 6 = 78. Hold on, I should double-check that division. 6 × 78 = 468, which matches the sum, so the average is indeed 78.

> Comparing to the options, 78 corresponds to choice C. I should confirm there isn't a trick in the phrasing or rounding; the question asks for the average score and the calculation is exact, so no rounding is needed and C is correct.
...
### Common measures or common metrics? A plea to harmonize measurement results [^115nMXds]. Clinical Psychology & Psychotherapy (2022). Medium credibility.
...
### Community norms for the symptom questionnaire (SQ-48): normalised T-Scores and percentile rank order scores [^112xAM5x]. Clinical Psychology & Psychotherapy (2025). Medium credibility.
...
### A mindfulness-based intervention to increase resilience to stress in university students (the mindful student study): a pragmatic randomised controlled trial [^112S7W4C]. The Lancet: Public Health (2018). Medium credibility.
...
### Development of a tool to measure student perceptions of equity and inclusion in medical schools [^114ztFHx]. JAMA Network Open (2024). High credibility.
...
Mean (SD) tool scores for female students were lower than scores for male students (80.05 [10.1] vs 81.21 [10.8]; η² = 0.003; P < .001); scores for Asian (79.68 [10.21]), Black (77.62 [11.15]), and Hispanic (79.94 [10.99]) students reported lower scores than White students (81.28 [9.73]) (η² = 0.008; P < .001); scores for LGB students were lower than scores for non-LGB students (78.17 [10.85] vs 80.81 [10.01]; η² = 0.005; P < .001); and scores for students from low-income backgrounds were lower than scores from students not from low-income backgrounds (79.91 [10.69] vs 80.89 [9.83]; η² = 0.001; P < .001) in analyzing scores from the Y2Q time point (Table 3). Similarly, mean (SD) tool scores calculated at the GQ time point were lower for female students compared with male students (81.82 [10.19] vs 83.32 [10.41]; η² = 0.004; P < .001); lower for Asian (82.0 [10.86]), Black (80.56 [11.28]), and Hispanic (82.18 [10.96]) students compared with White students (82.97 [9.91]) (η² = 0.003; P < .001); lower for LGB students compared with non-LGB students (79.64 [11.36] vs 82.77 [10.22]; η² = 0.005; P < .001); and lower for students from low-income backgrounds compared with students not from low-income backgrounds (81.85 [11.05] vs 82.81 [10.06]; η² = 0.001; P < .001, Table 3). Similar differences in scores were present in the mean tool scores among most individual factors for the Y2Q and GQ (eTable 1 and eTable 2 in Supplement 1).

---

### Evaluation of the assessment and grading of medical students on a neurology clerkship [^111GHDoR]. Neurology (2008). Low credibility.
...
### How can we teach medical students to choose wisely? A randomised controlled cross-over study of video-versus text-based case scenarios [^1172X6XK]. BMC Medicine (2018). Low credibility.
...
### School bus rebate program and student educational performance test scores [^113rugkr]. JAMA Network Open (2024). High credibility.
...
### The educational value of using cumulative sum charts [^1176C8Gq]. Anaesthesia (2012). Low credibility.
...
### Education and midlife cognitive functioning: evidence from the high school and beyond cohort [^111hKWiY]. Alzheimer's & Dementia (2025). Medium credibility.
...
### Web-based alcohol screening and brief intervention for university students: a randomized trial [^115p8nrP]. JAMA (2014). Excellent credibility.
...
### 7th international conference on malignancies in AIDS and other… [^116mME6J]. NCI (2025). Medium credibility.
...
### APA guidelines for psychological assessment and evaluation [^111XequZ]. APA (2020). High credibility.
...
### Effect of teaching Bayesian methods using learning by concept vs learning by example on medical students' ability to estimate probability of a diagnosis: a randomized clinical trial [^116RSDZf]. JAMA Network Open (2019). High credibility.
...
### Reading disability is characterized by reduced print-speech convergence [^116nnnmU]. Child Development (2024). Medium credibility.
...
### School bus rebate program and student educational performance test scores [^111FnRbR]. JAMA Network Open (2024). High credibility.
...
### Teledidactic versus hands-on teaching of abdominal, thoracic, and thyroid ultrasound-the TELUS II study [^112STT9v]. Journal of General Internal Medicine (2024). Medium credibility.
...
### The effectiveness of a primer to help people understand risk: two randomized trials in distinct populations [^112XmMKy]. Annals of Internal Medicine (2007). Low credibility.
...
### School readiness [^111U237X]. Pediatrics (2019). High credibility.
...
### The UKCAT-12 study: educational attainment, aptitude test performance, demographic and socio-economic contextual factors as predictors of first year outcome in a cross-sectional collaborative study of 12 UK medical schools [^113EMF38]. BMC Medicine (2013). Low credibility.
...
### Why questionnaire scores are not measures: a question-raising article [^1127Z5qo]. American Journal of Physical Medicine & Rehabilitation (2023). Medium credibility.
...
### APA guidelines for psychological assessment and evaluation [^112iE24r]. APA (2020). High credibility.
...
### Measuring human capital using global learning data [^112HkJzU]. Nature (2021). Excellent credibility.
...
### Predictive validity of the UKCAT for medical school undergraduate performance: a national prospective cohort study [^115ZVf3b]. BMC Medicine (2016). Low credibility.
...
### Why questionnaire scores are not measures: a question-raising article [^116wHKVW]. American Journal of Physical Medicine & Rehabilitation (2023). Medium credibility.
...
### Feasibility of a paediatric radiology escape room for undergraduate education [^116BJ8Sq]. Insights Into Imaging (2020). Medium credibility.
...
### Predicting real-life cognitive scores from functional connectivity [^116pvdAy]. Human Brain Mapping (2025). Medium credibility.
...
### Interplay between children's cognitive profiles and within-school social interactions is nuanced and differs across ages [^111dMU1s]. Communications Psychology (2025). Medium credibility.
...
### Association of MCAT scores obtained with standard vs extra administration time with medical school admission, medical student performance, and time to graduation [^1142DXiM]. JAMA (2015). Excellent credibility.
...
### Problem-based learning in radiology achieves similar results in classroom and metaverse settings [^111gbXfG]. Insights Into Imaging (2025). Medium credibility.
...
### Teaching medical students to prioritize preventive services [^112Kug9D]. Family Medicine (2006). Low credibility.
...
### Faculty evaluations correlate poorly with medical student examination performance in a fourth-year emergency medicine clerkship [^115dCWTw]. The Journal of Emergency Medicine (2017). Low credibility.
...
### Assessment of college students' awareness and knowledge about conditions relevant to metabolic syndrome [^112Sn2Sg]. Diabetology & Metabolic Syndrome (2014). Low credibility.
...
### Summative assessments are more powerful drivers of student learning than resource intensive teaching formats [^111CaMF6]. BMC Medicine (2013). Low credibility.
...
### Predictive validity of the UKCAT for medical school undergraduate performance: a national prospective cohort study [^111Bip6B]. BMC Medicine (2016). Low credibility.
...
### Measuring learning gain during a one-day introductory bronchoscopy course [^114ADHLR]. Surgical Endoscopy (2011). Low credibility.
...
### Effectiveness of the "teaching the teachers" diagnostic US training program [^115Xmp29]. Academic Radiology (2001). Low credibility.
...
### Clinical practice guidelines: diagnosis, treatment, and management of children and adults with central auditory processing disorder [^115fnprX]. AAA (2010). Medium credibility.
...
### Assessing the quality of clinical teachers: a systematic review of content and quality of questionnaires for assessing clinical teachers [^1111UAs1]. Journal of General Internal Medicine (2010). Low credibility.
...
### Effects of homicide timing on test scores: quasi-experimental evidence from two cities in Colombia [^1117LirH]. Child Development (2023). Medium credibility.
...
### Integrating evidence-based medicine skills into a medical school curriculum: a quantitative outcomes assessment [^1171YkLA]. BMJ Evidence-Based Medicine (2021). High credibility.
...
### Changes in medical student and doctor attitudes toward older adults after an intervention: a systematic review [^116dsWAc]. Journal of the American Geriatrics Society (2013). Low credibility.
...
### The mentee perspective: evaluating mentorship of medical students in the field of orthopaedic surgery [^114eWZh1]. Journal of the American Academy of Orthopaedic Surgeons: Global Research & Reviews (2023). Medium credibility.
...
### Assessment of vitamin D-related knowledge, attitudes and practices among sultan qaboos university students in Oman: a cross-sectional study [^115AJgwu]. BMJ Public Health (2024). High credibility.
...
### Improved medical student satisfaction and test performance with a simulation-based emergency medicine curriculum: a randomized controlled trial [^112Xpb92]. Annals of Emergency Medicine (2009). Low credibility.
...
### APA guidelines for psychological assessment and evaluation [^1178ZNvM]. APA (2020). High credibility.
...
### Development of validated instrument to measure medical student learning in clinical urology: a step toward evidence based education [^115gvbYA]. The Journal of Urology (2004). Low credibility.
...
### Effect of a smartphone intervention as a secondary prevention for use among university students with unhealthy alcohol use: randomised controlled trial [^112Lhyti]. BMJ (2023). Excellent credibility.
...
### Student-and school-level factors associated with mental health and well-being in early adolescence [^113Lkg34]. Journal of the American Academy of Child and Adolescent Psychiatry (2024). Medium credibility.
...
### Relationship between pathology curricular approaches and performance in the United States medical licensing examination (USMLE), step 1: a national cross-sectional study [^113o4hDf]. Human Pathology (2003). Low credibility.
...
### Timing of surgery and internal medicine clerkships and surgery shelf examination scores [^116mF4Br]. The Journal of Surgical Research (2019). Medium credibility.
...
### A 6-item scale for overall, emotional, and social loneliness: confirmatory tests on survey data [^115RWUHC]. Research on Aging (2006). Low credibility.
...
### The impact of the COVID-19 pandemic on college students in USA: two years later [^113cCojH]. Psychiatry Research (2022). Medium credibility.
...
### Student attendance and academic performance in undergraduate obstetrics / gynecology clinical rotations [^116rpm1W]. JAMA (2013). Excellent credibility.
...
### Contact dermatitis and patch testing education: a work group report from the allergic skin diseases committee of the AAAAI [^114Kz9sW]. The Journal of Allergy and Clinical Immunology: In Practice (2025). High credibility.
...
### The UKCAT-12 study: educational attainment, aptitude test performance, demographic and socio-economic contextual factors as predictors of first year outcome in a cross-sectional collaborative study of 12 UK medical schools [^112symrx]. BMC Medicine (2013). Low credibility.
...
### Clinical practice guidelines: childhood hearing screening [^1116qqij]. AAA (2011). Medium credibility.
...
### APA guidelines for psychological assessment and evaluation [^113f2PAh]. APA (2020). High credibility.
...
### Association of third-year medical students' first clerkship with overall clerkship performance and examination scores [^115MzQxf]. JAMA (2010). Excellent credibility.
...
### Assessing the value of an optional radiation oncology clinical rotation during the core clerkships in medical school [^113DatwP]. International Journal of Radiation Oncology, Biology, Physics (2012). Low credibility.
...
### Predictive validity of the UKCAT for medical school undergraduate performance: a national prospective cohort study [^1175jUuv]. BMC Medicine (2016). Low credibility.
...
### Association between a medical school admission process using the multiple mini-interview and national licensing examination scores [^113zPUYr]. JAMA (2012). Excellent credibility.
...
### Suicidal ideation and attempts among students in grades 8, 10, and 12-Utah, 2015 [^117ViPx7]. MMWR: Morbidity and Mortality Weekly Report (2018). Low credibility.
...
### Scoring system: use and not use from the future to present [^115gKova]. Critical Care (2024). Medium credibility.
...
### NASPGHAN guidelines for training in pediatric gastroenterology [^115fTAhT]. Journal of Pediatric Gastroenterology and Nutrition (2013). Medium credibility.
...
### A simple practical patient-reported clinic satisfaction measure for young adults [^113U36Lo]. British Journal of Cancer (2010). Low credibility.
...
### Teaching students to question [^115dZYDE]. American Journal of Obstetrics and Gynecology (2004). Low credibility.
...
### Teaching important basic EEG patterns of bedside electroencephalography to critical care staffs: a prospective multicenter study [^1127mE8D]. Neurocritical Care (2021). Medium credibility.
...
### Interpretation and use of a decision support tool for multiple treatment options: a combined randomised controlled trial and survey of medical students [^111CeW8G]. BMJ Evidence-Based Medicine (2024). High credibility.
...
To compare the two randomised groups, we used the Mann-Whitney U non-parametric test for outcomes with ordinal variables that had three or more categories. We used χ² tests for dichotomised outcomes. We used STATA for all statistical analysis.
...
### Exploring the knowledge and practices on road safety measures among motorbikers in dhaka, Bangladesh: a cross-sectional study [^112nEEm1]. Injury Prevention (2025). Medium credibility.
...
### Teaching medical students to help patients manage their weight: outcomes of an eight-school randomized controlled trial [^116md3Q3]. Journal of General Internal Medicine (2021). Medium credibility.
...
### Assessment of vitamin D-related knowledge, attitudes and practices among sultan qaboos university students in Oman: a cross-sectional study [^11214URm]. BMJ Public Health (2024). High credibility.
...
### The effect of a 13-hour curriculum to improve residents' teaching skills: a randomized trial [^1121hcLH]. Annals of Internal Medicine (2004). Low credibility.
...
### Safety of eyeglasses wear for visual acuity among middle school students in northwestern rural China: a cluster-randomised controlled trial [^115fpkiY]. BMJ Open Ophthalmology (2020). High credibility.
...
### Are people with negative diabetes screening tests falsely reassured? Parallel group cohort study embedded in the ADDITION (cambridge) randomised controlled trial [^111pqW12]. BMJ (2009). Excellent credibility.
...
### Examination of the test-retest reliability of a computerized neurocognitive test battery [^1171eTPa]. The American Journal of Sports Medicine (2014). Low credibility.
...
### Guidelines for assessment of and intervention with persons with disabilities [^116ih6VC]. The American Psychologist (2012). Medium credibility.
...
### US medical student performance on the NBME subject examination in internal medicine: Do clerkship sequence and clerkship length matter? [^112YkoF9]. Journal of General Internal Medicine (2015). Low credibility.
...
### An interuniversity competition for medical students to learn radiology in the second life metaverse [^115Q9vxn]. Journal of the American College of Radiology (2024). Medium credibility.
...
### Short social media videos as a supplementary educational resource in neuroanatomy: a nonrandomized clinical trial [^1161pDuE]. JAMA Network Open (2025). High credibility.
...
However, the model's explanatory power was limited. The coefficient of determination (R²) was 0.117, with the adjusted R² at 0.095, indicating that only 9.5% of the variance in neuroanatomy scores was explained by the variables in the model. Furthermore, the SE of the estimate was 20.71, highlighting a substantial margin of error in the estimation of individual scores.
...
### Clinical trials of potential cognitive-enhancing drugs in schizophrenia: what have we learned so far? [^115CBVeF]. Schizophrenia Bulletin (2013). Low credibility.
...
### ACFAS scoring scale user guide [^113u4P4V]. The Journal of Foot and Ankle Surgery (2005). Medium credibility.
...
### Guidelines for psychological practice with girls and women [^112cCXDL]. The American Psychologist (2007). Medium credibility.
...
### School-aged children who are not progressing academically: considerations for pediatricians [^116voiwi]. Pediatrics (2019). High credibility.
...
### NASPGHAN guidelines for training in pediatric gastroenterology [^115pSK1x]. Journal of Pediatric Gastroenterology and Nutrition (2013). Medium credibility.
...
### Suicidal ideation and attempts among students in grades 8, 10, and 12-Utah, 2015 [^116BKsJ3]. MMWR: Morbidity and Mortality Weekly Report (2018). Low credibility.
