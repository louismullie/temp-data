...
> I will now examine adult dosing because the user might be asking about adults too. The FDA labeling provides adult dosing regimens and again uses the "continue until 48–72 hours after symptom resolution" stop rule rather than a fixed duration; in practice, many clinicians use 5–7 days for adults with uncomplicated AOM, but the label does not mandate a specific number of days, so I should be cautious and tailor to response and severity [^3a100be8].
