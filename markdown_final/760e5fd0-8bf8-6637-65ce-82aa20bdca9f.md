...
### Multimodal mechanisms of human socially reinforced learning across neurodegenerative diseases [^115Qibd8]. Brain (2022). Medium credibility.
...
### Association between socioeconomic status and Parkinson's disease: findings from a large incident case-control study [^114UbTsb]. BMJ Neurology Open (2023). High credibility.
...
### Exploring rural households' knowledge and perception of acute kidney injury in the Southern region of the Gambia: a mixed-method community-based cross-sectional study design [^111S1fik]. BMJ Public Health (2024). High credibility.
...
### Aftereffects of cognitively demanding acute aerobic exercise on working memory [^115Y6qMW]. Medicine and Science in Sports and Exercise (2019). Medium credibility.
...
### Cost analysis of the PARENT trial of community health workers in early childhood preventive care: a secondary analysis of a cluster-randomized clinical trial [^111EscQ3]. JAMA Network Open (2025). High credibility.
...
### Dissociative and prioritized modeling of behaviorally relevant neural dynamics using recurrent neural networks [^1138b7ef]. Nature Neuroscience (2024). High credibility.
...
### Reinforcement learning increasingly relates to memory specificity from childhood to adulthood [^115t3NCL]. Nature Communications (2025). High credibility.
...
### Insulin degludec and liraglutide (xultophy 100 / 3.6) [^114wZQgs]. FDA (2025). Medium credibility.
...
### Psychological interventions that decrease psychological distance or challenge system justification increase motivation to exert effort to mitigate climate change [^1159qHL6]. Communications Psychology (2025). Medium credibility.
...
### Insulin glargine-aglr (rezvoglar) [^116L7cQR]. FDA (2024). Medium credibility.
...
### Vortioxetine versus placebo for major depressive disorder: a comprehensive analysis of the clinical trial dataset [^112usb1k]. The Journal of Clinical Psychiatry (2021). Medium credibility.
...
### Multidimensional imaging model for diagnosing primary open-angle glaucoma using fundus photographs and optical coherence tomography images [^1169C16h]. BMJ Open Ophthalmology (2025). High credibility.
...
### Genetic susceptibility to cancer: the role of polymorphisms in candidate genes [^117PDxbu]. JAMA (2008). Excellent credibility.
...
### Post-transplant cyclophosphamide versus anti-thymocyte globulin after reduced intensity peripheral blood allogeneic cell transplantation in recipients of matched sibling or 10 / 10 HLA matched unrelated donors: final analysis of a randomized, open-label, multicenter, phase 2 trial [^1176ZEmt]. Blood Cancer Journal (2024). Medium credibility.
...
### Genome-wide mutational biases fuel transcriptional diversity in the Mycobacterium tuberculosis complex [^111T3wnS]. Nature Communications (2019). High credibility.
...
### Ventral midbrain stimulation induces perceptual learning and cortical plasticity in primates [^113oAfeo]. Nature Communications (2019). High credibility.
...
### A prognostic enrichment strategy for selection of patients with acute respiratory distress syndrome in clinical trials [^114zFrcw]. Critical Care Medicine (2019). Medium credibility.
...
### Education and midlife cognitive functioning: evidence from the high school and beyond cohort [^113xkieS]. Alzheimer's & Dementia (2025). Medium credibility.
...
### A BERT model generates diagnostically relevant semantic embeddings from pathology synopses with active learning [^114d6A8R]. Communications Medicine (2021). Medium credibility.
...
### Factors associated with attention deficit / hyperactivity disorder among US children: results from a national survey [^11223UUC]. BMC Pediatrics (2012). Low credibility.
...
### Excess congenital non-synonymous variation in leukemia-associated genes in MLL-infant leukemia: a children's oncology group report [^115J812Y]. Leukemia (2014). Low credibility.
...
### The lothian birth cohort 1936: a study to examine influences on cognitive ageing from age 11 to age 70 and beyond [^11746qvV]. BMC Geriatrics (2007). Low credibility.
...
### Injectable and topical local anesthetics for acute dental pain: 2 systematic reviews [^114UQm1a]. Journal of the American Dental Association (2023). High credibility.
...
### Utility of medical record diagnostic codes to ascertain attention-deficit / hyperactivity disorder and learning disabilities in populations of children [^116oZtvk]. BMC Pediatrics (2020). Medium credibility.
...
### Shift schedule with fewer short daily rest periods and sickness absence among health care workers: a cluster randomized clinical trial [^112MNXkn]. JAMA Network Open (2025). High credibility.
...
### Arsenic and all-retinoic acid for acute promyelocytic leukemia: yes, it really is as good as it seems [^114DGrgt]. Haematologica (2021). Medium credibility.
...
### Widespread intra-axonal signal fraction abnormalities in bipolar disorder from multicompartment diffusion MRI: sensitivity to diagnosis, association with clinical features and pharmacologic treatment [^116hMitF]. Human Brain Mapping (2023). Medium credibility.
...
### Association of identification of facility and transportation for childbirth with institutional delivery in high priority districts of uttar pradesh, India [^116dYxmp]. BMC Pregnancy and Childbirth (2021). Medium credibility.
...
### High-dimensional topographic organization of visual features in the primate temporal lobe [^114q1UAd]. Nature Communications (2023). High credibility.
...
### Analgesics for the management of acute dental pain in the pediatric population: a systematic review and meta-analysis [^116PPk2x]. Journal of the American Dental Association (2023). High credibility.
...
### Time to recovery from severe acute malnutrition and its predictors among under five children admitted to therapeutic feeding units of general and referral hospitals in tigray, Ethiopia, 2020: a prospective cohort study [^111rFTE1]. BMC Pediatrics (2023). Medium credibility.
...
### Association of genetic variants linked to late-onset Alzheimer disease with cognitive test performance by midlife [^113ja7mp]. JAMA Network Open (2022). High credibility.
...
### Phenotypic and genetic analysis of cognitive performance in major depressive disorder in the generation scotland: Scottish family health study [^116eGyAN]. Translational Psychiatry (2018). Low credibility.
...
### Trends of depression and anxiety during massive civil unrest and COVID-19 in hong kong, 2019–2020 [^115i5Vz1]. Journal of Psychiatric Research (2022). Medium credibility.
...
### Assessment and management of patients at risk for suicide: synopsis of the 2024 U.S. department of veterans affairs and U.S. department of defense clinical practice guidelines [^112iyoTh]. Annals of Internal Medicine (2025). High credibility.
...
### Challenges and issues in new vaccine development [^115HPzqh]. Trends in Immunology (2002). Low credibility.
...
### ESTES guidelines: acute mesenteric ischaemia [^115V69kH]. European Journal of Trauma and Emergency Surgery (2016). Medium credibility.
