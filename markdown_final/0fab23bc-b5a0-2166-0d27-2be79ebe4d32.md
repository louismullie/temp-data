...
> I will now examine surgical options for refractory cases. For chronic or recurrent olecranon bursitis, bursectomy is traditional but has notable complication rates; emerging options like hydrothermal ablation show promising early results with fewer complications, though I should acknowledge limited follow-up and availability [^116gLLd4]. For trochanteric pain syndrome refractory to conservative care, endoscopic bursectomy with iliotibial band release can be effective, and for retrocalcaneal bursitis with Haglund deformity, calcaneal prominence resection with bursa excision is standard when nonoperative care fails [^114CrexQ] [^111xiSST]. I need to ensure patients have exhausted at least 3–6 months of conservative therapy before discussing surgery and that expectations are aligned with recovery timelines [^notfound].
