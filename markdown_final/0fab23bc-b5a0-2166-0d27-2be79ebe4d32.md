...
> Let me first confirm the classification framework, because treatment hinges on distinguishing aseptic from septic bursitis and on the anatomic location. Aseptic bursitis is typically inflammatory or microtraumatic, whereas septic bursitis is infectious and most often due to Staphylococcus aureus; clinically, septic bursitis more often shows erythema, warmth, tenderness, and systemic features, but overlap is substantial, so I should not rely on exam alone to exclude infection [^30195f53] [^6302f713]. I also need to remember that many "bursitis" syndromes, especially trochanteric, reflect broader entities like greater trochanteric pain syndrome with gluteal tendinopathy rather than true bursal inflammation, which changes management priorities [^ee3d918d] [^03b36fa4].

> Next, I should review the universal conservative foundation that applies across sites. Rest and activity modification to offload the bursa, ice, elevation, and NSAIDs are first-line for aseptic bursitis; I need to ensure NSAID use follows the principle of lowest effective dose for the shortest duration and account for contraindications, and I should remember that opioids are not first-line for musculoskeletal pain like bursitis when nonopioid options are appropriate [^30195f53] [^e3b059ab] [^285f1ff2]. Hold on, I should verify whether guidelines universally endorse NSAIDs for aseptic olecranon bursitis; ACOEM gives no recommendation for NSAIDs in aseptic olecranon bursitis, so I should be cautious not to overgeneralize and tailor NSAID use to patient risk and site-specific context [^03a3d449].

> Now, let me consider olecranon bursitis specifically. For nonseptic cases, compression with padding, NSAIDs, and avoidance of direct pressure are standard, and I should avoid routine aspiration because of iatrogenic infection risk; if I do aspirate, it should be for diagnostic uncertainty or for symptomatic relief, and I should weigh the risk of chronic drainage or fistula [^30195f53] [^e18115db]. Wait, let me verify the role of corticosteroid injection; a randomized trial showed no difference in resolution by 4 weeks among compression plus NSAIDs, aspiration alone, or aspiration plus steroid, though steroid hastened symptom resolution, and more recent reviews caution against routine injection due to complications, so I should reserve intrabursal steroids for refractory cases after shared decision-making [^d0c5b230] [^e18115db]. For suspected septic olecranon bursitis, I initially thought aspiration was mandatory, but hold on, let's not jump to conclusions; multiple ED cohorts suggest that carefully selected patients can be managed with empiric oral antibiotics without aspiration, with high rates of uncomplicated resolution, provided they are immunocompetent, have reliable follow-up, and are low risk for complications; I should still individualize and escalate to aspiration or surgical drainage if they fail to improve [^62471c8c] [^70278d9a] [^47eb42d6].

> Turning to greater trochanteric pain syndrome, I need to emphasize that most cases are not true bursitis and that gluteal tendinopathy and abductor weakness are central. Therefore, first-line management is education and progressive hip abductor strengthening, with NSAIDs as adjuncts for pain control; corticosteroid injections can provide short-term relief but should not replace rehabilitation, and I should minimize steroid exposure in older adults or those with metabolic risk [^cc383512] [^e60a9c05]. Let me double-check the injection evidence; a multicenter RCT found fluoroscopically guided injections were not superior to palpation-guided injections at 1 month, and systematic reviews show short-term benefit from corticosteroids but no long-term advantage over exercise-based care, reinforcing that injections are optional and best paired with therapy [^3e7e5091] [^5cec64d9]. If symptoms persist beyond 3–6 months despite conservative care, I should consider ultrasound-guided injection or PRP, acknowledging that PRP evidence is mixed and evolving, and reserve surgery for refractory cases with documented abductor pathology [^e07d2699] [^ea88e77e].

> For prepatellar bursitis, I should confirm that the approach mirrors superficial bursitis principles: activity modification to avoid kneeling, ice, NSAIDs, and compression with padding are first-line. Aspiration is reasonable for large, tense effusions or diagnostic uncertainty, and corticosteroid injection may be considered in nonseptic, refractory cases, balancing infection risk and recurrence [^30195f53] [^643db491]. Hold on, I should verify that the evidence base is weaker here; indeed, much of the guidance is consensus-driven, so I will individualize and ensure close follow-up if I proceed with injection [^notfound].

> For retrocalcaneal bursitis, I need to ensure I do not inject the Achilles tendon. Shoe modification to remove heel counter pressure, NSAIDs, and physical therapy focused on eccentric loading are foundational, and if injection is used, it should be ultrasound-guided into the bursa, not the tendon, to mitigate rupture risk. Surgery is reserved for refractory cases with Haglund deformity or persistent symptoms despite exhaustive conservative care [^25948d20] [^097323dd]. Let me reconsider the strength of injection evidence; it is largely based on feasibility and case series, so I should counsel patients about uncertain benefit and potential complications before proceeding [^097323dd].

> For subacromial bursitis within the broader context of subacromial pain, I should confirm that corticosteroid injection provides short-term pain relief and that combining injection with supervised physical therapy yields better mid-term outcomes. Ultrasound guidance improves accuracy but has not consistently improved patient-relevant outcomes over landmark-guided injection, so I should balance access, cost, and expertise when choosing guidance [^efe6714c] [^c7c46bdd]. But wait, what if the pain is primarily tendinopathy rather than bursitis; I should still anchor treatment in load management and rotator cuff strengthening, using injection as an adjunct for pain flares rather than monotherapy [^efe6714c].

> Next, I should review injection technique and dosing to minimize risk. For olecranon and other superficial bursae, a low-dose corticosteroid such as methylprednisolone acetate 20 mg is reasonable when indicated; for shoulders, 20 mg triamcinolone or equivalent is effective and higher doses are not clearly superior; I should always use sterile technique, consider image guidance for deep or anatomically complex targets, and avoid injecting through or into tendons, particularly the Achilles [^45611ea3] [^efe6714c] [^097323dd]. Hold on, I should verify that multiple injections carry cumulative risk; yes, repeated local steroids can impair tissue integrity, so I will limit injections to the lowest effective number and interval [^notfound].

> I will now examine surgical options for refractory cases. For chronic or recurrent olecranon bursitis, bursectomy is traditional but has notable complication rates; emerging options like hydrothermal ablation show promising early results with fewer complications, though I should acknowledge limited follow-up and availability [^de23fc5f]. For trochanteric pain syndrome refractory to conservative care, endoscopic bursectomy with iliotibial band release can be effective, and for retrocalcaneal bursitis with Haglund deformity, calcaneal prominence resection with bursa excision is standard when nonoperative care fails [^7d5ce4f9] [^25948d20]. I need to ensure patients have exhausted at least 3–6 months of conservative therapy before discussing surgery and that expectations are aligned with recovery timelines [^notfound].

> Special populations require extra caution. In older adults, I should minimize corticosteroid exposure due to systemic risks and prioritize strengthening and load modification. In patients with diabetes, immunocompromise, or those on systemic steroids, I should have a lower threshold to evaluate for infection and avoid elective injections. In children, bursitis is uncommon and management should be conservative, with specialist input if infection is suspected [^cc383512] [^30195f53]. For patients with inflammatory arthritis, I should treat the underlying disease and consider image-guided injections as adjuncts when inflammation is confirmed [^3b19dd5c].

> Let me synthesize a practical algorithm and double-check it aligns with evidence. First, confirm the diagnosis and exclude infection using clinical judgment and, when uncertain, ultrasound to distinguish bursitis from cellulitis or abscess. Second, implement universal conservative measures including rest, ice, NSAIDs if appropriate, and activity modification with protective padding. Third, add site-specific measures such as abductor strengthening for GTPS, shoe modification for retrocalcaneal bursitis, and compression for olecranon. Fourth, consider a single corticosteroid injection for persistent symptoms after 4–6 weeks, using image guidance for deep targets and avoiding tendon injection. Fifth, reassess at 6–12 weeks and escalate to surgical consultation only if symptoms remain disabling despite optimized conservative care [^30195f53] [^e18115db] [^cc383512] [^25948d20].

> Finally, I should confirm key takeaways and correct any overstatements. Nonseptic bursitis is common and usually self-limited; conservative management resolves most cases, and invasive procedures should be reserved for refractory disease. Corticosteroid injections can provide short-term relief but carry risks and should be used sparingly, ideally with therapy. Septic bursitis management is evolving, and in select ED patients, empiric antibiotics without aspiration can be reasonable with close follow-up, though aspiration remains appropriate when diagnostic clarity will change management or when patients are high risk or fail initial therapy [^30195f53] [^d0c5b230] [^62471c8c] [^70278d9a].

---

Bursitis treatment is **conservative first**, with rest, ice, NSAIDs, and activity modification [^30195f53] [^8933b734]. If symptoms persist, **corticosteroid injection** can provide short-term relief [^8b64e34d] [^5cec64d9]; ultrasound guidance improves accuracy and may reduce complications [^c7c46bdd] [^e07d2699]. Septic bursitis requires **antibiotics** [^30195f53] and aspiration for diagnosis; surgery is reserved for refractory or complicated cases [^643db491] [^8933b734]. Most patients improve with conservative care, but recurrence is common without ongoing activity modification [^e18115db] [^8933b734].

---

## Conservative management

Conservative management is the cornerstone of bursitis treatment and is effective in most cases [^8933b734]. The following measures are recommended:

- **Rest and activity modification**: Avoid activities that exacerbate symptoms, such as repetitive motions or prolonged pressure on the affected bursa [^30195f53] [^8933b734].

- **Ice therapy**: Apply ice packs for 15–20 minutes several times daily to reduce inflammation and pain [^notfound].

- **Nonsteroidal anti-inflammatory drugs (NSAIDs)**: Ibuprofen, naproxen, or indomethacin are commonly used to relieve pain and inflammation [^e3b059ab] [^6592d47a].

- **Physical therapy**: Focused exercises to strengthen surrounding muscles, improve flexibility, and correct biomechanical imbalances are beneficial, particularly for trochanteric and subacromial bursitis [^cc383512] [^efe6714c].

- **Protective padding**: Use elbow or knee pads to reduce pressure on the affected bursa during activities [^30195f53] [^643db491].
...
Corticosteroid injections are indicated for persistent bursitis that does not respond to conservative measures [^65c51785]. They provide **rapid relief** of pain and inflammation but carry risks such as infection, skin atrophy, and tendon rupture [^8b64e34d]. Ultrasound guidance improves accuracy and reduces complications [^c7c46bdd] [^e07d2699].

| **Bursa location** | **Indication for injection** | **Evidence level** |
|-|-|-|
| Olecranon | Persistent non-septic bursitis | Grade B [^8b64e34d] |
| Prepatellar | Persistent non-septic bursitis | Grade B [^notfound] |
| Trochanteric | Refractory cases | Moderate evidence [^5cec64d9] |
| Subacromial | Short-term pain relief | High certainty [^efe6714c] |

---

### Antibiotics

Antibiotics are indicated for **septic bursitis**, with Staphylococcus aureus being the most common pathogen [^30195f53]. Empiric therapy should cover this organism, and aspiration is recommended for diagnostic confirmation and to guide antibiotic selection [^30195f53] [^4bde4cb3].

---

## Surgical interventions

Surgery is reserved for refractory cases or complications such as chronic infection, persistent drainage, or significant functional impairment [^8933b734]. Common procedures include:

- **Bursectomy**: Removal of the inflamed bursa, often performed arthroscopically [^7d5ce4f9].

- **Debridement**: Removal of inflamed tissue and bone spurs, particularly in retrocalcaneal bursitis [^25948d20].

- **Tendon repair**: Addressing concomitant tendon pathology, such as in trochanteric bursitis with gluteal tendon tears [^69487050].

---

## Emerging therapies

Emerging therapies such as **platelet-rich plasma (PRP) injections** and **hydrothermal ablation** have shown promise in refractory cases, but evidence remains limited and further research is needed [^e07d2699] [^de23fc5f].

---

## Prognosis and recurrence

Most patients experience significant improvement with conservative management, but recurrence is common without ongoing activity modification and addressing underlying biomechanical issues [^8933b734]. Persistent cases may require repeated injections or surgical intervention [^8933b734].
...
### ACOEM practice guidelines: elbow disorders [^03a3d449]. Journal of Occupational and Environmental Medicine (2013). Medium credibility.
...
### Naproxen (naproxen sodium) [^e3b059ab]. FDA (2014). Low credibility.
...
### Indomethacin (Indomethacin er) [^74097325]. FDA (2010). Low credibility.
...
### Indomethacin [^6592d47a]. FDA (2025). Medium credibility.
...
### Diagnostic and therapeutic injection of the elbow region [^37df2110]. American Family Physician (2002). Low credibility.
...
### Naproxen (SALLUS pain relief collection with naproxen) [^962fc414]. FDA (2016). Low credibility.
...
### Meclofenamate sodium [^52252fc2]. FDA (2024). Medium credibility.
...
### Retro-trochanteric sciatica-like pain: current concept [^b73410a2]. Knee Surgery, Sports Traumatology, Arthroscopy (2011). Low credibility.
...
### Arthroscopic subacromial decompression for subacromial shoulder pain (CSAW): a multicentre, pragmatic, parallel group, placebo-controlled, three-group, randomised surgical trial [^6faa7fff]. Lancet (2018). Excellent credibility.
...
### Ultrasound-guided pes anserine bursitis injection choices: prolotherapy or oxygen-ozone or corticosteroid: a randomized multicenter clinical trial [^dc71d261]. American Journal of Physical Medicine & Rehabilitation (2024). Medium credibility.
...
### Adhesive capsulitis: a review [^7200535f]. American Family Physician (2011). Low credibility.
...
### Treatment of nonseptic olecranon bursitis (...) [^45611ea3]. JAMA Network (2025). Excellent credibility.
...
### Diagnostic and therapeutic injection of the shoulder region [^166943b7]. American Family Physician (2003). Low credibility.
...
### Hydrothermal ablation in recurrent or chronic olecranon bursitis: a prospective study [^de23fc5f]. Journal of Shoulder and Elbow Surgery (2024). Medium credibility.
...
### Managing shoulder pain in manual wheelchair users: a scoping review of conservative treatment interventions [^c8a10b73]. Clinical Rehabilitation (2020). Medium credibility.
...
### Mesotherapy in the treatment of musculoskeletal pain in rehabilitation: the state of the art [^41e5ea9d]. Journal of Pain Research (2019). Medium credibility.
...
### ACOEM practice guidelines: elbow disorders [^ed353e9c]. Journal of Occupational and Environmental Medicine (2013). Medium credibility.
...
### Case report: olecranon bursitis due toin an immunocompromised patient [^5df5760c]. The American Journal of Tropical Medicine and Hygiene (2019). Medium credibility.
...
### Indomethacin (Indomethacin er) [^43b1d7c0]. FDA (2010). Low credibility.
...
### Conservative treatments for greater trochanteric pain syndrome: a systematic review [^5cec64d9]. British Journal of Sports Medicine (2017). Low credibility.
...
### Surgical options for patients with shoulder pain [^98dcdeb8]. Nature Reviews: Rheumatology (2010). Medium credibility.
...
### Is ultrasound-guided injection more effective in chronic subacromial bursitis? [^00ccd0a0]. Medicine and Science in Sports and Exercise (2013). Low credibility.
...
### What's changed in the management of the frozen shoulder? [^a0a06031]. Drug and Therapeutics Bulletin (2015). Low credibility.
...
### Rotator cuff tendinopathy diagnosis, nonsurgical medical care, and rehabilitation: a clinical practice guideline [^3fda9bb3]. The Journal of Orthopaedic and Sports Physical Therapy (2025). High credibility.
...
### Arthroscopic management of painful and stiff scapulothoracic articulation [^f5eab7bc]. Arthroscopy (2003). Low credibility.
...
### Management of rotator cuff injuries [^18575c9b]. AAOS (2025). High credibility.
...
### Indomethacin [^db99899b]. FDA (2025). Medium credibility.
...
### Osteoarthritis of the acromioclavicular joint: a review of anatomy, biomechanics, diagnosis, and treatment [^27b9c203]. American Journal of Physical Medicine & Rehabilitation (2004). Low credibility.
...
### The effects of scapulothoracic bursa injections in patients with scapular pain: a pilot study [^e27216bc]. Archives of Physical Medicine and Rehabilitation (2009). Low credibility.
...
### Image-guided versus blind glucocorticoid injection for shoulder pain [^c7c46bdd]. The Cochrane Database of Systematic Reviews (2012). Low credibility.
...
### Clinical indications for image-guided interventional procedures in the musculoskeletal system: a Delphi-based consensus paper from the European society of musculoskeletal radiology (ESSR)-part VI, foot and ankle [^097323dd]. European Radiology (2022). Medium credibility.
...
### Musculoskeletal ultrasound intervention: principles and advances [^695e968b]. Radiologic Clinics of North America (2008). Low credibility.
...
### Comparison of treatments for frozen shoulder: a systematic review and meta-analysis [^0cdcc5d7]. JAMA Network Open (2020). High credibility.
...
### Editorial commentary: treatment of partial thickness undersurface abductor tears of the hip: like backwards a bike riding [^69487050]. Arthroscopy (2018). Low credibility.
...
### Betamethasone acetate and betamethasone sodium phosphate (Celestone soluspan) [^dad828b4]. FDA (2024). Medium credibility.
...
### The British Society for Rheumatology guideline for the management of foot health in inflammatory arthritis [^3b19dd5c]. Rheumatology (2025). Medium credibility.
...
### Ultrasound-guided minimally invasive surgical resection of retrocalcaneal bursitis: a preliminary comparison with traditional open surgery [^d1ed5877]. The Journal of Foot and Ankle Surgery (2019). Medium credibility.
