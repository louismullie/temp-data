...
A repeated-measures ANOVA revealed no main effect of drug on reaction time variability (online supplementary figure 3E). F Greenhouse-Geisser (1.38, 16.61) = 0.96, P = 0.371, BF 10 = 0.100, nor a main effect of time, F(4, 48) = 0.20, P = 0.939, BF 10 = 0.022. There was also no interaction between drug and time, F(8, 96) = 0.72, P = 0.673. These results provide moderate to strong evidence that there was no effect of drug or time on reaction time variability in the sustained attention task.
