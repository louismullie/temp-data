...
Independent repeated-measures ANOVAs revealed no main effect of drug on the difference between the cancellations on the right and left sides of the cancellation task (figure 2B), F(2, 24) = 0.39, P = 0.683, BF 10 = 0.231, and no main effect of drug on the centre of cancellation (figure 2C), F(2, 24) = 2.45, P = 0.108, BF 10 = 0.848. A direct comparison of the difference in right and left cancellations in the placebo (M = 12.0, SD = 7.99) and guanfacine (M = 11.92, SD = 11.36) conditions revealed no difference between the two, t(12) = 0.03, P = 0.976, BF 10 = 0.278.
