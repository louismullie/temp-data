...
> Let me consider ampicillin-sulbactam when SUL-DUR is unavailable. IDSA suggests high-dose ampicillin-sulbactam delivering 9 g/day of the sulbactam component as part of combination therapy, typically administered as 3 g ampicillin-sulbactam (2 g ampicillin/1 g sulbactam) every 8 hours as a 4-hour extended infusion, or as a continuous infusion of 27 g/day total ampicillin-sulbactam, to maximize %fT > MIC for sulbactam MICs up to 16–32 mg/L in CRAB [^notfound] [^notfound] [^notfound].

> I should confirm renal dosing adjustments for ampicillin-sulbactam. Both components are renally cleared, so frequency should be reduced as creatinine clearance declines. Standard tables provide interval adjustments, and in anuric patients on extended dialysis, twice-daily dosing of 2 g/1 g has been studied without accumulation, though clinical validation is limited and PK/PD targets should still guide practice [^notfound] [^80d0e52d].
