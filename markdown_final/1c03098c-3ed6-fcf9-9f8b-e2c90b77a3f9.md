...
> Let me first confirm the diagnostic framework and phenotype, because treatment hinges on accurate classification. Chronic rhinosinusitis is defined by at least two cardinal symptoms for at least 12 weeks plus objective evidence of sinonasal inflammation on endoscopy or CT, and I should explicitly distinguish CRS with nasal polyps from CRS without nasal polyps since management diverges significantly. Hold on, I should verify that objective confirmation is a strong recommendation; yes, guidelines emphasize documenting inflammation rather than relying on symptoms alone, which helps avoid misdiagnosis and inappropriate therapy [^765512ae].
