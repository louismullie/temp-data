...
The most likely diagnosis is **Guillain-Barré syndrome (GBS)** [^115oqJ8F], given the acute, symmetric, ascending weakness with areflexia/hyporeflexia [^112E8A7i] following a recent febrile illness with cough and diarrhea, and the absence of sensory loss or sphincter involvement. The macular rash is likely a post-infectious or drug-related eruption and not specific to GBS. Key differentials to exclude are acute flaccid myelitis (AFM) [^112GyM1w], transverse myelitis [^114XqWVX], and myasthenia gravis [^notfound]. Immediate workup should include **CSF analysis** [^115KWqxX], **nerve conduction studies** [^113v2jka], and **MRI of the brain and spine** [^114R7iKT] to confirm the diagnosis and exclude mimics. Early **IVIG or plasma exchange** [^115KWqxX] is indicated to reduce severity and hasten recovery [^111KpKRt].
