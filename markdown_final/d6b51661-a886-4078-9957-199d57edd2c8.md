...
> Let me first confirm the core clinical picture and timeline to avoid premature anchoring: a previously healthy adolescent with a 4-day prodrome of fever, cough, and diarrhea, followed by a macular rash on hands and legs and then acute, predominantly proximal limb weakness with preserved reflexes and no meningeal irritation, plus a respiratory count-to-10 impairment suggesting mild ventilatory compromise, which together point toward a post-infectious immune-mediated process rather than a primary CNS infection or compressive lesion.
