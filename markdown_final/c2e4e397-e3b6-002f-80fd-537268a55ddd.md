...
A 24-hour urine delta-ALA of 15.7 mg/day is **significantly elevated** (normal < 4 mg/day) and indicates increased heme precursor synthesis [^112Sbt5W]. This level is most consistent with **acute hepatic porphyria** (AIP, HCP, VP) during or between attacks, where ALA is typically 5–20× the upper limit of normal [^115TGqyP]. It can also reflect **lead poisoning** or hereditary tyrosinemia, so confirm with urine PBG, blood lead, and genetic testing [^113oyWV2] [^112Sbt5W]. If porphyria is confirmed, treat attacks with IV hemin and avoid triggers; if lead poisoning is found, initiate chelation and remove the source [^112d1T5d] [^112Sbt5W].
