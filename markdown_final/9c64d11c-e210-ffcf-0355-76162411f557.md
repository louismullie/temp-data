...
> Let me first confirm the scope of evidence. There are thousands of randomized controlled trials and over 2,000 systematic reviews of acupuncture, covering dozens of adult health conditions, which establishes a vast but heterogeneous evidence base that spans musculoskeletal pain, headache disorders, cancer-related symptoms, mental health, and more [^113Xj1ro] [^116yrsSj] [^115wtXgF].

> Wait, let me verify the certainty of evidence rather than just the quantity. High-quality evidence mapping shows that among hundreds of recent systematic reviews, only a minority conclude with high or moderate certainty, and most conclusions remain low or very low certainty, largely due to risk of bias, inconsistency, and imprecision; importantly, many of the higher-certainty findings come from comparisons with sham or no treatment rather than active therapies, which complicates inference about specific effects [^115wtXgF] [^115DNQKA] [^117HoUKy].

> I will now examine pain conditions, where signals are strongest. For chronic low back pain, multiple systematic reviews and guidelines suggest acupuncture provides clinically meaningful improvements in pain and function when added to usual care, though effects versus sham are small and sometimes indistinguishable; the VA/DoD guideline suggests acupuncture for chronic low back pain, and cost-effectiveness data support its use in some settings [^114ULniU] [^116cPqPh] [^115zK7mT] [^113rkCtL]. For migraine prophylaxis, Cochrane and subsequent reviews indicate moderate-certainty evidence that acupuncture reduces headache frequency versus no prophylaxis and shows a small but statistically significant benefit over sham, with favorable safety compared with drugs; VA/DoD headache guidelines also acknowledge potential benefit despite low-quality evidence [^114xUQ7R] [^112f6Fwt] [^117HoUKy]. For tension-type headache, Cochrane reviews report moderate-quality evidence of benefit over routine care and a small benefit over sham, supporting its consideration as a nonpharmacologic option [^1165rNVf] [^114bVCd9].

> Hold on, let's not jump to conclusions about all pain. I should double-check osteoarthritis of the knee. The AAOS guideline gives a limited-strength recommendation, noting that while some trials show pain and function benefits, effects are inconsistent and appear smaller when blinding is effective, so patient selection and shared decision-making are key [^1115SHEz]. For acute pain and perioperative settings, emerging systematic reviews and white papers suggest acupuncture can reduce pain and opioid requirements, but the evidence quality varies and access barriers remain substantial, so I need to be cautious about overgeneralization [^114xnxmp] [^1144Ged1].

> Next, I should review supportive oncology care. Moderate-certainty evidence indicates acupuncture and acupressure reduce cancer pain intensity and may reduce opioid consumption, and acupuncture is recommended by ASCO and NCCN as a nonpharmacologic option for cancer pain; additionally, acupuncture has consistent evidence for chemotherapy-induced nausea and vomiting, which is reflected in oncology guidelines and represents one of the more robust indications [^115V5TV2] [^113AhoGj] [^111Q3nem] [^112dWvLY].

> Let me consider mental health and other conditions. For depression, Cochrane and subsequent reviews conclude that evidence is low to very low quality overall, with small average effects versus no treatment and uncertain effects versus sham or medication; thus, acupuncture should not be considered first-line for depression outside of research or carefully selected cases [^112TZ7B7] [^116ox1G8]. For insomnia, evidence remains limited by heterogeneity and risk of bias, so routine use cannot be endorsed pending higher-quality trials [^114QSKyT] [^111q96nN]. For allergic rhinitis, some guidelines suggest acupuncture as a nonpharmacologic option given symptom improvements in RCTs, but confidence is low and patient preferences should guide use [^1131dGZ4] [^11245t2R].

> I need to ensure I address safety and implementation. Serious adverse events from acupuncture are rare in large datasets, and nonserious events such as bruising or transient soreness occur in roughly 7–11% of patients; however, proper training, sterile technique, and screening for contraindications are essential to minimize risk [^116UEhBX] [^1115SHEz]. Access remains a major barrier in many systems, with limited insurance coverage and workforce constraints, which affects real-world uptake despite favorable safety profiles [^111n84rx] [^113C7mwv].

> But wait, what about placebo and sham controls. I should confirm the magnitude of nonspecific effects. Meta-analyses of three-arm trials show a small, often clinically modest difference between true and sham acupuncture, alongside a larger difference between sham and no treatment, indicating substantial contextual and placebo components; this does not negate benefit but does complicate attribution to specific needle effects and argues for pragmatic, comparative effectiveness studies versus active treatments rather than more sham-controlled trials [^113nwQrc] [^1142AHX5] [^117HoUKy].

> Let me synthesize and translate this into practical guidance. Yes, there are data to support acupuncture for several conditions, with the most consistent, clinically meaningful benefits in chronic low back pain, migraine and tension-type headache prophylaxis, cancer-related pain and CINV, and select other pain syndromes; benefits are typically modest on average, safety is favorable when delivered by trained providers, and shared decision-making is crucial given heterogeneity and access issues [^114ULniU] [^114xUQ7R] [^1165rNVf] [^115V5TV2] [^116cPqPh]. For many other conditions, evidence remains low certainty or insufficient, so acupuncture may be considered case-by-case or within research contexts, and patients should be counseled about expected effect sizes, costs, and alternatives [^115wtXgF] [^115DNQKA].

> Finally, I should confirm the research gaps and future directions. The field needs fewer systematic reviews and more high-quality, adequately powered RCTs comparing acupuncture with active treatments, improved standardization and reporting of acupuncture protocols, and better integration of patient-centered outcomes and implementation science to close the evidence-practice gap [^116CENJs] [^111fQim6] [^117VCG37].

---

There is **moderate-certainty evidence** that acupuncture is effective for chronic low back pain [^114ULniU], migraine prevention [^114xUQ7R], and tension-type headache [^1165rNVf], with benefits over sham or usual care in these conditions. For other conditions, evidence is **limited or low certainty** [^115wtXgF], and acupuncture is generally safe when performed by trained practitioners [^115UTxLZ]. Guidelines suggest acupuncture as an option for chronic pain, migraine, and tension-type headache, but **more high-quality trials are needed** to clarify its role across conditions [^116cPqPh] [^116CENJs].
...
|-|-|-|
| Chronic low back pain | Acupuncture improves pain and function vs sham or usual care; moderate-certainty evidence supports clinical use [^114ULniU] [^116cPqPh] | Moderate |
| Migraine prevention | Reduces migraine frequency vs sham or no prophylaxis; comparable to drugs with fewer adverse effects [^114xUQ7R] [^113vc6DG] | Moderate |
| Tension-type headache | Reduces headache frequency vs sham or routine care; moderate-certainty evidence supports use [^1165rNVf] [^114bVCd9] | Moderate |

---

## Conditions with low or very low certainty evidence

- **Osteoarthritis**: Small, inconsistent benefits vs sham; evidence is low certainty [^1115SHEz].
- **Depression**: Small effects vs no treatment or sham; high risk of bias limits conclusions [^112TZ7B7] [^116ox1G8].
- **Insomnia**: Mixed results; heterogeneity and bias limit certainty [^114QSKyT] [^111q96nN].
- **Cancer pain**: Some reviews suggest benefit, but evidence remains limited and heterogeneous [^115V5TV2] [^112eRmaK].

---

## Safety profile

Acupuncture is **generally safe** when performed by trained practitioners; serious adverse events are rare, and non-serious events (e.g. bruising, soreness) occur in 7–11% of patients [^116UEhBX] [^115UTxLZ].

---

## Clinical guidelines and recommendations

- **Chronic low back pain**: VA/DoD recommends acupuncture as an option [^116cPqPh].
...
- **Sham controls**: Difficulty blinding and variability in sham methods complicate interpretation [^1169UcVi] [^1156KxWX].
- **Heterogeneity**: Differences in populations, protocols, and outcomes limit comparability [^114ULniU] [^1165rNVf].
- **Publication bias**: Positive results may be overrepresented, especially in non-English literature [^114QSKyT] [^1169UcVi].

---

## Conclusion and clinical implications

There is **moderate-certainty evidence** supporting acupuncture for chronic low back pain, migraine prevention, and tension-type headache, with favorable safety profiles. For other conditions, evidence is limited or low certainty, so acupuncture may be considered case-by-case. Clinicians should discuss benefits, risks, and patient preferences, and refer to trained practitioners when appropriate [^114ULniU] [^114xUQ7R] [^1165rNVf].

---

## References

### Evidence on acupuncture therapies is underused in clinical practice and health policy [^114mFjQs]. BMJ (2022). Excellent credibility.
...
### How to design high quality acupuncture trials-a consensus informed by evidence [^111fQim6]. BMJ (2022). Excellent credibility.
...
### Increasing the usefulness of acupuncture guideline recommendations [^113q1EbU]. BMJ (2022). Excellent credibility.
...
### Acupuncture – a critical analysis [^116UEhBX]. Journal of Internal Medicine (2006). Low credibility.
...
### How to design high quality acupuncture trials-a consensus informed by evidence [^115EcAsy]. BMJ (2022). Excellent credibility.
...
### Evidence on acupuncture therapies is underused in clinical practice and health policy [^114yKF3w]. BMJ (2022). Excellent credibility.
...
### Evidence on acupuncture therapies is underused in clinical practice and health policy [^116R9npX]. BMJ (2022). Excellent credibility.
...
### Acupuncture not supported by strong scientific evidence… [^1179xZmo]. AAFP (2020). Medium credibility.
...
### Increasing the usefulness of acupuncture guideline recommendations [^117VCG37]. BMJ (2022). Excellent credibility.
...
### Increasing the usefulness of acupuncture guideline recommendations [^117Pzogz]. BMJ (2022). Excellent credibility.
...
### Using economic evaluations to support acupuncture reimbursement decisions: current evidence and gaps [^111n84rx]. BMJ (2022). Excellent credibility.
...
### Increasing the usefulness of acupuncture guideline recommendations [^116wcjvM]. BMJ (2022). Excellent credibility.
...
### How to design high quality acupuncture trials-a consensus informed by evidence [^116yoLU3]. BMJ (2022). Excellent credibility.
...
### Acupuncture for the prevention of episodic migraine [^114xUQ7R]. The Cochrane Database of Systematic Reviews (2016). Low credibility.
...
### Use of acupuncture for adult health conditions, 2013 to 2021: a systematic review [^116CENJs]. JAMA Network Open (2022). High credibility.
...
### Acupuncture: what does the most reliable evidence tell us? [^112dWvLY]. Journal of Pain and Symptom Management (2009). Low credibility.
...
### Guideline summary review: an evidence-based clinical guideline for the diagnosis and treatment of low back pain [^1122hHGV]. The Spine Journal (2020). High credibility.
...
### Guideline summary review: an evidence-based clinical guideline for the diagnosis and treatment of low back pain [^115cjsYy]. The Spine Journal (2020). High credibility.
...
### Acupuncture analgesia during surgery: a systematic review [^113Qduff]. Pain (2005). Low credibility.
...
### Evidence on acupuncture therapies is underused in clinical practice and health policy [^116H5Kg3]. BMJ (2022). Excellent credibility.
...
### Evidence on acupuncture therapies is underused in clinical practice and health policy [^114EUZyk]. BMJ (2022). Excellent credibility.
...
### Acupuncture therapy as an evidence-based nonpharmacologic strategy for comprehensive acute pain care: the academic consortium pain task force white paper update [^114xnxmp]. Pain Medicine (2022). Medium credibility.
...
### Acupuncture for idiopathic headache [^111rTf5x]. The Cochrane Database of Systematic Reviews (2001). Low credibility.
...
### Increasing the usefulness of acupuncture guideline recommendations [^114b5tzR]. BMJ (2022). Excellent credibility.
...
### Is acupuncture beneficial in depression: a meta-analysis of 8 randomized controlled trials? [^116Zihfi]. Journal of Affective Disorders (2008). Low credibility.
...
### Acupuncture for depression [^116ox1G8]. The Cochrane Database of Systematic Reviews (2010). Low credibility.
...
### Acupuncture therapy as an evidence-based nonpharmacologic strategy for comprehensive acute pain care: the academic consortium pain task force white paper update [^113KHJhd]. Pain Medicine (2022). Medium credibility.
...
### Acupuncture: is it effective for treatment of insulin resistance? [^117Q67aN]. Diabetes, Obesity & Metabolism (2010). Low credibility.
...
### Acupuncture: a treatment for breakthrough pain in cancer? [^115V1j4D]. BMJ Supportive & Palliative Care (2011). Medium credibility.
...
### Acupuncture for insomnia [^111q96nN]. The Cochrane Database of Systematic Reviews (2007). Low credibility.
...
### Acupuncture for the prevention of episodic migraine [^111FNJrV]. The Cochrane Database of Systematic Reviews (2025). Medium credibility.
...
### Acupuncture for the prevention of episodic migraine [^1128FYN8]. The Cochrane Database of Systematic Reviews (2025). Medium credibility.
...
### Use of acupuncture for adult health conditions, 2013 to 2021: a systematic review [^111fqXKM]. JAMA Network Open (2022). High credibility.
...
### Acupuncture: evidence-based treatment in the rehabilitation setting [^115VbPdJ]. Physical Medicine and Rehabilitation Clinics of North America (2020). Medium credibility.
...
### Use of acupuncture for adult health conditions, 2013 to 2021: a systematic review [^113F39rA]. JAMA Network Open (2022). High credibility.
...
### The efficacy and safety of acupuncture for depression-related insomnia: protocol for a systematic review and meta-analysis [^117KEXLd]. Journal of Pain Research (2022). Medium credibility.
...
### Acupuncture for insomnia [^114QSKyT]. The Cochrane Database of Systematic Reviews (2012). Low credibility.
...
### Increasing the usefulness of acupuncture guideline recommendations [^1125QpEk]. BMJ (2022). Excellent credibility.
...
### Acupuncture versus standard medical care in the prophylactic treatment of migraine: a systematic review and meta-analysis [^117AZ7zh]. European Journal of Neurology (2025). Medium credibility.
...
### Acupuncture versus standard medical care in the prophylactic treatment of migraine: a systematic review and meta-analysis [^111z9u1k]. European Journal of Neurology (2025). Medium credibility.
...
### Evidence on acupuncture therapies is underused in clinical practice and health policy [^113Xj1ro]. BMJ (2022). Excellent credibility.
...
### Use of acupuncture for adult health conditions, 2013 to 2021: a systematic review [^115wtXgF]. JAMA Network Open (2022). High credibility.
...
### Guideline summary review: an evidence-based clinical guideline for the diagnosis and treatment of low back pain [^115zK7mT]. The Spine Journal (2020). High credibility.
...
### The efficacy and safety of acupuncture for depression-related insomnia: protocol for a systematic review and meta-analysis [^114K7z6t]. Journal of Pain Research (2022). Medium credibility.
...
### Acupuncture for the prevention of episodic migraine [^115tC8sB]. The Cochrane Database of Systematic Reviews (2025). Medium credibility.
...
### Guideline summary review: an evidence-based clinical guideline for the diagnosis and treatment of low back pain [^1129v9WV]. The Spine Journal (2020). High credibility.
...
### Acupuncture for patients with Alzheimer's disease: an evidence map of randomized controlled trials, systematic reviews, and meta-analysis [^117TtMCG]. Journal of Alzheimer's Disease (2024). Medium credibility.
...
### Efficacy and safety of acupuncture for pain relief: a systematic review and meta-analysis [^112U6t3r]. Supportive Care in Cancer (2024). Medium credibility.
...
### Use of acupuncture for adult health conditions, 2013 to 2021: a systematic review [^115UTxLZ]. JAMA Network Open (2022). High credibility.
...
### Methodological challenges in design and conduct of randomised controlled trials in acupuncture [^1156KxWX]. BMJ (2022). Excellent credibility.
...
### Use of acupuncture for adult health conditions, 2013 to 2021: a systematic review [^114NHSVJ]. JAMA Network Open (2022). High credibility.
...
### AAOS clinical practice guideline summary: management of osteoarthritis of the knee (nonarthroplasty), third edition [^1115SHEz]. The Journal of the American Academy of Orthopaedic Surgeons (2022). High credibility.
...
### Acupuncture for menstrual migraine: a systematic review [^114t7TJe]. BMJ Supportive & Palliative Care (2022). High credibility.
...
### Evidence on acupuncture therapies is underused in clinical practice and health policy [^116yrsSj]. BMJ (2022). Excellent credibility.
...
### Guideline summary review: an evidence-based clinical guideline for the diagnosis and treatment of low back pain [^113rkCtL]. The Spine Journal (2020). High credibility.
...
### Guideline summary review: an evidence-based clinical guideline for the diagnosis and treatment of low back pain [^117KVfZ8]. The Spine Journal (2020). High credibility.
...
### Use of acupuncture for adult health conditions, 2013 to 2021: a systematic review [^1169UcVi]. JAMA Network Open (2022). High credibility.
...
### Acupuncture for palliative cancer pain management: systematic review [^112eRmaK]. BMJ Supportive & Palliative Care (2021). High credibility.
...
### VA / DoD clinical practice guideline for management of stroke rehabilitation [^112qMwck]. VA/DoD (2024). High credibility.
...
### VA / DoD clinical practice guideline for management of stroke rehabilitation [^112c8Ayr]. VA/DoD (2024). High credibility.
...
### Using economic evaluations to support acupuncture reimbursement decisions: current evidence and gaps [^113C7mwv]. BMJ (2022). Excellent credibility.
...
### How large are the nonspecific effects of acupuncture? A meta-analysis of randomized controlled trials [^113BsBS3]. BMC Medicine (2010). Low credibility.
...
### Guideline summary review: an evidence-based clinical guideline for the diagnosis and treatment of low back pain [^117RZx6Z]. The Spine Journal (2020). High credibility.
...
### Acupuncture for palliative cancer pain management: systematic review [^111Q3nem]. BMJ Supportive & Palliative Care (2021). High credibility.
...
### Meta-analysis: acupuncture for low back pain [^115BCg52]. Annals of Internal Medicine (2005). Low credibility.
...
### Clinical practice guideline (update): adult sinusitis [^1131dGZ4]. Otolaryngology — Head and Neck Surgery (2015). Medium credibility.
...
### Acupuncture for depression [^112TZ7B7]. The Cochrane Database of Systematic Reviews (2018). Low credibility.
...
### Determining the efficacy and safety of acupuncture for the preventive treatment of menstrual migraine: a protocol for a PRISMA-compliant systematic review and meta-analysis [^113G1h6C]. Journal of Pain Research (2023). Medium credibility.
...
### Acupuncture treatment for pain: systematic review of randomised clinical trials with acupuncture, placebo acupuncture, and no acupuncture groups [^113nwQrc]. BMJ (2009). Excellent credibility.
...
### Acupuncture treatment for pain: systematic review of randomised clinical trials with acupuncture, placebo acupuncture, and no acupuncture groups [^1142AHX5]. BMJ (2009). Excellent credibility.
...
### Clinical practice guideline (update): adult sinusitis [^11245t2R]. Otolaryngology — Head and Neck Surgery (2015). Medium credibility.
...
### Acupuncture therapy as an evidence-based nonpharmacologic strategy for comprehensive acute pain care: the academic consortium pain task force white paper update [^1144Ged1]. Pain Medicine (2022). Medium credibility.
...
### Complementary and alternative medical therapies [^114W8V2A]. Current Opinion in Neurology (2008). Low credibility.
...
### Guideline summary review: an evidence-based clinical guideline for the diagnosis and treatment of low back pain [^113q7qkw]. The Spine Journal (2020). High credibility.
