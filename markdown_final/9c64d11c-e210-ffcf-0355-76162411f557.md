...
> I will now examine pain conditions, where signals are strongest. For chronic low back pain, multiple systematic reviews and guidelines suggest acupuncture provides clinically meaningful improvements in pain and function when added to usual care, though effects versus sham are small and sometimes indistinguishable; the VA/DoD guideline suggests acupuncture for chronic low back pain, and cost-effectiveness data support its use in some settings [^114ULniU] [^111Q3nem] [^115zK7mT] [^113rkCtL]. For migraine prophylaxis, Cochrane and subsequent reviews indicate moderate-certainty evidence that acupuncture reduces headache frequency versus no prophylaxis and shows a small but statistically significant benefit over sham, with favorable safety compared with drugs; VA/DoD headache guidelines also acknowledge potential benefit despite low-quality evidence [^114xUQ7R] [^112f6Fwt] [^117HoUKy]. For tension-type headache, Cochrane reviews report moderate-quality evidence of benefit over routine care and a small benefit over sham, supporting its consideration as a nonpharmacologic option [^1165rNVf] [^114bVCd9].
