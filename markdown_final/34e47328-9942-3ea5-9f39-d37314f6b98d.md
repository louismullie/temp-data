...
### Pill shape determines esophageal transit times – A pill-to-pill study [^112Dn6HD]. The Laryngoscope (2025). Medium credibility.
...
### Impact of knee support and shape of tabletop on rectum and prostate position [^116p5GBF]. International Journal of Radiation Oncology, Biology, Physics (2004). Low credibility.
...
### Potassium chloride (potassium chloride extended release) [^112anMzL]. FDA (2025). Medium credibility.
...
### Potassium chloride [^114iCyRE]. FDA (2025). Medium credibility.
...
### Sebetralstat (Ekterly) [^114xLoHz]. FDA (2025). Medium credibility.
...
### The sands of time run faster near the end [^117DU5dn]. Nature Communications (2017). Medium credibility.
...
### Extending resolution within a single imaging frame [^11387hJ3]. Nature Communications (2022). High credibility.
...
### Space-time wave packets localized in all dimensions [^117GdmEs]. Nature Communications (2022). High credibility.
...
### Joint practice guideline for sterile technique during vascular and interventional radiology procedures: from the Society of Interventional Radiology, association of periOperative registered nurses, and association for radiologic and imaging nursing, for the Society of Interventional Radiology standards of practice committee, and endorsed by the cardiovascular interventional radiological society of Europe and the Canadian Interventional Radiology Association [^112v3wAc]. Journal of Vascular and Interventional Radiology (2012). Medium credibility.
...
### Establishment registration&device listing… [^115wY6c8]. FDA (AccessData) (2013). Low credibility.
...
### Calculating the absorbed dose from radioactive patients: the line-source versus point-source model [^115FGKL1]. Journal of Nuclear Medicine (2002). Low credibility.
...
### Time-resolved 3D contrast-enhanced MRA of an extended FOV using continuous table motion [^111vVfCF]. Magnetic Resonance in Medicine (2004). Low credibility.
...
### High-resolution tomographic volumetric additive manufacturing [^112n1xpV]. Nature Communications (2020). High credibility.
...
### Potassium-cit [^1142wrc3]. FDA (2021). Medium credibility.
...
### Potassium citrate [^111ypUE9]. FDA (2025). Medium credibility.
...
### Deconvolution volumetric additive manufacturing [^113BHS46]. Nature Communications (2023). High credibility.
...
### Structural puzzles in virology solved with an overarching icosahedral design principle [^115MRuiY]. Nature Communications (2019). High credibility.
...
### Standardization of spirometry 2019 update. An official American Thoracic Society and European Respiratory Society technical statement [^116zBB6J]. American Journal of Respiratory and Critical Care Medicine (2019). High credibility.
...
### Humans in space [^114992r3]. Nature (2001). Excellent credibility.
...
### Phase segregation due to ion migration in all-inorganic mixed-halide perovskite nanocrystals [^111vMc2a]. Nature Communications (2019). High credibility.
...
### Bupropion hydrochloride — Bupropion hydrochloride — sr [^113FV3mQ]. FDA (2025). Medium credibility.
...
### Methylphenidate hydrochloride — methylphenidate hydrochloride — LA [^1152P3qj]. FDA (2025). Medium credibility.
...
### Long-distance teleportation of qubits at telecommunication wavelengths [^114YLjj3]. Nature (2003). Excellent credibility.
...
### ACR-AAPM-SPR practice parameter for diagnostic reference levels and achievable doses in medical X-ray imaging [^111RCq8J]. ACR/AAPM/SPR (2023). High credibility.
...
### British society of gastroenterology guidelines on the diagnosis and management of patients at risk of gastric adenocarcinoma [^114SegRu]. Gut (2019). High credibility.
...
### Extended field-of-view imaging with table translation and frequency sweeping [^116Xgya4]. Magnetic Resonance in Medicine (2003). Low credibility.
...
### Multicontrast sequences with continuous table motion: a novel acquisition technique for extended field of view imaging [^115yBE4B]. Magnetic Resonance in Medicine (2006). Low credibility.
...
### Evaluating quality of glycemic control: graphical displays of hypo-and hyperglycemia, time in target range, and mean glucose [^112auKP6]. Journal of Diabetes Science and Technology (2015). Low credibility.
...
### First over-the-counter daily contraceptive pill released [^111tKHxi]. ACOG (2024). High credibility.
...
### Closing the gap towards super-long suspension bridges using computational morphogenesis [^114eDHnn]. Nature Communications (2020). High credibility.
...
### Bupropion hydrochloride — Bupropion hydrochloride — sr [^114FEhcx]. FDA (2025). Medium credibility.
...
### Whole-body physics simulation of fruit fly locomotion [^113xQTiy]. Nature (2025). Excellent credibility.
...
### Single photon emission computed tomography (SPECT) myocardial perfusion imaging guidelines: instrumentation, acquisition, processing, and interpretation [^115dCJNP]. Journal of Nuclear Cardiology (2018). Medium credibility.
...
### Synthesis and assembly of extended quintulene [^1123nvYB]. Nature Communications (2020). High credibility.
...
### Tacrolimus extended-release capsules (tacrolimus) [^116PvqM3]. FDA (2024). Medium credibility.
...
### Successful kinetic impact into an asteroid for planetary defence [^1121jefX]. Nature (2023). Excellent credibility.
...
### A biophysical account of multiplication by a single neuron [^114TbU99]. Nature (2022). Excellent credibility.
...
### Beaded metamaterials [^117MVWBk]. Nature Communications (2025). High credibility.
...
### Levetiracetam (Elepsia xr 1, 000 mg) [^1159EASp]. FDA (2024). Medium credibility.
