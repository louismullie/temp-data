...
> I need to check ovarian cancer risk as well. Observational data suggest a small increase in ovarian cancer with long-term estrogen-only therapy, with risk rising after about 5 years and returning toward baseline after cessation; given heterogeneity and confounding, I should present this as a possible small risk signal rather than a definitive causal effect, especially when counseling on duration [^112PKmfE]. But wait, what if the patient has a BRCA mutation or strong family history; in that context, individualized oncology input is prudent because baseline risk and gene–environment interactions may alter the risk–benefit calculus for systemic therapy [^113bk3sm].
