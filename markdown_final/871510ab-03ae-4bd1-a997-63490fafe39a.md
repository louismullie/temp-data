...
ANA testing is not useful for routine monitoring of SLE activity because it is a **nonspecific screening test** [^113bfRPo] that lacks correlation with disease activity or flares [^notfound]. Serial ANA testing is discouraged; instead, monitor **anti-dsDNA and complement (C3/C4)** [^1112SkoR] to assess activity, especially in lupus nephritis [^111iVaDB]. ANA may be positive in other autoimmune diseases and healthy individuals, so results must be interpreted in clinical context [^113bfRPo] [^117BEZ5q]. Use validated activity indices (SLEDAI, BILAG) [^11413tUV] and anti-dsDNA/complement to guide management, not ANA [^111iVaDB].
