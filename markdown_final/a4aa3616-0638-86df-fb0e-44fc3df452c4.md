...
> Let me first confirm the clinical framework so I don't miss anything important. Gout management spans two main phases: treating acute flares and preventing future flares via long-term urate-lowering therapy, with a third, often overlooked, element of flare prophylaxis when starting ULT. I should also remember that asymptomatic hyperuricemia is not an indication for pharmacologic ULT, which I need to explicitly state to avoid overtreatment [^6239eda6] [^c2dd3093].
