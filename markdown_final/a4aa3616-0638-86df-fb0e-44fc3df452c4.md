...
| Colchicine | Colchicine | Inhibits microtubule polymerization, reducing neutrophil migration and inflammation | - Low-dose regimen preferred (1.2 mg then 0.6 mg in 1 hour) [^112kpWS7] <br/> - Avoid in severe renal impairment <br/> - Monitor for GI toxicity [^112D3qBA] |
| Glucocorticoids | - Prednisone <br/> - Prednisolone <br/> - Methylprednisolone <br/> - Intra-articular triamcinolone | Potent anti-inflammatory via glucocorticoid receptor signaling | - Use when NSAIDs/colchicine contraindicated <br/> - Short courses (≤ 5 days) to minimize adverse effects <br/> - Intra-articular steroids for monoarticular flares [^1139UKZq] |

---

## Urate-lowering therapy (ULT) for chronic gout management

ULT aims to **reduce serum urate below 6 mg/dL** [^115ZP7Lo] to dissolve crystals and prevent flares; it is indicated for frequent flares, tophi, or radiographic damage [^115C6rnR].

| **Medication class** | **Examples** | **Mechanism of action** | **Clinical considerations** |
|-|-|-|-|
| Xanthine oxidase inhibitors | - Allopurinol <br/> - Febuxostat | Inhibit uric acid synthesis | - Allopurinol first-line; start low (≤ 100 mg/day) and titrate every 2–5 weeks to target urate [^114pVPNt] <br/> - Febuxostat alternative; monitor cardiovascular risk [^115Uqus7] |
| Uricosurics | - Probenecid <br/> - Lesinurad (with allopurinol) | Increase renal uric acid excretion | - Use when xanthine oxidase inhibitors contraindicated <br/> - Avoid in renal stones or moderate-to-severe CKD [^112M1odJ] |
| Uricase therapy | Pegloticase | Converts uric acid to allantoin | - Reserved for refractory, tophaceous gout <br/> - Infusion reactions and antibody development common [^1168EXpt] |

---

## Prophylactic therapy during ULT initiation

Flares are common when starting ULT; **prophylaxis for 3–6 months** is recommended [^113WdF9o].

- **Colchicine**: 0.5–1 mg/day; adjust dose in renal impairment [^112D3qBA].
- **NSAIDs**: Low-dose regimens with gastroprotection if colchicine contraindicated [^114o8nJD].
...
Several new agents are under investigation or recently approved, including **IL-1 inhibitors** (anakinra, canakinumab) for refractory flares [^112ZXcoP] and **selective urate reabsorption inhibitors** (e.g. verinurad) in combination with allopurinol or febuxostat [^116kwExV].

---

## Special considerations

- **Renal impairment**: Allopurinol is first-line with dose adjustment; avoid high-dose colchicine and NSAIDs in severe CKD [^114pVPNt] [^114TZDE4].
- **Cardiovascular disease**: Prefer allopurinol over febuxostat; monitor closely if febuxostat is used [^113bRHCX] [^115Uqus7].
- **Hepatic disease**: Avoid febuxostat; prefer allopurinol or probenecid with caution [^notfound].

---

Gout management relies on **anti-inflammatories for acute flares** and **urate-lowering therapy for chronic control**, with prophylaxis during ULT initiation. Allopurinol is **first-line ULT** [^114pVPNt], and therapy should be individualized to comorbidities and patient preferences [^113ZunYn].
...
### Management of gout in chronic kidney disease: a G-CAN consensus statement on the research priorities [^112PkJxY]. Nature Reviews: Rheumatology (2021). High credibility.
...
### 2012 American College of Rheumatology guidelines for management of gout. part 1: systematic nonpharmacologic and pharmacologic therapeutic approaches to hyperuricemia [^115teZpZ]. Arthritis Care & Research (2012). Medium credibility.
