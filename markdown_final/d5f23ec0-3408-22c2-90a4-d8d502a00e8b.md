...
> I will now examine dosing and titration. Standard initiation is 20 mg once daily, with a recommended increase to 40 mg after at least 1 week if tolerated; doses above 40 mg/day are not recommended due to QT prolongation risk, which is a critical safety ceiling I must emphasize [^a30f7019]. Let me double-check special populations: in patients older than 60 years, those with hepatic impairment, or CYP2C19 poor metabolizers, the maximum recommended dose is 20 mg/day because of higher exposure and arrhythmia risk; I initially thought "elderly" might mean ≥ 65, but the label specifies > 60 years, so I should correct that nuance here [^0eba248f] [^215802d0].
