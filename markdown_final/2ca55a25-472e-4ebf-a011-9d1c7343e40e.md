...
MMF is a **first-line therapy** for CTD-ILD, especially SSc-ILD [^113YjMYr], with evidence of stabilizing or modestly improving lung function and a favorable tolerability profile compared with cyclophosphamide [^116hxBCT]. It is not effective in IPF and should be avoided there [^112ATYfC]. Typical dosing is 1.5–3 g/day [^notfound], with monitoring for GI upset, hematologic effects, and infection risk [^111kY3jH]; teratogenicity mandates strict contraception [^111zbQwY]. MMF is recommended by ATS/ERS and BSR for SSc-ILD [^113kUZYX] [^114XLjT7], and is often combined with nintedanib in progressive fibrosis [^114Ut6fV].
