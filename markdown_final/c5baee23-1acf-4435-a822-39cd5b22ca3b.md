...
> Pregnancy is another area where I need to check specifics. Anticoagulation should continue throughout pregnancy and for at least 6 weeks postpartum, typically with LMWH, and then the duration after pregnancy should be reclassified based on whether the PE was provoked or unprovoked, which I should plan proactively with obstetrics [^notfound].
