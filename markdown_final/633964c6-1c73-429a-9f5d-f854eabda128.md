...
Menveo (meningococcal ACWY-CRM) **does not provide tetanus protection** because it uses CRM197 (diphtheria protein) as the carrier, not tetanus toxoid [^112upt33]. Only meningococcal vaccines using tetanus toxoid as the carrier (e.g. MenQuadfi) can modestly boost anti-tetanus antibodies, but this is not a substitute for routine tetanus vaccination [^112c1Vo5] [^114ym6Wz]. Patients should still receive standard tetanus-containing vaccines (Tdap/Td) per schedule [^114gdgQy].
