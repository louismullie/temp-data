...
> Wait, let me verify the distinction between carrier and antigen, because that's where confusion often arises. In conjugate vaccines, the carrier protein helps elicit a T-dependent immune response to the polysaccharide antigens, but the carrier itself is not the disease antigen being targeted; tetanus toxoid used as a carrier does not confer tetanus protection, and conversely, CRM197 as a carrier does not confer diphtheria protection, even though it is derived from diphtheria toxin [^111E6SRE].
