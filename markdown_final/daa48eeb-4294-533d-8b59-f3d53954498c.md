...
> Wait, let me verify the epistemic framing. Traditional security studies, grounded in political realism, treats the state as the primary referent object and external military threats as the main concern, reinforcing a worldview that centers Western state interests and marginalizes non-Western perspectives. Postcolonial critics aptly describe this as a "colonizer's view of the world", which is why Critical Security Studies sought to widen and deepen the security discourse beyond states and militaries [^notfound] [^notfound].
