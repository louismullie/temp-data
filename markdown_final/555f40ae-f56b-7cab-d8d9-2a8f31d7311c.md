...
> Let me first confirm the clinical context and definitions so I don't anchor on the wrong population or interventions. Status asthmaticus refers to severe, life-threatening asthma requiring continuous bronchodilators and often ICU-level care; in pediatrics, this typically involves continuous albuterol and systemic corticosteroids, with methylprednisolone historically the IV standard and dexamethasone increasingly used as an alternative in some centers, including via IV dosing in the PICU [^e2659e16] [^8c0b5176].

> Wait, let me verify the direct head-to-head evidence in the PICU, because that's the most relevant for this question. The best available direct comparison is a single-center, open-label, parallel-group, nonrandomized trial of 92 children with critical asthma comparing IV dexamethasone 0.25 mg/kg every 6 hours for 48 hours versus IV methylprednisolone 1 mg/kg every 6 hours for 5 days; importantly, no differences were observed in corticosteroid-related adverse events between groups, suggesting comparable short-term safety profiles in this setting [^notfound].
