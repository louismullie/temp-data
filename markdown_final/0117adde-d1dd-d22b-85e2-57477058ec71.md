...
> Let me first confirm the diagnosis and severity. The patient has the classic tetrad of NMS: mental status change, fever, muscle rigidity, and autonomic dysfunction, with supportive labs showing leukocytosis and markedly elevated CK, and a temporal relationship to recent antipsychotic dose escalation, which aligns with consensus diagnostic criteria and FDA labeling across multiple antipsychotics, including haloperidol, olanzapine, and quetiapine [^019a1ba0] [^a14ce14d] [^8b849d6c] [^09dba706]. Hold on, I should verify severity: temperature above 40°C and heart rate above 120 bpm would qualify as severe; here, 102.5°F (about 39.2°C) and HR 110 suggest moderate severity, which still warrants aggressive management and consideration of specific pharmacotherapies beyond supportive care alone [^ed6513d3].

> Next, I should review immediate management. I need to ensure the offending antipsychotic is stopped immediately, along with other nonessential dopamine-blocking agents, and initiate supportive care in a monitored setting with aggressive IV fluids, external cooling, benzodiazepines for agitation or catatonia, and close surveillance for rhabdomyolysis, renal failure, aspiration, and thromboembolism. This is standard across FDA labels and contemporary critical care guidance for NMS [^a14ce14d] [^8b849d6c] [^09dba706] [^ed6513d3]. Wait, let me verify the role of benzodiazepines: lorazepam is reasonable in moderate cases to mitigate rigidity and catatonia while other therapies are arranged, though it is not definitive therapy for NMS itself [^e8a4dab1].

> Now, I will examine pharmacologic options for rigidity and hyperthermia. Dantrolene directly reduces skeletal muscle rigidity and heat generation via ryanodine receptor blockade and is recommended in moderate-to-severe NMS, typically 1–2.5 mg/kg IV push followed by 0.5–1 mg/kg every 6 hours, with a usual ceiling around 10 mg/kg total. This is supported by pediatric critical care guidance and aligns with FDA labeling that acknowledges dantrolene as a commonly used agent despite limited controlled evidence [^347ad4e3] [^e138088f]. Hold on, let's not jump to conclusions: dantrolene treats the muscle rigidity and hypermetabolism, but it does not reverse the underlying dopamine blockade, so it should be paired with supportive care and, in many cases, a dopamine agonist in moderate-to-severe presentations [^ed6513d3].

> I should also consider dopamine agonists. Bromocriptine or amantadine are reasonable adjuncts to restore dopaminergic tone; bromocriptine is often started at 1.25–2.5 mg twice daily and titrated up to 10 mg three times daily, while amantadine is commonly used at 100–200 mg twice daily, though evidence is largely from case series and expert consensus rather than RCTs, and they are particularly useful when rigidity and bradykinesia persist despite dantrolene and supportive measures [^347ad4e3] [^e138088f]. Let me reconsider timing: in moderate severity, starting both dantrolene and a dopamine agonist is reasonable, reserving ECT for refractory or life-threatening cases or when pharmacotherapy is contraindicated or ineffective [^e8a4dab1].

> But wait, what about the provided options? Morphine is an opioid analgesic and has no role in treating NMS; it would not address rigidity, hyperthermia, or dopamine blockade and could worsen mental status and respiratory drive, so I should exclude it. Valproate is an anticonvulsant and mood stabilizer; it does not treat NMS and has even been implicated as a potential precipitant in case reports, so it is not appropriate here. Lamotrigine is an anticonvulsant with no evidence for NMS treatment and would not be expected to help rigidity or hyperthermia, so it should not be chosen [^644aa64a].

> I should double-check the comparative rationale. Dantrolene is the only option listed that directly targets the pathophysiology of muscle rigidity and hypermetabolism in NMS, which is why it is the best choice among the alternatives provided, even though it must be integrated with supportive care and, in moderate-to-severe cases, a dopamine agonist to address the underlying dopamine blockade. This approach is consistent with pediatric critical care guidance and with FDA labeling that recognizes dantrolene as a standard, albeit evidence-limited, option for NMS management [^347ad4e3] [^e138088f].

> Final answer: B. Dantrolene, with the immediate addition of supportive care and consideration of a dopamine agonist such as bromocriptine or amantadine for moderate-to-severe NMS, and close monitoring for complications including rhabdomyolysis and renal failure [^347ad4e3] [^ed6513d3] [^e138088f].

---

The best treatment for this patient with suspected neuroleptic malignant syndrome (NMS) is **immediate discontinuation of the antipsychotic** and **supportive care**, including aggressive cooling, IV fluids, and benzodiazepines for agitation or rigidity [^ed6513d3]. Dantrolene is the **most appropriate pharmacologic option** among the choices provided because it directly reduces muscle rigidity and hyperthermia, which are central to NMS pathophysiology [^347ad4e3]. Morphine is not indicated, and valproate or lamotrigine are not treatments for NMS. Early recognition and prompt management are critical to reduce morbidity and mortality [^0e6bdd4f].

---

## Clinical diagnosis and severity assessment

The patient presents with the classic tetrad of NMS: **altered mental status, muscle rigidity, hyperthermia, and autonomic instability** (tachycardia, hypertension, diaphoresis) [^0e6bdd4f]. Laboratory findings of leukocytosis and markedly elevated CK further support the diagnosis [^019a1ba0]. The severity is **moderate to severe** given the high fever, significant rigidity, and autonomic instability, warranting aggressive management [^e8a4dab1].

---

## Pathophysiology of neuroleptic malignant syndrome

NMS is thought to result from **dopamine blockade** in the central nervous system, leading to rigidity, hyperthermia, and autonomic instability [^53212a04]. This dopamine blockade explains why dopamine agonists (e.g. bromocriptine) are often used in treatment [^e138088f].
...
- **Discontinue antipsychotic**: Stop the offending antipsychotic immediately [^a14ce14d].
- **Cooling measures**: Aggressive external cooling (ice packs, cooling blankets) to control hyperthermia [^347ad4e3].
- **Intravenous fluids**: Aggressive IV hydration to prevent renal failure from rhabdomyolysis [^347ad4e3].
- **Benzodiazepines**: Lorazepam or diazepam for agitation, rigidity, and anxiety [^e8a4dab1].

---

### Pharmacologic interventions

Pharmacologic options include **dopamine agonists** (bromocriptine, amantadine) to restore dopamine activity and reduce rigidity and hyperthermia [^e138088f], and **muscle relaxants** such as dantrolene to directly reduce muscle rigidity and hyperthermia [^347ad4e3].
...
Dantrolene is **supported by clinical guidelines and case reports** as an effective treatment for NMS, particularly for reducing muscle rigidity and hyperthermia [^ed6513d3]. It is recommended in moderate to severe cases, especially when rigidity and hyperthermia are prominent [^e8a4dab1].
...
### Evidence-based guidelines for the pharmacological treatment of schizophrenia: updated recommendations from the British Association for Psychopharmacology [^ea919a48]. Journal of Psychopharmacology (2020). High credibility.
...
### Malignant deep brain stimulator withdrawal syndrome [^faf759f4]. BMJ Case Reports (2019). High credibility.
...
### Atypical neuroleptic malignant syndrome [^4b714431]. BMJ Case Reports (2016). Medium credibility.
...
### Neuroleptic malignant syndrome following reintroduction of an antipsychotic after overdose [^4c4a9d05]. BMJ Case Reports (2018). Medium credibility.
...
### Neuroleptic malignant syndrome with delayed onset of fever following risperidone administration [^f7377d53]. The Annals of Pharmacotherapy (2006). Low credibility.
...
### Prochlorperazine-induced neuroleptic malignant syndrome [^c0de9c3a]. The American Journal of Emergency Medicine (2024). Medium credibility.
...
### Chlorpromazine [^a77b346d]. FDA (2024). Medium credibility.
...
### Prochlorperazine maleate [^a9773098]. FDA (2025). Medium credibility.
...
### Quetiapine [^09dba706]. FDA (2025). Medium credibility.
...
### Chlorpromazine hydrochloride [^84eb44ba]. FDA (2025). Medium credibility.
...
### Evaluation and management of children with acute mental health or behavioral problems. part II: recognition of clinically challenging mental health related conditions presenting with medical or uncertain symptoms [^0e6bdd4f]. Pediatrics (2016). Medium credibility.
...
### Carbidopa and levodopa (parcopa) [^6e12ef8f]. FDA (2007). Low credibility.
...
### Trifluoperazine hydrochloride [^a548e552]. FDA (2025). Medium credibility.
...
### Pharmacological and somatic treatments for first-episode psychosis and schizophrenia: synopsis of the US department of veterans affairs and US department of defense clinical practice guidelines [^6dce82f9]. Schizophrenia Bulletin (2025). High credibility.
...
### Evaluation and management of children with acute mental health or behavioral problems. part II: recognition of clinically challenging mental health related conditions presenting with medical or uncertain symptoms [^9ee97551]. Pediatrics (2016). Medium credibility.
...
### Executive summary: evaluation and management of children with acute mental health or behavioral problems. part II: recognition of clinically challenging mental health related conditions presenting with medical or uncertain symptoms [^4f0b5347]. Pediatrics (2016). Medium credibility.
...
### Haloperidol lactate [^a14ce14d]. FDA (2024). Medium credibility.
...
### Haloperidol lactate (haloperidol) [^144f6e07]. FDA (2025). Medium credibility.
...
### Malignant deep brain stimulator withdrawal syndrome [^0e46e248]. BMJ Case Reports (2019). High credibility.
...
### Atypical neuroleptic malignant syndrome in an incarcerated patient: a demographic who may be at increased risk [^14208c1e]. BMJ Case Reports (2024). High credibility.
...
### Structure and neural mechanisms of catatonia [^b342ccea]. The Lancet: Psychiatry (2019). High credibility.
...
### Managing an effective treatment for neuroleptic malignant syndrome [^ad346de8]. Critical Care (2007). Low credibility.
...
### Pregabalin capsule… [^f0087f5a]. FDA (DailyMed) (2025). Medium credibility.
...
### Fever, tachycardia, and hypertension with acute catatonic schizophrenia… [^3a21c840]. JAMA Network (2025). Excellent credibility.
...
### Amantadine hydrochloride [^e138088f]. FDA (2025). Medium credibility.
...
### Ziprasidone-and lithium-induced neuroleptic malignant syndrome [^464053d2]. The Annals of Pharmacotherapy (2006). Low credibility.
...
### Promethazine hydrochloride [^b1da919a]. FDA (2025). Medium credibility.
...
### Amantadine [^f0acc432]. FDA (2025). Medium credibility.
...
### Promethazine hydrochloride and phenylephrine hydrochloride (promethazine VC) [^a79cdb7e]. FDA (2012). Low credibility.
...
### Neuroleptic malignant syndrome associated with the use of prochlorperazine in a patient with a recent history of antipsychotic-induced neuroleptic malignant syndrome [^96ba3e7a]. The Annals of Pharmacotherapy (2011). Low credibility.
...
### Potentially fatal outcomes associated with clozapine [^9e06c257]. Schizophrenia Research (2018). Low credibility.
...
### Amantadine hydrochloride (amantadine HCl) [^b98e0b65]. FDA (2025). Medium credibility.
...
### Evidence-based guidelines for the pharmacological treatment of schizophrenia: updated recommendations from the British Association for Psychopharmacology [^9d7319ce]. Journal of Psychopharmacology (2020). High credibility.
...
### Perphenazine [^3e32f598]. FDA (2025). Medium credibility.
...
### Neuroleptic malignant syndrome: a concealed diagnosis with multitreatment approach [^00f91fbb]. BMJ Case Reports (2019). High credibility.
...
### Metoclopramide [^cd65b6b3]. FDA (2025). Medium credibility.
...
### Olanzapine and fluoxetine [^8b849d6c]. FDA (2025). Medium credibility.
...
### Label: QUETIAPINE tablet, extended release… [^a6beb2b9]. FDA (DailyMed) (2025). Medium credibility.
...
### Olanzapine and fluoxetine hydrochloride (Symbyax) [^57158426]. FDA (2025). Medium credibility.
...
### Amoxapine [^899f93b9]. FDA (2024). Medium credibility.
...
### Evaluation and management of children with acute mental health or behavioral problems. part II: recognition of clinically challenging mental health related conditions presenting with medical or uncertain symptoms [^347ad4e3]. Pediatrics (2016). Medium credibility.
...
### Neuroleptic malignant syndrome during a change from haloperidol to risperidone [^9abf1dcc]. The Annals of Pharmacotherapy (2001). Low credibility.
...
### Fluphenazine decanoate [^3479eab2]. FDA (2025). Medium credibility.
...
### Managing an effective treatment for neuroleptic malignant syndrome [^256e2e74]. Critical Care (2007). Low credibility.
...
### Label: QUETIAPINE tablet, film coated-dailyMeddailymed.nlm.nih.gov › dailymed › lookup… [^0e894b84]. FDA (DailyMed) (2025). Medium credibility.
...
### Schizophrenia [^ae721477]. American Family Physician (2022). High credibility.
...
### Lurasidone hydrochloride [^897e2eb6]. FDA (2025). Medium credibility.
...
### Neuroleptic malignant syndrome versus serotonin syndrome: the search for a diagnostic tool [^92ba6a32]. The Annals of Pharmacotherapy (2011). Low credibility.
...
### Fluphenazine hydrochloride [^3f20949e]. FDA (2025). Medium credibility.
...
### Neuroleptic malignant syndrome associated with haloperidol use in critical care setting: should haloperidol still be considered the drug of choice for the management of delirium in the critical care setting? [^39b55a25]. BMJ Case Reports (2013). Medium credibility.
...
### Fluphenazine hydrochloride (fluphenazine hydrochoride) [^c0ccaa2c]. FDA (2025). Medium credibility.
...
### An atypical case of neuroleptic malignant syndrome precipitated by valproate [^644aa64a]. BMJ Case Reports (2014). Medium credibility.
...
### Label: RISPERIDONE solution… [^3fa6f67e]. FDA (DailyMed) (2025). Medium credibility.
...
### Promethazine hydrochloride, phenylephrine hydrochloride and codeine phosphate [^6cce654d]. FDA (2023). Medium credibility.
...
### Promethazine and phenylephrine hydrochloride and codeine phosphate (promethazine VC with codeine oral solution) [^ec16875d]. FDA (2024). Medium credibility.
...
### Contemporary perspectives in critical care of neuroleptic malignant syndrome [^80ac808a]. Neurocritical Care (2025). Medium credibility.
...
### Promethazine, phenylephrine, codeine (promethazine HCl, phenylephrine HCl, codeine phosphate) [^bb1c75f8]. FDA (2024). Medium credibility.
...
### Combination of strategies to initiate clozapine for refractory schizophrenia in a patient with low neutrophil levels [^bded4fd0]. BMJ Case Reports (2022). High credibility.
...
### Lack of cardinal symptoms of meningitis in a hospitalized patient with chronic schizophrenia: lessons to be learned [^bc787bbe]. General Hospital Psychiatry (2015). Low credibility.
...
### Metoclopramide hydrochloride [^1895bb00]. FDA (2024). Medium credibility.
...
### Coexistence of serotonin syndrome and neuroleptic malignant syndrome: does it exist? [^1ef654cf]. BMJ Case Reports (2021). High credibility.
...
### Metoclopramide hydrochloride (metoclopramide) [^4650e899]. FDA (2025). Medium credibility.
...
### Evidence-based guidelines for the pharmacological treatment of schizophrenia: updated recommendations from the British Association for Psychopharmacology [^e0705510]. Journal of Psychopharmacology (2020). High credibility.
...
### Neuroleptic malignant syndrome secondary to quetiapine [^0955624a]. The Annals of Pharmacotherapy (2009). Low credibility.
...
### Managing an effective treatment for neuroleptic malignant syndrome [^c4556afb]. Critical Care (2007). Low credibility.
...
### Neuroleptic malignant syndrome following reintroduction of an antipsychotic after overdose [^53212a04]. BMJ Case Reports (2018). Medium credibility.
...
### Mental health gap action programme (mhGAP) guideline for mental, neurological and substance use disorders [^6754d7be]. Geneva: World Health Organization (2023). High credibility.
...
### Managing an effective treatment for neuroleptic malignant syndrome [^58327910]. Critical Care (2007). Low credibility.
...
### Takotsubo cardiomyopathy triggered by SARS-CoV-2 infection in a critically ill patient [^6f2546d3]. BMJ Case Reports (2020). High credibility.
...
### Zuclopenthixol-induced neuroleptic malignant syndrome in an adolescent girl [^269861a0]. Clinical Toxicology (2007). Low credibility.
...
### Cariprazine (Vraylar) [^976fe916]. FDA (2024). Medium credibility.
...
### Pain assessment and treatment in children with significant impairment of the central nervous system [^727805a7]. Pediatrics (2017). Medium credibility.
...
### Successful treatment of a complicated case of neuroleptic malignant syndrome [^213c4cda]. Intensive Care Medicine (2002). Low credibility.
...
### Managing an effective treatment for neuroleptic malignant syndrome [^00539b7d]. Critical Care (2007). Low credibility.
...
### The American psychiatric association practice guideline for the treatment of patients with schizophrenia [^3e16c593]. The American Journal of Psychiatry (2020). High credibility.
...
### Elevated neutrophil-to-lymphocyte ratios correlate with increased clozapine concentration-to-dose ratios during titration [^897daa8b]. Schizophrenia (2025). Medium credibility.
