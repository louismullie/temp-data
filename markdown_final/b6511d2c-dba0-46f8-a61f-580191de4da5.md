...
Neuropathic pain presents with **burning, shooting, or electric shock-like sensations** [^112VvgkG], often accompanied by **allodynia** (pain from light touch) [^116jXSdn] and **hyperalgesia** (exaggerated pain to painful stimuli) [^116jXSdn]. Patients may also report **numbness, tingling, or pins-and-needles** [^111pMTts], and symptoms typically follow a neuroanatomically plausible distribution [^113o7Wmo] (e.g. dermatomal or stocking-glove pattern) [^113o7Wmo]. Diagnosis relies on clinical history, sensory examination, and, when needed, confirmatory tests (e.g. MRI, EMG, skin biopsy) [^116AyNdy] to grade certainty as possible, probable, or definite neuropathic pain [^116JJCSf].
