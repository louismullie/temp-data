...
> I will now examine emollients. Regular leave-on emollients are foundational to restore barrier function and reduce itch, and should be continued even during flares; however, I should double-check bath additives, because I recall conflicting data. The large BATHE randomized trial found no added benefit from emollient bath additives beyond standard care, so I should counsel families to prioritize leave-on emollients and soap-free cleansing rather than bath additives [^113Zfx1v] [^115RLRoJ].

> Let me consider escalation for refractory flares. Wet-wrap therapy with low- to mid-potency topical corticosteroids can be used short term for moderate-to-severe acute eczema, with guidelines recommending standardized technique and education; evidence is largely pediatric and suggests modest incremental benefit over emollient-only wraps, but infections can occur and technique matters, so I need to ensure caregivers are trained if used [^115S4vkB] [^113cC9wm] [^114ahppr].

> But wait, what if the child is failing multiple topical strategies or has frequent, severe flares. I should confirm when systemic therapy is appropriate. Systemic corticosteroids are generally discouraged for atopic dermatitis due to rebound flares and systemic harms; expert consensus suggests they be reserved for rare, short-term rescue scenarios or as a bridge to safer systemic agents, and pediatric guidelines emphasize avoiding routine systemic steroids in children with AD [^113ApyEb] [^11714Lmz] [^1135RnSF].

> Next, I should review what to avoid. Systemic corticosteroids should not be used routinely for flares; leukotriene receptor antagonists like montelukast have not shown clinically meaningful benefit for eczema; and probiotics are not effective for treating established eczema, though they may be considered for prevention in select high-risk infants outside the scope of acute management [^113ApyEb] [^114HBu2e] [^111QuTVg].

> I need to ensure I address common misconceptions. Parents often fear "steroid addiction" or permanent skin damage; I should explain that short courses of appropriately potent topical corticosteroids are safe, that skin thinning is uncommon with short-term use, and that untreated inflammation itself causes more barrier injury and complications; shared decision-making and written action plans improve adherence and outcomes [^114WrPkL] [^116wwvUA] [^117TvTyZ].

> Let me synthesize a practical, stepwise plan. For a typical moderate acute flare, I would prescribe a moderate-potency topical corticosteroid once daily for 7 to 14 days to involved areas, continue a fragrance-free leave-on emollient multiple times daily, use soap-free cleansers, and reassess at 1 to 2 weeks; if improving, taper potency or frequency, and if not controlled, step up to a potent agent or consider a short, supervised wet-wrap course, reserving systemic options only for exceptional circumstances and with specialist input [^116wwvUA] [^114WrPkL] [^115S4vkB].

> Finally, I should confirm follow-up and prevention. After acute control, proactive therapy with twice-weekly topical corticosteroid to previously inflamed sites reduces relapse risk, and ongoing barrier-focused care with trigger avoidance and education sustains remission; I should schedule follow-up to review technique, adherence, and early signs of relapse, adjusting the plan accordingly [^114WrPkL] [^115N1Szm] [^115RVmFv].

---

Acute eczema in children is best managed with **topical corticosteroids as first-line therapy** [^116wwvUA], using potency matched to severity and site (mild for face/intertriginous areas, moderate for trunk/limbs, potent for severe flares) [^117BryDh] [^115N1Szm]. Apply once daily [^111ieYqq] for 7–14 days, then taper to the lowest effective dose; **once-daily application is as effective as twice daily** and improves adherence [^114WrPkL] [^115UxMcC]. Emollients should be used liberally and frequently to restore the barrier [^115RLRoJ] [^116A8WPo], and wet-wrap therapy can be added for severe or refractory flares [^115S4vkB] [^113cC9wm]. Avoid systemic corticosteroids due to rebound and adverse effects [^113ApyEb] [^11714Lmz]; reserve for exceptional cases with specialist input [^1135RnSF]. Educate caregivers on proper application, trigger avoidance, and when to seek care for infection or treatment failure [^115RVmFv].
...
- **Intense pruritus**: Often with scratching and sleep disturbance [^115RLRoJ].
- **Erythematous, edematous papules and vesicles**: Often with exudation and crusting [^114M7d81].
- **Distribution**: Commonly on the face, scalp, extensor limbs in infants; flexural areas in older children [^notfound].
- **Secondary infection**: Look for impetiginization (honey-colored crusts) or eczema herpeticum (punched-out erosions) [^114M7d81].
...
- **Identify and avoid triggers**: Allergens, irritants, stress, and climate factors [^115RVmFv].
- **Restore skin barrier**: Regular emollients are foundational [^115RLRoJ].
- **Control inflammation**: Topical corticosteroids are first-line [^116wwvUA].
- **Prevent secondary infection**: Recognize and treat promptly [^114M7d81].
- **Educate caregivers**: Improve adherence and outcomes [^115RVmFv].
...
Avoid very potent steroids in children unless under specialist supervision [^115N1Szm].

---

### Application guidelines

- **Frequency**: Once daily is as effective as twice daily for most flares; twice daily may be used for severe flares or when rapid control is needed [^114WrPkL] [^111ieYqq].
- **Duration**: 7–14 days, then taper to the lowest effective dose or switch to non-steroidal maintenance (e.g. calcineurin inhibitors) [^117BryDh].
...
- **Local adverse effects**: Skin atrophy, telangiectasia, striae, and secondary infection are rare with short-term use but increase with potency and duration [^114WrPkL] [^116a2u2o].
- **Systemic effects**: Rare with appropriate use; monitor growth if prolonged high-potency use is required [^116Ch22T].
- **Rebound flares**: Can occur with abrupt withdrawal; taper gradually [^11714Lmz].

---

## Emollients

Emollients are **essential for barrier repair** and should be applied liberally and frequently, even during flares [^115RLRoJ]. Choose fragrance-free, hypoallergenic formulations; ointments are preferred for very dry skin, while creams are acceptable for less dry or inflamed skin. Emollients should be applied before TCS to minimize stinging and improve absorption [^notfound].

---

## Wet-wrap therapy (WWT)

WWT is indicated for **severe or refractory flares**, particularly with significant sleep disturbance or failure of standard therapy [^115S4vkB]. Apply a low- to moderate-potency TCS, then cover with damp inner layers and dry outer layers for several hours or overnight; limit to 7–14 days and monitor for infection or irritation [^113cC9wm].

---

## Adjunctive therapies

- **Topical calcineurin inhibitors**: Tacrolimus 0.03% or pimecrolimus 1% for maintenance or sensitive areas (face, intertriginous regions) [^113aMCD8].
...
Systemic corticosteroids are **generally not recommended** due to rebound flares and adverse effects (growth suppression, hypertension, immunosuppression) [^113ApyEb] [^11714Lmz]. Reserve for exceptional cases (e.g. severe, refractory flares with significant systemic involvement) and use short courses (≤ 7 days) with close follow-up [^1135RnSF].

---

## Patient and caregiver education

Education improves adherence and outcomes. Key points include **proper TCS application**, consistent emollient use, trigger identification and avoidance, and recognition of infection or treatment failure. Provide written action plans and schedule follow-up to reinforce technique and adjust therapy [^115RVmFv].

---

## Follow-up and monitoring

Regular follow-up should assess **control, adherence, and adverse effects**. Adjust therapy based on severity, response, and patient preference, and monitor growth if prolonged high-potency TCS are used [^116Ch22T].

---

## Summary of recommendations

- **First-line therapy**: Topical corticosteroids matched to severity and site [^116wwvUA].
- **Emollients**: Liberal, frequent application [^115RLRoJ].
- **Wet-wrap therapy**: For severe or refractory flares [^115S4vkB].
- **Avoid**: Routine systemic corticosteroids [^113ApyEb].
- **Education**: Essential for adherence and outcomes [^115RVmFv].
...
### Atopic dermatitis: an overview… [^114M7d81]. AAFP (2012). Low credibility.
...
### Treatment of moderate-to-severe atopic eczema in adults within the U.K.: results of a national survey of dermatologists [^113BFekg]. The British Journal of Dermatology (2017). Low credibility.
...
### Updated guidelines for atopic dermatitis-AAAAI / ACAAI joint task force… [^116di34Q]. JAMA Network (2024). Excellent credibility.
...
### Atopic dermatitis [^115RLRoJ]. Lancet (2016). Excellent credibility.
...
### Strategies for using topical corticosteroids in children and adults with eczema [^113VsNpk]. The Cochrane Database of Systematic Reviews (2022). Medium credibility.
...
### TREatment of ATopic eczema (TREAT) registry taskforce: consensus on how and when to measure the core dataset for atopic eczema treatment research registries [^112p9j9r]. The British Journal of Dermatology (2019). Medium credibility.
...
### What is "eczema"? [^111Yqg8M]. The Journal of Dermatology (2025). Medium credibility.
...
### ETFAD / EADV eczema task force 2020 position paper on diagnosis and treatment of atopic dermatitis in adults and children [^115S4vkB]. Journal of the European Academy of Dermatology and Venereology (2020). High credibility.
...
### Strategies for using topical corticosteroids in children and adults with eczema [^114xGXXH]. The Cochrane Database of Systematic Reviews (2022). Medium credibility.
...
### Wet wrap therapy in moderate to severe atopic dermatitis [^114ahppr]. Immunology and Allergy Clinics of North America (2017). Low credibility.
...
### The European TREatment of ATopic eczema (TREAT) registry taskforce survey: prescribing practices in Europe for phototherapy and systemic therapy in adult patients with moderate-to-severe atopic eczema [^113bESUw]. The British Journal of Dermatology (2020). Medium credibility.
...
### Strategies for using topical corticosteroids in children and adults with eczema [^115ogSbE]. The Cochrane Database of Systematic Reviews (2022). Medium credibility.
...
### What's new in atopic eczema? An analysis of systematic reviews published in 2016. part 1: treatment and prevention [^114N2zCi]. Clinical and Experimental Dermatology (2019). Medium credibility.
...
### Strategies for using topical corticosteroids in children and adults with eczema [^111tQTXY]. The Cochrane Database of Systematic Reviews (2022). Medium credibility.
...
### What is "eczema"? [^114AY3Kt]. The Journal of Dermatology (2025). Medium credibility.
...
### Skin care interventions in infants for preventing eczema and food allergy [^111GVC2U]. The Cochrane Database of Systematic Reviews (2022). Medium credibility.
...
### Emollient bath additives for the treatment of childhood eczema (BATHE): multicentre pragmatic parallel group randomised controlled trial of clinical and cost effectiveness [^115rsARs]. BMJ (2018). Excellent credibility.
...
### Guidelines of care for the management of atopic dermatitis: section 4. prevention of disease flares and use of adjunctive therapies and approaches [^117TvTyZ]. Journal of the American Academy of Dermatology (2014). Medium credibility.
...
### Emollient bath additives for the treatment of childhood eczema (BATHE): multicentre pragmatic parallel group randomised controlled trial of clinical and cost effectiveness [^114fhc3G]. BMJ (2018). Excellent credibility.
...
### The eczema priority setting partnership: a collaboration between patients, carers, clinicians and researchers to identify and prioritize important research questions for the treatment of eczema [^1143KTkv]. The British Journal of Dermatology (2013). Low credibility.
...
### A practical toolbox for the effective transition of adolescents and young adults with asthma and allergies: an EAACI position paper [^113u6XAY]. Allergy (2023). Medium credibility.
...
### Topical anti-inflammatory treatments for eczema: network meta-analysis [^113JuK51]. The Cochrane Database of Systematic Reviews (2024). Medium credibility.
...
### Emollient bath additives for the treatment of childhood eczema (BATHE): multicentre pragmatic parallel group randomised controlled trial of clinical and cost effectiveness [^111719SJ]. BMJ (2018). Excellent credibility.
