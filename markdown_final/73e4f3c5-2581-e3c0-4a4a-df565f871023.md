...
> I will now examine decreased production causes, starting with anemia of inflammation/chronic disease, which is the most common normocytic anemia worldwide; cytokine-driven hepcidin upregulation sequesters iron, impairs erythropoietin responsiveness, and shortens RBC survival, yielding a normocytic, normochromic, hypoproliferative pattern with low serum iron, low transferrin saturation, and normal or high ferritin, and I should double-check that ferritin can be misleading in inflammation before I label it definitively [^f2002ab5] [^450f3652] [^fd2e1118].
