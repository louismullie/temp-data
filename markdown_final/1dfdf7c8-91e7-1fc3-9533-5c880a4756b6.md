...
The number of memorable 7-digit telephone numbers is **19,990**. This is calculated by counting numbers where the prefix (d_1d_2d_3) matches either (d_4d_5d_6) or (d_5d_6d_7), using inclusion–exclusion: (10^3 \\times 10) for each match minus (10) for the overlap, giving (10,000 + 10,000–10 = 19,990).
...
- **The prefix (d_1d_2d_3) can be any 3-digit sequence**: (10^3 = 1,000) choices.
- **Then (d_4d_5d_6) must match the prefix**: 1 choice.
- **(d_7) can be any digit**: 10 choices.
- **Total for this case**: (1,000 \\times 1 \\times 10 = 10,000).
...
- **The prefix (d_1d_2d_3) can be any 3-digit sequence**: (10^3 = 1,000) choices.
- **(d_4) can be any digit**: 10 choices.
- **(d_5d_6d_7) must match the prefix**: 1 choice.
- **Total for this case**: (1,000 \\times 10 \\times 1 = 10,000).

---

### Overlap: prefix matches both (d_4d_5d_6) and (d_5d_6d_7)

If the prefix matches both, then (d_4d_5d_6 = d_5d_6d_7), which implies (d_4 = d_5 = d_6 = d_7). Thus, all seven digits are the same (e.g. 1111111), and there are 10 such numbers.
...
### [ PDF ] AoPS community 2000 AMC 10 (...) [^9f78ab5b]. artofproblemsolving.com (2025). Medium credibility.
