...
- **Mixed hyperlipidemia**: With fenofibrate to reduce LDL-C [^116MnKfT].
...
- **Monotherapy**: Reduces LDL-C by ~18–25% [^114BHA5T] [^112LxuBB].
- **Combination therapy**: Adds ~15–20% LDL-C reduction on top of statins, achieving 50–70% total LDL-C lowering [^114BHA5T] [^112BjYkd].
- **Other lipids**: Modestly reduces triglycerides and increases HDL-C [^112LxuBB].

---

### Cardiovascular outcomes

- **IMPROVE-IT**: In 18,144 post-ACS patients, ezetimibe + simvastatin reduced LDL-C to 53.2 mg/dL vs 69.9 mg/dL with simvastatin alone and reduced the composite endpoint (CV death, MI, stroke, hospitalization for UA, or revascularization) by 6.4% (HR 0.936) [^112BjYkd] [^112BvZ71].
- **SHARP**: In chronic kidney disease, ezetimibe + simvastatin reduced major atherosclerotic events by 17% [^notfound].
- **Meta-analyses**: Ezetimibe reduces nonfatal MI and stroke, with minimal impact on mortality [^116kCpeb] [^113UCpzm].

---

## Safety and tolerability

- **Common adverse effects**: Nasopharyngitis, fatigue, myalgia, diarrhea, and upper respiratory infections [^116nqbfZ].
- **Serious adverse effects**: Rare liver enzyme elevations and myopathy; monitor LFTs if combined with statins [^115kJsPt].
- **Long-term safety**: No excess cancer, fractures, neurocognitive events, or diabetes in large meta-analyses [^1117en9U] [^112r4wf8].

---

## Dosage and administration

The **standard dose** is 10 mg orally once daily, with or without food [^117Lh9gM]. If a dose is missed, take it as soon as remembered; do not double the next dose. Separate administration by ≥ 2 hours before or ≥ 4 hours after bile acid sequestrants to avoid impaired absorption [^117Lh9gM]. Assess LDL-C as early as 4 weeks after initiation or changes [^117Lh9gM].

---

## Special populations

- **Renal impairment**: No dose adjustment needed [^116SqFdA].
- **Hepatic impairment**: Not recommended in moderate-to-severe hepatic impairment (Child-Pugh B or C) [^116SqFdA].
- **Elderly**: No dose adjustment; safety and efficacy are comparable to younger adults [^116SqFdA].
- **Pregnancy**: Category C; use only if benefits outweigh risks [^111GFieo].
- **Lactation**: Excreted in rat milk; use caution in nursing mothers [^111jcFBW].

---

## Drug interactions

Key interactions include **bile acid sequestrants**, which reduce ezetimibe absorption and require separation of doses [^117Lh9gM]. Cyclosporine increases ezetimibe exposure and may increase adverse effects, and fibrates may increase the risk of cholelithiasis when combined with ezetimibe.

---

## Clinical guidelines and recommendations

Guidelines recommend ezetimibe as **first-line add-on therapy** when LDL-C goals are not met with maximally tolerated statins or in statin-intolerant patients [^117NA1Er] [^112SYNSK]. It is also preferred over PCSK9 inhibitors in many patients due to lower cost and oral administration, though PCSK9 inhibitors may be added in very high-risk patients who remain above LDL-C thresholds [^112SYNSK].
...
- **Cancer signal**: Initial concerns from SEAS were not confirmed in larger studies and meta-analyses [^1151z98o] [^1117en9U].
- **Outcome data**: Most benefits are in high-risk secondary prevention; primary prevention data are limited [^116kCpeb].
...
### Lowering LDL cholesterol, but not raising LDL receptor activity, by ezetimibe [^113Wew3m]. Journal of Clinical Lipidology (2013). Low credibility.
