...
Genital warts are caused by HPV types 6 and 11 [^117JzhUR] and are diagnosed by **clinical inspection** [^1114efCB]; biopsy is reserved for atypical or non-resolving lesions [^114CHrs2]. Treatment aims to remove visible warts and reduce symptoms [^115rmWm1], with options including patient-applied podophyllotoxin, imiquimod, or sinecatechins [^113dZH5y], and provider-applied cryotherapy, TCA/BCA, or surgical methods [^112uqF9T] [^115HRAwR]. Recurrence is common [^112PpdCA], and **no therapy eradicates HPV** [^112PpdCA]; prevention is through HPV vaccination [^111TQ9ov] and consistent condom use [^112PpdCA]. Management should be individualized based on lesion size, number, location, and patient preference, with shared decision-making and counseling on transmission and recurrence [^115rmWm1] [^112PpdCA].
