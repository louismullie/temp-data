...
Treatment of UTI in males depends on **severity and site of infection** [^5165eba0]. For uncomplicated lower UTIs, use **7 days** of nitrofurantoin, trimethoprim-sulfamethoxazole, or a fluoroquinolone if resistance is low [^eae55c88] [^4f91305f]. For febrile or complicated UTIs, treat for **10–14 days** with a fluoroquinolone or an aminoglycoside plus a beta-lactam, adjusting to culture results [^e8b20eae] [^4f6fe763]. If acute bacterial prostatitis is suspected, extend therapy to **2–4 weeks** and ensure agents penetrate the prostate [^e8b20eae] [^b5d78ea0]. Always obtain urine culture before antibiotics when feasible, and tailor therapy to local resistance patterns [^4f91305f] [^5b3f0c5f].
