...
Compared with the OLZ group, the RIS group had a greater number of patients with elevated PRL (155/264 vs 58/175). Either the RIS or the OLZ group, the proportion of elevated PRL was greater in female patients (RIS: χ 2 = 6.76, p = 0.009; OLZ: χ 2 = 12.98, p < 0.001) and with higher doses of the related drugs (RIS: U = −3.73, p < 0.001; OLZ: U = −2.31, p = 0.021). In patients taking RIS, the elevated PRL subgroup took the drug for a longer period (U = −2.76, p = 0.006) and had lower triglyceride levels (U = 2.76, p = 0.006). In patients taking OLZ, the elevated PRL subgroup had lower fasting plasma glucose levels (U = 2.29, p = 0.022). Logistic regression analysis showed that gender, dose and fasting glucose levels were significantly associated with elevated PRL levels (RIS: p = 0.001, OLZ: p < 0.001; RIS: p < 0.001; OLZ: p = 0.003; RIS: p = 0.020, OLZ: p = 0.001, respectively).
