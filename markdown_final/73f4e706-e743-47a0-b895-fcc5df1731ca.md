...
> I will now examine follow-up and retesting. Because reinfection is common, all sexually active women should be retested at 3 months; if 3-month retesting is not possible, retest at the next healthcare encounter within 12 months, and use NAAT or culture for retesting, keeping in mind that NAAT within 3 weeks of treatment may detect nonviable nucleic acid and yield false positives [^1131F4wt] [^113hJ877]. Hold on, I should verify whether men need routine retesting; data are insufficient to support routine retesting in men, so I will individualize follow-up for men based on symptoms and exposure [^1131F4wt].
