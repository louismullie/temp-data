...
Overall rates of accurate treatment increased from 78.7% pre-POC to 87.7% post-POC (P = .02). Specifically, rates of not treating uninfected women increased from 61.4% pre-POC to 70.4% post-POC (P = .06), and rates of treating infected women were the same pre-POC (17.3%) and post-POC (17.3%; p = 0.99). Rates of inaccurate treatment decreased from 23.1% pre-POC to 13.1% post-POC (P = .02). Changes in missed treatment rates (14.0% pre-POC; 8.8% post-POC; p = 0.73) were not statistically significant.
