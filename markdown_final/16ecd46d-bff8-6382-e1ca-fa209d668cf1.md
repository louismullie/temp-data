...
> Let me first confirm the mechanistic frame: gout results from monosodium urate crystal deposition in the setting of hyperuricemia, so medications that raise serum urate can precipitate gout flares. Mechanistically, that happens via increased uric acid production, decreased renal excretion, or both, with impaired excretion being more common in drug-induced cases [^6239eda6].
