...
The American Heart Association now advocates routine assessment of cardiorespiratory capacity as a clinical vital sign, recognising that, in the general and at-risk population, the peak oxygen uptake (V̇O₂ peak) may be more powerful in predicting mortality than smoking, hypertension, hypercholesterolaemia and type 2 diabetes. In healthy adults, each one metabolic equivalent (3.5 mL×kg⁻¹×min⁻¹) improvement in V̇O₂ peak is associated with 15% reduction in cardiovascular events and a 13% reduction in all-cause mortality. Accordingly, a large trial in elderly non-transplant men showed each one metabolic equivalent improvement in V̇O₂ peak to result in a 12% improvement in survival. In end-stage liver disease, V̇O₂ peak is severely impaired while only partially recovering after transplantation to~70–85% of a matched reference population. Some data indicate that pathologically decreased muscle mass and function, already present before transplantation in 30–40% of liver transplant candidates, does not significantly improve in the initial 2 years post-transplant in the absence of lifestyle interventions. Moreover, persistent or new-onset sarcopenia after transplantation is a common finding. In addition, in light of prevalent excessive post-transplant weight gain, persistent and new-onset sarcopenia and sarcopenic obesity are common in this patient population.
