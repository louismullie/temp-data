...
> But wait, what if augmentation risk is a key concern or the patient has comorbid insomnia or pain; in that case, I should confirm that choosing pregabalin over dopamine agonists is reasonable, as AAN suggests pregabalin when avoidance of augmentation is a deciding factor; I should also remember that gabapentinoids improve sleep quality and quality of life, which aligns with patient-centered goals in many cases [^1159FpY2] [^11417akw].
