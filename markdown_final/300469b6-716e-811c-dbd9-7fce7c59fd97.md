...
### A cellular basis for mapping behavioural structure [^113pkMX7]. Nature (2024). Excellent credibility.
...
### Morphology of travel routes and the organization of cities [^112hSYwr]. Nature Communications (2017). Medium credibility.
...
### Structure, motion, and multiscale search of traveling networks [^114WcBog]. Nature Communications (2025). High credibility.
...
### Evaluation of the circles measurement and the ABC classification of acromioclavicular joint injuries [^1162J8wQ]. The American Journal of Sports Medicine (2021). Medium credibility.
...
### Impaired cerebellar purkinje cell potentiation generates unstable spatial map orientation and inaccurate navigation [^116Nhe6z]. Nature Communications (2019). High credibility.
...
### Morphology of travel routes and the organization of cities [^116YLZQ8]. Nature Communications (2017). Medium credibility.
...
### Age-related impairment of navigation and strategy in virtual star maze [^112rgTdG]. BMC Geriatrics (2021). Medium credibility.
...
### Repeated stress exposure leads to structural synaptic instability prior to disorganization of hippocampal coding and impairments in learning [^114dNKVM]. Translational Psychiatry (2022). Medium credibility.
...
### Ant odometry in the third dimension [^111N9VHh]. Nature (2001). Excellent credibility.
...
### Human navigation strategies and their errors result from dynamic interactions of spatial uncertainties [^1176hPaG]. Nature Communications (2024). High credibility.
...
### A transition to stable one-dimensional swimming enhances E. coli motility through narrow channels [^114KusYN]. Nature Communications (2020). High credibility.
...
### Walking and rolling of crystals induced thermally by phase transition [^117Rcoqt]. Nature Communications (2018). Medium credibility.
...
### Model-based prediction of spatial gene expression via generative linear mapping [^115iSMPc]. Nature Communications (2021). High credibility.
...
### Mice identify subgoal locations through an action-driven mapping process [^113sCupG]. Neuron (2023). Medium credibility.
...
### Travel time to health facilities in areas of outbreak potential: maps for guiding local preparedness and response [^113Q8PfC]. BMC Medicine (2019). Medium credibility.
...
### Dopamine in the tail of the striatum facilitates avoidance in threat-reward conflicts [^114f5xxw]. Nature Neuroscience (2025). High credibility.
...
### Sources of path integration error in young and aging humans [^112wwghJ]. Nature Communications (2020). High credibility.
...
### Reduced rotational flows enable the translation of surface-rolling microrobots in confined spaces [^112Z8gtu]. Nature Communications (2022). High credibility.
...
### In situ architecture of neuronal α-synuclein inclusions [^115GvkHN]. Nature Communications (2021). High credibility.
...
### Tracks of a non-main path traveler: 2011 Thomas willis lecture [^113qU5De]. Stroke (2012). Low credibility.
...
### No extension of quantum theory can have improved predictive power [^112qCS6K]. Nature Communications (2011). Medium credibility.
...
### Unravelling the spatial directionality of urban mobility [^1113QkAd]. Nature Communications (2024). High credibility.
...
### Roads diverge: mapping the journey towards diagnostic health equity [^1159vziT]. BMJ Open Quality (2025). High credibility.
...
### Dynamical constraints on neural population activity [^115bhuqF]. Nature Neuroscience (2025). High credibility.
...
### Unravelling the spatial directionality of urban mobility [^115vgUhG]. Nature Communications (2024). High credibility.
...
### A prediction rule to identify low-risk patients with community-acquired pneumonia [^117AH8fE]. The New England Journal of Medicine (1997). Excellent credibility.
...
### Perceiving distance accurately by a directional process of integrating ground information [^116UoVEX]. Nature (2004). Excellent credibility.
...
### The brain hierarchically represents the past and future during multistep anticipation [^111CBvaQ]. Nature Communications (2024). High credibility.
...
### Tracing a path for memory in the hippocampus [^117DXALi]. Neuron (2020). Medium credibility.
...
### Obstetric care consensus no. 6: periviable birth [^112m27QJ]. Obstetrics and Gynecology (2017). Medium credibility.
...
### Development and validation of a path length calculation for carotid-femoral pulse wave velocity measurement: a TASCFORCE, SUMMIT, and caerphilly collaborative venture [^1175B9Wo]. Hypertension (2018). Low credibility.
...
### Phage predation accelerates the spread of plasmid-encoded antibiotic resistance [^116hViWJ]. Nature Communications (2024). High credibility.
...
### Contrast does not lie, but can we see the true? [^113NM1Me]. Catheterization and Cardiovascular Interventions (2015). Low credibility.
...
### A persistent prefrontal reference frame across time and task rules [^115BNrjQ]. Nature Communications (2024). High credibility.
...
### A second-generation (44-channel) suprachoroidal retinal prosthesis: a single-arm clinical trial of feasibility [^1138iJ9f]. Ophthalmology Science (2024). Medium credibility.
...
### Multidimensional cerebellar computations for flexible kinematic control of movements [^116ohMJD]. Nature Communications (2023). High credibility.
...
### Depth relationships and measures of tissue thickness in dorsal midbrain [^114xEZkz]. Human Brain Mapping (2020). Medium credibility.
...
### Ambrisentan [^111ei5mR]. FDA (2025). Medium credibility.
...
### A curved host and second guest cooperatively inhibit the dynamic motion of corannulene [^112ntvYK]. Nature Communications (2021). High credibility.
...
### Predicting metabolic adaptation from networks of mutational paths [^117JYTCf]. Nature Communications (2017). Medium credibility.
...
### XPC deficiency increases risk of hematologic malignancies through mutator phenotype and characteristic mutational signature [^116RVaPd]. Nature Communications (2020). High credibility.
...
### Ambrisentan (Letairis) [^115jevTK]. FDA (2025). Medium credibility.
...
### 2019 APHRS expert consensus statement on three-dimensional mapping systems for tachycardia developed in collaboration with HRS, EHRA, and LAHRS [^1146jMCV]. Journal of Arrhythmia (2020). High credibility.
...
### The dynamic state of a prefrontal-hypothalamic-midbrain circuit commands behavioral transitions [^111YDFxf]. Nature Neuroscience (2024). High credibility.
...
### Endocrine therapy for the management and risk reduction of hormone receptor positive breast cancer [^116N2UXX]. ASBrS (2024). High credibility.
