...
36 × 44 △ABC has side lengths of 6, 8, 10, with the center at $P$, and a radius of 1. A circle rolls inside $\triangle ABC$, always remaining tangent to at least one side. When $P$ first returns to its initial position, the distance traveled by $P$ is
(A) 10.
(B) 12.
(C) 14.
(D) 15.
