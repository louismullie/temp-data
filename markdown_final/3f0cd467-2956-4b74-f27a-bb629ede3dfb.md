...
> I will now examine surgical decompression. Evidence from small, biased trials is very low quality and does not demonstrate clear benefit, so routine decompression is not recommended; it may be considered only in exceptional cases with complete paralysis, poor prognostic electrodiagnostics, and early presentation, ideally within about 12–14 days, using shared decision-making given risks like hearing loss and limited evidence [^1167Myd5] [^114vMu5d] [^114NEB8x]. Hold on, I should verify that guidelines align: yes, both AAO-HNSF and AAN issue no recommendation for routine decompression, emphasizing uncertainty and potential harms [^112YHzXw] [^114NEB8x].
