...
Kidney Disease Improving Global Outcomes (KDIGO) class of renal failure was determined from the estimated glomerular filtration rate (eGFR). An eGFR of 45 mL per min per 1.73 m² was chosen as the threshold that might allow future chemotherapy.
