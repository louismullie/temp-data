...
> But wait, what if the patient is switching formulations or using a generic XR? I should confirm bioequivalence considerations. The XR food-effect data are derived from the reference product and apply to bioequivalent generics; therefore, the same without-food or light-meal instruction should be used regardless of XR manufacturer, assuming bioequivalence [^df5f0038] [^0dff982d] [^63a0b8a1].
