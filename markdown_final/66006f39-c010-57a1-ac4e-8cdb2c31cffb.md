...
Glipizide is a **second-generation sulfonylurea** that lowers blood glucose by stimulating pancreatic insulin secretion [^112VxcSr]; it is indicated for type 2 diabetes as adjunct to diet and exercise [^115hbwfC]. It is available as immediate-release (IR) and extended-release (XL) formulations, with XL allowing once-daily dosing and a lower hypoglycemia risk [^115XGvEN]. Common adverse effects include hypoglycemia, weight gain, and gastrointestinal symptoms; **severe hypoglycemia can occur**, especially in elderly or those with renal/hepatic impairment [^117Q8K2M]. Glipizide is not recommended in type 1 diabetes, severe renal/hepatic disease, or pregnancy; use caution with CYP2C9 inhibitors and separate dosing from colesevelam by ≥ 4 hours [^114Ly2bi]. Compared to some sulfonylureas, glipizide has a lower risk of prolonged hypoglycemia, but newer agents (e.g. metformin, SGLT2 inhibitors, GLP-1 agonists) are often preferred for durability and cardiovascular safety [^1138Nvov] [^111PoLES].
