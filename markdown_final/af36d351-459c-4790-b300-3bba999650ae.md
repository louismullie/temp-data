...
> Next, I should review the core clinical indications and the strength of evidence. The most robust data are in trauma and postpartum hemorrhage: CRASH-2 showed that early intravenous tranexamic acid reduced all-cause mortality in bleeding trauma patients, with the clearest benefit when given within 3 hours of injury, and WOMAN demonstrated a reduction in death due to bleeding in women with postpartum hemorrhage when given within 3 hours of birth, which aligns with a time-sensitive antifibrinolytic mechanism [^115yiout] [^111z8MHS]. Hold on, I should verify the timing signal in trauma: exploratory analyses suggest the mortality benefit is greatest when administered within 1 hour and may wane after 3 hours, with potential harm if delayed beyond 3 hours, reinforcing the need for early administration in appropriate patients [^114JNk6E] [^112kzTTB].
