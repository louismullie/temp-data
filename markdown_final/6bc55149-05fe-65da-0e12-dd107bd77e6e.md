...
### Multiple imputation for analysis of incomplete data in distributed health data networks [^11162tEE]. Nature Communications (2020). High credibility.
...
### An alternative to the breeder's and lande's equations [^111Rgmpd]. G3 (2014). Low credibility.
...
### Longitudinal gut microbiome changes in immune checkpoint blockade-treated advanced melanoma [^115gEiQH]. Nature Medicine (2024). Excellent credibility.
...
### An alternative to the breeder's and lande's equations [^115Hp6PS]. G3 (2014). Low credibility.
...
### Computational modeling of the temporal influences between cues, craving and use in addiction: a dynamical system analysis based on ecological momentary assessment data [^114h18M7]. Translational Psychiatry (2025). Medium credibility.
...
### Conceptualizing productive engagement in a system dynamics framework [^114G8ySZ]. Innovation in Aging (2017). Low credibility.
...
### Maternal transmission as a microbial symbiont sieve, and the absence of lactation in male mammals [^112oVcmY]. Nature Communications (2024). High credibility.
...
### Anticipating regime shifts by mixing early warning signals from different nodes [^112wwnzc]. Nature Communications (2024). High credibility.
...
### A mechanistic model of tau amyloid aggregation based on direct observation of oligomers [^113HqSZ6]. Nature Communications (2015). Medium credibility.
...
### All-ferroelectric implementation of reservoir computing [^1138aAoU]. Nature Communications (2023). High credibility.
...
### An alternative to the breeder's and lande's equations [^111RnxMx]. G3 (2014). Low credibility.
...
### How to personalise ventilation of infants with congenital diaphragmatic hernia? A simulation study [^111wvnx3]. BMC Pediatrics (2025). Medium credibility.
...
### Energy scaling of targeted optimal control of complex networks [^1116uae3]. Nature Communications (2017). Medium credibility.
...
### How to personalise ventilation of infants with congenital diaphragmatic hernia? A simulation study [^112tggRd]. BMC Pediatrics (2025). Medium credibility.
...
### A deeper understanding of system interactions can explain contradictory field results on pesticide impact on honey bees [^111Qk26u]. Nature Communications (2022). High credibility.
...
### Single-trial dynamics of motor cortex and their applications to brain-machine interfaces [^117Q2Dyb]. Nature Communications (2015). Medium credibility.
...
### Topological magnon amplification [^115GmE2m]. Nature Communications (2019). High credibility.
...
### Reference equations for pulmonary function testing in healthy Chinese children aged 4–18 years [^115az1DQ]. Respiratory Research (2025). Medium credibility.
...
### Predictive model and software for inbreeding-purging analysis of pedigreed populations [^112hdQfQ]. G3 (2016). Low credibility.
...
### Restoration of rhythmicity in diffusively coupled dynamical networks [^111qTmLT]. Nature Communications (2015). Medium credibility.
...
### Analog reservoir computing via ferroelectric mixed phase boundary transistors [^114psDmH]. Nature Communications (2024). High credibility.
...
### KDIGO 2024 clinical practice guideline for the evaluation and management of chronic kidney disease [^115UEJev]. Kidney International (2024). High credibility.
...
### Quantifying dissipation using fluctuating currents [^111w5K97]. Nature Communications (2019). High credibility.
...
### The growth equation of cities [^115H25Td]. Nature (2020). Excellent credibility.
...
### Mutation load estimation model as a predictor of the response to cancer immunotherapy [^117CpKDn]. NPJ Genomic Medicine (2018). Low credibility.
...
### Optimizing chest compression to rescue ventilation ratios during one-rescuer CPR by professionals and lay persons: children are not just little adults [^111L9k6K]. Resuscitation (2004). Low credibility.
...
### Estimating and testing direct genetic effects in directed acyclic graphs using estimating equations [^114o9szA]. Genetic Epidemiology (2018). Low credibility.
...
### KDIGO 2024 clinical practice guideline for the evaluation and management of chronic kidney disease [^111uiZ4L]. Kidney International (2024). High credibility.
...
### KDIGO 2024 clinical practice guideline for the evaluation and management of chronic kidney disease [^112EFZw9]. Kidney International (2024). High credibility.
...
### Forecasting the outcome of spintronic experiments with neural ordinary differential equations [^111wAasU]. Nature Communications (2022). High credibility.
...
### Emergent second law for non-equilibrium steady States [^1177E5oj]. Nature Communications (2022). High credibility.
...
### Learning interpretable network dynamics via universal neural symbolic regression [^113NvjAF]. Nature Communications (2025). High credibility.
...
### Warped linear mixed models for the genetic analysis of transformed phenotypes [^115x5JEB]. Nature Communications (2014). Medium credibility.
...
### All-to-all reconfigurability with sparse and higher-order ising machines [^116uU2uQ]. Nature Communications (2024). High credibility.
...
### Bayesian model selection for complex dynamic systems [^111R3QMF]. Nature Communications (2018). Medium credibility.
...
### Observation of an anisotropic dirac cone reshaping and ferrimagnetic spin polarization in an organic conductor [^116ZCBNV]. Nature Communications (2016). Medium credibility.
...
### Race and ethnicity in pulmonary function test interpretation: an official American Thoracic Society statement [^114Hk15T]. American Journal of Respiratory and Critical Care Medicine (2023). High credibility.
...
### Modelling insights into the COVID-19 pandemic [^116gXe2u]. Paediatric Respiratory Reviews (2020). Medium credibility.
...
### Statistical methods in epidemiology. VI. correlation and regression: the same or different? [^111GAtFv]. Disability and Rehabilitation (2000). Low credibility.
...
### Plasmon transport in graphene investigated by time-resolved electrical measurements [^113yZ2ZA]. Nature Communications (2013). Medium credibility.
...
### Gravitationally redshifted absorption lines in the X-ray burst spectra of a neutron star [^115cSoMw]. Nature (2002). Excellent credibility.
...
### Estimating global, regional, and national daily and cumulative infections with SARS-CoV-2 through nov 14, 2021: a statistical analysis [^1137Latb]. Lancet (2022). Excellent credibility.
