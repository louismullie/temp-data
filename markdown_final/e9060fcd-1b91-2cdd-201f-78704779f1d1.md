...
> Next, I should review follow-up and stewardship metrics. Routine post-treatment cultures are not recommended, and asymptomatic household contacts should not be treated; I should double-check that unnecessary testing and prescribing remain common, with studies showing 28% of pediatric prescriptions are not guideline-concordant, so embedding decision rules and test-backup strategies can meaningfully reduce overtreatment without increasing complications [^2d839d1c] [^f6e6e368] [^e11908f4] [^6589bf93].
