...
Find, with explanation, the maximum value of f(x) = x³ − 3x on the set of all real numbers x satisfying x⁴ + 36 ≤ 13x².
...
The maximum value of (f(x) = x³ − 3x) on the set where (x⁴ + 36 ≤ 13x²) is **18**, achieved at (x = 3). The constraint set is (x ∈ [−3, −2] ∪ [2, 3]), and the function has no interior critical points there; thus, the maximum occurs at an endpoint, specifically at (x = 3).

---

## Step 1: Determine the constraint set

The inequality (x⁴ + 36 ≤ 13x²) is rearranged to:
...
## Step 2: Analyze the function (f(x) = x³ − 3x)
...
The maximum value of (f(x) = x³–3x) on the set where (x⁴ + 36 ≤ 13x²) is **18**, achieved at (x = 3).
...
### Have we been qualifying measurable residual disease correctly? [^115BPyzx]. Leukemia (2023). Medium credibility.
...
### ECOLE: learning to call copy number variants on whole exome sequencing data [^1154wPFy]. Nature Communications (2024). High credibility.
...
### Learning protocols for the fast and efficient control of active matter [^115SJbUP]. Nature Communications (2024). High credibility.
...
### Genetic-optimised aperiodic code for distributed optical fibre sensors [^112EkEC1]. Nature Communications (2020). High credibility.
...
### Maximum entropy technique and regularization functional for determining the pharmacokinetic parameters in DCE-MRI [^112up8Ba]. Journal of Digital Imaging (2022). Medium credibility.
...
### A machine learning approach for online automated optimization of super-resolution optical microscopy [^112R3ncT]. Nature Communications (2018). Medium credibility.
...
### Experimental evolution of yeast shows that public-goods upregulation can evolve despite challenges from exploitative non-producers [^112FSk5j]. Nature Communications (2024). High credibility.
...
### A robust deconvolution method to disentangle multiple water pools in diffusion MRI [^113CKzAF]. NMR in Biomedicine (2018). Low credibility.
...
### Sodium fluoride f-18 (sodium fluoride) [^113rb3Xy]. FDA (2024). Medium credibility.
...
### Environmental damping and vibrational coupling of confined fluids within isolated carbon nanotubes [^112DdRcU]. Nature Communications (2024). High credibility.
...
### Follitropin alfa (Gonal-F) [^1175ZpNv]. FDA (2025). Medium credibility.
...
### Reconstructing metastatic seeding patterns of human cancers [^112895y4]. Nature Communications (2017). Medium credibility.
...
### Eigenspectra optoacoustic tomography achieves quantitative blood oxygenation imaging deep in tissues [^113c9ce7]. Nature Communications (2016). Medium credibility.
...
### Fundamental limits to learning closed-form mathematical models from data [^112hc3Lk]. Nature Communications (2023). High credibility.
...
### The backtracking survey propagation algorithm for solving random K-SAT problems [^117K64Ls]. Nature Communications (2016). Medium credibility.
...
### Modelling transmission and control of the COVID-19 pandemic in Australia [^112kjsex]. Nature Communications (2020). High credibility.
...
### Aqueous asymmetric pseudocapacitor featuring high areal energy and power using conjugated polyelectrolytes and tiCTMXene [^114QJNLS]. Nature Communications (2025). High credibility.
...
### Active site localization of methane oxidation on Pt nanocrystals [^113EMrDJ]. Nature Communications (2018). Medium credibility.
...
### Mapping the absolute value of M0 using dipolar field effects [^114cv7Ji]. Magnetic Resonance in Medicine (2002). Low credibility.
