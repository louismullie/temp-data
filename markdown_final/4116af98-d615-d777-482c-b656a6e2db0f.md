...
### Functional implications of orientation maps in primary visual cortex [^111frAGr]. Nature Communications (2016). Medium credibility.
...
### Spatially precise visual gain control mediated by a cholinergic circuit in the midbrain attention network [^115GXbSG]. Nature Communications (2016). Medium credibility.
...
### Grid cells are modulated by local head direction [^114UhybK]. Nature Communications (2020). High credibility.
...
### Inferring time derivatives including cell growth rates using gaussian processes [^111pskpA]. Nature Communications (2016). Medium credibility.
...
### A flexible readout mechanism of human sensory representations [^115gUwBJ]. Nature Communications (2019). High credibility.
...
### Photo-activated raster scanning thermal imaging at sub-diffraction resolution [^1151fAe6]. Nature Communications (2019). High credibility.
...
### Pre-eruptive magmatic processes re-timed using a non-isothermal approach to magma chamber dynamics [^115xVrYe]. Nature Communications (2016). Medium credibility.
...
### The precision of value-based choices depends causally on fronto-parietal phase coupling [^11193EtS]. Nature Communications (2015). Medium credibility.
...
### Physical deep learning with biologically inspired training method: gradient-free approach for physical hardware [^111C9FkM]. Nature Communications (2022). High credibility.
...
### A daptomycin-xylitol-loaded polymethylmethacrylate bone cement: how much xylitol should be used? [^112BGtH6]. Clinical Orthopaedics and Related Research (2013). Low credibility.
...
### Is there a better way to predict death using heart rate recovery? [^1164hSk9]. Clinical Cardiology (2006). Low credibility.
...
### Pattern electroretinogram in ocular hypertension, glaucoma suspect and early manifest glaucoma eyes: a systematic review and meta-analysis [^1175DEYW]. Ophthalmology Science (2023). Medium credibility.
...
### Improved security bound for the round-robin-differential-phase-shift quantum key distribution [^113fee62]. Nature Communications (2018). Medium credibility.
...
### Feasibility of dynamic T*-based oxygen-enhanced lung MRI at 3T [^113cgnym]. Magnetic Resonance in Medicine (2024). Medium credibility.
...
### The SNMMI and EANM practice guideline for tele-nuclear medicine 2.0 [^116J7pX8]. Journal of Nuclear Medicine Technology (2014). Medium credibility.
...
### SNMMI procedure standard / EANM practice guideline for diuretic renal scintigraphy in adults with suspected upper urinary tract obstruction 1.0 [^111vfgSd]. Seminars in Nuclear Medicine (2018). Medium credibility.
...
### A geometric approach to characterize the functional identity of single cells [^115pCPXd]. Nature Communications (2018). Medium credibility.
...
### ACR-ACNM-SPR practice parameter for the performance of renal scintigraphy [^113s6KMt]. ACNM/ACR/SPR (2022). High credibility.
...
### Simultaneous spatiotemporal transcriptomics and microscopy of Bacillus subtilis swarm development reveal cooperation across generations [^11581sDd]. Nature Microbiology (2023). High credibility.
...
### A geometric approach to characterize the functional identity of single cells [^113v9tqR]. Nature Communications (2018). Medium credibility.
...
### Joint EANM / SNMMI / IHPBA procedure guideline for [Tc] Tc-mebrofenin hepatobiliary scintigraphy SPECT / CT in the quantitative assessment of the future liver remnant function [^111d4eSF]. HPB (2023). High credibility.
...
### Psychophysical analysis of monitor display functions affecting observer diagnostic performance of CT image on liquid crystal display monitors [^1139nVec]. European Radiology (2005). Low credibility.
...
### A simple new visualization of exercise data discloses pathophysiology and severity of heart failure [^114csYd8]. Journal of the American Heart Association (2012). Low credibility.
...
### A synaptic learning rule for exploiting nonlinear dendritic computation [^114PAfBg]. Neuron (2021). Medium credibility.
...
### Epistatic net allows the sparse spectral regularization of deep neural networks for inferring fitness functions [^115RHwHF]. Nature Communications (2021). High credibility.
...
### The snm procedure guideline for general imaging 6.0 [^116BA2Xm]. SNMMI (2010). Medium credibility.
...
### Distance-to-agreement investigation of tomotherapy's bony anatomy-based autoregistration and planning target volume contour-based optimization [^1157MM2h]. International Journal of Radiation Oncology, Biology, Physics (2013). Low credibility.
...
### KDOQI clinical practice guidelines and clinical practice recommendations for diabetes and chronic kidney disease [^113uCEd5]. American Journal of Kidney Diseases (2007). Medium credibility.
...
### Analysis of multi-condition single-cell data with latent embedding multivariate regression [^113NnDrp]. Nature Genetics (2025). High credibility.
...
### The effect of gradient nonlinearities on fiber orientation estimates from spherical deconvolution of diffusion magnetic resonance imaging data [^111fKGos]. Human Brain Mapping (2021). Medium credibility.
...
### Synthetic analog computation in living cells [^1163RNx6]. Nature (2013). Excellent credibility.
...
### Comparison of tumor volumes derived from glucose metabolic rate maps and SUV maps in dynamic 18F-FDG PET [^115JKE8e]. Journal of Nuclear Medicine (2008). Low credibility.
...
### American Clinical Neurophysiology Society technical standards for electrical stimulation with intracranial electrodes for functional brain mapping and seizure induction [^114WaK7N]. Journal of Clinical Neurophysiology (2025). High credibility.
...
### Iodinated I-131 albumin (volumex) [^116LLXTu]. FDA (2022). Medium credibility.
...
Using the above formula gives = [52,430 × 4000/48,100] = 4360 mL
...
### Exploring non-equilibrium processes and spatio-temporal scaling laws in heated egg yolk using coherent X-rays [^114LorfR]. Nature Communications (2023). High credibility.
...
### Thermalization and criticality on an analogue-digital quantum simulator [^112tZ7KW]. Nature (2025). Excellent credibility.
...
### A geometric approach to characterize the functional identity of single cells [^115fA1zn]. Nature Communications (2018). Medium credibility.
...
### Structural and functional insights into the delivery of a bacterial rhs pore-forming toxin to the membrane [^112ynQpd]. Nature Communications (2023). High credibility.
