...
> I should confirm the answer one more time. Original number: 7125. Erase the first digit: 125. Check the ratio: 7125 ÷ 125 = 57. Yes, the condition is satisfied, and no smaller natural number meets the criteria given the constraints on d and k, so the smallest such number is 7125.
...
### Supervised dimensionality reduction for big data [^112vfKvk]. Nature Communications (2021). High credibility.
...
### Re-assessing the dimensional structure of the informant questionnaire on cognitive decline in the elderly (IQCODE): empirical evidence for a shortened Brazilian version [^1112WVkX]. BMC Geriatrics (2015). Low credibility.
...
### Towards estimating the number of strains that make up a natural bacterial population [^116BshUQ]. Nature Communications (2024). High credibility.
...
### Dissociation between physical and mental number line bisection in right hemisphere brain damage [^116CDT8z]. Nature Neuroscience (2005). Medium credibility.
...
### Scalable training of artificial neural networks with adaptive sparse connectivity inspired by network science [^113dJW9M]. Nature Communications (2018). Medium credibility.
...
### Comparing explorative saccade and flicker training in hemianopia: a randomized controlled study [^11265c8G]. Neurology (2009). Low credibility.
...
### Gain a child, lose a tooth? Using natural experiments to distinguish between fact and fiction [^114rftuu]. Journal of Epidemiology and Community Health (2018). Low credibility.
...
### Optimal speed estimation in natural image movies predicts human performance [^114sEjtV]. Nature Communications (2015). Medium credibility.
...
### High-performance deep spiking neural networks with 0.3 spikes per neuron [^112hiQ6S]. Nature Communications (2024). High credibility.
...
### SHH protein variance in the limb bud is constrained by feedback regulation and correlates with altered digit patterning [^115q34rW]. G3 (2017). Low credibility.
...
### Decoding the representation of numerical values from brain activation patterns [^112jBSP5]. Human Brain Mapping (2013). Low credibility.
...
### Experimental noise cutoff boosts inferability of transcriptional networks in large-scale gene-deletion studies [^111A4z2w]. Nature Communications (2018). Medium credibility.
...
### Brain damage: neglect disrupts the mental number line [^112PYXpN]. Nature (2002). Excellent credibility.
...
### Incomplete human reference genomes can drive false sex biases and expose patient-identifying information in metagenomic data [^112z5dsX]. Nature Communications (2025). High credibility.
...
### Reservoir computing using dynamic memristors for temporal information processing [^112NmAgS]. Nature Communications (2017). Medium credibility.
...
### Three learning stages and accuracy-efficiency tradeoff of restricted boltzmann machines [^112u71fm]. Nature Communications (2022). High credibility.
...
### Hyperscanning shows friends explore and strangers converge in conversation [^111cgFUC]. Nature Communications (2024). High credibility.
...
### Lateralized neural responses to letters and digits in first graders [^114ZCYcP]. Child Development (2019). Medium credibility.
...
### Immobilization secondary to cell death of muscle precursors with a dual transcriptional signature contributes to the emu wing skeletal pattern [^116mJVAG]. Nature Communications (2024). High credibility.
...
### What counts? Sources of knowledge in children's acquisition of the successor function [^115tV2TC]. Child Development (2021). Medium credibility.
...
### Q1 stability testing of drug substances and drug products… [^1172HzdV]. FDA (2025). Medium credibility.
...
### Revealing nonlinear neural decoding by analyzing choices [^111V2dm7]. Nature Communications (2021). High credibility.
...
### Can we reduce capsule endoscopy reading times? [^112d5rZd]. Gastrointestinal Endoscopy (2009). Low credibility.
...
### Clinical practice guidelines: diagnosis, treatment, and management of children and adults with central auditory processing disorder [^112f8hv8]. AAA (2010). Medium credibility.
...
### Lost in translation: on the problem of data coding in penalized whole genome regression with interactions [^1162GaoQ]. G3 (2019). Medium credibility.
...
### Augmented manipulation ability in humans with six-fingered hands [^112AocC5]. Nature Communications (2019). High credibility.
...
### Prevalence of rare diseases: bibliographic data [^116NbeMJ]. Orphanet Report Series (2024). Medium credibility.

Worldwide, the prevalence of reducing body myopathy is estimated at 0.00006 per 100,000 population.

---

### Risk-sensitive events during laparoscopic cholecystectomy: the influence of the integrated operating room and a preoperative checklist tool [^111rCFTZ]. Surgical Endoscopy (2010). Low credibility.
...
### Weight illusions explained by efficient coding based on correlated natural statistics [^116JCe2v]. Communications Psychology (2024). Medium credibility.
...
### Probing the physical limits of reliable DNA data retrieval [^1135FFkD]. Nature Communications (2020). High credibility.
...
### Natural display mode for digital DICOM-conformant diagnostic imaging [^112FN916]. Academic Radiology (2002). Low credibility.
...
### Lost in translation: on the problem of data coding in penalized whole genome regression with interactions [^113rWnrq]. G3 (2019). Medium credibility.
...
### Human brain representations of internally generated outcomes of approximate calculation revealed by ultra-high-field brain imaging [^114aSWKN]. Nature Communications (2024). High credibility.
...
### Exceptional preservation and foot structure reveal ecological transitions and lifestyles of early theropod flyers [^112e9CJj]. Nature Communications (2022). High credibility.
...
### Decimal numbers and safe interpretation of clinical pathology results [^111fMr4k]. Journal of Clinical Pathology (2014). Low credibility.
...
### Lost in translation: on the problem of data coding in penalized whole genome regression with interactions [^113bPhpF]. G3 (2019). Medium credibility.
...
### Lateralized neural responses to letters and digits in first graders [^1146GKoQ]. Child Development (2019). Medium credibility.
...
### Removal of myomas in asymptomatic patients to improve fertility and / or reduce miscarriage rate: a guideline [^117N9osV]. Fertility and Sterility (2017). Medium credibility.
...
### Prevalence of rare diseases: bibliographic data [^117VJdKs]. Orphanet Report Series (2024). Medium credibility.
...
### Dactinomycin [^116vkZZC]. FDA (2020). Medium credibility.
...
### Input-output maps are strongly biased towards simple outputs [^115xvMdh]. Nature Communications (2018). Medium credibility.
...
### Clinical practice recommendations for the diagnosis and management of X-linked hypophosphataemia [^116hqgj2]. Nature Reviews: Nephrology (2025). High credibility.
...
### Quetiapine (Seroquel) [^113x9Xvt]. FDA (2025). Medium credibility.
...
### K-space undersampling in PROPELLER imaging [^113FXvth]. Magnetic Resonance in Medicine (2005). Low credibility.
...
### Computerized bone age estimation using deep learning based program: evaluation of the accuracy and efficiency [^112z4nKU]. AJR: American Journal of Roentgenology (2017). Low credibility.
...
### Efficient neural codes naturally emerge through gradient descent learning [^117HrGwu]. Nature Communications (2022). High credibility.
...
### Single mini-incisional blepharoplasty with the orbicularis-orbital septum fixation technique for the creation of a natural double eyelid [^113tHmYd]. Aesthetic Plastic Surgery (2024). Medium credibility.
...
### Clinical practice recommendations for the diagnosis and management of X-linked hypophosphataemia [^114o1AY6]. Nature Reviews: Nephrology (2025). High credibility.
...
### Coagulation factor X human (Coagadex) [^113Aw6nY]. FDA (2024). Medium credibility.
