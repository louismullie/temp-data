...
> Let me first confirm the clinical context and why etiology matters. Neuropathic pain is common, heterogeneous, and often chronic, with diabetes being the leading cause and chemotherapy-induced neuropathy representing a distinct, treatment-refractory phenotype; importantly, tight glycemic control slows progression in type 1 diabetes but has modest effects in type 2, so symptomatic therapy is essential in most patients [^114Yregc] [^117Nkojt]. Hold on, I should verify that guideline-concordant pharmacotherapy is underutilized; indeed, real-world data show frequent opioid use and low uptake of recommended agents, underscoring a quality gap that we need to address in practice [^117MgmFJ] [^113Pkg7D].
