...
> Let me consider duration carefully; for uncomplicated cystitis, 5 days of nitrofurantoin, 3 days of TMP-SMX if susceptible, and single-dose fosfomycin are acceptable regimens, and I should confirm that shorter courses reduce adverse effects without compromising efficacy when chosen appropriately, reserving longer durations for select scenarios such as pregnancy or diabetes where evidence is less definitive [^1159C8Cf].
...
UTI management centers on **empiric therapy tailored to local resistance** [^1135gEPy] and patient factors, with **short-course regimens** for uncomplicated cystitis (nitrofurantoin, TMP-SMX, or fosfomycin) [^1159C8Cf] and longer courses for complicated disease or pyelonephritis [^117BsxsL]. Obtain **urine culture** before antibiotics in complicated or recurrent cases [^114JpJPa], and de-escalate to narrow-spectrum agents when results are available [^112bPvv4]. For recurrent UTIs, use non-antibiotic strategies (vaginal estrogen, methenamine, D-mannose) [^1171guRo] or antibiotic prophylaxis (continuous, postcoital, or patient-initiated) [^114AqSwd] when indicated. Avoid treating **asymptomatic bacteriuria** except in pregnancy or before urologic procedures [^11183VFt]. Emphasize **antimicrobial stewardship** [^113w9t1z] and patient education to reduce resistance and recurrence.
