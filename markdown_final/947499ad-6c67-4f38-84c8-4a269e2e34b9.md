...
> Let me consider duration carefully; for uncomplicated cystitis, 5 days of nitrofurantoin, 3 days of TMP-SMX if susceptible, and single-dose fosfomycin are acceptable regimens, and I should confirm that shorter courses reduce adverse effects without compromising efficacy when chosen appropriately, reserving longer durations for select scenarios such as pregnancy or diabetes where evidence is less definitive [^114FafnN].
...
> Let me think about pregnancy; I should confirm that first-line therapy is beta-lactams such as amoxicillin, amoxicillin-clavulanate, or cephalexin for 5 to 7 days, avoid TMP-SMX in the first trimester and near term, and reserve fluoroquinolones for compelling indications, with urinalysis and culture recommended at the first prenatal visit and during any symptomatic episode to guide therapy [^116oNXE1].
