...
> Next, I should review outcomes and quality metrics. Reported orchiectomy rates vary widely, but contemporary series and meta-analyses suggest roughly 15–40% testicular loss, with late presentation and prolonged ischemic time as dominant predictors; long-term atrophy and subfertility remain concerns even after salvage, underscoring the need for early intervention and counseling [^e67fd854] [^5261b4d4] [^71aad82a].
...
Testicular torsion is a **surgical emergency** [^cfee3288] caused by twisting of the spermatic cord, cutting off testicular blood flow and risking irreversible ischemia within 6–8 hours [^d09fde52]. It presents with **sudden severe unilateral scrotal pain**, nausea/vomiting, and an absent cremasteric reflex [^d09fde52]; a high-riding, horizontally lying testis may be seen [^994a41e9]. Diagnosis is **primarily clinical** [^e21175d1]; Doppler ultrasound can confirm absent or reduced flow but should not delay urgent urology consultation or surgical exploration [^de1be06a] [^f4600cf1]. Immediate manual detorsion may be attempted if surgery is delayed, but definitive treatment is **surgical detorsion and bilateral orchiopexy** [^859a731b] [^f4600cf1]. Delays beyond 6–8 hours sharply reduce salvage rates, so time-critical management is essential [^c294a2a5].
