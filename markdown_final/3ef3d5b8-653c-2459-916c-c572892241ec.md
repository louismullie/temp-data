...
### Clinical bioinformatician body of knowledge-clinical laboratory regulation and data security core: a report of the Association for Molecular Pathology [^111f6HtW]. The Journal of Molecular Diagnostics (2025). High credibility.
...
### Clinical bioinformatician body of knowledge-clinical laboratory regulation and data security core: a report of the Association for Molecular Pathology [^1127zKRm]. The Journal of Molecular Diagnostics (2025). High credibility.
...
### Clinical bioinformatician body of knowledge-clinical laboratory regulation and data security core: a report of the Association for Molecular Pathology [^115ZASot]. The Journal of Molecular Diagnostics (2025). High credibility.
...
### SPIRIT 2025 explanation and elaboration: updated guideline for protocols of randomised trials [^116S8JWo]. BMJ (2025). Excellent credibility.
...
### Efgartigimod following plasma exchange in the treatment of subjects with generalised myasthenia gravis: study protocol for a multicentre, three-arm, open-label study [^117HyoWP]. BMJ Neurology Open (2025). High credibility.
...
### International charter of principles for sharing bio-specimens and data [^115h2QEt]. European Journal of Human Genetics (2015). Low credibility.
...
### 2017 ISHNE-HRS expert consensus statement on ambulatory ECG and external cardiac monitoring / telemetry [^111xfaiu]. Heart Rhythm (2017). Medium credibility.
...
### SPIRIT 2013 explanation and elaboration: guidance for protocols of clinical trials [^113dRAFo]. BMJ (2013). Excellent credibility.
...
### MRIdb: medical image management for biobank research [^111By3C4]. Journal of Digital Imaging (2013). Low credibility.
...
### Clinical bioinformatician body of knowledge-clinical laboratory regulation and data security core: a report of the Association for Molecular Pathology [^116jayHE]. The Journal of Molecular Diagnostics (2025). High credibility.
...
### Infrastructure and operating processes of PIONEER, the HDR-UK data hub in acute care and the workings of the data trust committee: a protocol paper [^115M87ek]. BMJ Health & Care Informatics (2021). High credibility.
...
### Interactive multimedia reporting technical considerations: HIMSS-SIIM collaborative white paper [^114PzcCq]. Journal of Digital Imaging (2022). Medium credibility.
...
### Guidelines for the practice of telepsychology [^115u28o3]. The American Psychologist (2013). Medium credibility.
...
### Improving authenticity and provenance in digital biomarkers: the case for digital watermarking [^111mVxXH]. NPJ Digital Medicine (2025). Medium credibility.
...
### Self-measured blood pressure telemonitoring programs: a pragmatic how-to guide [^115c9nxk]. American Journal of Hypertension (2023). Medium credibility.
...
### Clinical bioinformatician body of knowledge-clinical laboratory regulation and data security core: a report of the Association for Molecular Pathology [^117V2B2q]. The Journal of Molecular Diagnostics (2025). High credibility.
...
### Challenges and standardisation strategies for sensor-based data collection for digital phenotyping [^116tMBap]. Communications Medicine (2025). Medium credibility.
...
### Remote inspection of adversary-controlled environments [^117MfeHK]. Nature Communications (2023). High credibility.
...
### SPIRIT 2025 explanation and elaboration: updated guideline for protocols of randomised trials [^117PeLUF]. BMJ (2025). Excellent credibility.
...
### How secure are your health devices-stopping wearables becoming a personal and national security risk? [^116Va1Tc]. NPJ Digital Medicine (2025). Medium credibility.
...
### International charter of principles for sharing bio-specimens and data [^116K1JFt]. European Journal of Human Genetics (2015). Low credibility.
...
### Beyond traditional orthopaedic data analysis: AI, multimodal models and continuous monitoring [^113Pn6tX]. Knee Surgery, Sports Traumatology, Arthroscopy (2025). Medium credibility.
...
### Standards and guidelines for validating next-generation sequencing bioinformatics pipelines: a joint recommendation of the Association for Molecular Pathology and the college of American pathologists [^115qj2Md]. The Journal of Molecular Diagnostics (2018). Medium credibility.
...
### Providing integrity, authenticity, and confidentiality for header and pixel data of DICOM images [^111cjg1j]. Journal of Digital Imaging (2015). Low credibility.
...
### Computerized system for staging peritoneal surface malignancies [^112Akf6U]. Annals of Surgical Oncology (2016). Low credibility.
...
### Seamless EMR data access: integrated governance, digital health and the OMOP-CDM [^111cFaKd]. BMJ Health & Care Informatics (2024). High credibility.
...
### Security of electronic medical information and patient privacy: what you need to know [^116pXUuC]. Journal of the American College of Radiology (2014). Low credibility.
...
### Embracing generative artificial intelligence in clinical research and Beyond: opportunities, challenges, and solutions [^111awqwV]. JACC: Advances (2025). Medium credibility.
...
### Internet-delivered cognitive-behaviour therapy for anxiety related to asthma: study protocol for a randomised controlled trial [^1154emWf]. BMJ Open Respiratory Research (2024). High credibility.
...
### Concealable physical unclonable functions using vertical NAND flash memory [^116pFtpN]. Nature Communications (2025). High credibility.
...
### Security issues for mobile medical imaging: a primer [^112sWnxc]. Radiographics (2015). Low credibility.
...
### Registered access: a' triple-A' approach [^1122zmU5]. European Journal of Human Genetics (2016). Low credibility.
...
### Guidelines for the practice of telepsychology [^112uTzBi]. The American Psychologist (2013). Medium credibility.
...
### Driving digital transformation of comprehensive primary health services at scale in India: an enterprise architecture framework [^114wrjgH]. BMJ Global Health (2021). High credibility.
...
### Institutional review boards, professionalism, and the internet [^116hhdDB]. Science Translational Medicine (2010). Low credibility.
...
### Data management and sharing policy: the first step towards promoting data sharing [^117FruJL]. BMC Medicine (2019). Medium credibility.
...
### CDC program evaluation framework, 2024 [^113ay5k2]. MMWR: Recommendations and Reports (2024). Medium credibility.
...
### Practical implementation of AI in a non-academic, non-commercial pathology laboratory: real world experience and lessons learned [^113VfNLC]. Histopathology (2025). Medium credibility.
...
### Improving authenticity and provenance in digital biomarkers: the case for digital watermarking [^114kjtxT]. NPJ Digital Medicine (2025). Medium credibility.
...
### Web services and cloud computing in pediatric care [^117SRFGG]. Pediatrics (2021). High credibility.
...
### Open data sharing: what could possibly go wrong? [^112TMPoo]. Pain (2025). Medium credibility.
...
### The inborn errors of immunity-virtual consultation system platform in service for the Italian primary immunodeficiency network: results from the validation phase [^115tz8Wm]. Journal of Clinical Immunology (2024). Medium credibility.
...
### Technical requirements and optimization strategies for home-based teleradiology workstations: a review article [^1161yzkx]. Insights Into Imaging (2025). Medium credibility.
...
### A 10-year update to the principles for clinical trial data sharing by pharmaceutical companies: perspectives based on a decade of literature and policies [^116CiDk6]. BMC Medicine (2023). Medium credibility.
...
### Transforming Chinese cohort studies through artificial intelligence: a new era of population health research [^114k2uQh]. BMJ (2025). Excellent credibility.
...
### Source-device-independent heterodyne-based quantum random number generator at 17 gbps [^113318kv]. Nature Communications (2018). Medium credibility.
...
### Digital twins for health: a scoping review [^116qYoPD]. NPJ Digital Medicine (2024). Medium credibility.
...
### [DOC] health… [^114ZQTjq]. ncvhs.hhs.gov (2025). Medium credibility.
...
### Informatics in radiology: integration of the medical imaging resource center into a teaching hospital network to allow single sign-on access [^116Yr5ou]. Radiographics (2009). Low credibility.
...
### Guidelines for the practice of telepsychology [^1126eLk1]. The American Psychologist (2013). Medium credibility.
...
### Summary of the HIPAA security rule… [^116cqqzj]. HHS (2009). Low credibility.
...
### A scalable, secure, and interoperable platform for deep data-driven health management [^1159BHdk]. Nature Communications (2021). High credibility.
...
### Patient data security in the DICOM standard [^113LcesA]. European Journal of Radiology (2004). Low credibility.
...
### Clinical bioinformatician body of knowledge-clinical laboratory regulation and data security core: a report of the Association for Molecular Pathology [^114NhY7a]. The Journal of Molecular Diagnostics (2025). High credibility.
...
### Telemedicine for ophthalmology information statement-2018 [^114nm4SF]. AAO (2018). Medium credibility.
...
### Web services and cloud computing in pediatric care [^114Zgg26]. Pediatrics (2021). High credibility.
...
### Clinical bioinformatician body of knowledge-clinical laboratory regulation and data security core: a report of the Association for Molecular Pathology [^111x1RL4]. The Journal of Molecular Diagnostics (2025). High credibility.
...
### AD workbench: transforming Alzheimer's research with secure, global, and collaborative data sharing and analysis [^114ek6JX]. Alzheimer's & Dementia (2025). Medium credibility.
...
### APA guidelines for psychological assessment and evaluation [^113JWWCG]. APA (2020). High credibility.
...
### Unaddressed privacy risks in accredited health and wellness apps: a cross-sectional systematic assessment [^114Sdvft]. BMC Medicine (2015). Low credibility.
...
### A device-independent quantum key distribution system for distant users [^115S3ngX]. Nature (2022). Excellent credibility.
...
### Privacy and security of medical information [^113JtpgX]. Otolaryngologic Clinics of North America (2002). Low credibility.
...
### Proposal for DICOM multiframe medical image integrity and authenticity [^111gELCR]. Journal of Digital Imaging (2009). Low credibility.
...
### Clinical bioinformatician body of knowledge-clinical laboratory regulation and data security core: a report of the Association for Molecular Pathology [^116MQmuz]. The Journal of Molecular Diagnostics (2025). High credibility.
...
### Implementing telehealth in practice: ACOG committee opinion summary, number 798 [^1167dXUZ]. Obstetrics and Gynecology (2020). High credibility.
...
### SPIRIT 2025 explanation and elaboration: updated guideline for protocols of randomised trials [^115v39YA]. BMJ (2025). Excellent credibility.
...
### The METRIC-framework for assessing data quality for trustworthy AI in medicine: a systematic review [^114xC5Uq]. NPJ Digital Medicine (2024). Medium credibility.
...
### Realistic noise-tolerant randomness amplification using finite number of devices [^1149FYn9]. Nature Communications (2016). Medium credibility.
...
### Experimental verification of multipartite entanglement in quantum networks [^114kDBau]. Nature Communications (2016). Medium credibility.
...
### Occupational electronic health records: recommendations for the design and implementation of information systems in occupational and environmental medicine practice-ACOEM guidance statement [^116vmswr]. Journal of Occupational and Environmental Medicine (2024). High credibility.
...
### The federated database – a basis for biobank-based post-genome studies, integrating phenome and genome data from 600, 000 twin pairs in Europe [^111SvWwG]. European Journal of Human Genetics (2007). Low credibility.
...
### Clinical bioinformatician body of knowledge-bioinformatics and software core: a report of the Association for Molecular Pathology [^111TWeHx]. The Journal of Molecular Diagnostics (2025). High credibility.
...
### Value lies in the eye of the patients: the why, what, and how of patient-reported outcomes measures [^112BLsuX]. Clinical Therapeutics (2020). Medium credibility.
...
### Clinical bioinformatician body of knowledge-clinical laboratory regulation and data security core: a report of the Association for Molecular Pathology [^113jN7fc]. The Journal of Molecular Diagnostics (2025). High credibility.
...
### Survey, taxonomy, and emerging paradigms of societal digital twins for public health preparedness [^1179dBfT]. NPJ Digital Medicine (2025). Medium credibility.
...
### The spectrum of data sharing policies in neuroimaging data repositories [^111qcrz8]. Human Brain Mapping (2022). Medium credibility.
...
### SPIRIT 2013 explanation and elaboration: guidance for protocols of clinical trials [^111koxZG]. BMJ (2013). Excellent credibility.
...
### Nuclear disarmament verification via resonant phenomena [^111ZN2LZ]. Nature Communications (2018). Medium credibility.
...
### Heart Rhythm Society policy statement update: recommendations on the role of industry-employed allied professionals [^116QU1Xi]. Heart Rhythm (2023). High credibility.
...
### Guidelines for the use of cell lines in biomedical research [^115eUwAS]. British Journal of Cancer (2014). Low credibility.
...
### ACR-AAPM-SIIM practice parameter for determinants of image quality in mammography [^115Pnv5i]. SIIM/ACR/AAPM (2022). High credibility.
...
### Knowledge abstraction and filtering based federated learning over heterogeneous data views in healthcare [^114yeCvy]. NPJ Digital Medicine (2024). Medium credibility.
...
### Digital health governance in China by a whole-of-society approach [^111xwR4j]. NPJ Digital Medicine (2025). Medium credibility.
...
### India's evolving digital health strategy [^115unExd]. NPJ Digital Medicine (2024). Medium credibility.
...
### Responsible practices for data sharing [^113MDzLp]. The American Psychologist (2018). Low credibility.
...
### Spectral physical unclonable functions: downscaling randomness with multi-resonant hybrid particles [^111J5qhx]. Nature Communications (2025). High credibility.
...
### Zero-check: a zero-knowledge protocol for reconciling patient identities across institutions [^112Ne6js]. Archives of Pathology & Laboratory Medicine (2004). Low credibility.
...
### Mainecoon: implementing an open-source web viewer for DICOM whole slide images with AI-integrated PACS for digital pathology [^113AT9ur]. Journal of Imaging Informatics in Medicine (2025). Medium credibility.
...
### Occupational electronic health records: recommendations for the design and implementation of information systems in occupational and environmental medicine practice-ACOEM guidance statement [^112uYYqT]. Journal of Occupational and Environmental Medicine (2024). High credibility.
