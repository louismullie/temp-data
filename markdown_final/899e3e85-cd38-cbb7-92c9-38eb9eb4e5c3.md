...
> Next, I should review practical application details to avoid common pitfalls. Efinaconazole and tavaborole are applied once daily to the entire nail plate and hyponychium for 48 weeks; ciclopirox 8% is applied daily with weekly removal using alcohol and monthly professional debridement of unattached nail as part of a comprehensive program; patients should avoid nail polish and harsh chemicals on treated nails, and adherence over the long course is critical to outcomes [^091ef718] [^2e923b77].
