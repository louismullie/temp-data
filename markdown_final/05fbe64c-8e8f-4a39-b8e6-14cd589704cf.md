...
> Resistance and pharmacology matter, so I should review them. Ureaplasma lacks a cell wall, rendering beta-lactams ineffective; macrolides, tetracyclines, and fluoroquinolones target protein synthesis and are the mainstays, but macrolide resistance via 23S rRNA methylation can occur and may be selected with repeated exposures; in vitro, neonatal isolates generally have low azithromycin MICs, but clinical breakpoints are not standardized, complicating interpretation [^112ua8gn] [^111sBeMY] [^113Nwb22]. Hmm, wait a minute, I initially thought there were FDA-cleared Ureaplasma susceptibility methods; I should correct that: while FDA labeling lists in vitro activity, there are no standardized clinical breakpoints for Ureaplasma, and routine susceptibility testing is not established in clinical practice [^112ua8gn] [^111sBeMY].
