...
> Wait, let me verify the human safety signals before drawing conclusions. The FDA risk summaries indicate that available epidemiologic studies and postmarketing reports do not consistently demonstrate an increased risk of major birth defects or miscarriage with inhaled albuterol, which is reassuring but not definitive given observational design limits and potential confounding by disease severity [^31c81662] [^947a31ec] [^d1896322] [^45e70e20].
