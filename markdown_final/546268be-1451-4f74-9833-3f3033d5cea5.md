...
> Let me first confirm the terminology, because I need to ensure we are not mixing up "sulfa" with "sulbactam". "Sulfa" in common clinical usage refers to sulfonamide antibiotics such as sulfamethoxazole, which inhibit dihydropteroate synthase and are bacteriostatic, whereas sulbactam is a β-lactamase inhibitor with direct antibacterial activity against Acinetobacter via inhibition of penicillin-binding proteins, particularly PBP3, and is not a sulfonamide [^113AbAhc] [^1138TN8U].
