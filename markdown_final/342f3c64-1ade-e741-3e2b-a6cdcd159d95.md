...
Eosinophil counts and activation markers are used to diagnose and monitor disease, guide therapy, and predict response to corticosteroids and biologics. Key thresholds include **≥ 300 cells/µL** in asthma to predict ICS response and **≥ 1.5 × 10^9/L** to define hypereosinophilia and prompt evaluation for clonal or idiopathic causes [^e0e66b36] [^c791694a] [^5da129d9]. Biomarkers such as ECP, EDN, and EPO reflect activation and tissue involvement [^4a38b404] [^1c978932].
...
Eosinophil count reporting in EoE — Recommendation 4 states, "We recommend that eosinophil counts be quantified on esophageal biopsies from every endoscopy performed for EoE (quality of evidence: low; strength of recommendation: strong)." Beyond the diagnostic threshold, "more detail than " > 15 eos/hpf" is needed for subsequent patient management," because counts inform response monitoring, for example "if a patient has gone from 200 to 150 eos/hpf, or from 200 to 20 eos/hpf after treatment," even though severity is not strictly tied to absolute counts (e.g., "200 eos/hpf… as a patient with 100 eos/hpf"). For cross-study consistency, reporting density may be preferable, "in which case, the diagnostic threshold is ~60 eos/mm2."
