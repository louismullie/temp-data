...
> Next, I should review what to avoid so we don't propagate ineffective strategies. Do not use hydroxychloroquine, lopinavir/ritonavir, ivermectin, or colchicine for COVID-19 prophylaxis outside of clinical trials; these agents either have negative RCT data or insufficient evidence for prophylaxis and are not recommended by major guidelines [^a3d25939] [^4e5bf189] [^3f5c6d36].
