...
> Next, I should review the clinical presentation and the diagnostic delay problem. Typical symptoms include dysmenorrhea, chronic pelvic pain, deep dyspareunia, dyschezia, dysuria, and infertility; adolescents may present with acyclic pain and minimal findings on exam, yet delays of 4–11 years are common due to symptom normalization, stigma, and clinician factors such as limited training and reliance on nondiscriminatory tests [^7405fe03] [^41734c40] [^e5f276f3]. Wait, let me verify the magnitude of delay: multiple sources consistently cite 6–12 years, reinforcing the need for a noninvasive-first approach when appropriate [^41734c40] [^e5f276f3].
