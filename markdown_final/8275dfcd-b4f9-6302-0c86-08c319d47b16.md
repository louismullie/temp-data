...
Tretinoin is a **topical retinoid** for acne vulgaris and photoaging, with **comedolytic and anti-inflammatory effects** [^114CrcLM] [^115qGETQ]. It is available as creams, gels, and lotions (0.01–0.1%) [^1124zkmQ] and should be applied once nightly to clean, dry skin [^115bdPqf]. Common adverse effects include irritation, dryness, peeling, and photosensitivity [^115bdPqf]; use sunscreen and start slowly to improve tolerability [^115qGETQ]. Tretinoin is **contraindicated in pregnancy** due to teratogenic risk [^113gfpW5]; use effective contraception in women of childbearing potential [^113gfpW5]. It is less irritating than older formulations but more irritating than adapalene; fixed-dose combinations with clindamycin or benzoyl peroxide enhance efficacy and reduce resistance [^115qGETQ] [^113Dgat7].
