...
Tretinoin is a **topical retinoid** for acne vulgaris and photoaging, with **comedolytic and anti-inflammatory effects** [^7d5cc286] [^bd0aa2a7]. It is available as creams, gels, and lotions (0.01–0.1%) [^29d12ed3] and should be applied once nightly to clean, dry skin [^b3d82c5e]. Common adverse effects include irritation, dryness, peeling, and photosensitivity [^b3d82c5e]; use sunscreen and start slowly to improve tolerability [^bd0aa2a7]. Tretinoin is **contraindicated in pregnancy** due to teratogenic risk [^69005ad2]; use effective contraception in women of childbearing potential [^69005ad2]. It is less irritating than older formulations but more irritating than adapalene; fixed-dose combinations with clindamycin or benzoyl peroxide enhance efficacy and reduce resistance [^bd0aa2a7] [^56cc6150].
