...
### Developing IBD outcome effect size thresholds to inform research, guidelines, and clinical decisions [^113VkLbc]. Inflammatory Bowel Diseases (2025). Medium credibility.
...
### Statistical significance versus clinical importance of observed effect sizes: what Do P values and confidence intervals really represent? [^114wZNp4]. Anesthesia and Analgesia (2018). Low credibility.
...
### Are potentially clinically meaningful benefits misinterpreted in cardiovascular randomized trials? A systematic examination of statistical significance, clinical significance, and authors' conclusions [^114SoaS8]. BMC Medicine (2017). Low credibility.
...
### Writing up your clinical trial report for a scientific journal: the REPORT trial guide for effective and transparent research reporting without spin [^1144jeky]. British Journal of Sports Medicine (2022). Medium credibility.
...
### Understanding the role of P values and hypothesis tests in clinical research [^1169y45Y]. JAMA Cardiology (2016). Medium credibility.
...
### Are potentially clinically meaningful benefits misinterpreted in cardiovascular randomized trials? A systematic examination of statistical significance, clinical significance, and authors' conclusions [^116tkpTC]. BMC Medicine (2017). Low credibility.
...
### The difference between statistical significance and clinical relevance. the case of minimal important change, non-inferiority trials, and smallest worthwhile effect [^117KKzPR]. Injury (2023). Medium credibility.
...
### Developing IBD outcome effect size thresholds to inform research, guidelines, and clinical decisions [^112HoxHG]. Inflammatory Bowel Diseases (2025). Medium credibility.
...
### Determination of the clinical importance of study results [^117MPVRt]. Journal of General Internal Medicine (2002). Low credibility.
...
### Efficacy and safety of basimglurant as adjunctive therapy for major depression: a randomized clinical trial [^113gk8q6]. JAMA Psychiatry (2016). Medium credibility.
...
### CONSORT 2010 explanation and elaboration: updated guidelines for reporting parallel group randomised trials [^117KHDcX]. BMJ (2010). Excellent credibility.
...
### When should physicians act on non-statistically significant results from clinical trials? [^112K5VzW]. JAMA Network (2020). Excellent credibility.
...
### CONSORT 2025 explanation and elaboration: updated guideline for reporting randomised trials [^112ca6W3]. BMJ (2025). Excellent credibility.
...
### CONSORT 2025 explanation and elaboration: updated guideline for reporting randomised trials [^112fUcKo]. BMJ (2025). Excellent credibility.
...
### Interpretation of clinical trial results: a committee opinion [^114r4KZm]. Fertility and Sterility (2020). Medium credibility.
...
### Interpreting the clinical importance of group differences in chronic pain clinical trials: IMMPACT recommendations [^114TXZqg]. Pain (2009). Low credibility.
...
### Efficacy and safety of butylphthalide in patients with acute ischemic stroke: a randomized clinical trial [^1138yqVB]. JAMA Neurology (2023). High credibility.
...
### Interpretation of clinical trial results [^117GLwWd]. Fertility and Sterility (2008). Low credibility.
...
### Interpretation of clinical trial results [^111AMwC8]. Fertility and Sterility (2006). Low credibility.

This educational bulletin provides background and tips on how to recognize quality trials and then focuses on evaluating the validity, importance, and relevance of clinical trial results.

---

### Are potentially clinically meaningful benefits misinterpreted in cardiovascular randomized trials? A systematic examination of statistical significance, clinical significance, and authors' conclusions [^1159dwXp]. BMC Medicine (2017). Low credibility.
...
### Understanding results [^116GGye3]. The Journal of Urology (2009). Low credibility.
...
### Are potentially clinically meaningful benefits misinterpreted in cardiovascular randomized trials? A systematic examination of statistical significance, clinical significance, and authors' conclusions [^115gxXWf]. BMC Medicine (2017). Low credibility.
...
### Bayesian interpretation of p values in clinical trials [^117DVyaf]. BMJ Evidence-Based Medicine (2022). High credibility.
...
### Are potentially clinically meaningful benefits misinterpreted in cardiovascular randomized trials? A systematic examination of statistical significance, clinical significance, and authors' conclusions [^112a4AYc]. BMC Medicine (2017). Low credibility.
...
### CONSORT-DEFINE explanation and elaboration: recommendations for enhancing reporting quality and impact of early phase dose-finding clinical trials [^116EbVKP]. EClinicalMedicine (2025). Medium credibility.
...
### Ophthalmic statistics note 6: effect sizes matter [^114Ct1RZ]. The British Journal of Ophthalmology (2015). Low credibility.
...
### CONSORT 2025 explanation and elaboration: updated guideline for reporting randomised trials [^114WTXrW]. BMJ (2025). Excellent credibility.
...
### Introducing the JAMA guide to statistics and methods… [^113bHH33]. JAMA Network (2014). Excellent credibility.
...
### Editorial commentary: the statistical fragility index of medical trials is low by design: critical evaluation of confidence intervals is required [^112ziLSB]. Arthroscopy (2024). Medium credibility.
...
### Bayesian interpretation of p values in clinical trials [^112oiZRk]. BMJ Evidence-Based Medicine (2022). High credibility.
...
### Nonconventional clinical trial designs: approaches to provide more precise estimates of treatment effects with a smaller sample size, but at a cost [^116DTQA1]. Stroke (2007). Low credibility.
...
### CONSORT-DEFINE explanation and elaboration: recommendations for enhancing reporting quality and impact of early phase dose-finding clinical trials [^113zRfd5]. EClinicalMedicine (2025). Medium credibility.
...
### Interpretation of absolute measures of disease risk in comparative research [^1141ksWB]. Family Medicine (2007). Low credibility.
...
### Smaller sample sizes for phase II trials based on exact tests with actual error rates by trading-off their nominal levels of significance and power [^117RSC4j]. British Journal of Cancer (2012). Low credibility.
...
### CONSORT 2010 explanation and elaboration: updated guidelines for reporting parallel group randomised trials [^114Rt8vE]. BMJ (2010). Excellent credibility.
...
### Assessment of inverse publication bias in safety outcomes: an empirical analysis [^1168pUwZ]. BMC Medicine (2024). Medium credibility.
...
### Six persistent research misconceptions [^112zhQWJ]. Journal of General Internal Medicine (2014). Low credibility.
...
### Guidance for protocol content and reporting of factorial randomised trials: explanation and elaboration of the CONSORT 2010 and SPIRIT 2013 extensions [^1146aY3L]. BMJ (2025). Excellent credibility.
...
### Expert perspectives on key parameters that impact interpretation of randomized clinical trials in moderate-to-severe atopic dermatitis [^117PLDE9]. American Journal of Clinical Dermatology (2022). Medium credibility.
...
### Are potentially clinically meaningful benefits misinterpreted in cardiovascular randomized trials? A systematic examination of statistical significance, clinical significance, and authors' conclusions [^114P1UCo]. BMC Medicine (2017). Low credibility.
...
### A structured preapproval and postapproval comparative study design framework to generate valid and transparent real-world evidence for regulatory decisions [^111oJuMu]. Clinical Pharmacology and Therapeutics (2019). Medium credibility.
...
### Indication of measures of uncertainty for statistical significance in abstracts of published oncology trials: a systematic review and meta-analysis [^1133iHEs]. JAMA Network Open (2019). High credibility.
...
### Influence of trial sample size on treatment effect estimates: meta-epidemiological study [^114zxzKr]. BMJ (2013). Excellent credibility.
...
### On reporting of effect size in randomized clinical trials [^114o9RX6]. The American Journal of Cardiology (2013). Low credibility.
...
### End points in clinical trials: are they moving the goalposts? [^116E5teA]. Heart (2006). Low credibility.
...
### Application of the reverse fragility index to statistically nonsignificant randomized clinical trial results [^113Kvai8]. JAMA Network Open (2020). High credibility.
...
### Understanding measures of treatment effect in clinical trials [^116KBqXA]. Archives of Disease in Childhood (2005). Low credibility.
...
### How informative is a negative finding in a small pharmacogenetic study? [^114LUz5y]. The Pharmacogenomics Journal (2012). Low credibility.
...
### Improving the reporting of clinical trials of infertility treatments (IMPRINT): modifying the CONSORT statement [^112daV16]. Fertility and Sterility (2014). Medium credibility.
...
### Statistical significance versus clinical relevance in cardiovascular medicine [^112sdNkH]. Progress in Cardiovascular Diseases (2001). Low credibility.
...
### Statistical issues in interpreting clinical trials [^111Uii5d]. Journal of Internal Medicine (2004). Low credibility.
...
### Misleading reporting and interpretation of results in major infertility journals [^117RbFea]. Fertility and Sterility (2016). Low credibility.
...
### CONSORT-DEFINE explanation and elaboration: recommendations for enhancing reporting quality and impact of early phase dose-finding clinical trials [^111M1Xr9]. EClinicalMedicine (2025). Medium credibility.
...
### Non-inferiority trials: a systematic review on methodological quality and reporting standards [^117RrQ6Y]. Journal of General Internal Medicine (2024). Medium credibility.
...
### Comparison of clinical trial changes in primary outcome and reported intervention effect size between trial registration and publication [^114CizQk]. JAMA Network Open (2019). High credibility.
...
### CONSORT-DEFINE explanation and elaboration: recommendations for enhancing reporting quality and impact of early phase dose-finding clinical trials [^112w4UVv]. EClinicalMedicine (2025). Medium credibility.
...
### Current practice in analysing and reporting binary outcome data-a review of randomised controlled trial reports [^112BmyKr]. BMC Medicine (2020). Medium credibility.
...
### Reporting of sample size calculation in randomised controlled trials: review [^113T8ibU]. BMJ (2009). Excellent credibility.
...
### Statistical controversies in clinical research: statistical significance-too much of a good thing… [^114RTFnm]. Annals of Oncology (2016). Low credibility.
...
### CONSORT 2025 explanation and elaboration: updated guideline for reporting randomised trials [^115UisqX]. BMJ (2025). Excellent credibility.
...
### AGA clinical practice guideline on the prevention and treatment of hepatitis B virus reactivation in at-risk individuals [^111c814W]. Gastroenterology (2025). High credibility.
...
### CONSORT 2025 explanation and elaboration: updated guideline for reporting randomised trials [^116Muizb]. BMJ (2025). Excellent credibility.
...
### Is it time to abandon the use of-values in early phase translational trials: why (effect) size matters [^114vQ7Yy]. JACC: Basic to Translational Science (2024). Medium credibility.
...
### Comparative ocular outcomes of tirzepatide versus other anti-obesity medications in people with obesity [^111SbJM9]. Communications Medicine (2025). Medium credibility.
...
### Enhancing interpretability of cancer clinical trial results… [^116iVxqz]. JAMA Network (2017). Excellent credibility.
...
### Estimating treatment effects for individual patients based on the results of randomised clinical trials [^116rn51f]. BMJ (2011). Excellent credibility.
...
### Current practice in analysing and reporting binary outcome data-a review of randomised controlled trial reports [^116pow8i]. BMC Medicine (2020). Medium credibility.
...
### Development process of a consensus-driven CONSORT extension for randomised trials using an adaptive design [^112L69HV]. BMC Medicine (2018). Low credibility.
...
### Adverse events associated with ERCP [^11666hZw]. Gastrointestinal Endoscopy (2017). Medium credibility.
...
### Review of current controversial issues in clinical trials [^115m2LWQ]. General Psychiatry (2021). Medium credibility.
...
### Understanding clinical significance in rehabilitation: a primer for researchers and clinicians [^114pFA4R]. American Journal of Physical Medicine & Rehabilitation (2022). Medium credibility.
