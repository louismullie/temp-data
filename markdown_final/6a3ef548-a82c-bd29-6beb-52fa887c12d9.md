...
Asthma etiology is **multifactorial** [^1d7a819d], arising from the interplay of genetic susceptibility and environmental exposures [^aaf83d5b], with early-life events shaping disease inception and persistence [^5facbb5d]. Key genetic drivers include **polygenic variants** (e.g. IL33, IL1RL1, GSDMB) [^e406c620] and family history [^ef21ba40], while major environmental risks include early-life viral infections (especially RSV and rhinovirus) [^7c9c2ead], allergen sensitization [^b2dcc035], tobacco smoke [^9d76004a], air pollution [^aaf83d5b], and occupational exposures [^aaf83d5b]. Early-life immune programming, the microbiome [^88ad5492], and epigenetic modifications [^357f44e2] modulate risk, and **no single cause** explains all asthma; instead, cumulative effects of multiple factors drive heterogeneous phenotypes and endotypes [^0a473490] [^b031e323].
