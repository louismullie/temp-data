...
The ICD-10 code for muscle-eye-brain disease is **G71.0** (Muscular dystrophy). Muscle-eye-brain disease is a congenital muscular dystrophy with brain and eye involvement; because ICD-10-CM lacks a specific code for MEB, **G71.0** is the most appropriate category, with additional detail documented in the medical record [^notfound]. If a more specific subtype is known, use **G71.01** (Duchenne or Becker muscular dystrophy) or **G71.09** (other specified muscular dystrophy) as appropriate, and include the clinical name "muscle-eye-brain disease" in the documentation to support coding accuracy [^notfound].
