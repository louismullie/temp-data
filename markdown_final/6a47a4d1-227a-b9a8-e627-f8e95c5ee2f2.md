...
> Let me first confirm the indication and the agents involved. The FDA-approved indication for ocular pain and inflammation after corneal refractive surgery applies to topical NSAIDs, specifically ketorolac tromethamine ophthalmic solution 0.4% (Acular LS), and diclofenac sodium ophthalmic solution 0.1% for temporary relief of pain and photophobia in this setting, whereas other NSAIDs like bromfenac and nepafenac are indicated for post-cataract inflammation and pain rather than corneal refractive surgery per se, so I need to be careful not to overextend their labeled use here [^114FUFQX] [^111wHCps] [^116NpesN].
