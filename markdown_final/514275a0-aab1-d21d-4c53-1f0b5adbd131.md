...
- **Enhancers**: Vitamin C (ascorbic acid) significantly enhances non-heme iron absorption by reducing ferric iron (Fe³⁺) to ferrous iron (Fe²⁺) and forming soluble complexes [^827d140e]. Meat, fish, and poultry also enhance non-heme absorption via the "meat factor" [^6d003a49].
