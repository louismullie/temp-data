...
> Wait, let me verify whether other adult dosing regimens appear in the provided sources. I initially thought I saw an 8 mg three times daily regimen, but hold on, I should double-check that. On review, the only other adult dosing pattern I can substantiate is 8 mg twice daily; I do not find a validated 8 mg three times daily adult regimen in the supplied references, so I should correct that assumption and anchor on 8 mg twice daily as the evidence-based adult dose here [^1125tF9X] [^1125tF9X].

> Next, I should review duration and whether it is fixed or indication-dependent. The trial protocol specifies 10 days of therapy, which aligns with a short, acute treatment course rather than chronic maintenance, so I will keep the duration at 10 days unless a different indication-based regimen is supported by other data in this packet, which I do not see here [^1125tF9X] [^1125tF9X].
