...
The given expression is an exact differential because it satisfies the condition (\\frac{\\partial M}{\\partial y} = \\frac{\\partial N}{\\partial x}), where (M = y(e^{xy} + 6)) and (N = x(e^{xy} + 6)). The potential function is (f(x, y) = e^{xy} + 6xy + C), where (C) is an arbitrary constant.
...
[
M(x, y) = y(e^{xy} + 6) \\quad \\text{and} \\quad N(x, y) = x(e^{xy} + 6)
]

Compute the partial derivatives:

[
\\frac{\\partial M}{\\partial y} = \\frac{\\partial}{\\partial y} \\left[y(e^{xy} + 6) \\right] = e^{xy} + 6 + xy e^{xy}
]

[
\\frac{\\partial N}{\\partial x} = \\frac{\\partial}{\\partial x} \\left[x(e^{xy} + 6) \\right] = e^{xy} + 6 + xy e^{xy}
]

Since (\\frac{\\partial M}{\\partial y} = \\frac{\\partial N}{\\partial x}), the differential is exact.
...
[
f(x, y) = \\int M(x, y), dx = \\int y(e^{xy} + 6), dx = e^{xy} + 6xy + g(y)
]
...
[
\\frac{\\partial f}{\\partial y} = x e^{xy} + 6x + g'(y) = x(e^{xy} + 6)
]
