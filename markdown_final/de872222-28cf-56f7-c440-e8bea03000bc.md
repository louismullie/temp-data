...
> I will now examine the most specific available code. The closest, clinically appropriate ICD-10-CM code is L81.7, which corresponds to "pigmented purpuric dermatosis". This umbrella term encompasses Schamberg disease, Majocchi purpura, and other variants, and is the standard code used when the specific eponym is not explicitly listed in ICD-10-CM.
