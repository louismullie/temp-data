...
Graphs show higher usage codes, defined as those accounting for >1% (A), and lower usage codes, defined as those accounting for <1% of patients (B), presented in total and by year following the introduction of ICD-10. In panel A, there were 9 codes (2.1%) each for 2015, 2016, and 2017; 7 (1.6%) each for 2018 and 2019; and 6 (1.4%) each for 2020 and 2021. There was no statistically significant change in utilization of higher-usage codes from one year to the next following the introduction of ICD-10 (P =.94).
