...
While designing a high-resolution transmission electron microscope operating at an accelerating voltage of 1000 kV, Mike connected vacuum pumps to create an ultra-high vacuum state (< 10⁻⁹ Torr) in the sample compartment, aiming to minimize the presence of gas molecules for improved electron microscopy. However, as expected, some gas particles remained inside the compartment, as detected by the mass spectrometer. Mike accurately determined the mean free path of these gas molecules in the vacuum state (< 10⁻⁹ Torr) to be λ1, based on factors such as sample compartment volume, pressure, and temperature. However, upon initiating the electron beam, he made an intriguing observation concerning the mean free path based on electron scattering with the gas molecules. He found that the mean free path was no longer equal to λ1; rather, it was λ2, even though the sample compartment temperature remained the same.
...
> Let me first confirm the definitions. λ1 is the gas–gas mean free path, which depends on the number density of gas molecules and the collision cross-section between neutral gas molecules; at a given temperature, λ1 is inversely proportional to pressure, so at < 10⁻⁹ Torr, λ1 is very long, on the order of kilometers, which is why ultra-high vacuum is used to minimize gas scattering in TEM. Wait, let me verify that scale: yes, for air at room temperature, λ1 is roughly 1 km at 10⁻⁹ Torr, so the exact value is large but the key point is that λ1 is determined by neutral–neutral collisions and scales inversely with pressure.

> Now, λ2 is the electron–gas mean free path, which depends on the electron scattering cross-section with gas atoms or molecules and the gas number density. Importantly, λ2 is not the same as λ1 because the interaction cross-sections are fundamentally different: electrons interact via Coulomb and inelastic scattering processes that are not governed by the same hard-sphere or Lennard-Jones potentials that determine neutral–neutral collisions. Hold on, I should verify that the question is indeed asking about electron–gas scattering rather than gas–gas scattering; yes, the prompt explicitly says "mean free path based on electron scattering with the gas molecules", so λ2 reflects electron–gas interactions, not gas–gas collisions.
...
> Final answer: λ2 < λ1, because electron–gas scattering cross-sections are larger than gas–gas collision cross-sections, so the electron mean free path is shorter than the neutral gas mean free path at the same pressure and temperature. Therefore, the correct choice is A.
...
For gas molecules, the mean free path λ1 is determined by the **number density of gas molecules** and the collision cross-section between gas molecules. At ultra-high vacuum (< 10⁻⁹ Torr), the number density of gas molecules is extremely low, resulting in a very long mean free path. For example, at 10⁻⁹ Torr and room temperature, the mean free path of air molecules is approximately 1.3 km. This long mean free path is why ultra-high vacuum is essential in electron microscopy, as it minimizes unwanted collisions between gas molecules and the electron beam.
...
### Multiple proteins differing between laboratory stocks of mammalian orthoreoviruses affect both virus sensitivity to interferon and induction of interferon production during infection [^111S75EA]. Virus Research (2018). Low credibility.
...
### Ageing and brain white matter structure in 3, 513 UK biobank participants [^117MH34X]. Nature Communications (2016). Medium credibility.
...
### The role of macrophage IL-10 / innate IFN interplay during virus-induced asthma [^113oqPNo]. Reviews in Medical Virology (2015). Low credibility.
...
### Molecular sociology of virus-induced cellular condensates supporting reovirus assembly and replication [^112LEHB5]. Nature Communications (2024). High credibility.
...
### Resection of cerebellar tumours causes widespread and functionally relevant white matter impairments [^1163UAsu]. Human Brain Mapping (2021). Medium credibility.
...
### Microstructure assessment of the thalamus in Wilson's disease using diffusion tensor imaging [^114cnTaf]. Clinical Radiology (2014). Low credibility.
...
### Altered fornix integrity is associated with sleep apnea-related hypoxemia in mild cognitive impairment [^1175Z9Hy]. Alzheimer's & Dementia (2024). Medium credibility.
...
### A pathway linking reward circuitry, impulsive sensation-seeking and risky decision-making in young adults: identifying neural markers for new interventions [^1115371w]. Translational Psychiatry (2017). Low credibility.
...
### Bile acids drive the newborn's gut microbiota maturation [^113qXqK5]. Nature Communications (2020). High credibility.
...
### Product lambda-doublet ratios as an imprint of chemical reaction mechanism [^116zVBkf]. Nature Communications (2016). Medium credibility.
...
### AMPK is a mechano-metabolic sensor linking cell adhesion and mitochondrial dynamics to myosin-dependent cell migration [^111dtA1n]. Nature Communications (2023). High credibility.
...
### Comparative analysis of the antiviral effects mediated by type I and III interferons in hepatitis B virus-infected hepatocytes [^112odBXg]. The Journal of Infectious Diseases (2019). Medium credibility.
...
### Genotype specific pathogenicity of hepatitis E virus at the human maternal-fetal interface [^115X7Cau]. Nature Communications (2018). Medium credibility.
...
### Diffusion tensor imaging combined with chemical shift-encoded sequence to quantify the adaptive changes of calf muscles in amateur marathoners [^114TxTLF]. European Journal of Radiology (2024). Medium credibility.
...
### Enterovirus D68 vRNA induces type III IFN production via MDA5 [^111VrXFT]. Virus Research (2024). Medium credibility.
...
### Effect of exogenous interferons on rhinovirus replication and airway inflammatory responses [^113CcQNt]. Annals of Allergy, Asthma & Immunology (2013). Low credibility.
...
### Stability of synchronization in simplicial complexes [^116UJ5Eb]. Nature Communications (2021). High credibility.
...
### Expression of type III interferons (IFN λ s) and their receptor in Sjögren's syndrome [^117LLkwa]. Clinical and Experimental Immunology (2016). Low credibility.
...
### Changes in diffusion tensor imaging (DTI) eigenvalues of skeletal muscle due to hybrid exercise training [^113WKQgf]. Magnetic Resonance Imaging (2014). Low credibility.
...
### Anti-tumor immunity elicited by direct intratumoral administration of a recombinant adenovirus expressing either IL-28A / IFN-λ 2 or IL-29 / IFN-λ 1 [^112TE9Qd]. Cancer Gene Therapy (2016). Low credibility.
...
### Importance of screening severe COVID-19 patients for IFN-λ 1, IL-6 and anti-S1 IgG levels [^1133RNe1]. Cytokine (2023). Medium credibility.
...
### Enterovirus D68 vRNA induces type III IFN production via MDA5 [^117KYDJK]. Virus Research (2024). Medium credibility.

Fig. 3
EV-D68 viral RNA transfection stimulates type III interferon expression. EV-D68 at 0.1, 2,… 40 M.O. I. was used to infect Calu-3 cells for 12 h postinfection. The RNA expression levels of IFN-λ1, IFN-λ2/3, and EV-D68 5′ UTR was detected by RT‒qPCR (A). Calu-3 cells were infected with EV-D68 or UV-inactivated EV-D68 at an M.O. I. of 2 for 12 h postinfection. The EV-D68 5′ UTR, IFN-λ1, and IFN-λ2/3 were detected by RT‒qPCR (B). Calu-3 cells were transfected with 1 μg of RD RNA or EV-D68 viral RNA. Total RNA was collected at 12 h postinfection, and the expression of EV-D68 5′ UTR, IFN-λ1 and IFN-λ2/3 was analyzed by RT‒qPCR (C). LF2K (Lipofectamine 2000) serves as a control for transfection. Data are expressed as the mean value ± SD (*, p < 0.05, **, p < 0.01, **, p < 0.001, Student's t-test).

---

### Proteomic profiling of neonatal herpes simplex virus infection on dried blood spots [^115iwnwY]. Communications Medicine (2024). Medium credibility.
...
### Simplicial models of social contagion [^112J6Mi3]. Nature Communications (2019). High credibility.
...
### Effects of prolonged sitting with or without elastic garments on limb volume, arterial blood flow, and muscle oxygenation [^114DUnEx]. Medicine and Science in Sports and Exercise (2022). Medium credibility.
...
### Breast MRI during lactation: effects on tumor conspicuity using dynamic contrast-enhanced (DCE) in comparison with diffusion tensor imaging (DTI) parametric maps [^116ZBb8T]. European Radiology (2020). Medium credibility.
...
### Hsa-miR-2113-5p is not a key indicator for coronary artery disease: a case-controlled observational study [^114G2z4U]. Laboratory Medicine (2025). Medium credibility.
...
### Entecavir-induced interferon-λ 1 suppresses type 2 innate lymphoid cells in patients with hepatitis B virus-related liver cirrhosis [^113r3NCX]. Journal of Viral Hepatitis (2021). Medium credibility.
...
### Improvement of immune dysregulation in individuals with long COVID at 24-months following SARS-CoV-2 infection [^111LNept]. Nature Communications (2024). High credibility.
...
### An analytical theory of balanced cellular growth [^113f3UMm]. Nature Communications (2020). High credibility.
...
### Family history of neurodegenerative and vascular diseases in ALS: a population-based study [^111q4hHM]. Neurology (2011). Low credibility.
...
### Pathogenesis and transmission of SARS-CoV-2 D614G, alpha, gamma, delta, and omicron variants in golden hamsters [^117TQsBf]. Npj Viruses (2025). Medium credibility.
...
### Dynamical regimes of diffusion models [^112qMRVB]. Nature Communications (2024). High credibility.
...
### Innate immune responses to rhinovirus are reduced by the high-affinity IgE receptor in allergic asthmatic children [^113ezzth]. The Journal of Allergy and Clinical Immunology (2012). Low credibility.
...
### Modularity and stability in ecological communities [^116GRCXD]. Nature Communications (2016). Medium credibility.
...
### Human primary airway epithelial cells isolated from active smokers have epigenetically impaired antiviral responses [^117F9WPA]. Respiratory Research (2016). Low credibility.
...
### Three questions to ask before using model outputs for decision support [^116LHnXj]. Nature Communications (2020). High credibility.
...
### Mutualism supports biodiversity when the direct competition is weak [^111gFCSR]. Nature Communications (2017). Medium credibility.
...
### KDIGO 2021 clinical practice guideline for the management of blood pressure in chronic kidney Disease [^114DXBdP]. Kidney International (2021). High credibility.
...
### Structure and function of a neocortical synapse [^113xcJR9]. Nature (2021). Excellent credibility.
...
### Theoretically meaningful models can answer clinically relevant questions [^117FgVqm]. Brain (2019). Medium credibility.
...
### Model-free decision-making underlies motor errors in rapid sequential movements under threat [^113eZsTi]. Communications Psychology (2024). Medium credibility.
...
### Rapid, systematic updating of movement by accumulated decision evidence [^112M3pgM]. Nature Communications (2024). High credibility.
...
### Measuring the effects of particle orientation to improve the efficiency of electron cryomicroscopy [^116yZEQ3]. Nature Communications (2017). Medium credibility.
...
### Fluctuation-learning relationship in recurrent neural networks [^114zbpwP]. Nature Communications (2025). High credibility.
...
### Mutualism supports biodiversity when the direct competition is weak [^116aX5dB]. Nature Communications (2017). Medium credibility.
...
### KDIGO 2024 clinical practice guideline for the evaluation and management of chronic kidney disease [^116qsBjD]. Kidney International (2024). High credibility.
...
### COVID-19 epidemiology during delta variant dominance period in 45 high-income countries, 2020–2021 [^1134vf6P]. Emerging Infectious Diseases (2023). Medium credibility.
...
### Reconciling time and prediction error theories of associative learning [^117YTxxv]. Nature Communications (2025). High credibility.
...
### Ptychographic electron microscopy using high-angle dark-field scattering for sub-nanometre resolution imaging [^117EpG5q]. Nature Communications (2012). Medium credibility.
...
### Selecting fitted models under epistemic uncertainty using a stochastic process on quantile functions [^112yfpvx]. Nature Communications (2025). High credibility.
...
### Non-diffracting multi-electron vortex beams balancing their electron-electron interactions [^113aNn58]. Nature Communications (2017). Medium credibility.
...
### Transmission electron microscope (TEM) [^114V7qUu]. CDC (2024). Medium credibility.
...
### Exploring the biological hallmarks of cancer of unknown primary: where do we stand today? [^114Yid6D]. British Journal of Cancer (2020). Medium credibility.
...
### Technology readiness levels for machine learning systems [^112oNqdz]. Nature Communications (2022). High credibility.
...
### Direct imaging of electron density with a scanning transmission electron microscope [^116A9Lm6]. Nature Communications (2023). High credibility.
...
### Neighborhood characteristics and mental health from childhood to adolescence [^1114XwFo]. JAMA Network Open (2025). High credibility.
...
### Probing the symmetry of the potential of localized surface plasmon resonances with phase-shaped electron beams [^114i6zz5]. Nature Communications (2017). Medium credibility.
...
### Dynamically primed synaptic vesicle States: key to understand synaptic short-term plasticity [^115ZvUg6]. Neuron (2018). Low credibility.
...
### Controlling the pandemic during the SARS-CoV-2 vaccination rollout [^115FsmfQ]. Nature Communications (2021). High credibility.
...
### Full-field structured-illumination super-resolution X-ray transmission microscopy [^114wQwDt]. Nature Communications (2019). High credibility.
