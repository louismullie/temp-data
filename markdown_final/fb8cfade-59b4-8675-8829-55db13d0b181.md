...
- **Efficacy**: NSAIDs are highly effective for acute gout flares, providing rapid pain relief and reducing inflammation [^116qMxjN].
- **Safety**: NSAIDs have a higher risk of gastrointestinal adverse events compared to COX-2 inhibitors; consider gastroprotection (PPIs) in patients at risk [^116qMxjN] [^112iwfhS].
...
- **Efficacy**: Low-dose colchicine (1.2 mg followed by 0.6 mg one hour later) is effective and has fewer adverse effects than high-dose regimens [^112kpWS7] [^1135R2x9].
- **Safety**: Gastrointestinal side effects (nausea, diarrhea) are common but generally mild; avoid in severe renal or hepatic impairment and with strong CYP3A4 or P-gp inhibitors [^114WSd67].
- **Timing**: Initiate within 12 hours of flare onset for optimal efficacy [^1139UKZq].

---

### Glucocorticoids

- **Efficacy**: Oral, intra-articular, or intramuscular glucocorticoids are effective alternatives, particularly when NSAIDs or colchicine are contraindicated [^1137Cqjh] [^116vxpQt].
- **Safety**: Short-term use is generally safe; monitor for hyperglycemia, hypertension, and infection risk [^notfound].
- **Intra-articular injection**: Useful for monoarticular flares, providing rapid local relief [^116eZv8m].

---

## Clinical considerations and patient-specific factors

- **Comorbidities**: Choose therapy based on renal, hepatic, cardiovascular, and gastrointestinal conditions [^115S2gLD].
- **Patient preference**: Engage in shared decision-making to improve adherence and satisfaction [^116D1smR].
...
- **Ice application**: Topical ice can reduce pain and inflammation [^112kpWS7].
- **Prophylaxis**: Use low-dose colchicine or NSAIDs during ULT initiation to prevent flares [^113GgTZp] [^113UXfU7].
- **IL-1 inhibitors**: Consider for refractory flares or when standard therapies are contraindicated [^116TNCvZ] [^112ZXcoP].
...
NSAIDs, colchicine, and glucocorticoids are **first-line therapies** for acute gout flares, with selection individualized to comorbidities, patient preference, and timing of onset [^1137Cqjh] [^116V858N].
...
### Nonsteroidal anti-inflammatory drugs for treatment of acute gout [^112fhVor]. JAMA (2015). Excellent credibility.
...
### Initiation of febuxostat for acute gout flare does not prolong the current episode: a randomized clinical trial [^111d2qs4]. Rheumatology (2021). Medium credibility.
...
### Difficult-to-treat gout flares: eligibility for interleukin-1 inhibition in private practice is uncommon according to current EMA approval [^112mPUVP]. Rheumatology (2019). Medium credibility.
...
### Initiation of febuxostat for acute gout flare does not prolong the current episode: a randomized clinical trial [^111CCUfh]. Rheumatology (2021). Medium credibility.
...
### Progress in the pharmacotherapy of gout [^113fB3tK]. Current Opinion in Rheumatology (2010). Low credibility.
