...
> Let me synthesize a balanced recommendation. Yes, pioglitazone can be used with insulin in appropriately selected adults with type 2 diabetes who have persistent hyperglycemia on insulin, particularly if insulin resistance is prominent, provided there is no heart failure or high risk for fluid overload, and after discussing weight gain, edema, fracture risk, and the need for proactive insulin dose adjustments. In patients with established CVD or high risk, consider GLP-1 RAs or SGLT2 inhibitors first-line and reserve pioglitazone as an adjunct when additional A1C lowering is needed and safety screening is acceptable [^1161DrvX] [^115pqhqr].
