...
> Let me first confirm the problem setup. We want to optimize f(x, y, z) = x² + 2y² + 3z² on the unit sphere defined by g(x, y, z) = x² + y² + z² − 1 = 0. This is a classic constrained optimization problem, and the method of Lagrange multipliers is appropriate here [^notfound].
