...
8th Swedish 1968 Problem 1 Find the maximum and minimum values of x 2 + 2y 2 + 3z 2 for real x, y, z satisfying x 2 + y 2 + z 2 = 1.
...
The maximum value of (x^2 + 2y^2 + 3z^2) subject to (x^2 + y^2 + z^2 = 1) is **3**, achieved when ((x, y, z) = (0, 0, \\pm 1)). The minimum value is **1**, achieved when ((x, y, z) = (\\pm 1, 0, 0)). These results follow from the method of Lagrange multipliers, which shows that the extrema occur at points where the gradient of the objective function is parallel to the gradient of the constraint, i.e. where (\\nabla f = \\lambda \\nabla g) [^b0d02f80].
...
- **Case 1**: (x \\neq 0), (y = 0), (z = 0). This implies (\\lambda = 1).
- **Case 2**: (y \\neq 0), (x = 0), (z = 0). This implies (\\lambda = 2).
- **Case 3**: (z \\neq 0), (x = 0), (y = 0). This implies (\\lambda = 3).

---

## Substituting back into the constraint

We now substitute each case back into the constraint (x^2 + y^2 + z^2 = 1) to find the specific points:

- **Case 1**: (x^2 = 1 \\Rightarrow x = \\pm 1). The points are ((\\pm 1, 0, 0)).
- **Case 2**: (y^2 = 1 \\Rightarrow y = \\pm 1). The points are ((0, \\pm 1, 0)).
- **Case 3**: (z^2 = 1 \\Rightarrow z = \\pm 1). The points are ((0, 0, \\pm 1)).
...
|-|-|-|
| 1 | (± 1, 0, 0) | (1^2 + 2(0)^2 + 3(0)^2 = 1) |
| 2 | (0, ± 1, 0) | (0^2 + 2(1)^2 + 3(0)^2 = 2) |
| 3 | (0, 0, ± 1) | (0^2 + 2(0)^2 + 3(1)^2 = 3) |
...
- The **maximum value** of (x^2 + 2y^2 + 3z^2) is **3**, achieved at the points ((0, 0, \\pm 1)).
- The **minimum value** of (x^2 + 2y^2 + 3z^2) is **1**, achieved at the points ((\\pm 1, 0, 0)).

---

The maximum value of (x^2 + 2y^2 + 3z^2) subject to (x^2 + y^2 + z^2 = 1) is **3**, and the minimum value is **1**.
