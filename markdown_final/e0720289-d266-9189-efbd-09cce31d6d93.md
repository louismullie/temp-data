...
> Let me first confirm the clinical context. Schizoaffective disorder spans psychotic and affective symptoms, and treatment often requires antipsychotic coverage plus mood stabilization or antidepressant augmentation depending on subtype, which makes antidepressant use common in real-world care even though high-quality schizoaffective-specific trials are sparse, so I need to be careful not to overgeneralize from schizophrenia or bipolar data [^a8bb1979] [^4a6283b2].
