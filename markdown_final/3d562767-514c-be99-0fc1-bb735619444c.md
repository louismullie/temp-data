...
> Next, I should review the essential first-line tests that repeatedly appear across authoritative sources. The CDC recommends CBC with differential, ESR or CRP, a comprehensive metabolic panel including electrolytes, fasting glucose, renal function, and calcium/phosphate, TSH with free T4, iron studies (serum iron, transferrin saturation, ferritin), celiac screening with tissue transglutaminase IgA and total IgA, and urinalysis; these are echoed in primary care guidance and align with the principle of excluding common, treatable causes of fatigue [^5726d8be] [^a6af3413]. I should double-check that these are the minimal set most clinicians agree on before labeling fatigue as unexplained or considering ME/CFS, and yes, this is consistent with contemporary primary care and CDC guidance [^5726d8be] [^a6af3413].
