...
> Let me first confirm the clinical context. "Arthritis" in most treatment questions refers primarily to osteoarthritis of the knee, hip, and hand, but I should not conflate this with inflammatory arthritides such as rheumatoid arthritis or axial spondyloarthritis, where NSAIDs are adjuncts rather than disease-modifying monotherapy; guidelines for OA emphasize NSAIDs as first-line pharmacologic therapy, whereas in RA and axial spondyloarthritis NSAIDs are used for symptom control alongside DMARDs or as first-line for axial pain, respectively [^116qRMqb] [^1136kqYA] [^115YX5cL].
