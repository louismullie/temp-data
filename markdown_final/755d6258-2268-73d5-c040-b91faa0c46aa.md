...
### CTLA-4 expression by B-1a B cells is essential for immune tolerance [^115PsD6e]. Nature Communications (2021). High credibility.
...
### Ideological differences in the expanse of the moral circle [^1168Vu5u]. Nature Communications (2019). High credibility.
...
### Sensory experience modulates the reorganization of auditory regions for executive processing [^117K67b8]. Brain (2022). Medium credibility.
...
### Using geometry for the dorsiflexory wedge osteotomy of the first metatarsal [^111f5mEi]. The Journal of Foot and Ankle Surgery (2014). Low credibility.
...
### Dissociation of self and mother-related processing in abstinent heroin misusers [^116V1z2m]. Translational Psychiatry (2025). Medium credibility.
...
### Population coding of shape in area V4 [^116NVcwP]. Nature Neuroscience (2002). Medium credibility.
...
### Macular hole morphology and measurement using an automated three-dimensional image segmentation algorithm [^113yHrPA]. BMJ Open Ophthalmology (2020). High credibility.
...
### Integration of grid maps in merged environments [^117F6iGy]. Nature Neuroscience (2018). Medium credibility.
...
### Cranial base growth and morphology in second-trimester normal human fetuses and fetuses with cleft lip [^1158Kr42]. The Cleft Palate-Craniofacial Journal (2001). Low credibility.
...
### Assessing changes in incubation period, serial interval, and generation time of SARS-CoV-2 variants of concern: a systematic review and meta-analysis [^1168si87]. BMC Medicine (2023). Medium credibility.
...
### Large-area patterning of full-color quantum dot arrays beyond 1, 000 pixels per inch by selective electrophoretic deposition [^114pMdcc]. Nature Communications (2021). High credibility.
...
### Polygonal non-wetting droplets on microtextured surfaces [^114mRhgF]. Nature Communications (2022). High credibility.
...
### A novel approach to surgical markings based on a topographic map and a projected three-dimensional image [^114cWfSD]. Plastic and Reconstructive Surgery (2016). Low credibility.
...
### Efficacy evaluation of hyaluronic acid gel for the restoration of gingival interdental papilla defects [^116ouKX8]. Journal of Oral and Maxillofacial Surgery (2019). Medium credibility.
...
### KDOQI clinical practice guideline for hemodialysis adequacy: 2015 update [^113DP7W4]. American Journal of Kidney Diseases (2015). Medium credibility.
...
### The nutritional geometry of liver disease including non-alcoholic fatty liver disease [^115Z1a77]. Journal of Hepatology (2018). Low credibility.
...
### Underlying principles of visual shape selectivity in posterior inferotemporal cortex [^1126w4Lw]. Nature Neuroscience (2004). Medium credibility.
...
### Hippocampal spatial representations exhibit a hyperbolic geometry that expands with experience [^113YMJyd]. Nature Neuroscience (2023). High credibility.
...
### Combinatorial discovery of microtopographical landscapes that resist biofilm formation through quorum sensing mediated autolubrication [^111u85MN]. Nature Communications (2025). High credibility.
...
### Room temperature multi-phonon upconversion photoluminescence in monolayer semiconductor WS [^11381Aj9]. Nature Communications (2019). High credibility.
...
### Stiffness-switchable DNA-based constitutional dynamic network hydrogels for self-healing and matrix-guided controlled chemical processes [^112d4Chx]. Nature Communications (2019). High credibility.
...
### Topographically driven vigorous vertical mixing supports mesoscale biological production in the tsugaru gyre [^1174TEEu]. Nature Communications (2025). High credibility.
...
### Multilayer block copolymer meshes by orthogonal self-assembly [^114qTWRZ]. Nature Communications (2016). Medium credibility.
...
### Accuracy of left ventricular cavity volume and ejection fraction for conventional estimation methods and 3D surface fitting [^1137nu1k]. Journal of the American Heart Association (2019). Medium credibility.
...
### Comprehensive view of microscopic interactions between DNA-coated colloids [^112FzSZF]. Nature Communications (2022). High credibility.
...
### Improving fragment-based ab initio protein structure assembly using low-accuracy contact-map predictions [^1112DATT]. Nature Communications (2021). High credibility.
...
### Humorous peer play and social understanding in childhood [^114S3smS]. Communications Psychology (2025). Medium credibility.
...
### High-sensitive spatially resolved T cell receptor sequencing with SPTCR-seq [^117YDvjW]. Nature Communications (2023). High credibility.
...
### Indexing glomerular filtration rate to suit children [^111r3mPV]. Journal of Nuclear Medicine (2003). Low credibility.
...
### Programmable design of isothermal nucleic acid diagnostic assays through abstraction-based models [^1176RCMf]. Nature Communications (2022). High credibility.
