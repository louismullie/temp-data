...
- **Dosage**: 90 mg/kg/day of the amoxicillin component, with 6.4 mg/kg/day of clavulanate, divided into 2 daily doses (14:1 ratio) [^114HRxCA] [^112PEiiR].
- **Duration**: 10 days [^1135fz6j].
- **Indication**: First-line after failure of standard-dose amoxicillin-clavulanate, providing enhanced coverage against beta-lactamase–producing organisms and resistant Streptococcus pneumoniae [^114HRxCA] [^111f53kK].

---

### Ceftriaxone

- **Dosage**: 50 mg/kg IM or IV once daily for 1–3 days [^114HRxCA].
- **Indication**: Use if there is no improvement after 48–72 hours of high-dose amoxicillin-clavulanate, or when adherence to oral therapy is uncertain [^115y988r].
- **Evidence**: A 3-day course is superior to 1 day for persistent AOM [^115y988r].

---

### Tympanocentesis with specialist consultation

Tympanocentesis with specialist consultation is indicated for **persistent failure after 2–3 antibiotic courses** or when **severe infection** is present. It enables pathogen identification and susceptibility testing to guide therapy [^111a7pz8].
...
| Macrolides (azithromycin, clarithromycin) | Azithromycin: 10 mg/kg/day × 3 days | Penicillin allergy | Higher failure rates; not recommended unless no alternatives [^11587PSf] |

---

## Clinical assessment and follow-up

Reassess within **48–72 hours** after changing therapy to confirm improvement in symptoms and otoscopic findings [^116ZUjvu]. Ensure adherence to therapy and address any barriers, as nonadherence is a common cause of treatment failure [^113tSKY3]. Provide analgesia with acetaminophen or ibuprofen to manage pain and fever [^114DqTAM].

---

## Factors influencing antibiotic selection

- **Age**: Younger children (< 2 years) generally require more aggressive therapy due to higher risk of complications [^1135fz6j].
- **Severity**: Severe symptoms (high fever, severe otalgia) warrant prompt escalation [^116na4A4].
- **Allergy**: True penicillin allergy guides alternative antibiotic selection [^1155Vw1L].
...
### Diagnosis and management of acute otitis media… [^113HixDQ]. publications.aap.org (2025). Medium credibility.
...
### Azithromycin [^115SJS3E]. FDA (2025). Medium credibility.
...
### Cefdinir vs. amoxicillin / clavulanic acid in the treatment of suppurative acute otitis media in children [^114X7t59]. The Pediatric Infectious Disease Journal (2000). Low credibility.
