...
x² − (tan θ + i)x + i(2i − 1) = 0 (θ ∈ R).
(1) If this equation has 1 real root, find the value of the acute angle θ;
(2) For any real number θ, prove: this equation cannot have a purely imaginary root.
...
- **Real part**: (−y² + y − 2 = 0)
- **Imaginary part**: (−y tan θ − 3 = 0)

The real part is a quadratic in (y):

−y² + y − 2 = 0 ⇒ y² − y + 2 = 0

The discriminant is (D = (−1)² − 4(1)(2) = 1 − 8 = −7 < 0), so there is **no real solution** for (y). Thus, the equation cannot have a purely imaginary root for any real (θ).

---

The acute angle for exactly one real root is (θ = π/4), and the equation **cannot have a purely imaginary root** for any real (θ).
...
### Using sigLASSO to optimize cancer mutation signatures jointly with sampling likelihood [^111KVzom]. Nature Communications (2020). High credibility.
...
### An analytical theory of balanced cellular growth [^116zf4Lw]. Nature Communications (2020). High credibility.
...
### The challenges of containing SARS-CoV-2 via test-trace-and-isolate [^111jHKU2]. Nature Communications (2021). High credibility.
...
### Neurons exploit stochastic growth to rapidly and economically build dense dendritic arbors [^115Nrvx8]. Nature Communications (2025). High credibility.
...
### A theory of evolutionary dynamics on any complex population structure reveals stem cell niche architecture as a spatial suppressor of selection [^111zLF48]. Nature Communications (2024). High credibility.
...
### A tutorial introduction to inverse problems in magnetic resonance [^1164r3QH]. NMR in Biomedicine (2020). Medium credibility.
...
### Demography and the emergence of universal patterns in urban systems [^112QFg9J]. Nature Communications (2020). High credibility.
...
### Effects of social distancing and isolation on epidemic spreading modeled via dynamical density functional theory [^116CsLv8]. Nature Communications (2020). High credibility.
...
### Data-driven control of complex networks [^114ReChf]. Nature Communications (2021). High credibility.
...
### To infinity and some glimpses of beyond [^111Q8fda]. Nature Communications (2017). Medium credibility.
...
### Normal tissue radiobiology: from the laboratory to the clinic [^116WLCYX]. International Journal of Radiation Oncology, Biology, Physics (2001). Low credibility.
...
### Energy scaling of targeted optimal control of complex networks [^116nj8TK]. Nature Communications (2017). Medium credibility.
...
### Effects of changing population or density on urban carbon dioxide emissions [^111CaTPT]. Nature Communications (2019). High credibility.
...
### Incorporating functional genomic information in genetic association studies using an empirical bayes approach [^1148VWdN]. Genetic Epidemiology (2016). Low credibility.
...
### Drug regimens identified and optimized by output-driven platform markedly reduce tuberculosis treatment time [^112NoRzm]. Nature Communications (2017). Medium credibility.
...
### Non-linear relationships in clinical research [^113usJyh]. Nephrology, Dialysis, Transplantation (2025). Medium credibility.
...
### Modeling control strategies of respiratory pathogens [^111M4m7e]. Emerging Infectious Diseases (2005). Low credibility.
...
### Multi-modal synergistic PET and MR reconstruction using mutually weighted quadratic priors [^1161bCWT]. Magnetic Resonance in Medicine (2019). Medium credibility.
...
### An intermolecular FRET sensor detects the dynamics of T cell receptor clustering [^111wwiZC]. Nature Communications (2017). Medium credibility.
...
### An analytical solution to the dispersion-by-inversion problem in magnetic resonance elastography [^111KWmkw]. Magnetic Resonance in Medicine (2020). Medium credibility.
...
### Modeling and measurement of lead tip heating and resonant length for implanted, insulated wires [^117Jrzji]. Magnetic Resonance in Medicine (2024). Medium credibility.
...
### Epinephrine 0.15 pediatrics [^1115gC4Q]. FDA (2024). Medium credibility.
...
### Re-evaluation of quadratic and exponential models of litter accumulation incorporating climatic and species-specific dependence [^115enVYQ]. Nature Communications (2025). High credibility.
...
### Nonlinear magnitude and linear phase behaviors of T2✱ imaging: theoretical approximation and monte carlo simulation [^1146A4E5]. Magnetic Resonance Imaging (2015). Low credibility.
...
### Analog optical computer for AI inference and combinatorial optimization [^113NiGRa]. Nature (2025). Excellent credibility.
...
### The eighty five percent rule for optimal learning [^113aTYjX]. Nature Communications (2019). High credibility.
...
### Minimum-phase property of the hemodynamic response function, and implications for granger causality in fMRI [^113uy1oQ]. Human Brain Mapping (2025). Medium credibility.
...
### Nonlinear deltaR*2 effects in perfusion quantification using bolus-tracking MRI [^111Y75T2]. Magnetic Resonance in Medicine (2009). Low credibility.
...
### Linear quadratic gaussian-based closed-loop control of type 1 diabetes [^114PsSXC]. Journal of Diabetes Science and Technology (2007). Low credibility.
...
### Motion-corrected MRI with DISORDER: distributed and incoherent sample orders for reconstruction deblurring using encoding redundancy [^115Tx79D]. Magnetic Resonance in Medicine (2020). Medium credibility.
...
### Linear regression in medical research [^114hy2xH]. Anesthesia and Analgesia (2021). Medium credibility.
...
### Substantial hysteresis in emergent temperature sensitivity of global wetland CHemissions [^116Ac1Cm]. Nature Communications (2021). High credibility.
...
### Ab-initio variational wave functions for the time-dependent many-electron schrödinger equation [^115cyx3f]. Nature Communications (2024). High credibility.
...
### NIPMAP: niche-phenotype mapping of multiplex histology data by community ecology [^113fo7jx]. Nature Communications (2023). High credibility.
...
### Geometrical uncertainties, radiotherapy planning margins, and the ICRU-62 report [^116RuKAQ]. Radiotherapy and Oncology (2002). Low credibility.
...
### EEG functional connectivity as a riemannian mediator: an application to malnutrition and cognition [^113oezHJ]. Human Brain Mapping (2024). Medium credibility.
...
### From a microscopic inertial active matter model to the schrödinger equation [^113SM3Tg]. Nature Communications (2023). High credibility.
...
### Deep learning for universal linear embeddings of nonlinear dynamics [^112GKjt2]. Nature Communications (2018). Medium credibility.
...
### The controversies and pitfalls in modeling normal tissue radiation injury / damage [^115atkAj]. Seminars in Radiation Oncology (2001). Low credibility.
...
### A mechanism for reversible mesoscopic aggregation in liquid solutions [^117LNq6s]. Nature Communications (2019). High credibility.
...
### Light-induced switching between singlet and triplet superconducting States [^116GNu6F]. Nature Communications (2024). High credibility.
...
### Artificial web of disclination lines in nematic liquid crystals [^113LMv9r]. Nature Communications (2017). Medium credibility.
...
### Emergent second law for non-equilibrium steady States [^115TRWTF]. Nature Communications (2022). High credibility.
...
### Nonlinear delay differential equations and their application to modeling biological network motifs [^115jRE1k]. Nature Communications (2021). High credibility.
...
### A mathematical study to select fractionation regimen based on physical dose distribution and the linear-quadratic model [^111Si3MA]. International Journal of Radiation Oncology, Biology, Physics (2012). Low credibility.
...
### Double-layer geodesic and gradient-index lenses [^117PMuK2]. Nature Communications (2022). High credibility.
...
### Recommendations for noninvasive evaluation of native valvular regurgitation: a report from the American Society of Echocardiography developed in collaboration with the Society for Cardiovascular Magnetic Resonance [^1172FHRv]. Journal of the American Society of Echocardiography (2017). Medium credibility.
...
### Wave kinetics of random fibre lasers [^112snUNZ]. Nature Communications (2015). Medium credibility.
...
### Non-linear predictor outcome associations [^111bgJA5]. BMJ Medicine (2023). High credibility.
...
### Optimized amplitude modulated multiband RF pulse design [^113fRtLR]. Magnetic Resonance in Medicine (2017). Low credibility.
...
### Matrix factorization from non-linear projections: application in estimating T2 maps from few echoes [^114iuvb6]. Magnetic Resonance Imaging (2015). Low credibility.
...
### Listing criteria for heart transplantation: International Society for Heart and Lung Transplantation guidelines for the care of cardiac transplant candidates – 2006 [^115jtaBZ]. The Journal of Heart and Lung Transplantation (2006). Medium credibility.
...
### High tip angle approximation based on a modified bloch-riccati equation [^112Ljo3Y]. Magnetic Resonance in Medicine (2012). Low credibility.
...
### A model for optimizing normal tissue complication probability in the spinal cord using a generalized incomplete repair scheme [^114SRazp]. Radiation Research (2001). Low credibility.
...
### Satralizumab (Enspryng) [^1111VJ37]. FDA (2025). Medium credibility.
...
### Primer on binary logistic regression [^1131BvXN]. Family Medicine and Community Health (2021). Medium credibility.
...
### A unique analytical solution of the white matter standard model using linear and planar encodings [^117AZJf4]. Magnetic Resonance in Medicine (2019). Medium credibility.
...
### A single inverse-designed photonic structure that performs parallel computing [^116D11An]. Nature Communications (2021). High credibility.
...
### Similarity and economy of scale in urban transportation networks and optimal transport-based infrastructures [^111ehxwq]. Nature Communications (2024). High credibility.
...
### Modeling and measurement of lead tip heating and resonant length for implanted, insulated wires [^111TK3A1]. Magnetic Resonance in Medicine (2024). Medium credibility.
...
### Denoising brain networks using a fixed mathematical phase change in independent component analysis of magnitude-only fMRI data [^116XJ13S]. Human Brain Mapping (2023). Medium credibility.
