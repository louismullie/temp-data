...
> Next, I should review how often complications occur. Let me consider population-level data first. A large California cohort showed a 32% cumulative complication rate at 5 years, with children experiencing higher rates than adults (48% vs 27%), indicating substantial long-term risk but also heterogeneity by age [^112QmGYT]. Hold on, I should verify shorter-term benchmarks too; a UK multicenter study found 30-day and 1-year failure rates of 12.9% and 28.8% for new shunts, respectively, aligning with other multicenter datasets and supporting the notion that roughly one in three shunts requires revision within a few years [^111gP5GN]. I need to check adult-specific series as well; an 8-year adult surveillance study reported 17.2% mechanical dysfunction and 6.1% infection, reinforcing that complications are common though not universal [^113FEmTM].
