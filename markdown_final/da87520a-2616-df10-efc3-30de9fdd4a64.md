...
> Next, I should review non-TNF biologics. Tocilizumab blocks the IL-6 receptor and is particularly useful in high inflammatory phenotypes and in patients who cannot tolerate methotrexate; abatacept inhibits T cell co-stimulation and is a good option in seronegative disease or when TNF inhibitors are contraindicated; rituximab depletes B cells and is effective after TNF failure or in the presence of autoantibodies, though it is less commonly used early due to infusion-related logistics and safety considerations [^ff2d481f] [^8c9bec39]. Let me reconsider the sequence: current guidance supports choosing among bDMARDs based on comorbidity, safety, and patient factors rather than a rigid hierarchy, reinforcing individualized selection [^ff2d481f].
