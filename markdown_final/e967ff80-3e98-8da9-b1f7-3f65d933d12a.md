...
> Hold on, let's not jump to conclusions; I should confirm the requirement for concomitant anti-inflammatory prophylaxis. The ACR issues a strong recommendation for concomitant anti-inflammatory prophylaxis when starting ULT, favoring colchicine, NSAIDs, or low-dose prednisone/prednisolone for at least 3–6 months, with extension if flares continue; this is a strong recommendation based on high-quality evidence showing reduced flare risk during ULT initiation and titration [^111RqG5r] [^112nYRP4] [^115sedX8].
