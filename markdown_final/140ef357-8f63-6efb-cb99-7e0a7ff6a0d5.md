...
> Next, I should review when and how to resume anticoagulation; for most patients with resolved LGIB and controlled source, restarting dabigatran within about 7 days is reasonable, but I need to coordinate with the treating cardiologist or neurologist to balance thrombotic risk against rebleeding, and in high thrombotic risk scenarios, bridging with LMWH may be considered if dabigatran is held longer, though evidence is limited and decisions should be individualized [^839b153d].
