...
> Next, I should review the magnitude of benefit, if any, from antibiotics in acute bronchitis. The Cochrane review shows a statistically significant but clinically trivial reduction in cough duration of about 0.46 days, with no improvement in overall clinical improvement or activity limitation, and with increased adverse effects, so the net clinical benefit is essentially zero for most patients [^111FGJZY] [^117ABtD6]. Hold on, I should double-check the harm signal; yes, adverse effects are more common with antibiotics, reinforcing a risk–benefit balance that favors no antibiotics in typical cases [^111FGJZY].
