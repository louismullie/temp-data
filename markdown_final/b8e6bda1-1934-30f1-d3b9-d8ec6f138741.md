...
In most cases, **VATS requires a chest tube** [^08a511bc] to drain air and fluid and to monitor for leaks, with typical use of one 24–28 Fr tube [^2ef4bee6] [^c8008487] and an average duration of 2–4 days [^d69f8d00]. However, in selected patients undergoing **wedge resection without air leak**, tubeless VATS is safe and feasible [^d2a450f8] [^bc650775], and smaller or alternative drains (e.g. 7–16 Fr) [^ef47e63f] [^4d34670e] can reduce pain and expedite recovery [^64ad92b2] [^9c227dae]. Chest tube use is individualized based on procedure, lung integrity, and patient factors, with ongoing efforts to optimize size, timing, and early removal within ERAS protocols [^f82b69b6] [^00952bce].
