...
> Wait, let me verify the rationale so I don't overstate it. Chest tubes are used to prevent pneumothorax, facilitate lung re-expansion, and allow quantification of air leaks and drainage; this is why even minimally invasive VATS programs continue to prioritize tube management within ERAS pathways, and why meta-analyses and systematic reviews of VATS outcomes consistently report chest tube duration as a key endpoint, underscoring its routine use in standard cases [^f82b69b6] [^08a511bc] [^95376897].
