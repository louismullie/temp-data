...
> Let me first confirm the lattice structure and distance metric. On a triangular grid, each vertex has 6 neighbors at 60-degree angles, and the natural distance is the minimum number of unit steps along grid lines; positions within 1 unit of the origin are the origin itself and its 6 immediate neighbors, totaling 7 positions, which I should explicitly list to avoid mistakes: (0,0), (1,0), (-1,0), (0.5, √3/2), (-0.5, √3/2), (0.5, -√3/2), (-0.5, -√3/2).
...
> Now I will derive the recurrence relations. From the origin, all 6 moves go to a neighbor, so aₙ₊₁ = 6bₙ; from a neighbor, 1 move returns to origin and 2 moves stay within the allowed neighbor set, so bₙ₊₁ = aₙ + 2bₙ; I should double-check that these relations reflect the 3 allowed moves from a neighbor and the 6 allowed moves from the origin, which they do.

> I will now compute step-by-step up to n = 5, keeping track of aₙ and bₙ. For n = 1: a₁ = 6×0 = 0, b₁ = 1 + 2×0 = 1; for n = 2: a₂ = 6×1 = 6, b₂ = 0 + 2×1 = 2; for n = 3: a₃ = 6×2 = 12, b₃ = 6 + 2×2 = 10; for n = 4: a₄ = 6×10 = 60, b₄ = 12 + 2×10 = 32; for n = 5: a₅ = 6×32 = 192, b₅ = 60 + 2×32 = 124; so total valid paths at n = 5 are 192 + 6×124 = 192 + 744 = 936.
...
Total valid paths after 5 moves: (a₅ + 6b₅ = 192 + 6 × 124 = 936).
...
### Are grid cells used for navigation? On local metrics, subjective spaces, and black holes [^115kqxMd]. Neuron (2023). Medium credibility.
...
### Incomplete influenza A virus genomes occur frequently but are readily complemented during localized viral spread [^111f8yeP]. Nature Communications (2019). High credibility.
...
### Experimental and theoretical model for the origin of coiling of cellular protrusions around fibers [^114Va1Sq]. Nature Communications (2023). High credibility.
...
### Memory of cell shape biases stochastic fate decision-making despite mitotic rounding [^114sfPY8]. Nature Communications (2016). Medium credibility.
...
### Altered grid-like coding in early blind people [^114mH123]. Nature Communications (2024). High credibility.
...
### Covalently-assembled single-chain protein nanostructures with ultra-high stability [^1127yNAv]. Nature Communications (2019). High credibility.
...
### Entorhinal grid-like codes and time-locked network dynamics track others navigating through space [^112J4pQM]. Nature Communications (2023). High credibility.
...
### Phase information is conserved in sparse, synchronous population-rate-codes via phase-to-rate recoding [^113h73eM]. Nature Communications (2023). High credibility.
...
### A scaling law for random walks on networks [^111rd2nn]. Nature Communications (2014). Medium credibility.
...
### Two simple movement mechanisms for spatial division of labour in social insects [^113L3CLh]. Nature Communications (2022). High credibility.
...
### The computational neurology of movement under active inference [^111ZB1nB]. Brain (2021). Medium credibility.
...
### Conserved linear dynamics of single-molecule brownian motion [^1158SUGC]. Nature Communications (2017). Medium credibility.
...
### Mouse tracking reveals structure knowledge in the absence of model-based choice [^112dJbHk]. Nature Communications (2020). High credibility.
...
### The computational neurology of movement under active inference [^116eiofA]. Brain (2021). Medium credibility.
...
### Statistical moments of quantum-walk dynamics reveal topological quantum transitions [^117EievY]. Nature Communications (2016). Medium credibility.
...
### Nanoscale visualization of functional adhesion / excitability nodes at the intercalated disc [^112WKJHw]. Nature Communications (2016). Medium credibility.
...
### Complex behavior from intrinsic motivation to occupy future action-state path space [^111ZJ4Dr]. Nature Communications (2024). High credibility.
...
### Collaborative strategy on bed bugs [^112buJ6d]. CDC (2015). Medium credibility.
...
### Collaborative strategy on bed bugs [^114DbyeT]. CDC (2015). Medium credibility.
...
### CoCASA version history… [^116F2eYs]. CDC (2025). Medium credibility.
...
### Wilderness Medical Society practice guidelines for prevention and management of avalanche and nonavalanche snow burial accidents [^113CkzvM]. Wilderness & Environmental Medicine (2017). Medium credibility.
...
### Spatial organization of bacterial populations in response to oxygen and carbon counter-gradients in pore networks [^1118NRM4]. Nature Communications (2018). Medium credibility.
...
### Collaborative strategy on bed bugs [^11771fnR]. CDC (2015). Medium credibility.
...
### One-shot entorhinal maps enable flexible navigation in novel environments [^111Nqh5t]. Nature (2024). Excellent credibility.
...
### Collaborative strategy on bed bugs [^114rvnSg]. CDC (2015). Medium credibility.
...
### Collaborative strategy on bed bugs [^111jL3CF]. CDC (2015). Medium credibility.
...
### Constructing future behavior in the hippocampal formation through composition and replay [^111FjSvf]. Nature Neuroscience (2025). High credibility.
...
### Collaborative strategy on bed bugs [^112SGd3a]. CDC (2015). Medium credibility.
...
### Collaborative strategy on bed bugs [^111Z2ZyD]. CDC (2015). Medium credibility.
...
### Wilderness Medical Society clinical practice guidelines for prevention and management of avalanche and nonavalanche snow burial accidents: 2024 update [^111jVrXq]. Wilderness & Environmental Medicine (2024). High credibility.
...
### Evolutionary dynamics on graphs [^1162VYQk]. Nature (2005). Excellent credibility.
...
### Collaborative strategy on bed bugs [^115cR2ky]. CDC (2015). Medium credibility.
...
### Collaborative strategy on bed bugs [^111i3Ve5]. CDC (2015). Medium credibility.
...
### Population coding of conditional probability distributions in dorsal premotor cortex [^1117PSbS]. Nature Communications (2018). Medium credibility.
...
### CDC yellow book 2026: health information for international travel. chapter 3 environmental hazards and risks [^1146R5VJ]. CDC (2025). High credibility.
...
### Collaborative strategy on bed bugs [^113PdRq1]. CDC (2015). Medium credibility.
...
### Universal exploration dynamics of random walks [^115AonmK]. Nature Communications (2023). High credibility.
...
### Collaborative strategy on bed bugs [^117JaXth]. CDC (2015). Medium credibility.
...
### Collaborative strategy on bed bugs [^1171CoN2]. CDC (2015). Medium credibility.
...
### Collaborative strategy on bed bugs [^1112tvN5]. CDC (2015). Medium credibility.
...
### A scaling law for random walks on networks [^113jKW74]. Nature Communications (2014). Medium credibility.
...
### Adaptive resetting for informed search strategies and the design of non-equilibrium steady-states [^116PsztH]. Nature Communications (2025). High credibility.
...
### Joint statement on bed bug control in the United States from the U.S. centers for disease control and prevention (CDC) and the U.S. environmental protection agency (EPA) [^115mbdzk]. EPA/CDC (2010). Medium credibility.
...
### Social interactions lead to motility-induced phase separation in fire ants [^1141GcgU]. Nature Communications (2022). High credibility.
...
### The limits of precision monomer placement in chain growth polymerization [^115fVRSY]. Nature Communications (2016). Medium credibility.
...
### The promise and challenge of spatial inference with the full ancestral recombination graph under brownian motion [^115LFgDw]. G3 (2025). Medium credibility.
...
### Collaborative strategy on bed bugs [^115BvaMv]. CDC (2015). Medium credibility.
...
### Simulation-based reconstruction of global bird migration over the past 50, 000 years [^114y9KwL]. Nature Communications (2020). High credibility.
...
### Highly active enzymes by automated combinatorial backbone assembly and sequence design [^115r2g6p]. Nature Communications (2018). Medium credibility.
...
### Hysteresis stabilizes dynamic control of self-assembled army ant constructions [^113CmmYm]. Nature Communications (2022). High credibility.
...
### Human hippocampal and entorhinal neurons encode the temporal structure of experience [^1172Fxi1]. Nature (2024). Excellent credibility.
...
### Speed modulations in grid cell information geometry [^115s1jNB]. Nature Communications (2025). High credibility.
...
### Density-functional fluctuation theory of crowds [^113z233u]. Nature Communications (2018). Medium credibility.
...
### Haloarchaea swim slowly for optimal chemotactic efficiency in low nutrient environments [^114mJFZA]. Nature Communications (2020). High credibility.
...
### American Gastroenterological Association institute guideline on the diagnosis and management of Lynch syndrome [^111KwTUq]. Gastroenterology (2015). Medium credibility.
...
### Microtubule-based transport is essential to distribute RNA and nascent protein in skeletal muscle [^1178bGMw]. Nature Communications (2021). High credibility.
...
### Coherent movement of error-prone individuals through mechanical coupling [^1151F7ov]. Nature Communications (2023). High credibility.
...
### Population coding of conditional probability distributions in dorsal premotor cortex [^116WNJRG]. Nature Communications (2018). Medium credibility.
...
### The sex of organ geometry [^116Sujpm]. Nature (2024). Excellent credibility.
...
### A biophysical account of multiplication by a single neuron [^114GRTGV]. Nature (2022). Excellent credibility.
...
### Hysteresis stabilizes dynamic control of self-assembled army ant constructions [^115gTySr]. Nature Communications (2022). High credibility.
...
### Neural landscape diffusion resolves conflicts between needs across time [^117ErDXy]. Nature (2023). Excellent credibility.
...
### Generally overlooked fundamentals of bacterial genetics and ecology [^116SWxHr]. Clinical Infectious Diseases (2002). Low credibility.
...
### Arrays of individually controlled ions suitable for two-dimensional quantum simulations [^1176W5Vn]. Nature Communications (2016). Medium credibility.
