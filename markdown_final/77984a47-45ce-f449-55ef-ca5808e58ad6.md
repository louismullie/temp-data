...
> Let me first confirm the foundational definition so I don't misclassify entities. Peptic ulcer disease is a mucosal break extending beyond the muscularis mucosae in the stomach or proximal duodenum, which distinguishes ulcers from erosions that are more superficial and typically less than 3–5 mm, and this anatomic threshold is the key starting point for any typology of "stomach ulcers".
...
Stomach ulcers, or gastric ulcers, are classified by **location** (antral, body, fundus, cardia, pyloric channel), **size** (simple vs giant > 2 cm) [^1fa2fe8f], and **etiology** (H. pylori, NSAID, stress, idiopathic) [^748a2eb1]. They are also categorized by **complications** (bleeding, perforation, obstruction) [^1fa2fe8f] and by **endoscopic appearance** (active, healing, scarred). Accurate classification guides management, including acid suppression, H. pylori eradication, NSAID modification, and endoscopic or surgical intervention for complications [^1fa2fe8f] [^8b28a6ae].
