...
- **Severe congenital neutropenia**: Persistent absolute neutrophil count (ANC) < 500/µL, typically < 200/µL [^112QCE7J].
- **Recurrent bacterial infections**: Frequent and severe infections, including pneumonia, otitis media, skin infections, and sepsis [^112QCE7J].
...
### DEFERIPRONE tablet, coated… [^115898cQ]. FDA (DailyMed) (2025). Medium credibility.
...
### Interrupted time series analysis of cannabis coding in Colorado during the ICD-10-CM transition [^111RbAPY]. Injury Prevention (2021). Medium credibility.
...
### Development and assessment of a new framework for disease surveillance, prediction, and risk adjustment: the diagnostic items classification system [^113PnCw8]. JAMA Health Forum (2022). High credibility.
...
### Exploring the implications of the new ICD-10-CM classification system for injury surveillance: analysis of dually coded data from two medical centres [^112DW7uU]. Injury Prevention (2021). Medium credibility.
...
### Interrupted time series analysis to evaluate the performance of drug overdose morbidity indicators shows discontinuities across the ICD-9-CM to ICD-10-CM transition [^116D64F1]. Injury Prevention (2021). Medium credibility.
...
### Paclitaxel protein-bound particles for injectable… [^114Nc4d3]. FDA (DailyMed) (2022). Medium credibility.
...
### Interrupted time series analysis to evaluate the performance of drug overdose morbidity indicators shows discontinuities across the ICD-9-CM to ICD-10-CM transition [^112XkgVu]. Injury Prevention (2021). Medium credibility.
...
### NCCN guidelines® insights: myelodysplastic syndromes, version 2.2025 [^117CNETx]. Journal of the National Comprehensive Cancer Network (2025). High credibility.
...
### Validation of the new diagnosis grouping system for pediatric emergency department visits using the international classification of diseases, 10th revision [^116dd9LZ]. Pediatric Emergency Care (2013). Low credibility.
...
### NCCN guidelines® insights: myelodysplastic syndromes, version 2.2025 [^111KQZNv]. Journal of the National Comprehensive Cancer Network (2025). High credibility.
...
### Trends in mortality in septic patients according to the different organ failure during 15 years [^115yieuG]. Critical Care (2022). Medium credibility.
...
### The effect of the transition from the ninth to the tenth revision of the international classification of diseases on external cause registration of injury morbidity in Sweden [^116dANao]. Injury Prevention (2015). Low credibility.
...
### Kostmann's syndrome [^112QCE7J]. Clinical Imaging (2005). Low credibility.
...
### Interrupted time series analysis to evaluate the performance of drug overdose morbidity indicators shows discontinuities across the ICD-9-CM to ICD-10-CM transition [^115jSdhR]. Injury Prevention (2021). Medium credibility.
...
### Trends in severe maternal morbidity in the US across the transition to ICD-10-CM / PCS from 2012–2019 [^115X5sw7]. JAMA Network Open (2022). High credibility.
...
### Updated diagnosis grouping system for pediatric emergency department visits [^1116cGPB]. Pediatric Emergency Care (2023). Medium credibility.
...
### A trauma mortality prediction model based on the ICD-10-CM lexicon: TMPM-ICD10 [^113Bxb5F]. The Journal of Trauma and Acute Care Surgery (2019). Medium credibility.
