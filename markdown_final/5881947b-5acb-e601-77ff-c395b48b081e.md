...
Quantitative data will be collected through questionnaires and GPS and accelerometer devices (see section titled “Quantitative data collection” for more details on these modes of data collection). Quantitative data will be captured once for patients in category 1 and at four time points for patients in category 4 (the longitudinal study): 1) at enrollment; 2) just prior to daily-use O 2 initiation; 3) one month after starting daytime O 2 ; and 4) 9–12 months after starting daytime O 2.
