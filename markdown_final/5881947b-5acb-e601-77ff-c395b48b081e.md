...
- **Measure outcomes**: Quantify intervention effects, associations, and test hypotheses with statistical precision [^1161zsXS].

- **Generalize findings**: Enable inference from sample to population when sampling is representative [^116pP54i].

- **Compare groups**: Assess differences between interventions or populations using standardized metrics [^117J9U3B].

- **Detect trends**: Identify patterns or changes over time with longitudinal data [^114upgBt].

Common quantitative methods include surveys, questionnaires, structured observations, and administrative or clinical records; these tools provide numerical data suitable for statistical analysis and hypothesis testing [^1161zsXS] [^116pP54i].
...
- **Explore mechanisms**: Understand how and why interventions work or fail in real-world contexts [^1133jVU5].

- **Capture experiences**: Document patient and provider perspectives, values, and preferences [^1175JDPr].

- **Identify barriers and facilitators**: Reveal contextual factors that influence implementation and outcomes [^113CK5fQ].

- **Generate hypotheses**: Discover unexpected themes and refine future quantitative instruments [^113QB5WN].

Common qualitative methods include in-depth interviews, focus groups, participant observation, and open-ended survey items; these yield textual or observational data analyzed thematically or with grounded theory [^117GMho4] [^114L3JY5].

---

## Integration of quantitative and qualitative data

Mixed methods integration **enhances validity** by triangulating findings across data types, improves interpretability by explaining quantitative results with qualitative insights, and strengthens implementation by aligning interventions with patient needs and context [^11679D7t] [^114fTghT]. I will use a convergent design, collecting both strands concurrently with equal priority, then integrate during analysis to produce a comprehensive, context-aware interpretation [^114RW25L] [^113uSeQE].

---

## Practical considerations

- **Resources**: Mixed methods require time, funding, and multidisciplinary expertise; plan accordingly [^11679D7t].

- **Sampling**: Use purposive sampling for qualitative depth and probability sampling for quantitative generalizability [^117GMho4] [^116pP54i].

- **Analysis**: Apply rigorous quantitative statistics and established qualitative coding with intercoder reliability and reflexivity [^117SHF2U] [^11679D7t].

- **Reporting**: Use joint displays to transparently present integrated findings and facilitate interpretation [^111Cqy3q].

---

## Conclusion

I will collect **both quantitative and qualitative data** to answer "what works" and "why/how it works", leveraging mixed methods to produce robust, context-sensitive evidence that informs clinical practice and policy [^112yzay6] [^115X7T3L].

---

## References

### Data collection techniques [^117MoWW3]. Journal of the American Academy of Child and Adolescent Psychiatry (2001). Low credibility.
...
### Synthesising quantitative and qualitative evidence to inform guidelines on complex interventions: clarifying the purposes, designs and outlining some methods [^112giMst]. BMJ Global Health (2019). High credibility.
...
### Synthesis of guidance available for assessing methodological quality and grading of evidence from qualitative research to inform clinical recommendations: a systematic literature review [^115Ge4UT]. RMD Open (2024). Medium credibility.
...
### Qualitative research: standards, challenges, and guidelines [^115Wzxic]. Lancet (2001). Excellent credibility.
...
### Mixed methods research: a design for emergency care research? [^112LFrVQ]. Emergency Medicine Journal (2011). Low credibility.
...
### Synthesising quantitative and qualitative evidence to inform guidelines on complex interventions: clarifying the purposes, designs and outlining some methods [^111SN6CF]. BMJ Global Health (2019). High credibility.
...
### Methodological standards for qualitative and mixed methods patient centered outcomes research [^11679D7t]. BMJ (2020). Excellent credibility.
...
### Mixed methods and survey research in family medicine and community health [^115M9uMy]. Family Medicine and Community Health (2019). Medium credibility.
...
### Mixed methods and survey research in family medicine and community health [^111EXx6E]. Family Medicine and Community Health (2019). Medium credibility.
...
### Synthesising quantitative and qualitative research in evidence-based patient information [^114tMRKq]. Journal of Epidemiology and Community Health (2007). Low credibility.
...
### Collecting and analyzing qualitative data | Field epi manual… [^117GMho4]. CDC (2024). Medium credibility.
...
### Qualitative research methods: key features and insights gained from use in infection prevention research [^1133jVU5]. American Journal of Infection Control (2008). Low credibility.
...
### Using mixed methods for genetic counseling research [^114mQZUZ]. Journal of Genetic Counseling (2025). Medium credibility.
...
### Mixed methods research: a primer for the vascular surgeon [^115s4V99]. Seminars in Vascular Surgery (2022). Medium credibility.
...
### Synthesising quantitative and qualitative evidence to inform guidelines on complex interventions: clarifying the purposes, designs and outlining some methods [^111k4j4y]. BMJ Global Health (2019). High credibility.
...
### The research burden of randomized controlled trial participation: a systematic thematic synthesis of qualitative evidence [^113ZEZNZ]. BMC Medicine (2020). Medium credibility.
...
### Fundamentals of qualitative analysis in family medicine [^111a84qR]. Family Medicine and Community Health (2019). Medium credibility.
...
### Advanced and alternative research methods for the acute care surgeon scientist [^112cfR5u]. Trauma Surgery & Acute Care Open (2024). Medium credibility.
...
### Qualitative research: adding drive and dimension to clinical research [^113QB5WN]. Critical Care Medicine (2009). Low credibility.
...
### The quality of qualitative research [^117WBQ6N]. Medical Humanities (2025). Medium credibility.
...
### Synthesising quantitative and qualitative evidence to inform guidelines on complex interventions: clarifying the purposes, designs and outlining some methods [^112v7ciL]. BMJ Global Health (2019). High credibility.
...
### Understanding qualitative research in health care [^114m2iFr]. Drug and Therapeutics Bulletin (2017). Low credibility.
...
### Protocol for a mixed-methods study of supplemental oxygen in pulmonary fibrosis [^112yY8KR]. BMC Pulmonary Medicine (2014). Low credibility.
...
### Methodological standards for qualitative and mixed methods patient centered outcomes research [^112yzay6]. BMJ (2020). Excellent credibility.
...
### Synthesis of guidance available for assessing methodological quality and grading of evidence from qualitative research to inform clinical recommendations: a systematic literature review [^111yQq8J]. RMD Open (2024). Medium credibility.
...
### Mixed methods and survey research in family medicine and community health [^1152fbHV]. Family Medicine and Community Health (2019). Medium credibility.
...
### Specialist antenatal clinics for women at high risk of preterm birth: a systematic review of qualitative and quantitative research [^112ouPsB]. BMC Pregnancy and Childbirth (2017). Low credibility.
...
### Synthesis of guidance available for assessing methodological quality and grading of evidence from qualitative research to inform clinical recommendations: a systematic literature review [^116eCkUJ]. RMD Open (2024). Medium credibility.
...
### Collecting comprehensive and… [^113CqS8c]. FDA (2025). Medium credibility.
...
### Methodological standards for qualitative and mixed methods patient centered outcomes research [^116vQrJ2]. BMJ (2020). Excellent credibility.
...
### Qualitative approaches in health services research: a methodological primer [^116mnpvf]. Hospital Pediatrics (2025). Medium credibility.
...
### Fundamentals of qualitative analysis in family medicine [^114L3JY5]. Family Medicine and Community Health (2019). Medium credibility.
...
### Synthesising quantitative and qualitative evidence to inform guidelines on complex interventions: clarifying the purposes, designs and outlining some methods [^117JStDL]. BMJ Global Health (2019). High credibility.
...
### How to summarise and report written qualitative data from patients: a method for use in cancer support care [^114196To]. Supportive Care in Cancer (2007). Low credibility.
...
### [pdf] collecting comprehensive and representative input… [^113QwnFi]. FDA (2025). Medium credibility.
...
### Use of qualitative methods alongside randomised controlled trials of complex healthcare interventions: methodological study [^114NaEg8]. BMJ (2009). Excellent credibility.
...
### Reporting guidelines for allergy and immunology survey research [^113t4uBz]. Annals of Allergy, Asthma & Immunology (2023). Medium credibility.
...
### Qualitative research in emergency care part I: research principles and common applications [^116MYtno]. Academic Emergency Medicine (2015). Low credibility.
...
### Advanced and alternative research methods for the acute care surgeon scientist [^114fTghT]. Trauma Surgery & Acute Care Open (2024). Medium credibility.
...
### Multi-level factors affecting adolescent and youth engagement in HIV-research in low-and middle-income countries: a qualitative evidence synthesis [^112QwPRt]. The Cochrane Database of Systematic Reviews (2025). Medium credibility.
...
### Systematic debriefing after qualitative encounters: an essential analysis step in applied qualitative research [^112eeV7R]. BMJ Global Health (2018). Medium credibility.
...
### Practical mixed methods strategies used to integrate qualitative and quantitative methods in community-based primary health care research [^113uT5xq]. Family Practice (2019). Medium credibility.
...
### Applying a new concept of embedding qualitative research: an example from a quantitative study of carers of people in later stage dementia [^111EnMtD]. BMC Geriatrics (2019). Medium credibility.
...
### Fundamentals of qualitative analysis in family medicine [^111fk3Mq]. Family Medicine and Community Health (2019). Medium credibility.
...
### Qualitative data collection and analysis methods: the INSTINCT trial [^1148QPNz]. Academic Emergency Medicine (2007). Low credibility.
...
### Mixed methods and survey research in family medicine and community health [^113uSeQE]. Family Medicine and Community Health (2019). Medium credibility.
...
### Mixed methods and survey research in family medicine and community health [^111AvUJz]. Family Medicine and Community Health (2019). Medium credibility.
...
### Mixed methods and survey research in family medicine and community health [^1135F9Ni]. Family Medicine and Community Health (2019). Medium credibility.
...
### Synthesising quantitative and qualitative evidence to inform guidelines on complex interventions: clarifying the purposes, designs and outlining some methods [^115X7T3L]. BMJ Global Health (2019). High credibility.
...
### A guide to reading and using systematic reviews of qualitative research [^1175JDPr]. Nephrology, Dialysis, Transplantation (2016). Low credibility.
...
### Using mixed methods for genetic counseling research [^114RW25L]. Journal of Genetic Counseling (2025). Medium credibility.
...
### Evaluating an integrated primary care approach to improve well-being among frail community-living older people: a theory-guided study protocol [^114MJRsx]. BMC Geriatrics (2018). Low credibility.
...
### Interview-based qualitative research in emergency care part II: data collection, analysis and results reporting [^113JWLw9]. Academic Emergency Medicine (2015). Low credibility.

Qualitative methods are increasingly being used in emergency care research. Rigorous qualitative methods can play a critical role in advancing the emergency care research agenda by allowing investigators to generate hypotheses, gain an in-depth understanding of health problems or specific populations, create expert consensus, and develop new intervention and dissemination strategies. In Part I of this two-article series, we provided an introduction to general principles of applied qualitative health research and examples of its common use in emergency care research, describing study designs and data collection methods most relevant to our field (observation, individual interviews, and focus groups). Here in Part II of this series, we outline the specific steps necessary to conduct a valid and reliable qualitative research project, with a focus on interview-based studies. These elements include building the research team, preparing data collection guides, defining and obtaining an adequate sample, collecting and organizing qualitative data, and coding and analyzing the data. We also discuss potential ethical considerations unique to qualitative research as it relates to emergency care research.

---

### Synthesising quantitative and qualitative evidence to inform guidelines on complex interventions: clarifying the purposes, designs and outlining some methods [^115Q4mCd]. BMJ Global Health (2019). High credibility.
...
### Systematic debriefing after qualitative encounters: an essential analysis step in applied qualitative research [^111wDGvL]. BMJ Global Health (2018). Medium credibility.
...
### Synthesising quantitative and qualitative evidence to inform guidelines on complex interventions: clarifying the purposes, designs and outlining some methods [^111rhT2t]. BMJ Global Health (2019). High credibility.
...
### Using mixed methods for genetic counseling research [^111xSV9M]. Journal of Genetic Counseling (2025). Medium credibility.
...
### "The patient is speaking": discovering the patient voice in ophthalmology [^111GNYna]. The British Journal of Ophthalmology (2017). Low credibility.
...
### Iterative categorisation (IC) (part 2): interpreting qualitative data [^111aCAHQ]. Addiction (2021). Medium credibility.
...
### Healthcare workers' informal uses of mobile phones and other mobile devices to support their work: a qualitative evidence synthesis [^114mugtq]. The Cochrane Database of Systematic Reviews (2024). Medium credibility.
...
### Qualitative research methods in renal medicine: an introduction [^114aCV9M]. Nephrology, Dialysis, Transplantation (2015). Low credibility.
...
### Synthesis of guidance available for assessing methodological quality and grading of evidence from qualitative research to inform clinical recommendations: a systematic literature review [^116nfFxL]. RMD Open (2024). Medium credibility.
...
### Healthcare workers' perceptions and experiences of primary healthcare integration: a scoping review of qualitative evidence [^112sjhLx]. The Cochrane Database of Systematic Reviews (2023). Medium credibility.
...
### Practice guideline for the treatment of patients with obsessive-compulsive disorder [^117AUQSm]. The American Journal of Psychiatry (2007). Medium credibility.
...
### Data collection-the office of research integrityori.hhs.gov › products › n_illinois_u › datamanagement › dctopic… [^1115tEJY]. ori.hhs.gov (1998). Low credibility.
...
### Understanding the experience of stroke: a mixed-method research agenda [^113ojXp7]. The Gerontologist (2009). Low credibility.
...
### Synthesis of guidance available for assessing methodological quality and grading of evidence from qualitative research to inform clinical recommendations: a systematic literature review [^116J51JW]. RMD Open (2024). Medium credibility.
...
### Systematic debriefing after qualitative encounters: an essential analysis step in applied qualitative research [^111K7t4X]. BMJ Global Health (2018). Medium credibility.
...
### Statistics review 8: qualitative data-tests of association [^1173c2nD]. Critical Care (2004). Low credibility.
...
### Systematic review: the effect on surrogates of making treatment decisions for others [^116ej29X]. Annals of Internal Medicine (2011). Low credibility.
...
### Synthesis of guidance available for assessing methodological quality and grading of evidence from qualitative research to inform clinical recommendations: a systematic literature review [^1132ywEE]. RMD Open (2024). Medium credibility.
...
### Innovations in data collection, management, and archiving for systematic reviews [^1162KfXQ]. Annals of Internal Medicine (2015). Low credibility.
...
### Survey research: a primer for the academic radiologist [^116vg8JW]. Academic Radiology (2018). Low credibility.
...
### Proper analysis of secondary phenotype data in case-control association studies [^116nAvxA]. Genetic Epidemiology (2009). Low credibility.
...
### Using mixed methods for genetic counseling research [^116cZAEe]. Journal of Genetic Counseling (2025). Medium credibility.
...
### Goals of frail older people living with chronic kidney disease: a mixed methods study [^117TQQ2t]. Journal of the American Geriatrics Society (2025). Medium credibility.
...
### Importance of mixed methods in pragmatic trials and dissemination and implementation research [^113kNjSD]. Academic Pediatrics (2013). Low credibility.
...
### Factors that influence caregivers' and adolescents' views and practices regarding human papillomavirus (HPV) vaccination for adolescents: a qualitative evidence synthesis [^115UPDjE]. The Cochrane Database of Systematic Reviews (2025). Medium credibility.
...
### Peer support for parents of children with chronic disabling conditions: a systematic review of quantitative and qualitative studies [^114fda8y]. Developmental Medicine and Child Neurology (2013). Low credibility.
...
### Joint display of integrated data collection for mixed methods research: an illustration from a pediatric oncology quality improvement study [^111Cqy3q]. Annals of Family Medicine (2023). Medium credibility.
