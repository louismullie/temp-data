...
> Next, I should review the clinical evidence for serotonin syndrome. Hold on, let's not jump to conclusions; I need to check whether the interaction is theoretical or documented. Multiple authoritative sources list St. John's wort among serotonergic agents that increase serotonin syndrome risk when combined with SSRIs, and case reports document serotonin syndrome with SSRIs plus St. John's wort, so the risk is real and clinically relevant, not merely hypothetical [^9ac9d3d6] [^57731d8a].
