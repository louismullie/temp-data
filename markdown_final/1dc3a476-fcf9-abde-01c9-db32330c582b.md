...
> Let me first confirm the trial and the specific results. HYCARET was a pragmatic, multicenter, open-label randomized clinical trial comparing hybrid cardiac rehabilitation (10 supervised sessions plus remote support) versus standard center-based cardiac rehabilitation (18–22 supervised sessions) in a low-resource setting, with a primary outcome of cardiovascular events or mortality at 1 year and adherence-stratified per-protocol analyses reported in the main publication [^115mLx6K].
