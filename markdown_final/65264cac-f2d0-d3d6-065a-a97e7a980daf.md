...
> Let me first confirm the nature of the reported "allergy". Most so-called statin "allergies" are actually non-allergic adverse effects such as myalgias, arthralgias, or elevated liver enzymes, which are mechanistically tied to HMG-CoA reductase inhibition and dose intensity rather than IgE-mediated hypersensitivity; true immunologic allergy to statins is uncommon but documented, including rash, urticaria, and angioedema, so I need to clarify the phenotype before deciding on rechallenge [^01fa07a3].
