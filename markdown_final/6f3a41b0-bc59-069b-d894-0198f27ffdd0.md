...
> For longitudinal or repeated measures, I should verify whether I am summarizing within-subject trajectories or single endpoints. Descriptively, I can report summary statistics per subject and then aggregate, or present spaghetti plots or stacked probability plots to visualize time dynamics; I need to ensure I acknowledge within-subject correlation even if I am not modeling it explicitly in the descriptive phase [^111YvAqS] [^115r8Cqp].

> Let me consider a concise reporting template to keep this actionable. For each outcome, I will report the measure of central tendency with the appropriate measure of spread, the sample size and denominator, and a 95% CI when relevant; for categorical outcomes, I will report counts and percentages; for continuous outcomes, I will report mean with SD or median with IQR and justify the choice; for time-to-event, I will report median time with 95% CI and show the Kaplan-Meier curve; and I will explicitly note any missing data and how they were handled in the descriptive summaries [^117UQ4Cm] [^114QsVXb].

> Finally, I should double-check quality and transparency. I will prespecify outcomes and analysis plans when possible, report results for all measured outcomes to mitigate selective reporting, and provide enough detail that another investigator could reproduce the descriptive analyses. If I deviate from the plan, I will document and justify the change to maintain interpretability and trustworthiness [^116UyiZA] [^116o4fif].

---

Descriptive outcomes should be reported with **clear, concise statistics** that match the data type and distribution: use **mean ± SD** for normal continuous variables, **median (IQR)** for skewed or ordinal data, and **n (%)** for categorical outcomes [^114QsVXb] [^112wqdri]. Always include **sample size** and **missing data**, and add **95% CIs** for key estimates to convey precision [^117UQ4Cm] [^115vcziB]. For longitudinal or repeated measures, report change from baseline and use appropriate summary statistics (e.g. mean change, AUC) [^111YvAqS]. Avoid overinterpreting descriptive results; use them to characterize the sample and identify patterns, not to infer causality [^116aLcHP].

---

## Continuous outcomes

Continuous outcomes are **reported with measures of central tendency and dispersion** [^114QsVXb].

- **Normal distribution**: Mean ± standard deviation (SD) [^114QsVXb].
- **Non-normal distribution**: Median with interquartile range (IQR) [^114QsVXb].
- **Change from baseline**: Report mean or median change with SD or IQR, and consider percentage change if clinically meaningful [^114QsVXb].

---

## Categorical outcomes

Categorical outcomes are **summarized with counts and proportions** [^114QsVXb].

- **Binary outcomes**: n (%) with denominator and, when relevant, 95% CI [^116UyiZA].
- **Ordinal outcomes**: n (%) for each category; consider reporting the median category if ordinal [^114QsVXb].
- **Missing data**: Report the number and proportion of missing values [^116NqtHY].

---

## Time-to-event outcomes

Time-to-event outcomes require **survival statistics** [^114ad6jj].
...
For longitudinal data, **summarize within-subject changes** and use appropriate metrics [^111YvAqS].

- **Mean change**: Average change from baseline with SD or 95% CI [^114QsVXb].
- **Area under the curve (AUC)**: Summarizes repeated measures over time [^notfound].
- **Response rates**: Proportion achieving a clinically meaningful change (e.g. ≥ 50% improvement) [^115AF5Pf].

---

## Patient-reported outcomes (PROs)

PROs should be reported with **anchor- or distribution-based interpretation** [^116A2Na5].

- **Mean or median scores**: Baseline and follow-up with change and variability [^114QsVXb].
- **Minimal clinically important difference (MCID)**: Report the proportion achieving MCID [^116A2Na5].
- **Instrument-specific interpretation**: Use validated thresholds or responder definitions [^113rbnEV].

---

## Composite outcomes

Composite outcomes should be **defined clearly** with **component-level detail** [^111xPdyZ].

- **Composite event rate**: n (%) with 95% CI [^notfound].
- **Component events**: Report each component separately to clarify drivers of the composite [^111xPdyZ].
- **Clinical relevance**: Discuss whether components have similar importance and direction of effect [^111xPdyZ].

---

## Reporting standards and best practices

Follow **reporting standards** to ensure clarity and reproducibility [^117UQ4Cm].

- **CONSORT/STROBE**: Use structured reporting for trials and observational studies [^115j4FX7].
- **Confidence intervals**: Report 95% CIs for key estimates to indicate precision [^115vcziB].
- **Transparency**: Report all prespecified outcomes, even if not analyzed or significant [^116UyiZA].
...
- **Misusing measures of spread**: Do not report SD with median or IQR with mean [^112GjQEe].
- **Overinterpreting descriptive results**: Descriptive statistics do not imply causality [^116aLcHP].
- **Incomplete reporting**: Always report sample size, missing data, and denominators [^117UQ4Cm].
...
### The primary outcome measure and its importance in clinical trials [^116uCqMN]. The Journal of Clinical Psychiatry (2015). Low credibility.
...
### Outcome measures and implications for sample-size calculations [^1115GeVp]. The Journal of Bone and Joint Surgery: American Volume (2009). Low credibility.
...
### Guidance on statistical reporting to help improve your chances of a favorable statistical review [^117UQ4Cm]. American Journal of Respiratory and Critical Care Medicine (2020). Medium credibility.
...
### Defining the primary outcomes and justifying secondary outcomes of a study: usually, the fewer, the better [^116y5zUJ]. Anesthesia and Analgesia (2017). Low credibility.
...
### Core patient-reported outcomes in cancer clinical trials… [^112da1an]. FDA (2024). Medium credibility.
...
### Measuring patient outcomes: a primer [^114p7yM3]. Injury (2011). Low credibility.
...
### Understanding clinical trial outcomes: design, analysis, and interpretation [^114jvK9p]. Dermatologic Therapy (2007). Low credibility.
...
### Stakeholders in outcome measures: review from a clinical perspective [^116AdQhs]. Clinical Orthopaedics and Related Research (2013). Low credibility.
...
### CONSORT 2010 statement: extension to randomised pilot and feasibility trials [^1175NMqK]. BMJ (2016). Excellent credibility.
...
### Statistical considerations in the psychometric validation of outcome measures [^112RKgwb]. Clinical Orthopaedics and Related Research (2013). Low credibility.
...
### Population-based applications and analytics using patient-reported outcome measures [^117QNWBb]. The Journal of the American Academy of Orthopaedic Surgeons (2023). Medium credibility.
...
### Medical abortion reporting of efficacy: the MARE guidelines [^112wJzA6]. Contraception (2016). Medium credibility.
...
### Presentation of continuous outcomes in randomised trials: an observational study [^115qygVA]. BMJ (2012). Excellent credibility.
...
### Relationship between the asthma control test (ACT) and other outcomes: a targeted literature review [^1176yeaE]. BMC Pulmonary Medicine (2020). Medium credibility.
...
### Repeated measures designs and analysis of longitudinal data: If at first you Do not succeed-try, try again [^111YvAqS]. Anesthesia and Analgesia (2018). Low credibility.
...
### CONSORT-DEFINE explanation and elaboration: recommendations for enhancing reporting quality and impact of early phase dose-finding clinical trials [^113XcbfR]. EClinicalMedicine (2025). Medium credibility.
...
### Recommendations of the SUFU / AUGS / ICS female stress urinary incontinence surgical publication working group: a common standard minimum data set for the literature [^115j4FX7]. Urogynecology (2024). High credibility.
...
### Guidelines for reporting outcomes in trial reports: the CONSORT… [^116UyiZA]. JAMA Network (2022). Excellent credibility.
...
### Quantifying clinically significant change: a brief review of methods and presentation of a hybrid approach [^115AF5Pf]. The American Journal of Sports Medicine (2012). Low credibility.
...
### Definition, reporting, and interpretation of composite outcomes in clinical trials: systematic review [^111xPdyZ]. BMJ (2010). Excellent credibility.
...
### Observational studies: practical tips for avoiding common statistical pitfalls [^116NqtHY]. The Lancet Regional Health: Southeast Asia (2024). High credibility.
...
### Reappraisal of ventilator-free days in critical care research [^116f8vnw]. American Journal of Respiratory and Critical Care Medicine (2019). Medium credibility.
...
### Evaluating the credibility of anchor based estimates of minimal important differences for patient reported outcomes: instrument development and reliability study [^116A2Na5]. BMJ (2020). Excellent credibility.
...
### Reporting outcomes and outcome measures in open rhinoplasty: a systematic review [^115CjCi2]. Aesthetic Surgery Journal (2020). Medium credibility.
...
### Basics of statistics for primary care research [^113VNCrv]. Family Medicine and Community Health (2019). Medium credibility.
...
### Reporting and interpretation of SF-36 outcomes in randomised trials: systematic review [^117NLCjw]. BMJ (2009). Excellent credibility.
...
### Conscientious use of patient-reported outcome measures in supportive care [^112reaBo]. Supportive Care in Cancer (2023). Medium credibility.
...
### Reporting of numerical and statistical differences in abstracts: improving but not optimal [^112fJXvg]. Journal of General Internal Medicine (2002). Low credibility.
...
### Common errors in statistics and methods [^112GjQEe]. BMJ Paediatrics Open (2024). High credibility.
...
### Reporting of effect size and confidence intervals in JAMA otolaryngology-head&neck surgery [^113ryF7H]. JAMA Otolaryngology — Head & Neck Surgery (2017). Medium credibility.
...
### Statistical analysis of noncommensurate multiple outcomes [^114iHDx5]. Circulation: Cardiovascular Quality and Outcomes (2011). Low credibility.
...
### Are well functioning civil registration and vital statistics systems associated with better health outcomes? [^113TLAhm]. Lancet (2015). Excellent credibility.
...
### Developing, analyzing, and interpreting outcome assessments to improve endpoints in infectious diseases clinical research [^116ywbRB]. Clinical Infectious Diseases (2025). Medium credibility.
...
### Evaluation of pragmatic oxygenation measurement as a proxy for COVID-19 severity [^1163VH2k]. Nature Communications (2023). High credibility.
...
### Comparison of registered and published primary outcomes in randomized controlled trials of orthopaedic surgical interventions [^115AR8Fe]. The Journal of Bone and Joint Surgery: American Volume (2016). Low credibility.
...
### The effects of increased dose of exercise-based therapies to enhance motor recovery after stroke: a systematic review and meta-analysis [^1157okn5]. BMC Medicine (2010). Low credibility.
...
### Definition, reporting, and interpretation of composite outcomes in clinical trials: systematic review [^113B31uS]. BMJ (2010). Excellent credibility.
...
### Practice guidelines for obstetric anesthesia: an updated report by the American society of anesthesiologists task force on obstetric anesthesia and the Society for Obstetric Anesthesia and Perinatology [^115yY2dJ]. Anesthesiology (2016). Medium credibility.
...
### Reporting and interpretation of SF-36 outcomes in randomised trials: systematic review [^113xywHj]. BMJ (2009). Excellent credibility.
...
### Outcome selection and role of patient reported outcomes in contemporary cardiovascular trials: systematic review [^111KgsqK]. BMJ (2010). Excellent credibility.
...
### Critical review of published microarray studies for cancer outcome and guidelines on statistical analysis and reporting [^114rvZPk]. Journal of the National Cancer Institute (2007). Low credibility.
...
### Analysis of observational studies: a guide to understanding statistical methods [^115sRyTE]. The Journal of Bone and Joint Surgery: American Volume (2009). Low credibility.
...
### Outcome reporting bias in trials: a methodological approach for assessment and adjustment in systematic reviews [^116o4fif]. BMJ (2018). Excellent credibility.
...
### The treatment of pediatric supracondylar humerus fractures [^117DCsJK]. The Journal of the American Academy of Orthopaedic Surgeons (2012). Medium credibility.
...
### An official American Thoracic Society workshop report: developing performance measures from clinical practice guidelines [^112HsP95]. Annals of the American Thoracic Society (2014). Medium credibility.
...
### KDIGO clinical practice guideline for the care of kidney transplant recipients [^114d1QUx]. American Journal of Transplantation (2009). Medium credibility.
...
### Report of a consensus conference on transplant program quality and surveillance [^111y5b4p]. American Journal of Transplantation (2012). Low credibility.
...
### Harmonizing heterogeneous endpoints in coronavirus disease 2019 trials without loss of information [^115r8Cqp]. Critical Care Medicine (2021). Medium credibility.
...
### Diagnosis and treatment of bronchial intraepithelial neoplasia and early lung cancer of the central airways: diagnosis and management of lung cancer, 3rd ed: American College of Chest Physicians evidence-based clinical practice guidelines [^115YRX7w]. Chest (2013). Medium credibility.
...
### Descriptive studies: what they can and cannot do [^116aLcHP]. Lancet (2002). Excellent credibility.
...
### Frequency and reasons for outcome reporting bias in clinical trials: interviews with trialists [^114x8GGe]. BMJ (2011). Excellent credibility.
...
### Comparison of clinical trial changes in primary outcome and reported intervention effect size between trial registration and publication [^111bNfgW]. JAMA Network Open (2019). High credibility.
...
### Outcome selection and role of patient reported outcomes in contemporary cardiovascular trials: systematic review [^111KHuLP]. BMJ (2010). Excellent credibility.
...
### Comparison of treatment effect sizes associated with surrogate and final patient relevant outcomes in randomised controlled trials: meta-epidemiological study [^116NPyAf]. BMJ (2013). Excellent credibility.
...
### Outcome selection and role of patient reported outcomes in contemporary cardiovascular trials: systematic review [^111PKPRY]. BMJ (2010). Excellent credibility.
...
### Reporting and interpretation of SF-36 outcomes in randomised trials: systematic review [^114F5wDa]. BMJ (2009). Excellent credibility.
...
### Reporting and interpretation of SF-36 outcomes in randomised trials: systematic review [^116GMVqm]. BMJ (2009). Excellent credibility.
...
### Comparing methods to denote treatment outcome in clinical research and benchmarking mental health care [^116yXVw1]. Clinical Psychology & Psychotherapy (2016). Low credibility.
...
### KDIGO 2022 clinical practice guideline for diabetes management in chronic kidney disease [^113QHSsP]. Kidney International (2022). High credibility.
...
### Standard measures are inadequate to monitor pediatric adherence in a resource-limited setting [^116a6oVF]. AIDS and Behavior (2011). Low credibility.
...
### Methodology for ACOEM's occupational medicine practice guidelines-2025 revision [^1136D8hh]. ACOEM (2025). High credibility.
...
### FDA executive summary… [^1118D9bc]. FDA (2025). Medium credibility.
...
### Repeated measures designs and analysis of longitudinal data: If at first you Do not succeed-try, try again [^114qtqrF]. Anesthesia and Analgesia (2018). Low credibility.
...
### Assessment of the frequency and variety of persistent symptoms among patients with COVID-19: a systematic review [^111EGYBv]. JAMA Network Open (2021). High credibility.
...
### An official American Thoracic Society workshop report: developing performance measures from clinical practice guidelines [^117LYYMz]. Annals of the American Thoracic Society (2014). Medium credibility.
...
### The use of patient-reported outcome measures in clinical practice and clinical decision making [^113rbnEV]. The Journal of the American Academy of Orthopaedic Surgeons (2023). Medium credibility.
...
### A practical overview and reporting strategies for statistical analysis of Survival Studies [^114ad6jj]. Chest (2020). Medium credibility.
...
### Descriptive analysis of cochrane child-relevant systematic reviews: an update and comparison between 2009 and 2013 [^111AymEk]. BMC Pediatrics (2017). Low credibility.
...
### The routine use of patient reported outcome measures in healthcare settings [^115E9UsB]. BMJ (2010). Excellent credibility.
...
### Regression methods for investigating risk factors of chronic kidney disease outcomes: the state of the art [^112q716A]. BMC Nephrology (2014). Low credibility.
...
### 2018 Infectious Diseases Society of America clinical practice guideline for the management of outpatient parenteral antimicrobial therapy [^117Vor5u]. Clinical Infectious Diseases (2019). High credibility.
...
### Editor's choice – European Society for Vascular Surgery (ESVS) 2024 clinical practice guidelines on the management of asymptomatic lower limb peripheral arterial disease and intermittent claudication [^113oHPxg]. European Journal of Vascular and Endovascular Surgery (2024). High credibility.
...
### Comparison of registered and published outcomes in randomized controlled trials: a systematic review [^112FaWHQ]. BMC Medicine (2015). Low credibility.
...
### Evaluating the credibility of anchor based estimates of minimal important differences for patient reported outcomes: instrument development and reliability study [^1118Ua4J]. BMJ (2020). Excellent credibility.
...
### Use of imaging prior to referral to a musculoskeletal oncologist [^116t2fuR]. The Journal of the American Academy of Orthopaedic Surgeons (2019). High credibility.
...
### Health outcomes in primary care: a 20-year evidence map of randomized controlled trials [^11554VP9]. Family Practice (2023). Medium credibility.
