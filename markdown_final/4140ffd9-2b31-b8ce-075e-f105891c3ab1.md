...
|-|-|
| Acute respiratory infections (ARI) | Strong evidence supports PCT-guided algorithms to reduce antibiotic exposure without increasing mortality or treatment failure [^e9152902] [^957d0821] |
| Sepsis and septic shock | Weak recommendation to use PCT with clinical evaluation to guide antibiotic discontinuation; not recommended to guide initiation [^5a5d94dc] [^9bd48716] |
| Community-acquired pneumonia (CAP) | Not recommended to guide initiation; may be considered to guide discontinuation in select cases [^2d1e9e45] [^b1b9ca48] |
| Hospital-acquired pneumonia (HAP)/ventilator-associated pneumonia (VAP) | Not recommended to guide initiation; clinical criteria alone are advised [^7c97fe21] [^a1e2807a] |
...
- **Reduced antibiotic exposure**: Significant reductions in antibiotic use across multiple settings, including primary care, emergency departments, and ICUs [^e9152902] [^957d0821].
- **Improved clinical outcomes**: Lower mortality and fewer antibiotic-related side effects in some studies, particularly in sepsis and respiratory infections [^e2065f45] [^957d0821].
- **Cost-effectiveness**: Reduced antibiotic use and shorter hospital stays can lower healthcare costs [^3e910ea3].
...
- **False positives and negatives**: Elevated PCT can occur in non-infectious inflammatory states (e.g. surgery, trauma, malignancy), and low levels can occur in localized infections or early viral disease [^5d5cec61] [^a978bd3b].
- **Patient populations**: Less reliable in immunocompromised patients, those with chronic kidney disease, and certain viral infections (e.g. COVID-19) [^a978bd3b] [^00e71f71].
- **Assay variability**: Different assays and cutoffs can affect interpretation; standardized protocols are essential [^b7c8824d] [^2df94de1].
...
- **Clear protocols**: Define when to measure PCT, how to interpret results, and when to start or stop antibiotics [^2df94de1].
- **Training**: Educate clinicians on PCT interpretation and integration with clinical judgment [^0b264f4e].
- **Monitoring**: Track adherence and outcomes to ensure safe and effective use [^bb7379e2].

---

## Conclusion

PCT is a **valuable tool** for antibiotic stewardship, particularly in respiratory infections and sepsis, reducing unnecessary antibiotic use without compromising outcomes. It should be used alongside clinical assessment and local protocols, with awareness of its limitations and the clinical context [^5bb292ba] [^2df94de1].
...
### Prevalence of discordant procalcitonin use at an academic medical center [^bb7379e2]. American Journal of Clinical Pathology (2022). Medium credibility.
...
### Procalcitonin-guided antibiotic discontinuation and mortality in critically ill adults: a systematic review and meta-analysis [^e2065f45]. Chest (2019). Medium credibility.
...
Among critically ill adults (5,158 randomized; 5,000 analyzed), PCT-guided antibiotic discontinuation was associated with decreased mortality (16 RCTs; risk ratio [RR], 0.89; 95% CI, 0.83-0.97; I 2 = 0%; low certainty). Death was the primary outcome in only one study and a survival benefit was not observed in the subset specified as sepsis (10 RCTs; RR, 0.94; 95% CI, 0.85-1.03; I 2 = 0%), those without industry sponsorship (nine RCTs; RR, 0.98; 95% CI, 0.87-1.10; I 2 = 0%), high PCT-guided algorithm adherence (five RCTs; RR, 0.93; 95% CI, 0.71-1.22; I 2 = 0%), and PCT-guided algorithms without C-reactive protein (eight RCTs; RR, 0.96; 95% CI, 0.87-1.06; I 2 = 0%). PCT-guided antibiotic discontinuation decreased antibiotic duration (mean difference, 1.31 days; 95% CI, -2.27 to -0.35; I 2 = 93%) (low certainty).
...
### Practice patterns and outcomes associated with procalcitonin use in critically ill patients with sepsis [^8f19c5f2]. Clinical Infectious Diseases (2017). Low credibility.
...
### FDA executive summary (...) [^e62a6f86]. FDA (2025). Medium credibility.
...
### Use of procalcitonin to reduce patients' exposure to antibiotics in intensive care units (PRORATA trial): a multicentre randomised controlled trial [^7029ed51]. Lancet (2010). Excellent credibility.
...
### Procalcitonin as a diagnostic marker for sepsis: a systematic review and meta-analysis [^14c5efc2]. The Lancet: Infectious Diseases (2013). Medium credibility.
...
### Do we need new trials of procalcitonin-guided antibiotic therapy? [^bb23887a]. Critical Care (2018). Low credibility.
...
### Procalcitonin to guide initiation and duration of antibiotic treatment in acute respiratory infections: an individual patient data meta-analysis [^f4ab225f]. Clinical Infectious Diseases (2012). Low credibility.
...
### Procalcitonin to guide initiation and duration of antibiotic treatment in acute respiratory infections: an individual patient data meta-analysis [^588dfaa6]. Clinical Infectious Diseases (2012). Low credibility.
...
### The prognostic value of serum procalcitonin measurements in critically injured patients: a systematic review [^1858693a]. Critical Care (2019). Medium credibility.
...
### Surviving Sepsis Campaign: international guidelines for management of sepsis and septic shock 2021 [^a087cfd1]. Critical Care Medicine (2021). High credibility.
...
### Procalcitonin-guided antibiotic therapy: a systematic review and meta-analysis [^0423d2fa]. Journal of Hospital Medicine (2013). Low credibility.
...
### A procalcitonin-based algorithm to guide antibiotic use in patients with acute pancreatitis (PROCAP): a single-centre, patient-blinded, randomised controlled trial [^6156fee4]. The Lancet: Gastroenterology & Hepatology (2022). High credibility.
...
### Procalcitonin to guide initiation and duration of antibiotic treatment in acute respiratory infections: an individual patient data meta-analysis [^654e1b47]. Clinical Infectious Diseases (2012). Low credibility.
...
### Cost-effectiveness of procalcitonin-guided antibiotic use in community acquired pneumonia [^3e910ea3]. Journal of General Internal Medicine (2013). Low credibility.
...
### Procalcitonin-guided antibiotic therapy may shorten length of treatment and may improve survival-a systematic review and meta-analysis [^75807112]. Critical Care (2023). Medium credibility.
...
### Use of a procalcitonin-guided antibiotic treatment algorithm in the pediatric intensive care unit [^2c866626]. The Pediatric Infectious Disease Journal (2021). Medium credibility.
...
### Procalcitonin algorithm in critically ill adults with undifferentiated infection or suspected sepsis. A randomized controlled trial [^621ef949]. American Journal of Respiratory and Critical Care Medicine (2014). Low credibility.
...
### Antibiotic prescribing patterns for coronavirus disease 2019 (COVID-19) in two emergency departments with rapid procalcitonin [^d823a840]. Infection Control and Hospital Epidemiology (2021). Medium credibility.
...
### Using procalcitonin to guide antimicrobial duration in sepsis: asking the same questions will not bring different answers [^40977413]. Critical Care (2014). Low credibility.
...
### Prognostic value of procalcitonin in respiratory tract infections across clinical settings [^847868ad]. Critical Care (2015). Low credibility.
...
### Procalcitonin to guide initiation and duration of antibiotic treatment in acute respiratory infections: an individual patient data meta-analysis [^3a8d6b82]. Clinical Infectious Diseases (2012). Low credibility.
...
### Procalcitonin algorithm to guide initial antibiotic therapy in acute exacerbations of COPD admitted to the ICU: a randomized multicenter study [^cbf1d713]. Intensive Care Medicine (2018). Low credibility.
...
### Procalcitonin decrease over 72 hours in US critical care units predicts fatal outcome in sepsis patients [^5574a429]. Critical Care (2013). Low credibility.
...
### Procalcitonin-guided therapy in intensive care unit patients with severe sepsis and septic shock – a systematic review and meta-analysis [^11218fc4]. Critical Care (2013). Low credibility.
...
### Procalcitonin-guided duration of antibiotic treatment in children hospitalised with confirmed or suspected bacterial infection in the UK (BATCH): a pragmatic, multicentre, open-label, two-arm, individually randomised, controlled trial [^f3caa252]. The Lancet: Child & Adolescent Health (2025). High credibility.
...
### Procalcitonin-guided antibiotic therapy may shorten length of treatment and may improve survival-a systematic review and meta-analysis [^3208a354]. Critical Care (2023). Medium credibility.
...
### Benefits and harms of procalcitonin-or C-reactive protein-guided antimicrobial discontinuation in critically ill adults with sepsis: a systematic review and network meta-analysis [^807eda32]. Critical Care Medicine (2024). Medium credibility.
...
### Procalcitonin as a marker of severe bacterial infection in children in the emergency department [^e408359b]. Pediatric Emergency Care (2010). Low credibility.
...
### Procalcitonin algorithm to guide initial antibiotic therapy in acute exacerbations of COPD admitted to the ICU: a randomized multicenter study [^2842ce0b]. Intensive Care Medicine (2018). Low credibility.
...
### Procalcitonin to guide initiation and duration of antibiotic treatment in acute respiratory infections: an individual patient data meta-analysis [^446030db]. Clinical Infectious Diseases (2012). Low credibility.
...
### Medullary thyroid carcinoma: recent advances in identification, treatment, and prognosis [^b87e0546]. Therapeutic Advances in Endocrinology and Metabolism (2021). Medium credibility.
