...
> Let me first confirm the clinical frame: NAFLD spans simple steatosis to NASH with fibrosis, and only those with biopsy-proven NASH and at least stage 2 fibrosis (or high-risk features) are generally considered for liver-directed pharmacotherapy, because simple steatosis has an excellent prognosis and does not warrant drug therapy by itself [^115uYnQT] [^111zd4Ni] [^115AjgM3].
