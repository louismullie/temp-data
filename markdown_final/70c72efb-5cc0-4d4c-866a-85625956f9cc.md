...
> I need to verify the FDA-approved indication and labeled strengths. Tacrolimus ointment 0.03% and 0.1% are indicated as second-line therapy for short-term and non-continuous chronic treatment of moderate to severe atopic dermatitis in non-immunocompromised patients who have failed or cannot tolerate other topical prescriptions; only 0.03% is approved for children aged 2 to 15 years, and use under 2 years is not recommended [^116wTUQv] [^112FMEdP].

> Next, I should review efficacy versus vehicle. In phase 3 randomized trials, both 0.03% and 0.1% were superior to vehicle, with 0.1% showing higher response rates; for example, approximately 27.5% with 0.03% and 36.8% with 0.1% achieved at least 90% improvement by physician global assessment versus 6.6% with vehicle, with onset often within the first week of therapy [^11591a2F] [^117NFj8v].
