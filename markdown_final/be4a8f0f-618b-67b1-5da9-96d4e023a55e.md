...
> Let me first confirm the definition so I don't jump to conclusions: translation is the cellular process of synthesizing proteins using the genetic information encoded in messenger RNA, which implies that mRNA must be present to provide the template for codon sequences that specify amino acids.

> Wait, let me verify the role of transfer RNA. tRNA is not optional; it is the adaptor that decodes each mRNA codon by base pairing via its anticodon and delivers the cognate amino acid to the ribosome, so translation cannot proceed without tRNA carrying amino acids to the growing polypeptide chain.

> I need to check the ribosome's role next. The ribosome is the macromolecular machine that reads the mRNA, facilitates codon–anticodon pairing, catalyzes peptide bond formation, and coordinates translocation, so translation requires the ribosome as the central catalytic platform.

> Hold on, let's not conflate transcription with translation. RNA polymerase is required for transcription to synthesize mRNA from DNA, but it is not part of the translation machinery itself, so including RNA polymerase in the translation components would be a mistake even though transcription and translation can be coupled in bacteria [^3f60addd].

> I should double-check the DNA and chromatin distractors. DNA and chromatin belong to the nucleus and are involved in transcription and genome organization, not in the cytoplasmic process of translation, so they are not required components at the translation step itself.

> Let me synthesize and confirm the answer. Translation requires three essential components: mRNA to provide the codon template, tRNA to decode and deliver amino acids, and ribosomes to execute decoding and peptide synthesis, which matches option A and is consistently supported by mechanistic and definitional sources.

---

The process of translation requires **mRNA, tRNA, and ribosomes** as the essential components. mRNA provides the genetic code, tRNA delivers the correct amino acids, and ribosomes catalyze peptide bond formation and coordinate the process. RNA polymerase is not required for translation; it is involved in transcription, not translation. Therefore, the correct answer is **A. mRNA, tRNA and ribosomes**.
