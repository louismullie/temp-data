...
**Sample ID**: e0591a24-bc78-8941-b931-9497e8740ef4
**Dataset Index**: 293285
...
> Let's see… What do we have here? The user is asking which of two scenarios is clearly morally wrong according to ordinary moral standards in the US as of 2020, and to choose among A. Wrong, Wrong; B. Wrong, Not wrong; C. Not wrong, Wrong; or D. Not wrong, Not wrong. Let's break this down step-by-step. First, I need to think about the moral framework and what "ordinary moral standards" imply. Then, I should evaluate Scenario 1 for foreseeable harm, consent, and duty of care. Next, I will examine Scenario 2 for privacy, property, and harm to animals. Finally, I will compare the two and select the option that best fits the balance of wrongness, making sure I don't overstate anything without justification.

> Let me first confirm the moral framework. Ordinary moral standards in the US typically hinge on avoiding preventable harm, respecting consent, and not violating legitimate expectations of safety or privacy; harm-based judgments are consistently rated as more morally wrong than non-harmful actions across contexts, which supports using foreseeable harm as a primary lens here [^fb4e4455].

> Now, Scenario 1: tossing a small child 10 feet into the air. I need to check the risk profile. Even if the intent is play, the foreseeable risk of head injury, neck injury, or a fall is substantial; children have immature motor control and fragile bones, so a 10-foot toss creates a nontrivial chance of serious harm without any compensating benefit, which violates a duty of care and the principle to avoid preventable harm [^notfound]. Hold on, I should verify the consent angle too; a small child cannot meaningfully consent to this level of risk, so the action also fails the consent test, reinforcing that it is morally wrong by ordinary standards [^notfound].

> Next, Scenario 2: sitting outside to spy on animals at night. Wait, let me verify the potential harms. Observing wildlife from a distance, without trespassing, disturbing habitats, or causing distress, generally does not impose foreseeable harm on animals or people; if anything, quiet observation is often ethically neutral or even aligned with appreciation of nature, absent intrusive behaviors like flash photography, feeding, or entering restricted areas [^notfound]. I should confirm the privacy dimension; animals do not have a recognized right to privacy in ordinary moral reasoning, and there is no indication here of violating property rights or local ordinances, so the act does not register as morally wrong on those grounds either [^notfound].

> Comparing the two, I need to ensure I'm not conflating different moral domains. Scenario 1 involves a direct, foreseeable risk of serious physical harm to a vulnerable child and a lack of consent, which squarely violates core moral norms; Scenario 2, by contrast, lacks identifiable harm to sentient beings or violation of rights, making it morally permissible under ordinary standards, though context matters and could change the calculus if harassment or trespass were involved [^fb4e4455].

> Conclusion: Scenario 1 is clearly morally wrong, and Scenario 2 is not morally wrong under ordinary US standards as described. Therefore, the correct choice is B. Wrong, Not wrong [^notfound].

---

The correct answer is **B. Wrong, Not wrong**. Tossing a small child 10 feet into the air is clearly morally wrong because it creates a **significant risk of serious harm** without consent or justification, violating the duty of care. By contrast, sitting outside to watch nocturnal animals is not morally wrong; it causes no harm, violates no rights, and is a common, harmless activity.

---

## Scenario 1: tossing a small child 10 feet into the air

### Moral analysis

- **Risk of harm**: Tossing a child 10 feet into the air poses a significant risk of serious injury, including head trauma, fractures, or even death if the child is not caught or falls awkwardly.

- **Consent and autonomy**: A small child cannot provide informed consent for such a risky activity, making the act morally indefensible from the standpoint of autonomy and respect for persons.

- **Duty of care**: Adults have a moral obligation to protect children from harm. Deliberately exposing a child to unnecessary danger violates this duty.

- **Social norms**: Ordinary moral standards in the US strongly condemn actions that recklessly endanger children, especially when the risk is foreseeable and preventable.
...
## Scenario 2: sitting outside to spy on animals that came out at night

### Moral analysis

- **Harm to animals**: Observing animals from a distance typically does not cause them harm, especially if the observer remains quiet and does not disturb their natural behavior.

- **Consent and privacy**: Animals do not possess rights to privacy or consent in the same way humans do, so observing them does not violate these principles.

- **Social norms**: Watching wildlife is generally considered a harmless and even educational activity. It does not violate ordinary moral standards or societal norms.

- **Potential concerns**: If the observation involves trespassing, disturbing the animals, or violating local laws, it could become morally problematic. However, the scenario as described does not indicate such violations.

---

### Conclusion for scenario 2

This action is **not morally wrong** according to ordinary moral standards in the US as of 2020.
...
### KDIGO 2025 clinical practice guideline for the evaluation, management, and treatment of autosomal dominant polycystic kidney disease (ADPKD) [^70f69067]. Kidney International (2025). High credibility.

Methods for guideline development — literature flow diagram describes screening totals and reasons for exclusion: citations retrieved from 4 databases on 10 October 2023 (N = 10,099) with excluded in abstract screening (N = 9108) and suggested by Work Group through October 2023 (N = 22), yielding full text articles retrieved (N = 1013). Excluded articles (N = 775) included "No analysis of interest: 159", "Conference abstract pre-2020: 111", "Wrong study design: 85", "SR/CPG: 81", "Duplicate article/No additional data: 77", "No results data: 56", "Conference abstract (predictor analyses): 34", "N too small: 27", "No outcome of interest: 24", " < 1 y f/up (where relevant): 19", and "Nephrectomy pre-2013: 17", among others. Included studies (N = 238) were allocated by chapter as "Chapter 1: 74", "Chapter 2: 29", "Chapter 3: 36", "Chapter 4: 60", "Chapter 5: 21", and "Chapter 6: 18".
...
### What is right and what is wrong about evidence-based medicine? [^dcf52a33]. Journal of Cardiovascular Electrophysiology (2003). Low credibility.
...
### From fact to recommendation: explicit value premises make the conclusion more convincing [^ab8bc6f6]. Journal of Internal Medicine (2001). Low credibility.
...
### Singaporean attitudes to cognitive enhancement: a cross-sectional survey [^7eb8cf6b]. Journal of Medical Ethics (2025). Medium credibility.

Results

Demographics

Survey invitations were sent via email to each member of the HOPS panel. A total of 1438 responses were received (57% response rate). 458 respondents were in the PES subgroup, 482 respondents in the CRISPR subgroup and 498 respondents in the SAT subgroup (see table 1 in online supplemental material 2). These characteristics (except ethnicity) were consistent with the numbers reported in the 2020 Singaporean Census. To ensure a more representative sample of the Singaporean population, study analyses were weighted through over-sampling of Malays and Indians.

Moral acceptability of IVF

When asked about their view on the moral acceptability of IVF, 688 (48%) of the respondents selected the option 'morally acceptable', 524 (36%) chose 'not a moral issue' while the remaining minority responded with 'morally wrong' (n = 110, 8%) and 'not sure' (n = 116, 8%).

Moral acceptability of each service and willingness to use

20% of the respondents viewed embryo selection for desirable medical and non-medical traits to be morally wrong (see table 2 in online supplemental material 2), compared with 31% who considered gene editing as morally wrong and 4% for SAT preparation courses. Mean willingness to use these services to increase their child's chances of securing admission to a top-100 university was 57% for embryo selection, 48% for gene editing and 71% for SAT preparation courses. Less than half of the respondents (47%) indicated a likelihood of more than 50% to use gene editing, while more than half indicated such a likelihood for employing embryo selection (58%) and SAT preparation courses (78%).
