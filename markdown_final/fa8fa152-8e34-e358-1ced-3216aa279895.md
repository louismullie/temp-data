...
> In summary, I need to be precise: there is no direct clinical evidence in the provided references supporting neem for acne vulgaris, mechanistic rationale is insufficient, and established therapies with supportive evidence remain the standard of care; therefore, neem should not be recommended for acne treatment outside of a clinical trial, and patients using it should be counseled accordingly while transitioning to guideline-supported regimens when possible [^notfound] [^afa331fb] [^b4358aaa].
