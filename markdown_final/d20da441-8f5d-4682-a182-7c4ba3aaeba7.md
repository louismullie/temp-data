...
Tirbanibulin has shown unique features in terms of mechanism of action, including its dual activity on microtubule dynamics and Src kinase signaling, short treatment duration, clinical outcomes, and favorable tolerability profile. These characteristics may support its use across various AK presentations, including hyperkeratotic forms, maintaining an excellent safety profile even when applied on a large field of up to 100 cm 2.
