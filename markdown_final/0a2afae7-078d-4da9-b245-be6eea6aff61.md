...
**Sample ID**: 0a2afae7-078d-4da9-b245-be6eea6aff61
**Dataset Index**: 4164
...
At what age do we stop mammograms

---

## Answer

> Let's see… What do we have here? The user is asking when to stop screening mammography in older women and how to frame that decision. Let's break this down step-by-step. First, I need to think about the highest-quality guideline positions and where they converge or diverge. Then, I should verify the strength of evidence for women 75 years and older, especially whether randomized trials exist. Next, I will examine observational and modeling data to estimate benefits and harms beyond 75. After that, I need to check how life expectancy modifies benefit and how to operationalize a 10-year life expectancy threshold. Finally, I will synthesize practical recommendations and a shared decision-making approach, while double-checking for any conflicting data I might be overlooking.

> Let me first confirm the guideline landscape so I don't jump to conclusions. The USPSTF gives a B recommendation for biennial screening ages 40–74 and an I statement for women 75 and older, reflecting insufficient evidence to recommend for or against screening beyond 74, which is a key anchor for shared decision-making rather than a blanket stop rule [^111v445a]. The American Cancer Society advises continuing screening as long as overall health is good and life expectancy is at least 10 years, explicitly rejecting age-alone cessation and emphasizing individualized decisions beyond 75 [^111FYQwv]. ACOG recommends screening at least through age 75 and then individualizing beyond that based on health status and longevity, again avoiding a fixed stop age [^1164hhhG]. The ACR and Society of Breast Imaging support continuing screening past 74 without an upper age limit unless severe comorbidities limit life expectancy, aligning with a more permissive stance for healthy older women [^111BpqKv]. Hold on, I should verify that these are the most current statements; yes, these reflect the 2024 USPSTF update and contemporary ACS and ACOG positions [^1164hhhG] [^111FYQwv] [^111VgZPM].

> Wait, let me verify the evidence gap for women 75 and older before inferring benefit. There are no randomized controlled trials of screening mammography that enrolled women 75 years or older, so the highest-quality trial evidence is absent for this exact question, which is why USPSTF issues an I statement and why recommendations must rely on observational data, modeling, and extrapolation from younger cohorts [^111v445a] [^116V11Pj]. I should double-check whether any emulated trials or large observational studies inform this; yes, a Medicare emulation found no mortality benefit to continuing screening from 75–84 compared with stopping, whereas modeling studies have suggested potential benefit, highlighting the uncertainty and the need to individualize decisions [^115uzzRT] [^115aqSdB].

> Next, I should review the magnitude of potential benefit and harms beyond 75 to frame counseling. Modeling estimates suggest that continuing screening in women 75 and older can avert a small number of breast cancer deaths but increases false positives and overdiagnosis; for example, five additional screens over 10 years in healthy 75-year-olds may avert roughly 4–15 breast cancer deaths per 1000 while yielding 238–268 false positives and 29–31% overdiagnosis, with diminishing returns at older ages and with comorbidity [^112qQ9fy]. Observational syntheses report mixed mortality signals and consistent increases in overdiagnosis with screening beyond 75, reinforcing that the balance of benefits and harms shifts with age and health status [^111v3nt8] [^114pDRPE]. Hold on, I should verify that these harms are not trivial; false positives and overdiagnosis can lead to invasive procedures, anxiety, and overtreatment, which carry higher risks in older adults, so patient values are crucial here [^112jtt4w].

> I need to ensure I'm applying the right decision threshold. The most consistently endorsed clinical criterion is a 10-year life expectancy: if life expectancy is under 10 years, the time-to-benefit for screening is unlikely to be realized, and harms likely predominate; if life expectancy is 10 years or more, screening may be reasonable depending on preferences and health status [^111FYQwv] [^111VgZPM]. Let me consider how this translates at the bedside: approximately 50% of 80-year-old women and 25% of 85-year-old women have a 10-year life expectancy, so many women in their late 70s to early 80s still meet this threshold, whereas most women older than 85–90 do not, though exceptions exist in the healthiest quartiles [^116ZTVC4]. I should confirm that tools like ePrognosis can help estimate life expectancy objectively to support these discussions [^116FTBAX].

> But wait, what if a healthy 75-year-old wants to continue annual screening rather than biennial? Does that change the calculus? Annual screening increases detection and may modestly increase mortality reduction at the cost of more false positives and overdiagnosis; modeling and radiology society guidance suggest that annual screening can be offered to women who prioritize maximizing benefit and accept more recalls, whereas biennial screening is more efficient at the population level and may better balance benefits and harms for many older women [^115aqSdB] [^111BpqKv]. I should double-check that this aligns with patient preference discussions; yes, shared decision-making should explicitly weigh these trade-offs, including anxiety from callbacks and the possibility of treating indolent disease [^112jtt4w].

> Let me synthesize a practical approach, and I will now examine how to operationalize it. For women aged 75 and older, I should confirm health status and estimate life expectancy; if life expectancy is less than 10 years, I recommend stopping screening and pivoting to comfort-focused and geriatric-preventive priorities, explaining that the lag to benefit exceeds expected survival and that harms are more likely [^111FYQwv] [^111VgZPM]. If life expectancy is 10 years or more, I should offer screening with a discussion of frequency, acknowledging that biennial screening is reasonable and efficient, while annual screening is acceptable if the patient values marginal gains and accepts more false positives and potential overdiagnosis; this is a shared decision, not a mandate [^1164hhhG] [^111BpqKv]. Hold on, I should verify that stopping rules are framed gently; using decision aids and clear communication about overdiagnosis can improve informed choice and reduce unnecessary screening in those unlikely to benefit [^114DRF5j] [^1145fCq1].

> I should confirm special situations. For women with significant comorbidity or frailty, even if age is under 85, life expectancy may be under 10 years, so stopping screening is appropriate. Conversely, exceptionally healthy women in their early 80s may still have a 10-year life expectancy and could reasonably continue screening if they value potential benefit more than harms [^116ZTVC4]. For breast cancer survivors, surveillance mammography decisions should also be individualized by life expectancy, with many experts recommending cessation when life expectancy is under 5–10 years, while continuing for those with longer expected survival and higher in-breast event risk, again via shared decision-making [^116FSUVt].

> Hmm, wait a minute, I almost implied there is a hard stop at 75. That would be misleading. There is no universal age cutoff endorsed by major U.S. guidelines, and authoritative bodies explicitly reject age-alone cessation, so the decision must be individualized to health, comorbidity, and preferences rather than a calendar age [^111VgZPM] [^111FYQwv]. I should double-check that this nuance is clear: the USPSTF I statement is not a recommendation to stop; it is a call for individualized decisions in the absence of trial evidence, which is why many clinicians use the 10-year life expectancy framework to guide discussions [^111v445a].

> Final check and bottom line: Do not stop mammograms based on age alone. Stop when life expectancy is under 10 years or when severe comorbidity limits benefit, and for women 75 and older with 10 or more years of life expectancy, offer screening with a conversation about biennial versus annual intervals, potential false positives, and overdiagnosis, documenting shared decision-making and patient values to guide continuation or cessation [^111FYQwv] [^111VgZPM].

---

There is **no fixed age to stop mammograms**; decisions should be individualized based on health status and life expectancy [^111VgZPM]. Most guidelines recommend continuing screening **as long as the woman is in good health and has a life expectancy of at least 10 years** [^111FYQwv] [^1164hhhG]. The USPSTF gives an **I statement** for women ≥ 75 due to insufficient evidence, so shared decision-making is essential [^111v445a]. ACOG advises screening at least to age 75, then individualized decisions thereafter [^114L13HJ] [^111VgZPM]. Stop screening when life expectancy is < 10 years or when severe comorbidities limit benefit [^116FTBAX] [^112MVT8d].

---

## Current guidelines and recommendations

| **Organization** | **Recommendation on stopping mammograms** |
|-|-|
| USPSTF | - Insufficient evidence (I statement) for women ≥ 75 years <br/> - Individualize decisions based on health, comorbidities, and preferences [^111v445a] |
| ACOG | - Screen at least to age 75 <br/> - Individualize beyond 75 based on health and longevity [^111VgZPM] |
| ACS | - Continue as long as overall health is good and life expectancy ≥ 10 years [^111FYQwv] |
| ACR/SBI | - Continue past 74 without an upper age limit unless severe comorbidities limit life expectancy [^111BpqKv] |
| WPSI | - Continue through at least age 74 <br/> - Age alone should not determine stopping [^115wE8Lp] |

---

## Evidence on benefits and harms of screening in older women

### Benefits

Potential benefits include **early detection** of smaller, lower-stage cancers, enabling less invasive treatment and reduced morbidity and mortality [^116bMxHF] [^117LfpNJ]. Observational data suggest a **mortality reduction** with regular screening in healthy older women [^116bMxHF] [^116FTBAX].

---

### Harms

- **False positives**: Increased risk of false positives, biopsies, and anxiety [^116FTBAX] [^112jtt4w].
- **Overdiagnosis**: Higher risk of overdiagnosis and overtreatment, especially with limited life expectancy [^116FTBAX] [^111v3nt8].
- **Physical/psychological**: Potential harms from unnecessary procedures and treatments [^116FTBAX] [^113d36kB].

---

## Factors influencing the decision to stop screening

- **Life expectancy**: Key determinant; ≥ 10 years supports continued screening [^111FYQwv] [^111VgZPM].
- **Comorbidities**: Severe comorbidities or functional limitations may outweigh benefits [^1164hhhG] [^115CDdsy].
- **Patient preferences**: Values and preferences should guide decisions [^111VgZPM] [^114PTzJb].
- **Health status**: Overall health and functional status inform benefit-harm balance [^116FTBAX] [^111VgZPM].

---

## Clinical evidence on stopping screening at specific ages

- **Age 75**: No clear mortality benefit to continuing beyond 75 in all women; individualize decisions [^115uzzRT] [^111VgZPM].
- **Age 80**: Many women have < 10-year life expectancy; screening often stops unless exceptional health [^116ZTVC4] [^116FTBAX].
- **Age 85**: Generally recommended to stop due to limited life expectancy and increased harms [^116FTBAX] [^112MVT8d].

---

## Shared decision-making and patient counseling

Shared decision-making is essential to discuss **benefits, harms, and preferences** and to align screening decisions with patient values and goals [^114PTzJb] [^116FTBAX]. Decision aids can improve **informed decision-making** and help patients weigh trade-offs [^114DRF5j].

---

## Practical clinical recommendations

- **Continue screening**: For women in good health with ≥ 10-year life expectancy [^111FYQwv] [^112SjnVL].
- **Individualize decisions**: Base on comorbidities, functional status, and preferences [^116bMxHF] [^111VgZPM].
- **Stop screening**: When life expectancy < 10 years or severe comorbidities limit benefit [^116FTBAX] [^112MVT8d].
- **Annual vs biennial**: Annual may benefit highest-risk women; biennial reduces harms [^1152SscC] [^115aqSdB].

---

There is **no fixed age to stop mammograms**; decisions should be individualized based on health, comorbidities, and preferences, with screening continued as long as life expectancy is ≥ 10 years and stopped when severe comorbidities or limited life expectancy make harms outweigh benefits [^111FYQwv] [^111VgZPM] [^111BpqKv].
...
### Effect of mammographic screening from age 40 years on breast cancer mortality (UK age trial): final results of a randomised, controlled trial [^1172CwFP]. The Lancet: Oncology (2020). High credibility.

Introduction

The UK, along with many other countries, has a breast cancer screening programme offering mammography to women aged 50–70 years every 3 years. There remains uncertainty as to the appropriate age at which to start screening, specifically about whether to screen women younger than 50 years. Recommendations from official and charitable bodies vary. Mammographic screening in this age group presents a greater challenge than at older ages in both radiological and public health terms. First, the typical composition of the breast is more radiologically dense in younger women, reducing the sensitivity of mammography. Second, breast cancer incidence and mortality are lower in women younger than 50 years than in women aged 50 years and older, so the potential absolute gain from screening is lower. Third, there is evidence that tumours in younger women progress more rapidly, are more likely to be oestrogen receptor negative, and have unfavourable histological grade. Thus, there remains interest in the effects, both favourable and unfavourable, of mammography screening in women aged 40–49 years.

Two major UK studies of mammographic screening before 50 years of age are the AgeX trialof extending the screening age range to 47–73 years, and the UK Age trialof yearly screening from the age of 40 years. The AgeX trial is not expected to report results until 2026. The UK Age trial reported 17-year follow-up results in 2015, showing a reduction in breast cancer mortality with yearly screening from the age of 40 years, which was significant in the first 10 years after randomisation, and was attenuated thereafter. In this paper, we report on breast cancer incidence and mortality results in the UK Age trial after 23 years of follow-up.

Research in context

Evidence before this study

We searched PubMed with no date or language restrictions with the search terms "breast" AND "screening" AND "mammography" AND "age" AND "trial". This search yielded eight trials. Results from all the trials (except the UK Age trial) included the effect of screening after participants younger than 50 years at randomisation reached age 50 years. In meta-analyses of these trials, Cochrane and US Preventive Services Task Force reviews found 13–16% reductions in breast cancer mortality with invitation to screening before age 50 years. There is considerable uncertainty about overdiagnosis of breast cancer in this age group, as previous estimates vary widely.
...
### Screening mammography among older women: a review of United States guidelines and potential harms [^113d36kB]. Journal of Women's Health (2019). Medium credibility.
...
Of the 27 observational studies, 18 studies followed up women after screening and/or diagnosis; follow-up times in these studies ranged from 4 months to 20 years. Three studies did not include any comparison group and provided only descriptive statistics and three studies compared groups by detection methods in those with breast cancer. One study had multiple comparisons (by age and screening history); the remaining studies compared mammography screening outcomes in women aged 75 years and older with screening outcomes in women: of other ages (ten studies); differing screening histories (three studies); differing screening intervals (three studies) or historical unscreened women (one study); women who did not screen (one study) and women who stopped screening (two studies). (Table 1).
...
### Collaborative modeling to compare different breast cancer screening strategies: a decision analysis for the US preventive services task force [^115aqSdB]. JAMA (2024). Excellent credibility.
...
### Use of patient decision aids increased younger women's reluctance to begin screening mammography: a systematic review and meta-analysis [^115S3M4C]. Journal of General Internal Medicine (2017). Low credibility.
...
### The cost-effectiveness of screening mammography beyond age 65 years: a systematic review for the U.S. Preventive Services Task Force [^114dbEe5]. Annals of Internal Medicine (2003). Low credibility.
...
### Informing women about overdetection in breast cancer screening: two-year outcomes from a randomized trial [^114DRF5j]. Journal of the National Cancer Institute (2021). Medium credibility.
...
Decision aids are tools to communicate evidence-based information about benefits and harms of different health-care options to help people make informed decisions. Numerous randomized trials show decision aids improve knowledge and facilitate informed choice in various settings, including cancer screening. However, earlier breast screening decision aid trials did not involve women aged 50 years (when screening is initiated in many countries), and the decision aids paid little attention to overdetection. We developed the world's first mammography decision aid giving comprehensive explanatory and quantitative information about overdetection along with other important breast screening outcomes. Both intervention and control versions included information about breast cancer deaths averted and false-positive screening results, but only the intervention decision aid contained information about overdetection.

The aim of our study was to investigate for the first time the effects of including evidence-based consumer-friendly information about overdetection of breast cancer in a decision aid in a community sample of women around the target age for starting breast screening in Australia. Mammographic screening is offered free of charge to women in Australia, and treatment is available to all through the public health-care system. We previously published short-term findings showing that overdetection information statistically significantly improved knowledge and increased the number of women making an informed choice about breast screening. Here, we present the effects of the intervention on a range of additional prespecified outcomes collected from the same study cohort over 2 years of follow-up, importantly including both self-reported and objectively measured data on participation in screening.
...
### Effect of mammographic screening from age 40 years on breast cancer mortality in the UK age trial at 17 years' follow-up: a randomised controlled trial [^1152nnKd]. The Lancet: Oncology (2015). Medium credibility.
...
### Screening mammography in women 40–49 years old: current evidence [^115ReCRe]. AJR: American Journal of Roentgenology (2018). Low credibility.

Objective

Breast cancer is an important health problem for women 40–49 years old, yet screening mammography for this age group remains controversial. This article reviews recent guidelines and supporting evidence on screening mammography in women of this age group.

Conclusion

Evidence supports the benefit of annual screening mammography in women 40–49 years old. Models of different breast cancer screening strategies consistently show the greatest breast cancer mortality reduction and life-years gained with annual screening starting when women reach 40 years old.
...
### Challenges women face limit mammograms… [^114udaPP]. CDC (2025). Medium credibility.

Screening mammograms can save lives Breast cancer causes more than 40, 000 deaths in women each year in the United States. Deaths due to breast cancer have decreased over time, yet some groups experience more deaths than others. For example, Black women, women who are uninsured, and women with low incomes are more likely to die from breast cancer. Screening mammograms have been shown to reduce breast cancer death by 22%. Regular mammograms can find breast cancer early Getting screening mammograms regularly can help find breast cancer early when it is easier to treat. Women ages 50 to 74 years should get a screening mammogram every 2 years, as currently recommended by the U. S. Preventive Services Task Force. The task force is a group of doctors and disease experts who look at research on the best way to prevent diseases. This group makes recommendations on how doctors can help patients avoid diseases or find them early.

Women ages 40 to 49 years should talk to their health care providers about when to start and how often to get a mammogram. Regular mammograms can find breast cancer early Getting screening mammograms regularly can help find breast cancer early when it is easier to treat. Women ages 50 to 74 years should get a screening mammogram every 2 years, as currently recommended by the U. S. Preventive Services Task Force. The task force is a group of doctors and disease experts who look at research on the best way to prevent diseases. This group makes recommendations on how doctors can help patients avoid diseases or find them early. Women ages 40 to 49 years should talk to their health care providers about when to start and how often to get a mammogram. Only about 3 in 4 women ages 50 to 74 years were up to date with their mammograms in 2022. More women need to get screening mammograms that can save lives.

Women ages 50 to 74 years who are at average risk for breast cancer should get a screening mammogram every 2 years. This will help find breast cancer early when treatment works best. Average risk refers to women without a strong family history of breast cancer, without changes in certain breast cancer genes, and who have not had chest radiation. Women who are 40 to 49 years old should talk to their doctor about when to start and how often to get a mammogram.
...
- There is no mortality benefit to screening women 75 years or older or with a life expectancy less than 10 years because screening benefits are not seen for 11 years. Recommendations AGE 50 TO 74 YEARS Women 50 to 74 years of age should be screened with mammography biennially. Screening women 50 to 69 years of age reduces breast cancer mortality but not all-cause mortality.

A benefit is less clear for women 70 to 74 years of age, but the best balance of benefits to harms for breast cancer screening is from 50 to 74 years of age. AGE 40 TO 49 YEARS Women 40 to 49 years of age should discuss the decision to screen for breast cancer with their clinician. For most women, the harms outweigh the benefits of screening for breast cancer with mammography. If 1, 000 women are screened from 40 to 74 years of age, one additional breast cancer death will be prevented at the cost of 576 additional false-positive screens, 67 additional unnecessary biopsies, and two cancers will be overdiagnosed compared with screening from 50 to 74 years of age. AGE 75 OR OLDER OR LIFE EXPECTANCY LESS THAN 10 YEARS Women 75 years or older or who have a life expectancy of 10 years or less should not be screened for breast cancer.

Older age, comorbid conditions that reduce life expectancy, and the patient value of the balance of benefits and harms are all reasons to discontinue breast cancer screening for this age group. The American Academy of Family Physicians supports the USPSTF recommendations for biennial screening in women 50 to 74 years of age and an individual decision for starting biennial screening at age 40 based on limited benefit and increased harms. — Michael Arnold, MD, Medical Editing Fellow.

---

### Effect of mammographic screening from age 40 years on breast cancer mortality (UK age trial): final results of a randomised, controlled trial [^114FG51a]. The Lancet: Oncology (2020). High credibility.

Randomisation and masking

Women were randomly assigned (1:2) to the intervention group or control group. From April 1, 1992, onwards, randomisation and allocation to trial group were carried out on the Health Authorities computer system using ad hoc software. Randomisation used computerised random number generation and was done by Health Authority personnel independently of the screening centres and without the screening services having previous sight of the randomisation status. Before this, in three centres that started the trial early, when randomisation on the system was not yet available to the trial, random number lists were generated, also from a computerised random number generator, by the trial coordinators and applied to GP practice lists. This randomisation was also done independently of screening services, without their knowledge of randomisation status. It was not feasible to blind the screening services thereafter, because they had to deliver the screening to the intervention group. Individual randomisation was done, stratified by GP practice, so that a third of the women in any practice were allocated to the intervention group, but otherwise randomisation was unrestricted and unblocked. For each general practice, the entire randomisation allocation was performed in a single run.

Procedures

Screening in the trial was by two-view film (analogue) mammography at the first screen, with single view thereafter, unless otherwise indicated. Mammograms were double read (both reads done locally). All women in the intervention group were re-invited for screening yearly unless they requested otherwise. Women who moved to areas not covered by the trial were not re-invited for screening as part of the trial, but were able to self-refer to either their previous or their nearest participating screening centre. Screening in three centres ceased prematurely (after four, five, and six rounds of screening) due to the inability of the centres to manage the additional workload.

Women were flagged with the National Health Service (NHS) Central Register, and the trialists have been notified of all breast cancers, breast cancer deaths, and deaths from all other causes, up to Feb 28, 2017. Since 2015, notifications were supplied by NHS Digital. At the age of 50 years, both groups became eligible for invitation to screening every 3 years as part of the NHSBSP, and received their first invitation between age 50 and 52 years. The intervention phase of the trial ceased for each participant when they were invited to their first NHSBSP screen. Cessation in all centres followed this protocol, except for three centres that had to stop screening early because of logistic and capacity issues.
...
### The benefits and harms of breast cancer screening: an independent review [^1139frsh]. British Journal of Cancer (2013). Low credibility.
...
### Recommendations from the Women's Preventive Services Initiative on breast cancer screening for women at average risk and patient navigation services for breast and cervical cancer screening [^113xFxkS]. Obstetrics and Gynecology (2025). Medium credibility.
...
### Individualizing surveillance mammography for older patients after treatment for early-stage breast cancer: multidisciplinary expert panel and International Society of Geriatric Oncology consensus statement [^116FSUVt]. JAMA Oncology (2021). High credibility.
...
### Health benefits and harms of mammography screening in older women (75 + years)-a systematic review [^111v3nt8]. British Journal of Cancer (2024). Medium credibility.

Discussion

The studies included in our systematic review used heterogeneous methods to assess and report on a range of outcomes for mammography screening in older women. Given this heterogeneity, we have summarised study-specific findings in evidence tables (since pooling of data would not be appropriate), noting there was mixed evidence about the benefits of continuing mammography screening beyond the age of 75 years. The few studies that reported on breast cancer mortality as outcome gave contrasting (mixed) results: about equal numbers of studies showed a beneficial effect or no effect on mortality and/or used un-informative comparisons.

Although fewer studies reported on the harms of screening beyond the age of 75, evidence presented on various harms (false positives, recalls, biopsy, and overdiagnosis) were generally more consistent. Specifically, there was consistent evidence that screening into older age increases overdiagnosis which can be partially explained due to the shorter follow-up time possible with older women, and higher competing causes of mortality.

The evidence reported in this review should be interpreted factoring in the various limitations we identified. Many studies used comparisons that were not informative about the health impact of screening into older age or used comparisons that could bias towards an effect from screening: the ideal comparison to assess the impact of screening beyond the age of 75 would be to compare those who continue screening with those who stop screening at the age of 75. Only two observational studies undertook this comparison, although some modelling studies simulated this scenario. The results of these studies are summarised in Appendix 2. When considering only these studies three of the modelling studies indicated a benefit, whereas both observational studies and one modelling study did not, and all six studies reported harms. One study showed similar estimates in breast cancer deaths averted, two showed no difference in risk of breast cancer death, two indicated benefit in terms of life years gained and two estimated a reduction in breast cancer mortality. We also see an additional number of false positive screens, an increase in the false positive biopsy rate, an increase in the incidence of breast cancer (including increase in both invasive cancer detection rates and DCIS rates)and an increase in overdiagnosis.
...
### Benefits and harms of breast cancer screening: a systematic review [^112jtt4w]. JAMA (2015). Excellent credibility.
...
### The WISDOM study: breaking the deadlock in the breast cancer screening debate [^116uvzPX]. NPJ Breast Cancer (2017). Low credibility.

Introduction

Annual screening mammography — the most common approach in the US today — has its roots in the large, randomized screening trials of the 1980s. The first trial of annual screening, the U.S. Health Insurance Plan of Greater New York, began in 1963 and included 31,000 women in each arm. At 18 years of follow-up, it showed a 25% reduction in mortality, although benefit to women in their forties accrued after they were 50. The overview of the Swedish trials of bi- or triennial screening showed a relative reduction in breast cancer mortality of 21%, with maximum benefit for women in their sixties. The degree and timing of benefit to younger women in particular has generated a great deal of controversy. Even a decade later, there remains a continuing debate over the methodologic flaws of each of these studies, the net effect of which has impeded consensus on public recommendations for breast screening. –

From the outset, translating these studies into population-based screening recommendations stirred controversy, with debate focused on the frequency and most appropriate age to begin screening. The January 1997 Consensus Development Panel convened by the National Institutes of Health recommended women aged 40–49 be informed of the benefits and risks of screening and decide for themselves. The National Cancer Institute (NCI) and American Cancer Society (ACS), however, recommended regular screening for women in their forties while disagreeing on screening frequency, with the former recommending every 1–2 years, the latter annually. Partly because of the controversy generated, the NCI later stopped issuing screening guidelines.

Now, 20 years later, we find ourselves in a familiar place — still reviewing and reanalyzing data from the same trials, debating the optimum age to begin and interval, with professional societies that set guidelines compelled to "take a side" in the debate. The controversy following the 2009 JAMA commentary "Rethinking Screening"and updates to USPSTF guidelinesillustrates how entrenched both sides have become. Consensus on recommendations remains distant.
...
### Breast cancer screening for average-risk women: recommendations from the ACR commission on breast imaging [^111rY5dB]. Journal of the American College of Radiology (2017). Low credibility.
...
### Health benefits and harms of mammography screening in older women (75 + years)-a systematic review [^114pDRPE]. British Journal of Cancer (2024). Medium credibility.
...
### Mammography screening should begin at age 40 years [^113ZZBkc]. Journal of Breast Imaging (2024). Medium credibility.
...
### Health benefits and harms of mammography screening in older women (75 + years)-a systematic review [^116w24KA]. British Journal of Cancer (2024). Medium credibility.
...
### Factors influencing elderly women's mammography screening decisions: implications for counseling [^1118Y416]. BMC Geriatrics (2007). Low credibility.

Although several studies offer clinicians advice on how to encourage patients to undergo mammography screening and two studies provide clinicians data to help determine which of their older patients may benefit from screening, we are unaware of studies that offer clinicians advice on how to discuss stopping screening with their patients. As it is important for clinicians to learn how to recommend screening, it is also important for clinicians to learn how to discuss stopping screening, especially since older patients report that they want to have these discussions with their clinicians. When discussing stopping screening with elderly women in poor health, clinicians may want to acknowledge they understand how hard it must be for a patient to stop going for mammography when they have been doing so for years. Clinicians may also want to explain that just as there is a time to start screening, there is also a time to stop screening. Clinicians should discuss the risks of screening elderly women in poor health (e.g. unknown benefit of screening and complications from work-up and treatment of breast cancer). In addition, since a need for reassurance about one's health is important to patients, clinicians should be sure to offer patients reassurance by saying they will focus on preventive health measures (e.g. screening for geriatric health issues) that are more likely to benefit these women. This may help prevent patients from feeling like their doctor is giving up on them.

Although it is difficult to draw conclusions about factors that influence older women to choose not to be screened due to the low numbers of these women in our study, women aged 80 and older who chose not to be screened ranked age and then doctor's counseling as the most important factors influencing their decision. In fact, women aged 80 and older were significantly more likely than younger women to score age highly in their decision not to get screened. Resnick et al. also found that age and a lack of a doctor's recommendation were the most common reasons older adults living in a retirement community gave for not undergoing screening. Physicians may need to explain to older women in good health who prefer not to be screened, that health rather than age should influence their decision. This is especially important since observational studies have found a mortality benefit of regular mammography screening for women aged 80–84 in good health.

---

### Benefits and harms of mammography screening in 75 + women to inform shared decision-making: a simulation modeling study [^112qQ9fy]. Journal of General Internal Medicine (2024). Medium credibility.
