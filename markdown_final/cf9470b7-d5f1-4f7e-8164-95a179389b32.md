...
Patients acquire Klebsiella pneumoniae primarily through **person-to-person contact** in healthcare settings [^1114jHPE], especially via contaminated hands and medical equipment [^notfound], and through **environmental reservoirs** such as sinks, ventilators, and surfaces [^113rcc12]. Community acquisition is less common but occurs via **fecal-oral transmission** [^112ikm25], contaminated food or water [^notfound], and close contact with colonized individuals [^112cJCXu]. Risk increases with **antibiotic exposure** [^1138vG6X], **indwelling devices** (catheters, ventilators) [^112E5a1A], and immunocompromised states [^116zTodt]. Preventing transmission relies on strict hand hygiene, device care, and infection control [^111UkJpA].
