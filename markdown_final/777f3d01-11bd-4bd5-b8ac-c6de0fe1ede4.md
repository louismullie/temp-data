...
> Let me first confirm the clinical phenotype of candidal diaper dermatitis. Classically, it presents as a beefy-red, confluent plaque involving the perianal and intertriginous areas with satellite pustules and often involvement of the deep folds, which helps distinguish it from irritant diaper dermatitis that tends to spare the folds and lacks satellite lesions [^notfound]. Wait, let me verify the satellite sign; yes, the presence of small peripheral pustules is a hallmark that should prompt consideration of Candida overgrowth superimposed on barrier breakdown [^1168cD8Y].
