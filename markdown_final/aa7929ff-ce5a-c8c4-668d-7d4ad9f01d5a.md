...
> Let me first confirm the foundational principles so I don't jump to conclusions: endometriosis is a chronic, estrogen-dependent, inflammatory disease with heterogeneous presentations, so a patient-centered, multimodal, and interdisciplinary approach is essential, and diagnosis should be clinical whenever possible to reduce the historical 5–12 year delay. I should also remember that normal imaging does not exclude disease, especially superficial peritoneal lesions, and that shared decision-making is critical at every step [^113MTMsK] [^113fTVX7] [^113y1aRp] [^117CEkk2].
...
- **Pelvic pain**: Cyclic, progressive dysmenorrhea; chronic pelvic pain; deep dyspareunia; dyschezia; dysuria [^113y1aRp].
- **Infertility**: Unexplained infertility or subfertility [^115wpZYk].
- **Physical findings**: Uterine tenderness, fixed retroverted uterus, adnexal masses, uterosacral nodularity, or tenderness [^116SJhqY].
...
Obtain a **detailed history** (pain characteristics, menstrual history, fertility goals, family history) and perform a **focused physical examination** (pelvic and rectovaginal) to identify deep nodules or endometriomas [^111vMneE] [^1146ibXg].

---

### Step 2: imaging

- **Transvaginal ultrasound (TVUS)**: First-line to detect endometriomas and deep infiltrating endometriosis (DIE) [^114UfQA6] [^1172Y659].
- **Magnetic resonance imaging (MRI)**: Use when TVUS is inconclusive or DIE is suspected; superior for mapping complex lesions [^111Zdafi] [^115f4cZQ].
- **Limitations**: Imaging cannot reliably detect superficial peritoneal disease; negative imaging does not exclude endometriosis [^117CEkk2] [^115wpZYk].

---

### Step 3: definitive diagnosis

Laparoscopy with histopathology remains the **gold standard** for definitive diagnosis, particularly when imaging is negative or empiric therapy fails [^111XeyKb] [^115wpZYk].

---

## Treatment algorithm

Treatment is **individualized** based on symptoms, fertility goals, age, and disease severity [^113fTVX7].

---

### Medical management (first-line)

- **Combined hormonal contraceptives**: First-line for pain suppression; continuous or cyclic regimens [^115wpZYk].
- **Progestin-only therapy**: Oral progestins, depot medroxyprogesterone acetate, or levonorgestrel intrauterine system (LNG-IUS) [^115wpZYk].
- **NSAIDs**: Adjunctive therapy for pain relief [^115vv2wu].

---

### Second-line medical therapy

- **GnRH agonists/antagonists**: For refractory pain; use with add-back therapy to mitigate bone loss [^111dVN7Z] [^114D274f].
- **Danazol**: Alternative for refractory cases; androgenic side effects limit use [^115wpZYk].

---

### Surgical management

- **Indications**: Refractory pain despite medical therapy, fertility goals, suspected malignancy, or large/endometriomas [^115JWHrT] [^115Z5oaN].
- **Approach**: Laparoscopic excision or ablation; excision preferred for endometriomas and deep disease [^112r1vtj] [^116kWBQ3].
- **Adjunctive therapy**: Postoperative hormonal suppression to reduce recurrence [^113MTMsK].

---

## Special considerations

- **Adolescents**: Empiric medical therapy is appropriate; laparoscopy reserved for refractory cases or diagnostic uncertainty [^116Xjzsp] [^112vWckN].
- **Infertility**: Individualized approach; consider surgery or assisted reproductive technology (ART) based on disease severity and patient preference [^112JsMWQ] [^113fTVX7].
- **Deep endometriosis**: Multidisciplinary care and expert surgical centers are recommended [^116EipnQ] [^1121Gkdv].

---

## Follow-up and monitoring

Regular follow-up is essential to assess **symptom control**, **treatment response**, and **recurrence**. Management should be adjusted based on patient feedback, side effects, and changing fertility goals [^113fTVX7].

---

## Emerging therapies and research

Research is ongoing into **noninvasive biomarkers**, **AI-assisted diagnostics**, and **novel medical therapies** to improve early detection and personalize treatment [^114xpFnU] [^116YPMyK] [^111cZZ4v].

---

The endometriosis algorithm emphasizes **early clinical recognition**, **targeted imaging**, and **individualized therapy**, with surgery reserved for refractory cases or fertility goals. This approach aims to reduce diagnostic delay, improve symptom control, and enhance quality of life [^113fTVX7].
...
### Role of a symptom-based algorithmic approach to chronic pelvic pain [^113ji7R8]. International Journal of Gynaecology and Obstetrics (2001). Low credibility.
...
### The endometrioma treatment paradigm when fertility is desired: a systematic review [^112mkw13]. Journal of Minimally Invasive Gynecology (2021). Medium credibility.
...
### Improving the diagnosis of endometriosis in Asia-Pacific: consensus from the Asia-Pacific endometriosis expert panel for endometriosis [^113KrfAb]. International Journal of Gynaecology and Obstetrics (2023). Medium credibility.
...
### Real world perspectives on endometriosis disease phenotyping through surgery, omics, health data, and artificial intelligence [^1121vZbg]. Npj Women's Health (2025). Medium credibility.
...
### Bowel endometriosis: diagnosis and management [^116g9hKR]. American Journal of Obstetrics and Gynecology (2018). Low credibility.
...
### Clinical use of artificial intelligence in endometriosis: a scoping review [^114ZgrSr]. NPJ Digital Medicine (2022). Medium credibility.
...
### ESHRE guideline: endometriosis [^115JWHrT]. Human Reproduction Open (2022). High credibility.
...
### ESHRE guideline: endometriosis [^116DiEAd]. Human Reproduction Open (2022). High credibility.
...
### Focus for the future: tackling the 'pelvic pain' problem in gynecologic practice-an interactive session [^117A8WH6]. International Journal of Gynaecology and Obstetrics (2001). Low credibility.
...
### Endometriosis: diagnosis and management [^116EipnQ]. Journal of Obstetrics and Gynaecology Canada (2010). Medium credibility.
...
### ESHRE guideline: endometriosis [^1153YLUN]. Human Reproduction Open (2022). High credibility.
...
### Endometriosis: diagnosis and management [^1121Gkdv]. Journal of Obstetrics and Gynaecology Canada (2010). Medium credibility.
...
### ESHRE guideline: endometriosis [^111o5VpM]. Human Reproduction Open (2022). High credibility.
...
### ESHRE guideline: endometriosis [^112JsMWQ]. Human Reproduction Open (2022). High credibility.
...
### ESHRE guideline: endometriosis [^112r1vtj]. Human Reproduction Open (2022). High credibility.
