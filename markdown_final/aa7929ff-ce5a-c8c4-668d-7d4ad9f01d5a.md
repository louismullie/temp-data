...
> Let me first confirm the foundational principles so I don't jump to conclusions: endometriosis is a chronic, estrogen-dependent, inflammatory disease with heterogeneous presentations, so a patient-centered, multimodal, and interdisciplinary approach is essential, and diagnosis should be clinical whenever possible to reduce the historical 5–12 year delay. I should also remember that normal imaging does not exclude disease, especially superficial peritoneal lesions, and that shared decision-making is critical at every step [^5c0a6ac6] [^682efa72] [^7405fe03] [^f24fa443].
