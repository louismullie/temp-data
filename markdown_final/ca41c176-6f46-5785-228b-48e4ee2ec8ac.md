...
### Secure and scalable gene expression quantification with pQuant [^114BFgRt]. Nature Communications (2025). High credibility.
...
### Optimization by decoded quantum interferometry [^117RNerT]. Nature (2025). Excellent credibility.
...
### Optimization by decoded quantum interferometry [^112QiFEo]. Nature (2025). Excellent credibility.
...
### Tamoxifen resistance in early breast cancer: statistical modelling of tissue markers to improve risk prediction [^116Swmbc]. British Journal of Cancer (2010). Low credibility.
...
### Computing high-degree polynomial gradients in memory [^113ceEDs]. Nature Communications (2024). High credibility.
...
### Computing conditional entropies for quantum correlations [^1125DMQg]. Nature Communications (2021). High credibility.
...
### Predicting longitudinal traits derived from high-throughput phenomics in contrasting environments using genomic legendre polynomials and B-splines [^116Q8rFu]. G3 (2019). Medium credibility.
...
### Hippocampus shape characterization with 3D zernike transformation in clinical Alzheimer's disease progression [^112Hd3nD]. Human Brain Mapping (2023). Medium credibility.
...
### Lost in translation: on the problem of data coding in penalized whole genome regression with interactions [^114ppcaQ]. G3 (2019). Medium credibility.
...
### Lost in translation: on the problem of data coding in penalized whole genome regression with interactions [^111CSPQd]. G3 (2019). Medium credibility.
...
### Universal expressiveness of variational quantum classifiers and quantum kernels for support vector machines [^114p2mNB]. Nature Communications (2023). High credibility.
...
### Assessing genotype adaptability and stability in perennial forage breeding trials using random regression models for longitudinal dry matter yield data [^113pa1vA]. G3 (2025). Medium credibility.
...
### Refractive errors preferred practice pattern ® [^116dsb2f]. Ophthalmology (2023). High credibility.

Refractive errors — patient population includes individuals who have refractive errors.

---

### Unexpectedly uneven distribution of functional trade-offs explains cranial morphological diversity in carnivores [^117Vd6n9]. Nature Communications (2024). High credibility.
...
### Percolation on feature-enriched interconnected systems [^115MC8xJ]. Nature Communications (2021). High credibility.
...
### Global translational landscape of the Candida albicans morphological transition [^11646NzK]. G3 (2021). Medium credibility.
...
### A mechanism for reversible mesoscopic aggregation in liquid solutions [^113pTrnd]. Nature Communications (2019). High credibility.
...
### Minimum days estimation for reliable dietary intake information: findings from a digital cohort [^1127c8ce]. European Journal of Clinical Nutrition (2025). Medium credibility.
...
### Lanadelumab-flyo (Takhzyro) [^116cXC2r]. FDA (2025). Medium credibility.
...
### Regional filling characteristics of the lungs in mechanically ventilated patients with acute lung injury [^115QvGjS]. European Journal of Anaesthesiology (2007). Low credibility.
...
### Philadelphia chromosome-negative classical myeloproliferative neoplasms: revised management recommendations from European LeukemiaNet [^1113tgdF]. Leukemia (2018). Medium credibility.
...
### Committee opinion no. 676 summary: health literacy to promote quality of care [^116vSY1p]. Obstetrics and Gynecology (2016). Low credibility.
...
### Statistical analysis of high-dimensional biomedical data: a gentle introduction to analytical goals, common approaches and challenges [^115dMGNb]. BMC Medicine (2023). Medium credibility.
...
### Committee opinion no. 676: health literacy to promote quality of care [^111JMbu8]. Obstetrics and Gynecology (2016). Low credibility.
...
### Electron transfer rules of minerals under pressure informed by machine learning [^1122S5jU]. Nature Communications (2023). High credibility.
...
### The sensory representation of causally controlled objects [^11197dHC]. Neuron (2021). Medium credibility.
...
### GetArchivalFile.cfm? archive_id = 99563… [^111QB4ij]. FDA (DailyMed) (2025). Medium credibility.
...
### A model for integrating clinical care and basic science research, and pitfalls of performing complex research projects for addressing a clinical challenge [^112me3jr]. Injury (2010). Low credibility.
...
### Longitudinal plasma phosphorylated-tau217 and other related biomarkers in a non-demented Alzheimer's risk-enhanced sample [^114Zu7qh]. Alzheimer's & Dementia (2024). Medium credibility.
...
### KDIGO 2025 clinical practice guideline for the evaluation, management, and treatment of autosomal dominant polycystic kidney disease (ADPKD) [^112WQu8e]. Kidney International (2025). High credibility.
...
### Poorer elbow proprioception in patients with lateral epicondylitis than in healthy controls: a cross-sectional study [^1113L5w1]. Journal of Shoulder and Elbow Surgery (2007). Low credibility.
...
### EPISPOT: an epigenome-driven approach for detecting and interpreting hotspots in molecular QTL studies [^116uC6g4]. American Journal of Human Genetics (2021). Medium credibility.
...
### Small-bowel capsule endoscopy and device-assisted enteroscopy for diagnosis and treatment of small-bowel disorders: European Society of Gastrointestinal Endoscopy (ESGE) guideline-update 2022 [^117NK1PS]. Endoscopy (2023). High credibility.
...
### Human botulinum neurotoxin a / b immune globulin (Babybig) [^112GXtZn]. FDA (2024). Medium credibility.
...
### The management of antibodies in heart transplantation: an ISHLT consensus document [^111Wjwv2]. The Journal of Heart and Lung Transplantation (2018). Medium credibility.
...
### Cost-effectiveness modelling to optimise active screening strategy for gambiense human African trypanosomiasis in endemic areas of the democratic republic of Congo [^111R3wB1]. BMC Medicine (2021). Medium credibility.
...
### Looking further when symptoms are disproportionate to physical findings [^112ZExiL]. Medicine and Science in Sports and Exercise (2019). Medium credibility.
...
### Cycles of goal silencing and reactivation underlie complex problem-solving in primate frontal and parietal cortex [^115xinwL]. Nature Communications (2023). High credibility.
...
### Asymmetric projection of introspection reveals a behavioural and neural mechanism for interindividual social coordination [^113H7ZpK]. Nature Communications (2025). High credibility.
...
### AGA living clinical practice guideline on computer-aided detection-assisted colonoscopy [^112xnbFV]. Gastroenterology (2025). High credibility.
...
### Neck pain: revision 2017 [^11722tdu]. The Journal of Orthopaedic and Sports Physical Therapy (2017). Medium credibility.
...
### Guideline no. 454: identification and treatment of perinatal mood and anxiety disorders [^111wU1aB]. Journal of Obstetrics and Gynaecology Canada (2024). High credibility.
...
### Refractive errors preferred practice pattern ® [^112sdfAY]. Ophthalmology (2023). High credibility.
