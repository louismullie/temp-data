...
Viral sinusitis is managed with **supportive care only** [^116yhLrd] because antibiotics are ineffective and not recommended [^115hCaj7]. Use **analgesics, intranasal corticosteroids, and saline irrigation** for symptom relief [^113tMAcp]; avoid antibiotics unless bacterial infection is confirmed or strongly suspected [^116yhLrd]. Most cases resolve within 10–14 days [^116yhLrd]; **seek care if symptoms persist beyond 10 days**, worsen, or severe complications develop [^116dMDhJ].
