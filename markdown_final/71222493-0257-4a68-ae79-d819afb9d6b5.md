...
> Let me first confirm the clinical context and scope, because I need to ensure I am not conflating primary prevention with treatment of established osteoporosis. Primary prevention applies to community-dwelling adults without osteoporosis or vitamin D deficiency, whereas treatment applies to patients with confirmed osteoporosis or those receiving pharmacologic therapy, and the evidence base and recommendations differ meaningfully between these groups, so I should keep them separate in my reasoning [^114s4MHD].
