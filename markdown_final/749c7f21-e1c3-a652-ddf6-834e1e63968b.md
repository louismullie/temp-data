...
> Let me first confirm the authoritative sources and scope. The FDA prescribing information is the primary source for labeled adverse reactions, warnings, and precautions, and I should prioritize those data while integrating large randomized trials and meta-analyses for context and precision of estimates, especially for events like DKA, genital infections, and volume depletion.
