...
To assess heterogeneity, the I 2 metric was employed following the approach by Holling et al. A significant level for heterogeneity was considered for I 2 confidence intervals above 25%, leading to further sensitivity analyses through the DOR univariate meta-analysis to identify and re-analyze potential outliers.
...
Review Manager version 5.3.5 (Cochrane Collaboration, Oxford, UK) was used for all data analysis. The relative ratio (RR) and weighted mean difference (WMD) were used to respectively analyze dichotomous outcome and continuous outcome. Both were reported with 95% confidence interval (CI), and a P value lower than 0.05 or a 95% CI that did not contain unity was considered statistically significant. Heterogeneity was evaluated with the I 2 test, and the I 2 > 50% indicated significant heterogeneity. In this meta-analysis, both fixed- and random-effect models were employed. Since similar results were obtained, only results of the random-effect model are presented.
