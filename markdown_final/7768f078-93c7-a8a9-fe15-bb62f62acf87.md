...
> But wait, what if prior evidence contradicts this? Let me contextualize. Multiple prospective studies and meta-analyses have shown high sensitivity and specificity for ultrasound in pediatric distal forearm fractures, with pooled estimates around 94–95% sensitivity and 93–95% specificity, and several studies report less pain and shorter procedure time with ultrasound, which triangulates with BUCKLED's safety and feasibility signals even though BUCKLED itself was not designed to test diagnostic accuracy as its primary aim [^023a1c6a] [^2670e956] [^41e00206].
