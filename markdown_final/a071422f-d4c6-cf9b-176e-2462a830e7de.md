...
### Size limits the sensitivity of kinetic schemes [^113fJYyH]. Nature Communications (2023). High credibility.
...
### Optoelectronic system and device integration for quantum-dot light-emitting diode white lighting with computational design framework [^115yoAdN]. Nature Communications (2022). High credibility.
...
### Local orthorhombic lattice distortions in the paramagnetic tetragonal phase of superconducting NaFeNiAs [^111Qy1za]. Nature Communications (2018). Medium credibility.
...
### Fractional response analysis reveals logarithmic cytokine responses in cellular populations [^116cY5xV]. Nature Communications (2021). High credibility.
...
### Rationally reduced libraries for combinatorial pathway optimization minimizing experimental effort [^114SfJEv]. Nature Communications (2016). Medium credibility.
...
### Seasonal changes of MéLange thickness coincide with Greenland calving dynamics [^111o1gSA]. Nature Communications (2025). High credibility.
...
### Versatile whole-organ / body staining and imaging based on electrolyte-gel properties of biological tissues [^112m6FNJ]. Nature Communications (2020). High credibility.
...
### High temperature singlet-based magnetism from hund's rule correlations [^116Nn2tb]. Nature Communications (2019). High credibility.
...
### On the UNFOLD method [^1129KFFY]. Magnetic Resonance in Medicine (2002). Low credibility.
...
### Recovery coupling in multilayer networks [^115uwVst]. Nature Communications (2022). High credibility.
...
### Identifiability analysis of second-order systems [^115kAgPx]. Nuclear Medicine and Biology (2003). Low credibility.
...
### Dimerization deficiency of enigmatic retinitis pigmentosa-linked rhodopsin mutants [^113S8eNp]. Nature Communications (2016). Medium credibility.
...
### AsymptoticMK: a web-based tool for the asymptotic McDonald-Kreitman test [^112N7JnX]. G3 (2017). Low credibility.
...
### Multiradionuclide evidence for the solar origin of the cosmic-ray events of ᴀ ᴅ 774 / 5 and 993 / 4 [^114E9m6p]. Nature Communications (2015). Medium credibility.
...
### Neural substrates of cognitive biases during probabilistic inference [^113M2qai]. Nature Communications (2016). Medium credibility.
...
### Universality of quantum phase transitions in the integer and fractional quantum hall regimes [^112ARZFA]. Nature Communications (2024). High credibility.
...
### Deriving disease modules from the compressed transcriptional space embedded in a deep autoencoder [^113XjM1u]. Nature Communications (2020). High credibility.
...
### The three major axes of terrestrial ecosystem function [^111Erk6T]. Nature (2021). Excellent credibility.
...
### A geometric approach to characterize the functional identity of single cells [^113hddT7]. Nature Communications (2018). Medium credibility.
...
### Recommendations for a standardized pulmonary function report. An official American Thoracic Society technical statement [^116QAi8Z]. American Journal of Respiratory and Critical Care Medicine (2017). Medium credibility.
...
### A rich conformational palette underlies human ca2.1-channel availability [^1132GWp6]. Nature Communications (2025). High credibility.
...
### In-plane dielectric constant and conductivity of confined water [^1135j4th]. Nature (2025). Excellent credibility.
...
### Statistical laws of stick-slip friction at mesoscale [^115owmPc]. Nature Communications (2023). High credibility.
...
### FEMA: fast and efficient mixed-effects algorithm for large sample whole-brain imaging data [^113o4huz]. Human Brain Mapping (2024). Medium credibility.
...
### An exact form for the magnetic field density of States for a dipole [^11291VLg]. Magnetic Resonance Imaging (2001). Low credibility.
...
### Effect of altering breathing frequency on maximum voluntary ventilation in healthy adults [^116BsLrg]. BMC Pulmonary Medicine (2018). Low credibility.
...
### Accurate prediction of protein function using statistics-informed graph networks [^114zCEMc]. Nature Communications (2024). High credibility.
...
### Survival analysis part I: basic concepts and first analyses [^1171ri2b]. British Journal of Cancer (2003). Low credibility.
...
### Noise considerations for PET quantification using maximum and peak standardized uptake value [^1158XAMw]. Journal of Nuclear Medicine (2012). Low credibility.
...
### A step-by-step guide to the systematic review and meta-analysis of diagnostic and prognostic test accuracy evaluations [^116jXoBp]. British Journal of Cancer (2013). Low credibility.
...
### Two-dome structure in electron-doped iron arsenide superconductors [^111mvpGm]. Nature Communications (2012). Medium credibility.
...
### Quantitative imaging metrics for the assessment of pulmonary pathophysiology: an official American Thoracic Society and Fleischner society joint workshop report [^114NH8XG]. Annals of the American Thoracic Society (2023). High credibility.
...
### Survival analysis part IV: further concepts and methods in survival analysis [^11276NBj]. British Journal of Cancer (2003). Low credibility.
...
### Survival analysis part I: basic concepts and first analyses [^116Q1LSu]. British Journal of Cancer (2003). Low credibility.
...
### Functional genomics and proteomics: application in neurosciences [^111qdrjn]. Journal of Neurology, Neurosurgery, and Psychiatry (2004). Low credibility.
...
### Single photon emission computed tomography (SPECT) myocardial perfusion imaging guidelines: instrumentation, acquisition, processing, and interpretation [^111F5PWm]. Journal of Nuclear Cardiology (2018). Medium credibility.
...
### ASNC imaging guidelines / SNMMI procedure standard for positron emission tomography (PET) nuclear cardiology procedures [^113THi7P]. Journal of Nuclear Cardiology (2016). Medium credibility.
...
### Perioperative management of antiplatelet and anticoagulant therapy in patients undergoing interventional techniques: 2024 updated guidelines from the American Society of Interventional Pain Physicians (ASIPP) [^115ooQ5n]. Pain Physician (2024). High credibility.
...
### Proteomics: the first decade and beyond [^1125LVje]. Nature Genetics (2003). Medium credibility.
...
### A compendium of human gene functions derived from evolutionary modelling [^116FwZbM]. Nature (2025). Excellent credibility.
...
### A systematic evaluation of single cell RNA-seq analysis pipelines [^115uvNHZ]. Nature Communications (2019). High credibility.
...
### A spectral method for assessing and combining multiple data visualizations [^116KWjrK]. Nature Communications (2023). High credibility.
...
### Practice parameter update: the care of the patient with amyotrophic lateral sclerosis: drug, nutritional, and respiratory therapies (an evidence-based review): report of the quality standards subcommittee of the American Academy of Neurology [^113q3Whd]. Neurology (2009). Medium credibility.
