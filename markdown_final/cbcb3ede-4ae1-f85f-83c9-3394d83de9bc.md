...
> Now, I need to check dopamine antagonists, especially metoclopramide. The NEJM cohort of over 3,000 first-trimester exposures found no increased risk of major congenital malformations, low birth weight, preterm delivery, or perinatal death; however, I should double-check maternal adverse effects and duration limits, as extrapyramidal symptoms and tardive dyskinesia risks rise with prolonged use, prompting many guidelines to position metoclopramide as second-line and to limit courses when possible [^117LEyZT] [^112uZSX6] [^1154hqWY].
