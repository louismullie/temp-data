...
- **Infectious**: Viral (measles, chickenpox, COVID-19) [^d558584c], bacterial (RMSF, meningococcemia) [^739412c2], fungal (tinea) [^2db6a2bb], parasitic (scabies) [^b7a97607].
- **Allergic**: Drug eruptions, contact dermatitis, urticaria [^3de8c411].
- **Autoimmune**: Psoriasis, lupus, vasculitis [^notfound].
- **Systemic diseases**: Syphilis, HIV, hepatitis, malignancy [^5836f3e3].
...
A structured approach is essential: **history, morphology, and distribution** guide the differential and testing [^57b64ad2]:

- **History**: Onset, duration, progression, pruritus, pain, fever, systemic symptoms, travel, exposures, medications, allergies, family history [^57b64ad2].
- **Physical examination**: Morphology, distribution, mucosal involvement, lymphadenopathy, organomegaly [^notfound].
- **Laboratory tests**: CBC, inflammatory markers, serologies, cultures, skin biopsy as indicated [^b9ca154a].
- **Specialized tests**: Patch testing, immunofluorescence, molecular diagnostics [^420a8cfd].
...
- **Fever with petechiae or purpura**: Meningococcemia, RMSF, vasculitis [^739412c2].
- **Rapidly progressive rash with mucosal involvement**: SJS/TEN [^5a1cb21f].
- **Neurological symptoms with rash**: Meningitis, encephalitis, neurosyphilis [^dca70831].
...
- **Supportive care**: Topical corticosteroids, antihistamines, emollients, analgesics [^5eecd623].
- **Specific therapies**: Antibiotics for infections, antivirals for herpes, immunosuppressants for autoimmune disease, chemotherapy for malignancy [^5836f3e3].
- **Emergency care**: Hospitalization, IV fluids, systemic corticosteroids, immunoglobulin for severe reactions [^5eecd623].
...
A rash is a visible skin change with a broad differential; **careful history and exam** enable accurate diagnosis and management, while red flags demand urgent care to prevent serious complications [^36efc081].

---

## References

### Mycosis fungoides presenting as symmetric concentric patches mimicking figurate erythema [^2032e842]. JAAD Case Reports (2017). Low credibility.
...
### Widespread skin rash following travel to south-east Asia [^953497db]. BMJ Case Reports (2014). Medium credibility.
...
### Man with leg rash [^3c9f5d9c]. Emergency Medicine Journal (2017). Low credibility.
...
### Cutaneous eruption associated with (group C) bacteremia [^d016c38f]. JAAD Case Reports (2017). Low credibility.
...
### Black-spot toxicodendron dermatitis with varied presentation [^0a09fc33]. Wilderness & Environmental Medicine (2022). Medium credibility.
...
### Defining D-irAEs: consensus-based disease definitions for the diagnosis of dermatologic adverse events from immune checkpoint inhibitor therapy [^3d46bc46]. Journal for Immunotherapy of Cancer (2024). Medium credibility.
...
### Severe urticarial rash as the initial symptom of COVID-19 infection [^9751752a]. BMJ Case Reports (2021). High credibility.
...
### Clinical features and novel presentations of human monkeypox in a central london centre during the 2022 outbreak: descriptive case series [^f6dc7be9]. BMJ (2022). Excellent credibility.
...
### Linear erythematous papulovesicular rash in a newborn [^50553d5e]. JAAD Case Reports (2025). Medium credibility.
...
### Grover' s-like drug eruption in a patient with metastatic melanoma under ipilimumab therapy [^3c87bb7d]. Journal for Immunotherapy of Cancer (2016). Low credibility.
...
### A 35-year-old man with fever, cough, and erythematous-erosive mucous membrane lesions accompanied by a generalized cutaneous rash [^67493bf3]. Chest (2022). Medium credibility.
...
### Spectrum of gluten-related disorders: consensus on new nomenclature and classification [^b365f16c]. BMC Medicine (2012). Low credibility.
...
### Linear darier disease after COVID-19 infection [^bf78b8f2]. JAAD Case Reports (2022). Medium credibility.
...
### Familial annular erythema – a rare dermatology diagnosis [^adbb8cd5]. Pediatric Dermatology (2011). Low credibility.
...
### Going viral 2019: zika, chikungunya, and dengue [^03152c2c]. Dermatologic Clinics (2019). Medium credibility.
...
### Segmental prurigo pigmentosa [^c56acf74]. Pediatric Dermatology (2014). Low credibility.
...
### Travel-associated skin disease [^b9ca154a]. Infectious Disease Clinics of North America (2012). Low credibility.
...
### Itchy lesions in pigmented skin [^7f0d4e79]. BMJ Case Reports (2013). Medium credibility.
...
### Skin manifestations in patients with coronavirus disease 2019 [^dc5230bf]. Current Opinion in Infectious Diseases (2022). Medium credibility.
...
### Dermatitis herpetiformis: an update on diagnosis and management [^04b76573]. American Journal of Clinical Dermatology (2021). Medium credibility.
...
### A flexural exanthem following postexposure prophylaxis [^3ae2ccdd]. Clinical and Experimental Dermatology (2022). Medium credibility.
...
### Lack of classic histology should not prevent diagnosis of necrolytic acral erythema [^55e00a6a]. Journal of the American Academy of Dermatology (2009). Low credibility.
...
### Prurigo nodularis in a 9-year-old girl [^284a6ead]. Clinical Pediatrics (2009). Low credibility.
...
### Nodular mucinosis misdiagnosed as non-responsive secondary syphilis [^1c4a1781]. BMJ Case Reports (2015). Medium credibility.
...
### Hemorrhagic bullae on bilateral lower extremities [^07ea7d5d]. JAAD Case Reports (2025). Medium credibility.
...
### Relapsing pityriasis rosea with HHV-7 reactivation in an 11-year-old girl [^14a1f309]. Pediatrics (2018). Low credibility.
...
### Urticarial exanthem as early diagnostic clue for COVID-19 infection [^b949e6dc]. JAAD Case Reports (2020). Medium credibility.
...
### Differential diagnosis of round or discoid lesions [^15adb7b9]. Clinics in Dermatology (2011). Low credibility.
...
### Case of bullous grover disease [^7ded9f49]. The American Journal of Dermatopathology (2021). Medium credibility.
...
### A pemphigus-like presentation of secondary syphilis [^9f4169b9]. JAAD Case Reports (2019). Medium credibility.
...
### Case 31: eosinophilia and pruritus [^819397d7]. Leukemia & Lymphoma (2006). Low credibility.
...
### Dermatologic findings in 2 patients with COVID-19 [^9111aa3d]. JAAD Case Reports (2020). Medium credibility.
...
### How to differentiate skin rash in covid, mononucleosis, chickenpox, sixth disease and measles [^ecd8b221]. Current Opinion in Infectious Diseases (2023). Medium credibility.
...
### The rash that leads to eschar formation [^8e86ec61]. Clinics in Dermatology (2018). Low credibility.
...
### Reactivated chronic graft-versus-host disease following SARS-CoV-2 infection [^9dd5b05f]. JAAD Case Reports (2022). Medium credibility.
