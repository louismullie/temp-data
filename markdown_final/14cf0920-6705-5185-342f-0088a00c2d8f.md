...
> Let me first confirm the disease framework so I don't jump to conclusions: fatty liver in this context refers to NAFLD, spanning simple steatosis (NAFL) and NASH, with fibrosis staging (F0–F4) driving prognosis and treatment intensity; patients with NASH and fibrosis are at highest risk of progression to cirrhosis and hepatocellular carcinoma, so I need to ensure staging informs therapy decisions [^113bjwL3] [^112MgP2T].

> I should confirm the universal foundation of care: lifestyle modification is first-line for all patients with NAFLD, regardless of stage, because it improves steatosis, NASH activity, and cardiometabolic outcomes; weight loss of about 3–5% improves steatosis, 7–10% improves NASH histology, and around 10% can reverse fibrosis in many patients, though sustainability is challenging and often requires multidisciplinary support [^115AjgM3] [^115uYnQT] [^1125dPUp].
