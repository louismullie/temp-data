...
> Wait, let me verify the biomarker question before I anchor any thresholds. Total serum 25(OH)D is the accepted marker of vitamin D status because it reflects both cutaneous synthesis and intake and has a longer half-life of about 2–3 weeks, whereas 1,25(OH)2D is tightly regulated, short-lived, and not a reliable indicator of stores; however, assay variability and lack of standardization complicate interpretation and meta-analyses, so I need to be cautious about comparing across studies and laboratories [^11639dQb] [^111Pgz2L] [^1167Q1RY].
...
Vitamin D is a fat-soluble hormone that maintains calcium and phosphate homeostasis, supporting bone health and neuromuscular function. It is produced in the skin via UVB exposure and obtained from diet or supplements; **25(OH)D is the main circulating biomarker** of status [^111Pgz2L]. Deficiency is common worldwide and linked to rickets, osteomalacia, osteoporosis, and fractures; evidence for extraskeletal benefits is mixed, with strong support for immune modulation and possible roles in cancer, cardiovascular disease, and metabolic health, though causality remains uncertain [^116fiStm] [^116iFrFV]. Routine screening is not recommended for asymptomatic adults; **target 25(OH)D ≥ 20 ng/mL for bone health**, and typical supplementation is 600–800 IU/day, with higher needs in older adults, people with obesity, or those with limited sun exposure [^111UJRQk] [^112X488E] [^116sT4h1].
