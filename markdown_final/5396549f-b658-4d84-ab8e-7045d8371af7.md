...
> Let me consider the differential diagnosis carefully, because misclassification changes therapy. STEC-HUS typically follows diarrheal illness and is complement-driven, aHUS reflects complement dysregulation with normal ADAMTS13, DIC shows coagulation abnormalities, and drug-induced TMAs (e.g., quinine, calcineurin inhibitors, gemcitabine) require a careful exposure history. Distinguishing these entities matters because TTP responds to plasma exchange and immunomodulation, whereas aHUS requires complement blockade and TPE is not routinely indicated for STEC-HUS [^113totvJ].
