...
> Let me consider the differential diagnosis carefully, because misclassification changes therapy. STEC-HUS typically follows diarrheal illness and is complement-driven, aHUS reflects complement dysregulation with normal ADAMTS13, DIC shows coagulation abnormalities, and drug-induced TMAs (e.g., quinine, calcineurin inhibitors, gemcitabine) require a careful exposure history. Distinguishing these entities matters because TTP responds to plasma exchange and immunomodulation, whereas aHUS requires complement blockade and TPE is not routinely indicated for STEC-HUS [^117B5rWb] [^114qhRB8] [^113totvJ].
...
Thrombotic thrombocytopenic purpura (TTP) is a **life-threatening thrombotic microangiopathy** [^116CGTkW] caused by severe ADAMTS13 deficiency, most often due to autoantibodies [^113s53AA], leading to platelet-rich microthrombi and organ ischemia [^115VBC4F]. It presents with thrombocytopenia, microangiopathic hemolytic anemia, neurologic deficits, and renal dysfunction; without treatment, mortality exceeds 90% [^115KaCV8]. Immediate therapeutic plasma exchange (TPE) [^113TAd2M] with corticosteroids is essential [^1128psvE]; rituximab and caplacizumab are added in immune-mediated TTP to reduce relapse and mortality [^114TCXSb] [^114jMCbH]. Early diagnosis and rapid TPE within 4–8 hours [^1121AvPj] are critical to outcomes [^116JMXAd]; ADAMTS13 activity < 10% confirms the diagnosis [^117NgZt3] and guides therapy [^1154mCCY].
...
Previously, TTP was diagnosed as a pentad (thrombocytopenia, microangiopathic haemolytic anaemia (MAHA), neurological features, fever and renal involvement) and HUS was classified by the presence or absence of bloody diarrhoea. Indeed, the relevance of 'diarrhoea negative' HUS was unclear. This has now changed, and central to the diagnosis of TMAs is thrombocytopenia, MAHA and the clinical or histological effects of microvascular thrombosis. The degree of thrombocytopenia at initial presentation of TTP and aHUS is, broadly, < 50 × 10 9 /l for TTP and usually > 50 × 10 9 /l for aHUS. However, this is only a general rule and TTP cases with platelet counts > 50 × 10 9 /l and aHUS cases with platelet counts < 50 × 10 9 /l can be recalled and are not anecdotal. Therefore, a clinical suspicion and full diagnostic work up is required. Presentation may not be 'classic'. In patients presenting with neurological, cardiac or bleeding symptoms (such as haematuria) as an emergency, and is associated with thrombocytopenia, TTP should be considered. The presence of neurological and cardiological involvement signifies severe disease and should be considered, especially in young patients. At least 10% of presenting TTP patients require intubation and ventilation. Identification of subgroups of TTP, such as human immunodeficiency virus (HIV)‐associated, pregnancyand drug‐related cases, require associated treatment of the underlying condition as well as plasma exchange (PEX).
