...
- **Age**: 18–80 years [^651d1aa2].
- **Diagnosis**: PN confirmed by a dermatologist for ≥ 3 months [^651d1aa2].
- **Severity**: ≥ 20 nodules on the extremities and/or trunk, and WI-NRS ≥ 7 (severe itch) [^651d1aa2].
- **Inadequate control**: Failure of medium-to-super-potent topical corticosteroids (± TCI) for ≥ 14 days or when TCS were not advisable [^651d1aa2].
- **Exclusions**: PN secondary to medications or medical conditions, severe renal disease, uncontrolled thyroid disease, active TB or NTM, or other serious illnesses [^651d1aa2].

These criteria define the **target population** for dupilumab in PN: adults with significant nodular burden, severe itch, and refractory disease despite optimized topical therapy [^651d1aa2].
...
|-|-|
| Loading dose | 600 mg SC on day 1 (two 300 mg injections) [^3534d630] |
| Maintenance dose | 300 mg SC every 2 weeks (Q2W) for 24 weeks [^3534d630] |

---

This regimen is consistent across both trials and aligns with the FDA label for PN in adults [^52868293].
...
- **Itch reduction**: ≥ 4-point WI-NRS improvement at week 24 in 60.0% (PRIME) and 37.2% at week 12 (PRIME2) vs 18.4% and 22.0% with placebo, respectively [^a1e5e07e].
- **Lesion clearance**: IGA PN-S 0/1 (≤ 5 nodules) at week 24 in 48.0% (PRIME) and 44.9% (PRIME2) vs 18.4% and 15.9% with placebo, respectively [^ac57d535].
- **Composite endpoint**: Concurrent ≥ 4-point WI-NRS reduction and IGA PN-S 0/1 at week 24 in 38.7% (PRIME) and 32.1% (PRIME2) vs 9.2% and 8.5% with placebo, respectively [^ac57d535].
- **Quality of life**: Significant improvements in DLQI, skin pain, anxiety/depression (HADS), and sleep by week 24 [^96d785cc].

Efficacy was **similar in atopic and non-atopic patients**, supporting use across PN phenotypes [^21ab32a5].
...
- **Common adverse effects**: Injection site reactions, conjunctivitis, herpes viral infections, nasopharyngitis, muscle pain, diarrhea, and throat pain [^36fb21ab].
- **Serious adverse events**: Low and similar to placebo; no treatment-related deaths or malignancies reported [^8136a466].
- **Discontinuations**: 0% due to adverse events in the dupilumab groups vs 3% with placebo [^1a194e42].

The safety profile is consistent with dupilumab's use in other indications, with no new signals identified [^8136a466].

---

## Clinical implications

Dupilumab is the **first FDA-approved systemic therapy for PN** [^36fb21ab], offering a targeted option for patients with moderate-to-severe disease refractory to topical therapy. It addresses both itch and lesions, with early onset of benefit and sustained improvements over 24 weeks [^a321d848]. Clinicians should consider dupilumab for adults with ≥ 20 nodules, WI-NRS ≥ 7, and inadequate response to topical therapy, regardless of atopic status [^21ab32a5].

---

## Limitations and considerations

- **Pediatric use**: Not established; trials enrolled adults only [^651d1aa2].
- **Long-term data**: 24-week trials; longer-term safety and durability remain under evaluation [^64dc6138].
- **Cost and access**: Biologic therapy may pose financial and logistical barriers for some patients [^b8d9956d].

---

Dupilumab is indicated for adults with **moderate-to-severe prurigo nodularis** who have ≥ 20 nodules, WI-NRS ≥ 7, and inadequate control with topical therapies, using 600 mg SC on day 1 followed by 300 mg SC every 2 weeks [^3534d630]. It provides rapid, clinically meaningful improvements in itch and lesions with a favorable safety profile, and efficacy is independent of atopic status [^21ab32a5].

---

## References

### Dupilumab SC dosing for prurigo nodularis [^fdfa4b54]. FDA (2025). Medium credibility.
...
### Dupilumab in patients with prurigo nodularis: two randomized, double-blind, placebo-controlled phase 3 trials [^e636aacf]. Nature Medicine (2023). Excellent credibility.
...
### Dupilumab in patients with prurigo nodularis: two randomized, double-blind, placebo-controlled phase 3 trials [^b3b762bb]. Nature Medicine (2023). Excellent credibility.
...
### Effectiveness and safety of dupilumab for prurigo nodularis in China: a multicentric and observational study [^9705dabb]. Allergy (2025). Medium credibility.
...
### Dupilumab provides acceptable safety and sustained efficacy for up to 4 years in an open-label study of adults with moderate-to-severe atopic dermatitis [^ce076236]. American Journal of Clinical Dermatology (2022). Medium credibility.
...
### Efficacy and safety of dupilumab in adolescents with uncontrolled moderate to severe atopic dermatitis: a phase 3 randomized clinical trial [^583a2349]. JAMA Dermatology (2020). High credibility.
...
### Recalcitrant prurigo nodularis treated successfully with dupilumab [^482756ee]. JAAD Case Reports (2019). Medium credibility.
...
### Management of immune-related adverse events in patients treated with immune checkpoint inhibitor therapy: ASCO guideline update [^9a407069]. Journal of Clinical Oncology (2021). High credibility.
...
### Efficacy and safety of multiple dupilumab dose regimens after initial successful treatment in patients with atopic dermatitis: a randomized clinical trial [^ca99ea3c]. JAMA Dermatology (2020). High credibility.
...
### Efficacy and safety of multiple dupilumab dose regimens after initial successful treatment in patients with atopic dermatitis: a randomized clinical trial [^a5488b90]. JAMA Dermatology (2020). High credibility.
...
### Epidermolysis bullosa pruriginosa treated with dupilumab [^58475202]. Pediatric Dermatology (2021). Medium credibility.
...
### Chronic prurigo including prurigo nodularis: new insights and treatments [^039ff6af]. American Journal of Clinical Dermatology (2024). Medium credibility.
...
### Long-term efficacy and safety of dupilumab in adolescents with moderate-to-severe atopic dermatitis: results through week 52 from a phase III open-label extension trial (LIBERTY AD PED-OLE) [^0cdc2a82]. American Journal of Clinical Dermatology (2022). Medium credibility.
...
### Laboratory safety of dupilumab in moderate-to-severe atopic dermatitis: results from three phase III trials (LIBERTY AD SOLO 1, LIBERTY AD SOLO 2, LIBERTY AD CHRONOS) [^830db466]. The British Journal of Dermatology (2020). Medium credibility.
...
### Long-term efficacy and safety of dupilumab in adolescents with moderate-to-severe atopic dermatitis: results through week 52 from a phase III open-label extension trial (LIBERTY AD PED-OLE) [^dcb7b7a5]. American Journal of Clinical Dermatology (2022). Medium credibility.
...
### Efficacy and safety of multiple dupilumab dose regimens after initial successful treatment in patients with atopic dermatitis: a randomized clinical trial [^c74cbafe]. JAMA Dermatology (2020). High credibility.
...
### Clinically meaningful responses to dupilumab in adolescents with uncontrolled moderate-to-severe atopic dermatitis: post-hoc analyses from a randomized clinical trial [^03cafda3]. American Journal of Clinical Dermatology (2020). Medium credibility.
...
### Long-term efficacy and safety of dupilumab in adolescents with moderate-to-severe atopic dermatitis: results through week 52 from a phase III open-label extension trial (LIBERTY AD PED-OLE) [^7a2ffb10]. American Journal of Clinical Dermatology (2022). Medium credibility.
...
### Efficacy and safety of dupilumab in adolescents with uncontrolled moderate to severe atopic dermatitis: a phase 3 randomized clinical trial [^af439b0a]. JAMA Dermatology (2020). High credibility.
...
### Clinically meaningful responses to dupilumab in adolescents with uncontrolled moderate-to-severe atopic dermatitis: post-hoc analyses from a randomized clinical trial [^1e2863a4]. American Journal of Clinical Dermatology (2020). Medium credibility.
...
### Dupilumab provides acceptable safety and sustained efficacy for up to 4 years in an open-label study of adults with moderate-to-severe atopic dermatitis [^b2903793]. American Journal of Clinical Dermatology (2022). Medium credibility.
...
### Laboratory safety of dupilumab in moderate-to-severe atopic dermatitis: results from three phase III trials (LIBERTY AD SOLO 1, LIBERTY AD SOLO 2, LIBERTY AD CHRONOS) [^addb348a]. The British Journal of Dermatology (2020). Medium credibility.
...
### European S2k guideline on chronic pruritus [^3bccfa53]. Acta Dermato-Venereologica (2019). High credibility.
...
### Dupilumab (Dupixent) [^0b568f3b]. FDA (2025). Medium credibility.
...
### Dupilumab shows long-term safety and efficacy in patients with moderate to severe atopic dermatitis enrolled in a phase 3 open-label extension study [^3a1f3d10]. Journal of the American Academy of Dermatology (2020). Medium credibility.
...
### The posology of dupilumab in pediatric patients with atopic dermatitis [^e45f3556]. Clinical Pharmacology and Therapeutics (2021). Medium credibility.
...
### Dupilumab provides acceptable safety and sustained efficacy for up to 4 years in an open-label study of adults with moderate-to-severe atopic dermatitis [^4e2d167d]. American Journal of Clinical Dermatology (2022). Medium credibility.
...
### Efficacy and safety of dupilumab in patients with erythrodermic atopic dermatitis: a post hoc analysis of 6 randomized clinical trials [^c388951c]. JAMA Dermatology (2023). High credibility.
...
### Assessing the use of dupilumab in a pediatric patient with bullous congenital ichthyosiform erythroderma [^600a928e]. JAAD Case Reports (2023). Medium credibility.
...
### Efficacy and safety of dupilumab in adolescents with uncontrolled moderate to severe atopic dermatitis: a phase 3 randomized clinical trial [^b9be2415]. JAMA Dermatology (2020). High credibility.
...
### Worst itch numeric rating scale for prurigo nodularis: a secondary analysis of 2 randomized clinical trials [^6f5c3aa7]. JAMA Dermatology (2024). High credibility.
