...
> I should confirm the treat-to-target urate goal and the minimum prophylaxis duration before moving on. The ACR recommends a treat-to-target strategy titrating ULT to achieve and maintain serum urate less than 6 mg/dL, and to continue prophylaxis for at least 3–6 months when starting ULT, extending if flares persist, which anchors both the biochemical target and the initial prophylaxis window [^115ZP7Lo] [^116Tdtmx] [^116Tdtmx].
