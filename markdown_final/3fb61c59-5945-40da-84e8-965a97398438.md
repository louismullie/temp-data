...
Kidney cysts on ultrasound are common and usually benign, but management depends on **Bosniak classification** and patient factors [^114NeYvU]. Simple cysts (Bosniak I/II) require **no follow-up** unless symptomatic, whereas complex cysts (Bosniak III/IV) need **contrast-enhanced CT or MRI** for further characterization and urology referral for possible surgery or biopsy [^114GU1du] [^111Wem6C]. Bosniak IIF cysts warrant **surveillance imaging at 6–12 months** [^11681uYN]. Evaluate for ADPKD if there are multiple bilateral cysts or a family history, and refer to nephrology if there is CKD or hypertension [^112ajxKq] [^115u6Lb5]. Always correlate with clinical context and use shared decision-making for management [^1115BZm5].
