...
Long-term pregabalin use is associated with **modest weight gain** (average ~5 kg after 2 years in diabetics) [^17e11d85], **peripheral edema**, and **dose-related CNS effects** (dizziness, somnolence, cognitive slowing) that often improve with dose adjustment [^70bc1f1f]. Serious adverse effects are uncommon but include **suicidal ideation** [^55f83c38], **respiratory depression** (especially with opioids) [^089870ef], and **heart failure exacerbation** [^bcaaf7bf]; long-term cardiovascular risks (DVT, PE, MI) may be increased in diabetic patients [^7a5268de]. Dependence and withdrawal can occur with abrupt cessation; taper slowly [^aae2b59a]. Regular monitoring of weight, edema, mood, and renal function is recommended, with dose adjustments for renal impairment [^94370818].
