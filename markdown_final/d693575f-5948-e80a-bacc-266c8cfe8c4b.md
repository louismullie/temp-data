...
### A critical edge number revealed for phase stabilities of two-dimensional ball-stick polygons [^114pX11x]. Nature Communications (2024). High credibility.
...
### A critical edge number revealed for phase stabilities of two-dimensional ball-stick polygons [^115k1aWJ]. Nature Communications (2024). High credibility.
...
### A primer on deep learning and convolutional neural networks for clinicians [^111d9sn1]. Insights Into Imaging (2021). Medium credibility.
...
### Full randomness from arbitrarily deterministic events [^111Bhzfd]. Nature Communications (2013). Medium credibility.
...
### Dissociation of long-term verbal memory and fronto-executive impairment in first-episode psychosis [^113uAHsk]. Psychological Medicine (2009). Low credibility.
...
### Fault-tolerant error correction with the gauge color code [^112ssdg8]. Nature Communications (2016). Medium credibility.
...
### Experimental demonstration of a skyrmion-enhanced strain-mediated physical reservoir computing system [^113sVcBL]. Nature Communications (2023). High credibility.
...
### Multispectral imaging method for rapid identification and analysis of paraffin-embedded pathological tissues [^114Pvi4U]. Journal of Digital Imaging (2023). Medium credibility.
...
### Insightful classification of crystal structures using deep learning [^115Sweks]. Nature Communications (2018). Medium credibility.
...
### A network-based framework for shape analysis enables accurate characterization of leaf epidermal cells [^112tSHsT]. Nature Communications (2021). High credibility.
...
### Predicting phase behavior of grain boundaries with evolutionary search and machine learning [^111do3EK]. Nature Communications (2018). Medium credibility.
...
### Improved machine learning algorithm for predicting ground state properties [^116Szevr]. Nature Communications (2024). High credibility.
...
### Thermodynamics of structure-forming systems [^114VYsJA]. Nature Communications (2021). High credibility.
...
### Exponential suppression of bit or phase errors with cyclic error correction [^111KYqZt]. Nature (2021). Excellent credibility.
...
### The complexity of NISQ [^11488frM]. Nature Communications (2023). High credibility.
...
### 120 GOPS photonic tensor core in thin-film lithium niobate for inference and in situ training [^1116bZPy]. Nature Communications (2024). High credibility.
...
### A model-free method to learn multiple skills in parallel on modular robots [^113dEA6e]. Nature Communications (2024). High credibility.
...
### Universal and uniquely human factors in spontaneous number perception [^115pJw7C]. Nature Communications (2017). Medium credibility.
...
### Genomic prediction of complex human traits: relatedness, trait architecture and predictive meta-models [^116XqSd8]. Human Molecular Genetics (2015). Low credibility.
...
### Experimental realization of the quantum universal NOT gate [^111idQFg]. Nature (2002). Excellent credibility.
...
### 111In-leukocyte scintigraphy for suspected infection / inflammation 3.0 [^114BCc4W]. SNMMI (2024). High credibility.
...
### Sample size and power [^114Uk8C8]. American Journal of Infection Control (2012). Low credibility.
...
### Topological solitonic macromolecules [^115GKVXS]. Nature Communications (2023). High credibility.
...
### The problem with unadjusted multiple and sequential statistical testing [^1114G9JC]. Nature Communications (2019). High credibility.
...
### Stochastic representation of many-body quantum States [^114ULGdo]. Nature Communications (2023). High credibility.
...
### Harnessing citizen science through mobile phone technology to screen for immunohistochemical biomarkers in bladder cancer [^113neNVq]. British Journal of Cancer (2018). Low credibility.
...
### Data-driven discovery of dimensionless numbers and governing laws from scarce measurements [^114fxQkn]. Nature Communications (2022). High credibility.
...
### The problem with unadjusted multiple and sequential statistical testing [^116YSdsX]. Nature Communications (2019). High credibility.
...
### Genome-driven evolutionary game theory helps understand the rise of metabolic interdependencies in microbial communities [^115PRnMR]. Nature Communications (2017). Medium credibility.
...
### The problem with unadjusted multiple and sequential statistical testing [^116ZnBaX]. Nature Communications (2019). High credibility.
...
### Hydrodynamic cavitation in stokes flow of anisotropic fluids [^113RPBiE]. Nature Communications (2017). Medium credibility.
...
### A myoelectric digital twin for fast and realistic modelling in deep learning [^111gGbiN]. Nature Communications (2023). High credibility.
...
### Thermalization and criticality on an analogue-digital quantum simulator [^113Uj6ZW]. Nature (2025). Excellent credibility.
...
### Game theoretical inference of human behavior in social networks [^111BW3Nm]. Nature Communications (2019). High credibility.
...
### Coding schemes in neural networks learning classification tasks [^111whTyh]. Nature Communications (2025). High credibility.
...
### A molecular overlayer with the fibonacci square grid structure [^112gDQQM]. Nature Communications (2018). Medium credibility.
...
### Guidelines for the appropriate use of bedside general and cardiac ultrasonography in the evaluation of critically ill patients-part I: general ultrasonography [^113vRkAP]. Critical Care Medicine (2015). Medium credibility.
...
### Controllable gliders in a nanomagnetic metamaterial [^115N5DYY]. Nature Communications (2025). High credibility.
...
### Gap junctions desynchronize a neural circuit to stabilize insect flight [^116o4JaG]. Nature (2023). Excellent credibility.
...
### Neural-like computing with populations of superparamagnetic basis functions [^111q1eiD]. Nature Communications (2018). Medium credibility.
...
### Common errors in statistics and methods [^117GGRr1]. BMJ Paediatrics Open (2024). High credibility.
...
### Understanding statistical power [^117EwfY6]. The Journal of Orthopaedic and Sports Physical Therapy (2001). Low credibility.
...
### Common errors in statistics and methods [^115BRUS5]. BMJ Paediatrics Open (2024). High credibility.
...
### Digit preference in office blood pressure measurements, United States 2015–2019 [^112AHrap]. American Journal of Hypertension (2021). Medium credibility.
...
### FDA raw data-HHS.gov… [^111zDVgy]. HHS (2022). Medium credibility.
...
### An optical neural network using less than 1 photon per multiplication [^114CXwqM]. Nature Communications (2022). High credibility.
...
### Scale-free networks are rare [^117SfjbQ]. Nature Communications (2019). High credibility.
...
### Evaluating and defining the sharpness of intraocular lenses: microedge structure of commercially available square-edged hydrophilic intraocular lenses [^116GwEeF]. Journal of Cataract and Refractive Surgery (2009). Low credibility.
...
### Universal scaling in real dimension [^112J3WW2]. Nature Communications (2024). High credibility.
