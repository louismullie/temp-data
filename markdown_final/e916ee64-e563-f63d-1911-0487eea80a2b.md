...
• Guidelines involving metformin and contrast agents are reliable and optimal. • Most guidelines advocate discontinuing metformin before using contrast agents in diabetic patients with advanced renal failure, but there are controversial suggestions regarding kidney function thresholds. • The gaps regarding the time of discontinuation of the metformin with moderate renal impairment (30 mL/min/1.73 m 2 <eGFR<60 mL/min/1.73 m 2 ) must be considered in the extensive RCT studies.
