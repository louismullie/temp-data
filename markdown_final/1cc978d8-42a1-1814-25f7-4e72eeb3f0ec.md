...
> I need to check the remaining sites. The wrist (scaphoid and lunate) and ankle (talus) are repeatedly included among common sites in radiologic and clinical reviews, and metadiaphyseal long bone infarcts in the femur and tibia are described as common, though they are often asymptomatic and discovered incidentally, which may underrepresent their clinical prominence relative to articular sites [^5f845074]. Hold on, let's not jump to conclusions; absence of symptoms does not equal absence of occurrence, so I should keep metadiaphyseal infarcts on the list while acknowledging their different clinical impact [^notfound].
