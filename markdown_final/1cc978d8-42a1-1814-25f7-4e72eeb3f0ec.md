...
> Let me synthesize a cautious hierarchy. Based on repeated emphasis across sources, the femoral head is clearly the most common site, followed by the humeral head as the second most common, with the knee, scaphoid, lunate, talus, and femoral/tibial metadiaphysis rounding out the commonly affected locations; however, I should emphasize that beyond the femoral and humeral heads, precise ordinal rankings are not quantified in the cited literature, so the order of the remaining sites is inferred from their repeated inclusion rather than incidence data [^113ScGTm] [^1165HRn7]. I should double-check that I am not overstating any numeric claims; indeed, I find no site-specific incidence percentages in these sources, so I will avoid assigning numbers where none are provided [^113ScGTm].
