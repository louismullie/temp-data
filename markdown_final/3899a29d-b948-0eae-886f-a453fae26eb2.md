...
> Next, I should review prevalence, but wait, let me verify why numbers diverge so much. Reported ADA rates vary widely depending on disease, concomitant immunomodulators, and especially the assay used. In RA cohorts, prospective data show around 25–28% over 12–36 months, with most appearing early, whereas psoriasis cohorts report roughly 49% at 1 year, and IBD cohorts often cite 7–12% in routine practice but higher in some studies. Critically, ELISA-based methods detect antibodies only when drug is low, whereas ECL assays detect ADAs even with circulating drug, explaining much of the heterogeneity [^1173NdFg] [^11237sxD] [^114hgkwd] [^111MDUg8].
