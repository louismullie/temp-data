...
Let (S = {1², 2², ..., 44²}). For any (a, b \\in S), we have (a = m^2) and (b = n^2) for some integers (m, n). Then (a × b = m² × n² = (mn)²), which is a perfect square. Thus, the set (S) satisfies the required condition.
