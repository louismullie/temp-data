...
> I need to ensure I address neuromodulation options beyond ECT and ketamine. Repetitive transcranial magnetic stimulation (rTMS) is FDA-cleared for TRD and has favorable tolerability; accelerated theta-burst stimulation protocols show promise in recent randomized trials, though access and payer coverage vary and durability may require maintenance sessions [^111UFK1J] [^111UFK1J]. Hmm, wait a minute, I initially thought vagus nerve stimulation (VNS) had consistent sham-controlled evidence; let me verify — sham-controlled trials have been equivocal, so VNS remains a niche option for highly selected, chronic TRD after multiple failures, and deep brain stimulation is reserved for severe, refractory cases in specialized centers [^113Ds3hS] [^113TQ5qD].
...
The primary outcome was the Hedges g value for the reported depression scales. Secondary outcomes included moderators assessed via meta-regression and response and remission rates. Heterogeneity was assessed with the I² test, and publication bias was evaluated using the Egger test and a funnel plot. Cochrane Risk of Bias Tool was used to estimate risks.
