...
Terbutaline lowers serum potassium by **activating β2-adrenergic receptors**, which stimulates Na+/K+-ATPase and shifts potassium intracellularly [^115mGi9x]. This effect is **rapid and transient**, typically lowering potassium by 0.5–1.2 mmol/L within 30–60 minutes and lasting 2–6 hours [^115EkJWM]. Clinically, terbutaline is used as adjunct therapy for acute hyperkalemia, especially when insulin is contraindicated or unavailable [^115mGi9x], but requires **cardiac monitoring** due to risk of tachycardia and arrhythmias [^115mGi9x].
