...
> But wait, what about a niche use I recall for bone pain? I should verify the pegfilgrastim data. Randomized and observational studies suggest loratadine may modestly reduce the incidence or severity of G-CSF–associated bone pain, with the NOLAN trial showing lower patient-reported pain metrics versus no prophylaxis and better tolerability than naproxen, though the primary AE endpoint was not statistically significant, so I should present this as a reasonable, low-risk option to consider when bone pain is anticipated or has occurred previously [^0bc39510] [^0587abaf] [^617ef213].
