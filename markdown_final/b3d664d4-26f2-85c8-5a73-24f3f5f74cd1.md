...
> Next, I should review onset and comparative efficacy. Loratadine has an onset of action around 60–75 minutes with maximal effect in 1–8 days, which is slower than cetirizine's 1-hour onset and fexofenadine's relatively rapid onset, and in controlled exposure models, cetirizine suppresses histamine-induced wheal-and-flare more robustly than loratadine, which can matter for rapid symptom control in some patients [^114J22oS] [^115kLe57]. Wait, let me verify the potency claim: yes, fexofenadine and cetirizine generally show stronger suppression in skin test models than loratadine, reinforcing that loratadine is effective but may be less potent in certain pharmacodynamic assays [^116LrGeD].
