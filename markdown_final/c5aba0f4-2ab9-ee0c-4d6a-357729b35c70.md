...
### Systematic inference and comparison of multi-scale chromatin sub-compartments connects spatial organization to cell phenotypes [^112uBaH6]. Nature Communications (2021). High credibility.
...
### On-demand tailoring soliton patterns through intracavity spectral phase programming [^114d7rNm]. Nature Communications (2025). High credibility.
...
### The geometric nature of weights in real complex networks [^112hrN4x]. Nature Communications (2017). Medium credibility.
...
### Ventricular septum curvature ratio: a novel imaging marker to predict clinical deterioration in normotensive acute pulmonary embolism [^113tF72e]. Critical Care (2025). Medium credibility.
...
### Nasopharyngeal carcinoma in nonendemic regions… [^112K71Yd]. JAMA Network (2025). Excellent credibility.
...
### Separability and geometry of object manifolds in deep neural networks [^111qNFnQ]. Nature Communications (2020). High credibility.
...
### A phase three study of the safety and immunogenicity of a four-dose series of 20-valent pneumococcal conjugate vaccine in healthy infants [^115UgHLs]. The Pediatric Infectious Disease Journal (2024). Medium credibility.
...
### Deep transfer learning for inter-chain contact predictions of transmembrane protein complexes [^115JB2k1]. Nature Communications (2023). High credibility.
...
### September 26, 2024 meeting of the oncologic drugs advisory committee-PM-merck briefing document… [^114ywLax]. FDA (2025). Medium credibility.
...
### The groin triangle: a patho-anatomical approach to the diagnosis of chronic groin pain in athletes [^111heSsb]. British Journal of Sports Medicine (2009). Low credibility.
...
### A geometric framework for evaluating rare variant tests of association [^116chDkj]. Genetic Epidemiology (2013). Low credibility.
...
FIGURE 2
Calculation of the SVF. Based on the lengths of the 2 sides " d₁ " and " d₂ " of triangle A1, with an angle of 15 degrees formed at the apex between " d₁ " and " d₂", the area of the triangle can be determined as "[1/2] sin 15° × d₁ × d₂". Area of SVF can be approximated as the sum of the area of the 12 triangles.
...
### Posterior infundibular dissection: safety first in laparoscopic cholecystectomy [^115nw5jU]. Surgical Endoscopy (2021). Medium credibility.
...
### Making sense of the shadows: priorities for creating a learning healthcare system based on routinely collected data [^114rKBBf]. BMJ Quality & Safety (2015). Medium credibility.
...
### Geometric and electromyographic assessments in the evaluation of curve progression in idiopathic scoliosis [^113D1Nww]. Spine (2006). Low credibility.
...
### The geometric nature of weights in real complex networks [^113vKE6r]. Nature Communications (2017). Medium credibility.
...
### The relationship between foveal outer nuclear layer thickness in the active and resolved phases of central serous chorioretinopathy treated with half-dose photodynamic therapy [^112ffrcv]. BMC Ophthalmology (2019). Medium credibility.
...
### American Thyroid Association consensus review and statement regarding the anatomy, terminology, and rationale for lateral neck dissection in differentiated thyroid cancer [^115ZCUav]. Thyroid (2012). Medium credibility.
...
### Deep transfer learning for inter-chain contact predictions of transmembrane protein complexes [^1145PpaY]. Nature Communications (2023). High credibility.
...
### Phenotypic and genetic characteristics of retinal vascular parameters and their association with diseases [^111MHzf2]. Nature Communications (2024). High credibility.
...
### Nature of power electronics and integration of power conversion with communication for talkative power [^111yxjPH]. Nature Communications (2020). High credibility.
...
### Mining extreme properties from a large metamaterial database [^112NP5jD]. Nature Communications (2025). High credibility.
...
### The greater trochanter triangle; a pathoanatomic approach to the diagnosis of chronic, proximal, lateral, lower limb pain in athletes [^112jKmFA]. British Journal of Sports Medicine (2009). Low credibility.
...
### Rivaroxaban (Xarelto) [^113naAQo]. FDA (2025). Medium credibility.
...
### Daridorexant (Quviviq) [^115vVzet]. FDA (2024). Medium credibility.
...
### The significance of the interleaflet triangles in determining the morphology of congenitally abnormal aortic valves: implications for noninvasive imaging and surgical management [^115FFkZb]. Journal of the American Society of Echocardiography (2016). Low credibility.
...
### Plaque distribution correlates with morphology of lenticulostriate arteries in single subcortical infarctions [^111Tnt9D]. Stroke (2020). Medium credibility.
...
### Turbulent coherent structures and early life below the kolmogorov scale [^1136Bj57]. Nature Communications (2020). High credibility.
...
### Predictive ability of pressure-corrected arterial stiffness indices: comparison of pulse wave velocity, cardio-ankle vascular index (CAVI), and CAVI0 [^113AAjmv]. American Journal of Hypertension (2022). Medium credibility.
...
### Three-dimensional echocardiography in congenital heart disease: an expert consensus document from the European association of Cardiovascular imaging and the American Society of Echocardiography [^1152yc5J]. Journal of the American Society of Echocardiography (2017). Medium credibility.
...
### Trandolapril and verapamil hydrochloride (tarka) [^117KgeB4]. FDA (2012). Low credibility.
...
### Wetting and complex remodeling of membranes by biomolecular condensates [^114SzSEm]. Nature Communications (2023). High credibility.
...
### Experimental nonclassicality in a causal network without assuming freedom of choice [^1171PWvS]. Nature Communications (2023). High credibility.
...
### Major variation in carotid bifurcation anatomy: a possible risk factor for plaque development? [^1124DURo]. Stroke (2001). Low credibility.
...
### Algorithms to measure carotid intima-media thickness in trials: a comparison of reproducibility, rate of progression and treatment effect [^114pRHNc]. Journal of Hypertension (2011). Low credibility.
...
### Neutralizing antibodies after the third COVID-19 vaccination in healthcare workers with or without breakthrough infection [^117S927T]. Communications Medicine (2024). Medium credibility.
...
### Experimental nonclassicality in a causal network without assuming freedom of choice [^116wJm1Y]. Nature Communications (2023). High credibility.
...
### Topological phonon transport in an optomechanical system [^1149iDZv]. Nature Communications (2022). High credibility.
...
### Solving olympiad geometry without human demonstrations [^112qCPpP]. Nature (2024). Excellent credibility.
...
### Ecological networks of dissolved organic matter and microorganisms under global change [^1152X5fz]. Nature Communications (2022). High credibility.
...
### SCAI expert consensus statement on the management of calcified coronary lesions [^117319kH]. Journal of the Society for Cardiovascular Angiography & Interventions (2024). High credibility.
...
### How are dysplastic hips different? A three-dimensional CT study [^112DHB1v]. Clinical Orthopaedics and Related Research (2015). Low credibility.
...
### Measuring external rotation of the fibula and fibular length in bilateral computed tomography scans: how reliable is this method? [^11592ne1]. Journal of Orthopaedic Trauma (2024). Medium credibility.
...
### Integration of molecular coarse-grained model into geometric representation learning framework for protein-protein complex property prediction [^111rVb6R]. Nature Communications (2024). High credibility.
...
### Experimental nonclassicality in a causal network without assuming freedom of choice [^116To2bP]. Nature Communications (2023). High credibility.
...
### Daridorexant (Quviviq) [^116cMCiG]. FDA (2024). Medium credibility.
...
### Pharmacokinetics of intravenously (DIZ101), subcutaneously (DIZ102), and intestinally (LCIG) infused levodopa in advanced parkinson disease [^113kqhFH]. Neurology (2022). Medium credibility.
...
### De novo design of modular peptide-binding proteins by superhelical matching [^111rv74b]. Nature (2023). Excellent credibility.
...
### Ten years of progress towards universal health coverage: has China achieved equitable healthcare financing? [^114hkg8r]. BMJ Global Health (2020). High credibility.
...
### Solving olympiad geometry without human demonstrations [^111EKuQU]. Nature (2024). Excellent credibility.
...
### Solving olympiad geometry without human demonstrations [^112ANDDp]. Nature (2024). Excellent credibility.
...
### Impact of the aortomitral positional anatomy on atrioventricular conduction disorder following mitral valve surgery [^1132Ptjx]. Journal of the American Heart Association (2024). Medium credibility.
...
### Medial packing and elastic asymmetry stabilize the double-gyroid in block copolymers [^114JPpnq]. Nature Communications (2022). High credibility.
...
### Balancing the anteroposterior diameters of the nostril lengths in cleft rhinoplasty [^113mS8K5]. Aesthetic Plastic Surgery (2023). Medium credibility.
...
### ACR-SPR-SSR practice parameter for the performance and interpretation of magnetic resonance imaging (MRI) of the hip and pelvis for musculoskeletal disorders [^111ABoX1]. SPR/ACR/SSR (2021). High credibility.
...
### Femoral head-neck offset measurements in 339 subjects: distribution and implications for femoroacetabular impingement [^112iFuW6]. Knee Surgery, Sports Traumatology, Arthroscopy (2013). Low credibility.
...
### Disadvantages of using the area under the receiver operating characteristic curve to assess imaging tests: a discussion and proposal for an alternative approach [^112Hq332]. European Radiology (2015). Low credibility.
...
### Disadvantages of using the area under the receiver operating characteristic curve to assess imaging tests: a discussion and proposal for an alternative approach [^115aZLez]. European Radiology (2015). Low credibility.
...
### Is the fibular station on lateral ankle radiographs symmetric? A retrospective observational radiographic study [^114RXsKv]. Clinical Orthopaedics and Related Research (2020). Medium credibility.
...
### Leucine aminopeptidase1 controls egg deposition and hatchability in male aedes aegypti mosquitoes [^115H929V]. Nature Communications (2024). High credibility.
...
### Pharmacokinetic evaluation of a drug transporter cocktail consisting of digoxin, furosemide, metformin, and rosuvastatin [^1128vxbm]. Clinical Pharmacology and Therapeutics (2016). Low credibility.
...
### Iobenguane I-123 (Adreview) [^117G8PbY]. FDA (2024). Medium credibility.
