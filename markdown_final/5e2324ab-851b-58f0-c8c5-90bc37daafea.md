...
> Hold on, I should verify alternatives for patients who cannot take or do not respond to first-line agents. Topiramate has moderate-quality evidence for reducing heavy drinking and is recommended by VA/DoD as an alternative, though it is not FDA-approved for AUD and requires slow titration due to cognitive and paresthesia side effects. Gabapentin may be considered when first-line options are unsuitable, particularly in patients with insomnia or withdrawal symptoms, but evidence is mixed and dosing frequency can limit adherence [^26c16b88] [^772a6f88] [^3d73af7d] [^10bf9f7f].
