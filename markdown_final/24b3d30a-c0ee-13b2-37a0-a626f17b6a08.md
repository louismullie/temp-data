...
> Wait, let me verify whether 12 weeks is sufficient or if longer treatment improves outcomes. High-quality meta-analyses and contemporary guidelines support naltrexone as first-line for AUD and note clinically meaningful benefits, but many trials are 12 to 16 weeks, and some extended-release studies run 24 weeks, suggesting that while 12 weeks is the minimum evidence-based duration, longer treatment may yield additional benefit in some patients, particularly for maintaining gains and reducing heavy drinking days [^afb7f19d] [^9b492f97] [^e6129b12].
...
> I should also consider special settings. Hospital-initiated naltrexone is feasible and can be continued outpatient, with emerging data showing acceptability and signals for reduced craving even when engagement is modest. In these cases, starting oral naltrexone at discharge with a 12-week plan and close follow-up is pragmatic, and extended-release naltrexone can be considered when adherence is a concern or access allows [^f3c3d934] [^a694aeb6] [^ec82f4af].

> Let me reconsider liver disease, because I need to ensure safety. Earlier caution was excessive. Current guidance indicates naltrexone is acceptable in compensated liver disease, including cirrhosis, with monitoring, so liver disease does not automatically preclude a 12-week or longer course if clinically indicated, though decompensated disease remains a contraindication [^f7cddd46] [^a4a6b463].
...
The standard duration of naltrexone for alcohol use disorder is **12 weeks at 50 mg/day** [^fb3a8486] [^5f370461], based on FDA labeling and pivotal trials [^8b65dcce]. Many clinicians extend therapy to **3–6 months or longer** [^notfound] if effective and tolerated, as benefits persist with continued use [^91411630]. For patients with adherence issues, **extended-release injectable naltrexone** (380 mg every 4 weeks) for 24 weeks is supported [^8be5f48a] [^6d187a5f]. Treatment should be individualized, with reassessment at 12 weeks to decide on continuation [^notfound].
