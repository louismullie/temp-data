...
> But wait, what if someone is thinking about ultra-short regimens or other experimental durations as "new"? I should double-check that. Trials of 6-week DAA therapy have largely shown inferior SVR compared with standard durations, and abbreviated courses are not recommended for acute or chronic infection outside trials, so these are not new approved options despite ongoing research interest [^114iKp5D] [^111rYYF3].
