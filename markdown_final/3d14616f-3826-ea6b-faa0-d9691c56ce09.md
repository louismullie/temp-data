...
1. The number of solutions to the equation [3/19]^x + [5/19]^x + [11/19]^x = 2√(x − 1) is (
(A) 0
(B) 1
(C) 2
(D) Infinite
...
The equation ([3/19]^x + [5/19]^x + [11/19]^x = 2√(x − 1)) has **exactly one solution**. The left side is a strictly decreasing exponential sum, while the right side is a strictly increasing square root function; they intersect exactly once in the domain (x \\geq 1). Thus, the correct answer is **(B) 1**.
...
The LHS, (f(x) = [3/19]^x + [5/19]^x + [11/19]^x), is a sum of exponential functions with bases between 0 and 1, so it is **strictly decreasing** for all (x). At (x = 1), (f(1) = [3/19] + [5/19] + [11/19] = 1). As (x → ∞), (f(x) → 0).
