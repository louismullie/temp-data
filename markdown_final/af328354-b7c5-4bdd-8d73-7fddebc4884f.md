...
> For severe disease with erosions or marked inflammation, I should confirm whether candidal involvement is likely and, if so, obtain a KOH prep; if candida is present, I need to treat with an antifungal such as miconazole nitrate 0.25% in zinc oxide/petrolatum base or nystatin, and I should remember that VUSION (miconazole 0.25% with zinc oxide and petrolatum) is FDA-indicated only for diaper dermatitis complicated by documented candidiasis in immunocompetent infants 4 weeks and older, used adjunctively with frequent diaper changes and gentle cleansing, and not for prophylaxis or for more than 7 days without reassessment [^113sbrwj] [^117Sx7aY] [^1164Eoit].
