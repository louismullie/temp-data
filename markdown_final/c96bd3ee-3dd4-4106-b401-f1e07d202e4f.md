...
> Patching is a classic question. I should confirm that multiple randomized trials and Cochrane reviews show no benefit and possible harm from patching in simple abrasions, including delayed healing and loss of binocular vision, so I should not patch routine cases [^116vTb33] [^1174HynG] [^112gDtHV]. Hold on, I should verify exceptions: in large abrasions, some guidelines suggest considering a therapeutic bandage contact lens with antibiotic coverage and short-duration use, but I need to ensure there is no retained foreign body and arrange close follow-up, and I should avoid patching in contact lens wearers due to increased keratitis risk [^117D2ENF] [^112gxL6d] [^115BdaDc]. Let me double-check that wilderness guidance aligns with avoiding patching; yes, WMS 2024 also recommends against patching in corneal abrasion [^116f7jY2].
