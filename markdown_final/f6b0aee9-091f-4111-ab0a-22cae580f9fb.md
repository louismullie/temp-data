...
Hypertension-mediated organ damage — echocardiographic definitions: Echocardiographic thresholds for left ventricular hypertrophy (LVH), concentric geometry, left ventricular (LV) chamber size, and left atrial size are as follows: LV mass/height².⁷ (g/m².⁷) > 50 (men) and > 47 (women); LV mass/BSA (g/m²) > 115 (men) and > 95 (women); relative wall thickness (RWT) ≥ 0.43; LV end-diastolic diameter/height (cm/m) > 3.4 (men) and > 3.3 (women); and left atrial volume/height² (mL/m²) > 18.5 (men) and > 16.5 (women).
