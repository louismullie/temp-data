...
> Next, I should review the evidence hierarchy and identify anchor sources. Hold on, let's not jump to conclusions; I need to prioritize high-quality syntheses and guidelines. The 2019 Annals systematic review on antipsychotics for treating delirium in hospitalized adults, the 2018 Cochrane review on antipsychotics in non-ICU patients, the 2019 Cochrane review on pharmacologic interventions in critically ill adults, and the 2025 APA Practice Guideline provide the most authoritative, setting-specific guidance, while HELP and related multicomponent programs anchor non-pharmacologic prevention and treatment frameworks [^115BJqAf] [^111uz4df] [^114TWpfQ] [^117VLSVn] [^113sqWWk].

> I will now examine non-pharmacologic strategies, because these are consistently recommended as first-line for prevention and as foundational for treatment. Wait, let me verify the magnitude of benefit. Multicomponent non-pharmacologic interventions such as HELP reduce incident delirium by roughly 30–50% across hospital settings, with moderate-certainty evidence, and are endorsed by major guidelines; components include reorientation, sleep optimization, early mobilization, vision/hearing aids, hydration, and medication review, often delivered by interdisciplinary teams [^114Vg6dU] [^112XBQmC] [^1126VjxV] [^117VLSVn]. I should double-check that these benefits extend to treatment of established delirium; while prevention data are stronger, implementation studies suggest reduced delirium duration and improved process measures when these bundles are applied to active delirium, though higher-quality RCTs are needed for treatment endpoints [^114Vg6dU].

> Now, for ICU delirium treatment, I need to check the status of antipsychotics. The 2019 Cochrane review found no consistent benefit of antipsychotics on delirium duration or other patient-centered outcomes, and the 2025 focused update concludes there is insufficient evidence to recommend for or against antipsychotics for ICU delirium treatment, noting a possible small increase in delirium-free days and a possible mortality signal that did not reach statistical significance, with arrhythmia risk that warrants caution [^114TWpfQ] [^1143nyiu]. Hold on, I should verify the mortality signal; pooled analyses suggest haloperidol may reduce mortality versus placebo, but confidence intervals overlap and trial sequential analysis has not reached firm conclusions, so this remains hypothesis-generating rather than practice-changing [^111FTbbQ] [^114WjcZj].

> For non-ICU hospitalized adults with established delirium, I should confirm the stance on antipsychotics. The Annals review and the Cochrane non-ICU review converge: there is no consistent benefit of haloperidol or second-generation antipsychotics on delirium duration, severity, resolution, or mortality, and routine use is not supported; antipsychotics may be considered only for severe agitation threatening safety or essential care, at the lowest effective dose and for the shortest duration, with close monitoring [^115BJqAf] [^111uz4df]. But wait, what if the patient has distressing psychotic features? Even then, evidence is limited and decisions should be individualized, with explicit reassessment of ongoing need [^1126VjxV].

> In palliative care, I should review the limited RCT data carefully. Trials in terminally ill adults show no clear benefit of haloperidol or risperidone over placebo for delirium symptoms and suggest possible worsening of delirium severity in some comparisons, alongside increased extrapyramidal symptoms; thus, pharmacologic therapy should be reserved for distressing symptoms or safety concerns, and non-pharmacologic comfort measures prioritized [^116et1Zh]. Hmm, wait a minute, I initially thought haloperidol might consistently improve agitation in this group, but the data are mixed and often not statistically significant, reinforcing a conservative approach [^116et1Zh].

> Let me consider alternatives when antipsychotics are contraindicated or ineffective. Benzodiazepines are not recommended for routine delirium treatment outside alcohol or benzodiazepine withdrawal, given limited efficacy and risk of oversedation; evidence in non-ICU settings is sparse and low quality, so they should be avoided as first-line for agitation [^111AUFTw] [^1121Asqe]. Cholinesterase inhibitors have not shown benefit for treating established delirium and should not be started for this indication, although prophylactic use in surgical populations may reduce incidence, which is a different question than treatment [^117TaPis] [^112KD14C]. Dexmedetomidine shows promise for reducing delirium duration in ICU settings, but evidence is heterogeneous and not directly applicable to non-ICU treatment; it remains a sedative alternative rather than a general delirium treatment [^114TWpfQ].

> I should confirm safety monitoring if antipsychotics are used off-label. Key risks include QT prolongation, torsades, extrapyramidal symptoms, and neuroleptic malignant syndrome; baseline and serial ECGs are prudent in patients with cardiac risk, and drug–drug interactions should be screened, especially with other QT-prolonging agents; in older adults, start low and go slow, for example haloperidol 0.5–1 mg IV/PO with cautious titration, and reassess frequently for ongoing need [^115BJqAf] [^1126VjxV]. Hold on, I should verify that guidelines align with this cautious stance; yes, major guidelines emphasize minimal effective dosing, time-limited use, and continuous non-pharmacologic care in parallel [^1126VjxV] [^117VLSVn].

> Next, I should review implementation and systems issues, because effectiveness depends on how care is delivered. Multicomponent bundles require protocolized workflows, education, and leadership support; the Australian Delirium Clinical Care Standard and the ICU Liberation ABCDEF bundle operationalize these elements, and adherence to delirium monitoring correlates with improved outcomes, underscoring the need for reliable detection and consistent intervention delivery [^114ZmtBc] [^112QojNP] [^1132zdaZ]. I need to ensure we also address modifiable risk factors such as benzodiazepines, anticholinergics, sleep disruption, immobility, and sensory deficits, as these materially influence delirium trajectory and recovery [^1126VjxV] [^116XJtYe].

> Let me synthesize a practical approach. For all hospitalized patients with delirium, immediately identify and treat precipitating causes, implement multicomponent non-pharmacologic interventions, and monitor severity with validated tools such as CAM-ICU or 4AT; reserve antipsychotics for severe agitation or psychosis that threatens safety or essential care, use the lowest effective dose for the shortest duration, and reassess daily for de-escalation or discontinuation; in the ICU, recognize that antipsychotics are not routinely recommended and dexmedetomidine may be considered as a sedative alternative within a bundle; in palliative care, prioritize comfort, family support, and non-pharmacologic measures, using medications sparingly for distressing symptoms [^1126VjxV] [^117VLSVn] [^1143nyiu] [^116et1Zh]. I should double-check that this aligns with major guidelines; yes, this reflects the consensus across high-quality reviews and professional society guidance [^1126VjxV] [^117VLSVn] [^1143nyiu].

> Finally, I need to highlight uncertainties and research directions. Evidence gaps persist regarding treatment of established delirium, optimal dosing and duration of antipsychotics when needed, and the role of etiologic phenotyping to personalize therapy; core outcome sets and adaptive trial designs are being advanced to harmonize endpoints and accelerate discovery, and long-term cognitive and functional outcomes remain underreported and should be prioritized in future trials [^111PbtaQ] [^112h1baL] [^116JQaJs]. Hold on, I should verify that current practice remains dynamic; indeed, as new RCTs emerge, especially in ICU and palliative populations, recommendations may evolve, so clinicians should periodically revisit the evidence base and local protocols [^1143nyiu] [^111FTbbQ].

---

Hospital delirium treatment centers on **multicomponent nonpharmacologic care** [^1126VjxV] as first-line therapy, including reorientation, sleep optimization, early mobilization, hydration, vision/hearing aids, and medication review [^114Vg6dU] [^112XBQmC]. Antipsychotics are **not routinely recommended** [^115BJqAf]; reserve haloperidol or second-generation agents for severe agitation or psychosis that threatens safety or care, using the lowest effective dose and close monitoring for adverse effects [^1126VjxV] [^115a1k2N]. Benzodiazepines are avoided except for alcohol/benzodiazepine withdrawal [^111AUFTw] [^1121Asqe]. Address underlying causes, monitor vitals and mental status, and reassess daily to taper medications promptly [^116XJtYe] [^1126VjxV].

---

## Nonpharmacologic interventions (first-line)

Multicomponent nonpharmacologic interventions are the cornerstone of delirium management and are **strongly recommended** by guidelines [^1126VjxV] [^117VLSVn]. These interventions target modifiable risk factors and have been shown to reduce delirium incidence, duration, and severity [^114Vg6dU] [^112XBQmC].

Key components include:

- **Reorientation and environmental modifications**: Frequent reorientation, familiar objects, clocks, calendars, and adequate lighting [^114Vg6dU].

- **Sleep optimization**: Noise reduction, minimizing nighttime interruptions, and nonpharmacologic sleep aids [^114Vg6dU].

- **Early mobilization**: Daily ambulation or physical therapy to prevent functional decline [^notfound].

- **Hydration and nutrition**: Ensure adequate intake and address deficiencies [^114Vg6dU].

- **Sensory aids**: Provide glasses and hearing aids to reduce sensory deprivation [^114Vg6dU].

- **Medication review**: Discontinue or reduce deliriogenic drugs (e.g. anticholinergics, benzodiazepines, opioids) [^1121Asqe].

---

## Pharmacologic interventions (reserved for specific indications)

Pharmacologic therapy is **not routinely recommended** and should be reserved for patients with severe agitation, psychosis, or when nonpharmacologic measures fail [^1126VjxV] [^115BJqAf]. The choice of medication depends on patient-specific factors, including age, comorbidities, and delirium subtype [^115a1k2N].

---

### Antipsychotics

Antipsychotics are the **most studied pharmacologic agents** for delirium, but evidence for their efficacy is limited and mixed [^115BJqAf] [^111uz4df]. They may reduce agitation and psychotic symptoms but do not consistently shorten delirium duration or improve long-term outcomes [^115BJqAf] [^111uz4df].

| **Medication** | **Indication** | **Recommended dose** | **Notes** |
|-|-|-|-|
| Haloperidol | Severe agitation, psychosis | 0.5–2 mg IV/PO q4–6h PRN | - Monitor for extrapyramidal symptoms <br/> - QT prolongation <br/> - And neuroleptic malignant syndrome [^115a1k2N] |
| Risperidone | Severe agitation, psychosis | 0.5–1 mg PO BID PRN | Lower risk of extrapyramidal symptoms compared to haloperidol [^111FSFyo] |
| Olanzapine | Severe agitation, psychosis | 2.5–5 mg PO/IM daily PRN | Lower risk of extrapyramidal symptoms; monitor for metabolic effects [^112Ncy5d] |
| Quetiapine | Severe agitation, psychosis | 25–50 mg PO BID PRN | Sedating; useful for hypoactive delirium [^notfound] |

---

Antipsychotics should be used at the **lowest effective dose**, for the shortest duration, with daily reassessment and prompt tapering once symptoms resolve [^1126VjxV] [^115a1k2N].

---

### Benzodiazepines

Benzodiazepines are **generally avoided** due to their sedative properties and potential to worsen delirium, except in cases of alcohol or benzodiazepine withdrawal [^111AUFTw] [^1121Asqe]. If used, short-acting agents such as lorazepam may be administered cautiously with close monitoring [^111AUFTw].

---

### Other pharmacologic agents

- **Cholinesterase inhibitors**: Not recommended for treatment of established delirium due to lack of efficacy [^117TaPis] [^1121Asqe].
- **Dexmedetomidine**: An alpha-2 agonist primarily used in ICU settings for agitated delirium, particularly in mechanically ventilated patients. Evidence suggests it may reduce delirium duration and mechanical ventilation days, but its use is limited to ICU settings [^114TWpfQ] [^1143nyiu].
- **Melatonin**: May be considered for prevention of delirium in high-risk patients, but evidence for treatment of established delirium is limited [^115SVEMB] [^113bc7bj].
...
- **Family and caregiver involvement**: Educate and engage family members in care strategies, including reorientation and environmental modifications [^112QojNP].

---

## Special considerations

- **Elderly patients**: Greater susceptibility to medication side effects, particularly extrapyramidal symptoms and falls. Use lower doses and monitor closely [^115a1k2N].
- **Patients with pre-existing cognitive impairment**: Require individualized care plans and careful monitoring due to increased risk of persistent delirium and cognitive decline [^113R9D1J].
- **Palliative care settings**: Emphasis on comfort, symptom control, and family support. Pharmacologic therapy may be used judiciously for distressing symptoms [^116et1Zh].

---

Hospital delirium treatment relies on **multicomponent nonpharmacologic care** as the foundation, with pharmacologic therapy reserved for severe cases. Address underlying causes, monitor closely, and reassess daily to optimize outcomes and minimize adverse effects [^1126VjxV] [^116XJtYe].

---

## References

### Antipsychotics for treating delirium in hospitalized adults: a systematic review [^115BJqAf]. Annals of Internal Medicine (2019). Medium credibility.
...
### Antipsychotics in the treatment of delirium in older hospitalized adults: a systematic review [^116vGvtR]. Journal of the American Geriatrics Society (2011). Low credibility.
...
### Can we improve delirium prevention and treatment in the emergency department? A systematic review [^1175koms]. Journal of the American Geriatrics Society (2022). Medium credibility.
...
### Antipsychotic medication for prevention and treatment of delirium in hospitalized adults: a systematic review and meta-analysis [^111ssyxG]. Journal of the American Geriatrics Society (2016). Low credibility.
...
### A core outcome set for studies evaluating interventions to prevent and / or treat delirium for adults requiring an acute care hospital admission: an international key stakeholder informed consensus study [^112h1baL]. BMC Medicine (2021). Medium credibility.
...
### A core outcome set for studies evaluating interventions to prevent and / or treat delirium for adults requiring an acute care hospital admission: an international key stakeholder informed consensus study [^115bJKRR]. BMC Medicine (2021). Medium credibility.
...
### Non-pharmacological interventions for preventing delirium in hospitalised non-ICU patients [^114Vg6dU]. The Cochrane Database of Systematic Reviews (2021). Medium credibility.
...
### Interventions for preventing delirium in hospitalised non-ICU patients [^113bc7bj]. The Cochrane Database of Systematic Reviews (2016). Low credibility.
...
### Multidisciplinary team interventions for delirium in patients with chronic cognitive impairment [^112yJX3o]. The Cochrane Database of Systematic Reviews (2004). Low credibility.
...
### Haloperidol for the treatment of delirium in critically ill patients: an updated systematic review with meta-analysis and trial sequential analysis [^111FTbbQ]. Critical Care (2023). Medium credibility.
...
### How we prevent and treat delirium in the ICU [^112QojNP]. Chest (2021). Medium credibility.
...
### Non-pharmacologic multicomponent interventions preventing delirium in hospitalized people [^112XBQmC]. Journal of the American Geriatrics Society (2020). Medium credibility.
...
### Antipsychotics in the treatment of delirium in critically ill patients: a systematic review and meta-analysis of randomized controlled trials [^111xBh6Y]. Critical Care Medicine (2024). Medium credibility.
...
### Acetylcholinesterase inhibitors for delirium prevention: a systematic review and meta-analysis [^112KD14C]. Critical Care Medicine (2025). Medium credibility.
...
### Delirium in elderly adults: diagnosis, prevention and treatment [^1156eRit]. Nature Reviews: Neurology (2009). Medium credibility.
...
### Delirium and COVID-19: a narrative review of emerging evidence [^113v6irY]. Anaesthesia (2022). Medium credibility.
...
### Clinical practice guidelines for delirium management: potential application in palliative care [^111etxjT]. Journal of Pain and Symptom Management (2014). Low credibility.
...
### More questions than answers in ICU delirium: pressing issues for future research [^113BcKoK]. The Annals of Pharmacotherapy (2013). Low credibility.
...
### Antipsychotics for preventing delirium in hospitalized adults: a systematic review [^1179nw67]. Annals of Internal Medicine (2019). Medium credibility.
...
### A core outcome set for studies evaluating interventions to prevent and / or treat delirium for adults requiring an acute care hospital admission: an international key stakeholder informed consensus study [^113Yk2i8]. BMC Medicine (2021). Medium credibility.
...
### Delirium in the intensive care unit [^111HR112]. Critical Care (2008). Low credibility.
...
### Exercise therapy for the treatment of delirium in the intensive care unit [^113sqWWk]. The Cochrane Database of Systematic Reviews (2025). Medium credibility.
...
### Delirium in palliative medicine: a review [^115x9fK7]. Journal of Pain and Symptom Management (2012). Low credibility.
...
### A roadmap to advance delirium research: recommendations from the NIDUS scientific think tank [^116L6Vxb]. Alzheimer's & Dementia (2020). Medium credibility.
...
### Can we improve delirium prevention and treatment in the emergency department? A systematic review [^1128d7bQ]. Journal of the American Geriatrics Society (2022). Medium credibility.
...
### WITHDRAWN: multidisciplinary team interventions for delirium in patients with chronic cognitive impairment [^1131AQgY]. The Cochrane Database of Systematic Reviews (2007). Low credibility.
...
### Design and methods of the hospital elder life program (HELP), a multicomponent targeted intervention to prevent delirium in hospitalized older patients: efficacy and cost-effectiveness in Dutch health care [^117QzBSF]. BMC Geriatrics (2013). Low credibility.
...
### The Australian delirium clinical care standard: not just another brick in the wall [^114ZmtBc]. Age and Ageing (2023). Medium credibility.
...
### Haloperidol for the treatment of delirium in critically ill patients: an updated systematic review with meta-analysis and trial sequential analysis [^115mio6C]. Critical Care (2023). Medium credibility.
...
### The American psychiatric association practice guideline for the prevention and treatment of delirium [^114yQcYv]. The American Journal of Psychiatry (2025). High credibility.
...
### Advancing delirium treatment trials in older adults: recommendations for future trials from the network for investigation of delirium: unifying scientists (NIDUS) [^111PbtaQ]. Critical Care Medicine (2025). Medium credibility.
...
### Update of the European Society of Anaesthesiology and Intensive Care medicine evidence-based and consensus-based guideline on postoperative delirium in adult patients [^114xxrEu]. European Journal of Anaesthesiology (2024). Medium credibility.
...
### Non-pharmacological interventions for delirium in the pediatric population: a systematic review with narrative synthesis [^111rAxKG]. BMC Pediatrics (2024). Medium credibility.
...
### Interventions for preventing intensive care unit delirium in adults [^113Q5xZU]. The Cochrane Database of Systematic Reviews (2018). Low credibility.
...
### Evidence-based treatment of delirium in patients with cancer [^11285aGv]. Journal of Clinical Oncology (2012). Low credibility.
...
### A multifaceted approach to prevention of delirium on intensive care [^115cAa7o]. BMJ Quality Improvement Reports (2015). Medium credibility.
...
### American Geriatrics Society abstracted clinical practice guideline for postoperative delirium in older adults [^1162qeU8]. Journal of the American Geriatrics Society (2015). Low credibility.
...
### A call to action for delirium research: meta-analysis and regression of delirium associated mortality [^115qpLXx]. BMC Geriatrics (2020). Medium credibility.
...
### The johns hopkins delirium consortium: a model for collaborating across disciplines and departments for delirium prevention and treatment [^112NddGR]. Journal of the American Geriatrics Society (2011). Low credibility.
...
### American Geriatrics Society identifies another five things that healthcare providers and patients should question [^117PgM8k]. Journal of the American Geriatrics Society (2014). Medium credibility.
...
### The modified hospital elder life program (HELP) in geriatric hospitalized patients in internal wards: a double-blind randomized control trial [^114CEfZa]. BMC Geriatrics (2021). Medium credibility.
...
### American Geriatrics Society abstracted clinical practice guideline for postoperative delirium in older adults [^1157fXwy]. Journal of the American Geriatrics Society (2015). Medium credibility.
...
### Olanzapine versus haloperidol for treatment of delirium in patients with advanced cancer: a phase III randomized clinical trial [^111SFsJw]. The Oncologist (2020). Medium credibility.
...
### Outcome of delirium in critically ill patients: systematic review and meta-analysis [^112CQuKx]. BMJ (2015). Excellent credibility.
...
### American Geriatrics Society abstracted clinical practice guideline for postoperative delirium in older adults [^113q3n15]. Journal of the American Geriatrics Society (2015). Medium credibility.
...
### A call to action for delirium research: meta-analysis and regression of delirium associated mortality [^112hYH83]. BMC Geriatrics (2020). Medium credibility.
...
### Olanzapine versus haloperidol for treatment of delirium in patients with advanced cancer: a phase III randomized clinical trial [^111FSFyo]. The Oncologist (2020). Medium credibility.
...
### Does melatonin prevent hospital-acquired delirium?… [^115SVEMB]. AAFP (2024). Medium credibility.
...
### A multi-phase quality improvement initiative for the treatment of active delirium in older persons [^115dtQcS]. Journal of the American Geriatrics Society (2021). Medium credibility.
...
### Clinical practice guidelines for the prevention and management of pain, agitation / sedation, delirium, immobility, and sleep disruption in adult patients in the ICU [^1132zdaZ]. Critical Care Medicine (2018). Medium credibility.
...
### Cholinesterase inhibitors for delirium [^117TaPis]. The Cochrane Database of Systematic Reviews (2008). Low credibility.
...
### When there's smoke, look for the fire: the complex interplay between delirium and dementia [^113P9FME]. American Journal of Respiratory and Critical Care Medicine (2025). Medium credibility.
...
### Geriatric emergency department guidelines [^114EhAFd]. Annals of Emergency Medicine (2014). Medium credibility.
...
### American Geriatrics Society abstracted clinical practice guideline for postoperative delirium in older adults [^111LpMAY]. Journal of the American Geriatrics Society (2015). Medium credibility.
...
### Update of the European Society of Anaesthesiology and Intensive Care medicine evidence-based and consensus-based guideline on postoperative delirium in adult patients [^1153cpXK]. European Journal of Anaesthesiology (2024). Medium credibility.
...
### Olanzapine versus haloperidol for treatment of delirium in patients with advanced cancer: a phase III randomized clinical trial [^112Ncy5d]. The Oncologist (2020). Medium credibility.
...
### American Geriatrics Society abstracted clinical practice guideline for postoperative delirium in older adults [^1121Asqe]. Journal of the American Geriatrics Society (2015). Medium credibility.
...
### A systematic meta-review of interventions to prevent and manage delirium in the intensive care unit: part 2-non-pharmacological and multicomponent interventions [^111wwthV]. Critical Care (2025). Medium credibility.
...
### Long-term clinical outcomes of delirium after hospital discharge: a systematic review and meta-analysis [^1134QvNy]. Age and Ageing (2025). Medium credibility.
...
### Pharmacological treatments of non-substance-withdrawal delirium: a systematic review of prospective trials [^1169v1k7]. The American Journal of Psychiatry (2014). Low credibility.
...
### Olanzapine versus haloperidol for treatment of delirium in patients with advanced cancer: a phase III randomized clinical trial [^112R7j85]. The Oncologist (2020). Medium credibility.
...
### Pharmacological and non-pharmacological interventions to prevent delirium in critically ill patients: a systematic review and network meta-analysis [^114MhgKe]. Intensive Care Medicine (2021). Medium credibility.
...
### Antipsychotics for delirium [^115VDf7F]. The Cochrane Database of Systematic Reviews (2007). Low credibility.
...
### Delirium in older persons: prevention, evaluation, and management [^115UdMEj]. American Family Physician (2023). High credibility.
