...
> Hold on, let's not jump to conclusions about outpatient therapy. I should verify severity criteria that mandate hospitalization. Indications for admission include fever, chills, rigors, hemodynamic instability, inability to tolerate oral intake, immunocompromise, diabetes, older age, or concern for urosepsis; in these cases, intravenous therapy and closer monitoring are indicated, so outpatient regimens apply only to clinically stable patients without these red flags [^114JJCk9].
