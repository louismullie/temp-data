...
> Hold on, let's not jump to conclusions about outpatient therapy. I should verify severity criteria that mandate hospitalization. Indications for admission include fever, chills, rigors, hemodynamic instability, inability to tolerate oral intake, immunocompromise, diabetes, older age, or concern for urosepsis; in these cases, intravenous therapy and closer monitoring are indicated, so outpatient regimens apply only to clinically stable patients without these red flags [^810855ea] [^650b2ba9].
...
> I should confirm partner management and public health steps. Patients should abstain from sexual activity until they and their partners complete treatment and symptoms resolve, and all sexual partners within the prior 60 days should be notified, tested, and presumptively treated for gonorrhea and chlamydia; patients should also be screened for HIV and syphilis at baseline, with repeat HIV testing if the initial test is early after exposure and results are negative or indeterminate [^91bdd048] [^f092d4d0] [^f76f8f45].
...
For suspected STI-related acute prostatitis in the outpatient setting, use **ceftriaxone 500 mg IM once** [^650b2ba9] plus **doxycycline 100 mg orally twice daily for 10 days** [^650b2ba9]. If enteric organisms are likely (e.g. insertive anal sex), add **levofloxacin 500 mg orally once daily for 10 days** [^650b2ba9]. Treat for a total of 2–4 weeks [^0a5c8219] based on severity and response, and ensure partner treatment and STI screening [^91bdd048].
