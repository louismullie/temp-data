...
### A short primer on lung stereology [^112kb1UE]. Respiratory Research (2021). Medium credibility.
...
### The role of intersection and street design on severity of bicycle-motor vehicle crashes [^111Jmnwc]. Injury Prevention (2017). Low credibility.
...
### Spatial analysis with SPIAT and spaSim to characterize and simulate tissue microenvironments [^116Q4WfL]. Nature Communications (2023). High credibility.
...
### Online legal driving behavior monitoring for self-driving vehicles [^112VWBbK]. Nature Communications (2024). High credibility.
...
### Changes in articular cartilage after meniscectomy and meniscus replacement using a biodegradable porous polymer implant [^1128uyDQ]. Knee Surgery, Sports Traumatology, Arthroscopy (2011). Low credibility.
...
### Artificial intelligence techniques for automatic detection of peri-implant marginal bone remodeling in intraoral radiographs [^117FATJU]. Journal of Digital Imaging (2023). Medium credibility.
...
### Validation of a new method for the detection of pathlines in vascular X-ray images [^114SXrq2]. Investigative Radiology (2004). Low credibility.
...
### Universal protein misfolding intermediates can bypass the proteostasis network and remain soluble and less functional [^112mDVT3]. Nature Communications (2022). High credibility.
...
### Consensus guide on CT-based prediction of stopping-power ratio using a hounsfield look-up table for proton therapy [^111qiFrZ]. Radiotherapy and Oncology (2023). Medium credibility.
...
### Principles of epidemiology: lesson 4, section 3 archive… [^1145pZfr]. archive.cdc.gov (2023). Medium credibility.
...
### Smoking-attributable cancer mortality in California, 1979–2005 [^111TRmdX]. Tobacco Control (2010). Low credibility.
...
### Bending forces and nucleotide state jointly regulate F-actin structure [^117YTSWf]. Nature (2022). Excellent credibility.
...
### Automatic cobb angle determination from radiographic images [^115Ky4F6]. Spine (2013). Low credibility.
...
### Grasping through dynamic weaving with entangled closed loops [^113sgihH]. Nature Communications (2023). High credibility.
...
### Standardized medical terminology for cardiac computed tomography: a report of the Society of Cardiovascular Computed Tomography [^111qq8cp]. Journal of Cardiovascular Computed Tomography (2011). Medium credibility.
...
### Unlocking the general relationship between energy and entanglement spectra via the wormhole effect [^111b4Gsm]. Nature Communications (2023). High credibility.
...
### Microfluidic multipoles theory and applications [^1135J59g]. Nature Communications (2019). High credibility.
...
### C. elegans chromosomes connect to centrosomes by anchoring into the spindle network [^114Rc5nN]. Nature Communications (2017). Medium credibility.
...
### Phage predation accelerates the spread of plasmid-encoded antibiotic resistance [^1126gCVx]. Nature Communications (2024). High credibility.
...
### Precise segmentation of densely interweaving neuron clusters using G-cut [^116YeVxh]. Nature Communications (2019). High credibility.
...
### Topological phase locking in stochastic oscillators [^115hSB6P]. Nature Communications (2025). High credibility.
...
### Programming molecular topologies from single-stranded nucleic acids [^113p57Mn]. Nature Communications (2018). Medium credibility.
...
### Vertebral level in pregnancy according to the posterior superior iliac spine: an observational study [^114qzMh6]. BMC Pregnancy and Childbirth (2024). Medium credibility.
...
### The new qualitative scoring MMSE pentagon test (QSPT) as a valid screening tool between autopsy-confirmed dementia with lewy bodies and Alzheimer's disease [^117VSP2W]. Journal of Alzheimer's Disease (2014). Low credibility.
...
### Neuropathological findings in down syndrome, Alzheimer's disease and control patients with and without SARS-COV-2: preliminary findings [^112bFDgY]. Acta Neuropathologica (2024). Medium credibility.
...
### Sox9 inhibits activin A to promote biliary maturation and branching morphogenesis [^114NaeNE]. Nature Communications (2025). High credibility.
...
### Three-dimensional magnetic nanotextures with high-order vorticity in soft magnetic wireframes [^112e2iPH]. Nature Communications (2024). High credibility.
...
### ACR-ACOG-AIUM-SPR-SRU practice parameter for the performance of ultrasound of the female pelvis [^111m3RBy]. SPR/AIUM/SRU/ACR/ACOG (2024). High credibility.
...
### Rotors detected by phase analysis of filtered, epicardial atrial fibrillation electrograms colocalize with regions of conduction block [^115gSx2t]. Circulation: Arrhythmia and Electrophysiology (2018). Low credibility.
...
### Guidelines and recommendations for targeted neonatal echocardiography and cardiac point-of-care ultrasound in the neonatal intensive care unit: an update from the American Society of Echocardiography [^115Rsjv8]. Journal of the American Society of Echocardiography (2024). High credibility.
...
### Degenerate boundaries for multiple-alternative decisions [^1155bzJ5]. Nature Communications (2022). High credibility.
...
### Global fitting for high-accuracy multi-channel single-molecule localization [^113oR6ra]. Nature Communications (2022). High credibility.
...
### Three-dimensional stereoscopic evaluation and quantitative gray scale assessment of the nasolabial fold and its application in injection therapy [^1174esWk]. The Journal of Craniofacial Surgery (2025). Medium credibility.
...
### Neurons exploit stochastic growth to rapidly and economically build dense dendritic arbors [^117EpADG]. Nature Communications (2025). High credibility.
...
### From pretraining to privacy: federated ultrasound foundation model with self-supervised learning [^117Qb6Fe]. NPJ Digital Medicine (2025). Medium credibility.
...
### Using the demographic health survey wealth index to create family planning market segments based on absolute income levels [^1124LmPK]. BMJ Global Health (2020). High credibility.
...
### Unlocking the general relationship between energy and entanglement spectra via the wormhole effect [^116gMAnp]. Nature Communications (2023). High credibility.
...
### Line versus representational bisections in unilateral spatial neglect [^1179VkqY]. Journal of Neurology, Neurosurgery, and Psychiatry (2000). Low credibility.
...
### Guideline no. 447: diagnosis and management of endometrial polyps [^112XDaku]. Journal of Obstetrics and Gynaecology Canada (2024). High credibility.
...
### SCCT guidelines for the interpretation and reporting of coronary CT angiography: a report of the Society of Cardiovascular Computed Tomography guidelines committee [^112BNNS1]. Journal of Cardiovascular Computed Tomography (2014). Medium credibility.
...
### Different pathways for engulfment and endocytosis of liquid droplets by nanovesicles [^1119H4CM]. Nature Communications (2023). High credibility.
...
### A critical edge number revealed for phase stabilities of two-dimensional ball-stick polygons [^115wHt9v]. Nature Communications (2024). High credibility.
...
### Fork in the road: are all bifurcations created equal? [^113RYQmq]. Catheterization and Cardiovascular Interventions (2016). Low credibility.
...
### A comparison of skeletal muscle diffusion tensor imaging tractography seeding methods [^116uErh6]. NMR in Biomedicine (2025). Medium credibility.
...
### Kinetochore-and chromosome-driven transition of microtubules into bundles promotes spindle assembly [^1166Ev4u]. Nature Communications (2022). High credibility.
...
### How do patients with neglect see a horizontal line? Analysis of performances in coloured line bisection task [^116qu5TP]. Journal of Neurology (2004). Low credibility.
...
### X-linked hypophosphatemia management in adults: an international working group clinical practice guideline [^116BbVCn]. The Journal of Clinical Endocrinology and Metabolism (2025). High credibility.
