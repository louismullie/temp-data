...
> But wait, what if the margin was too permissive or the event rates too low to detect a difference. The 2.1% absolute margin was prespecified and aligns with contemporary noninferiority practice, and the observed event rates were low and similar between arms, which actually makes the noninferiority finding more robust; moreover, the trial's population and procedures reflect real-world elective practice, enhancing applicability despite being single-center [^afb61be7].
