...
> Let me synthesize: magnesium is helpful in asthma exacerbation primarily via bronchodilation and possibly anti-inflammatory effects, and the most consistent, albeit modest, benefit is with intravenous magnesium in severe exacerbations that fail initial therapy, translating into fewer hospitalizations and small improvements in lung function, whereas inhaled magnesium has not shown reliable clinical benefit and should not be used routinely, and oral magnesium has no role in acute care [^ded677d5] [^d1acfc98] [^068ca0f3].

> Finally, I should acknowledge uncertainties and future directions. Larger, multicenter pediatric RCTs are needed to clarify IV magnesium's effect size and safety, head-to-head comparisons with other second-line agents are sparse, and biomarkers or phenotypes that predict response could refine selection; until then, magnesium remains a reasonable, low-risk rescue adjunct for severe, refractory exacerbations after standard therapy, with shared decision-making about potential benefits and the limits of evidence [^12076749] [^068ca0f3].

---

Magnesium helps in asthma exacerbation by **bronchodilating airway smooth muscle** via calcium channel blockade and by **reducing inflammation** through inhibition of inflammatory mediators [^816534eb]. Intravenous magnesium sulfate is most beneficial in **severe exacerbations** that do not respond to initial bronchodilators and corticosteroids, reducing hospital admissions and improving lung function [^ded677d5] [^f93be9ed]. Nebulized magnesium may offer modest benefits in severe cases, but evidence is weaker and not sufficient for routine use [^d1acfc98] [^068ca0f3]. Magnesium is **safe and inexpensive**, with minimal adverse effects, and is recommended by guidelines for selected severe cases [^068ca0f3] [^065862b6].
...
- **Bronchodilation**: Magnesium acts as a calcium channel blocker, reducing calcium influx in airway smooth muscle cells, thereby decreasing muscle contraction and promoting bronchodilation [^816534eb].

- **Anti-inflammatory effects**: Magnesium inhibits the release of inflammatory mediators such as histamine and acetylcholine, and stabilizes mast cells and T lymphocytes, reducing airway inflammation [^816534eb].

- **Improved beta-agonist responsiveness**: Magnesium may enhance the sensitivity of beta-adrenergic receptors to bronchodilators, potentially augmenting the effects of beta-agonists [^816534eb].
...
- **Reduction in hospital admissions**: A Cochrane review of 14 RCTs (2,313 adults) found that IV MgSO4 reduced hospital admissions by 25% (OR 0.75, 95% CI 0.60–0.92) [^ded677d5].

- **Improvement in lung function**: IV MgSO4 significantly improved lung function indices such as FEV1 and peak expiratory flow (PEF) in adults with acute asthma [^ded677d5].

- **Greatest benefit in severe exacerbations**: The most pronounced benefits were observed in patients with severe or life-threatening asthma exacerbations [^5ac5ea68].
...
- **Modest benefits in severe cases**: Some studies suggest modest improvements in lung function and reduced hospital admissions when nebulized magnesium is added to standard therapy in severe asthma exacerbations [^d0eaa041] [^d1acfc98].

- **Limited routine use**: The evidence is insufficient to recommend routine use of nebulized magnesium in acute asthma management [^d1acfc98] [^068ca0f3].
...
|-|-|
| Global Initiative for Asthma (GINA) 2024 | - IV magnesium sulfate is not recommended for routine use <br/> - Consider IV magnesium (2 g over 20 min) in severe exacerbations not responding to initial treatment, particularly with persistent hypoxemia or FEV1 < 25–30% predicted in adults or FEV1 < 60% predicted in children after 1 hour of care [^068ca0f3] [^065862b6] |
...
- **Common adverse effects**: Flushing, fatigue, nausea, headache, and mild hypotension are the most commonly reported side effects [^ded677d5].

- **Serious adverse effects**: Serious adverse events such as respiratory depression, bradycardia, or significant hypotension are rare but require monitoring, especially in patients with renal impairment or cardiovascular instability [^816534eb].
...
- **Variability in study design**: Differences in patient populations, intervention protocols, and outcome measures contribute to heterogeneity in study results [^ded677d5].

- **Limited pediatric evidence**: The evidence base for pediatric patients is smaller and less consistent, necessitating further research [^94478874].

- **Routine vs. selective use**: While some guidelines recommend selective use in severe cases, others argue for broader application, highlighting the need for individualized clinical judgment [^068ca0f3] [^d5066d83].
...
### Intravenous magnesium sulfate for asthma exacerbations in children: systematic review with meta-analysis [^12076749]. Paediatric Respiratory Reviews (2024). Medium credibility.
...
### Pharmacologic treatment of the adult hospitalized asthma patient [^439c5768]. Clinical Reviews in Allergy & Immunology (2001). Low credibility.
...
### Intravenous magnesium sulfate for acute asthma… [^5ac5ea68]. AAFP (2021). Medium credibility.
...
### Magnesium sulfate [^6c2a743e]. FDA (2023). Medium credibility.
...
### Use of nebulised magnesium sulphate as an adjuvant in the treatment of acute exacerbations of COPD in adults: a randomised double-blind placebo-controlled trial [^63052577]. Thorax (2013). Low credibility.
...
### Analysis of guideline recommendations for treatment of asthma exacerbations in children: a pediatric emergency research networks (PERN) study [^6e19161d]. Archives of Disease in Childhood (2024). Medium credibility.
...
### Prospective observational study of clinical outcomes after intravenous magnesium for moderate and severe acute asthma exacerbations in children [^5e996043]. The Journal of Allergy and Clinical Immunology: In Practice (2022). Medium credibility.
...
### Role of nebulised magnesium sulfate in treating acute asthma in children: a systematic review and meta-analysis [^787f35de]. BMJ Paediatrics Open (2024). High credibility.
...
### The role of oral magnesium supplements for the management of stable bronchial asthma: a systematic review and meta-analysis [^5233fe43]. NPJ Primary Care Respiratory Medicine (2019). Medium credibility.
...
### Treatment patterns and frequency of key outcomes in acute severe asthma in children: a paediatric research in emergency departments international collaborative (PREDICT) multicentre cohort study [^83e1d910]. BMJ Open Respiratory Research (2022). High credibility.
...
### Use of isotonic nebulised magnesium sulphate as an adjuvant to salbutamol in treatment of severe asthma in adults: randomised placebo-controlled trial [^d0eaa041]. Lancet (2003). Excellent credibility.
...
### Intravenous magnesium: prompt use for asthma in children treated in the emergency department (IMPACT-ED), a pilot randomized trial [^d397c032]. Academic Emergency Medicine (2025). Medium credibility.
...
### Magnesium and outcomes in children with acute asthma… [^6e456b5b]. AAFP (2001). Low credibility.
...
### 38th international symposium on intensive care and emergency medicine: brussels, belgium. 20–23 March 2018 [^1b4b73d5]. Critical Care (2018). Low credibility.
...
### 44th international symposium on intensive care&emergency medicine [^2b674498]. Critical Care (2025). Medium credibility.
...
### Evidence synthesis of outcomes of extracorporeal membrane oxygenation for life-threatening asthma exacerbations [^9a2d2baa]. CHEST Critical Care (2024). Medium credibility.
...
### Magnesium use in asthma pharmacotherapy: a pediatric emergency research Canada study [^e33fc5d5]. Pediatrics (2012). Low credibility.
