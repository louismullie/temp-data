...
Patients aged 18 to 60 years presenting with acute asthma and FEV1 < or = 30% predicted on arrival to the ED.
...
The difference of the postinterventional minus the baseline provocative dose of metacholine required to decrease the forced expiratory volume in 1 second by 20% (PC20) was significantly higher in the magnesium group compared with the placebo group (0.48 +/- 0.46 mg/mL versus 0.05 +/- 0.73 mg/mL, P = .028). In the magnesium group, the PC(20) significantly increased (from 0.83 +/- 0.54 mg/mL to 1.31 +/- 0.66 mg/mL, P = .0001), whereas there was no change in the placebo group (0.86 +/- 0.52 mg/mL to 0.91 +/- 0.54 mg/mL, P = .83).
