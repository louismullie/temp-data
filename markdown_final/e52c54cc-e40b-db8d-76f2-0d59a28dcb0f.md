...
The new asthma guidelines emphasize **ICS-containing therapy for all patients** [^4ad523f0] to reduce exacerbation risk, with **SMART/MART as preferred care** for adults and adolescents [^4ad523f0] and as-needed ICS-formoterol for mild asthma [^4ad523f0]. SABA-only treatment is discouraged due to increased risk [^4ad523f0]. For severe asthma, **biologics are recommended** [^e3d08f85] based on phenotype/endotype, and FeNO is suggested to guide therapy in selected patients [^f15c402c]. Treatment is individualized, with regular review and step-up/down based on control and risk [^2f33fbd5] [^fea5b03e].
