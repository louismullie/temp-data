...
> Let me first confirm the disease construct and pathophysiology so I don't anchor on outdated notions. Acne vulgaris is a chronic inflammatory disease of the pilosebaceous unit driven by four interacting pillars: increased sebum production influenced by androgens, abnormal follicular keratinization with microcomedo formation, Cutibacterium acnes colonization and strain-level effects, and innate/adaptive immune-mediated inflammation; newer data also implicate neuropeptides and the skin microbiome, which helps explain heterogeneity and treatment variability [^112DMEmP] [^115j6bjy].
