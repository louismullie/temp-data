...
> I will now examine blood loss as the most common cause. In premenopausal women, heavy menstrual bleeding is the leading etiology, with estimates that 38% of reproductive-age women have iron deficiency without anemia and about 13% have iron-deficiency anemia in high-income settings, underscoring the magnitude of menstrual iron loss and its underrecognition [^2455baf2] [^c0e26ecb]. In men and postmenopausal women, gastrointestinal blood loss predominates, and guidelines recommend urgent bidirectional endoscopy to evaluate for malignancy or other GI pathology when iron deficiency anemia is confirmed without an obvious cause, given the cancer risk signal [^0146f4d6] [^bb17945e]. I should also remember NSAID use as a frequent contributor to occult GI bleeding and that dual pathology can coexist in a minority of cases, which is why comprehensive evaluation is prudent in older adults [^bb17945e].
