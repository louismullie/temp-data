...
> I should double-check indications for ULT to avoid overtreatment. Strong indications include frequent flares (≥ 2/year), tophi, or radiographic damage attributable to gout; conditional indications include more than one prior flare even if infrequent, marked hyperuricemia (SU > 9 mg/dL), or CKD stage ≥ 3, and in these scenarios I should discuss benefits, harms, and costs with the patient using shared decision-making [^a3f9b726] [^bea6ab4b] [^a8a4b616].
