...
> Next, I should review treat-to-target principles and monitoring. Allopurinol is preferred first-line ULT, started low (≤ 100 mg/day, lower in CKD) and titrated every 2–5 weeks toward a serum urate target of < 6 mg/dL, or < 5 mg/dL in severe disease with tophi; I need to check serum urate periodically and adjust therapy to sustain the target, as this reduces flares, shrinks tophi, and prevents joint damage [^7043fabc] [^5a66e003] [^6239eda6].
