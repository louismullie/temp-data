...
Gastrointestinal adverse effects by corticosteroid type—eFigure 4 shows subgroup analyses for nausea or vomiting: Dexamethasone subtotal (95% CI) 44 36 63.0 −0.30 (−0.83 to 0.23), with heterogeneity τ2 = 0.13, χ2 = 8.37 (P = .004), I2 = 88% and test for overall effect z = 1.11 (P = .27); Methylprednisolone subtotal (95% CI) 20 20 37.0 0.00 (−0.09 to 0.09), heterogeneity not applicable, and test for overall effect z = 0.00 (P = 1.00). The overall totals are also shown: Total (95% CI) 64 56 100.0 −0.19 (−0.54 to 0.16), Total events 5 12, with test for subgroup differences χ2 = 1.19 (P = .28), I2 = 15.9%.
