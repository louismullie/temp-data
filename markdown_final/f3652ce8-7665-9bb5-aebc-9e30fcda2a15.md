...
Gastrointestinal adverse effects by corticosteroid type — eFigure 4 shows subgroup analyses for nausea or vomiting: Dexamethasone subtotal (95% CI) 44 36 63.0 −0.30 (−0.83 to 0.23), with heterogeneity τ² = 0.13, χ² = 8.37 (P = 0.004), I² = 88% and test for overall effect z = 1.11 (P = 0.27); Methylprednisolone subtotal (95% CI) 20 20 37.0 0.00 (−0.09 to 0.09), heterogeneity not applicable, and test for overall effect z = 0.00 (P = 1.00). The overall totals are also shown: Total (95% CI) 64 56 100.0 −0.19 (−0.54 to 0.16), Total events 5 12, with test for subgroup differences χ² = 1.19 (P = 0.28), I² = 15.9%.
