...
> Wait, let me verify the filter choices before jumping to vehicles. Mineral filters (zinc oxide, titanium dioxide) are generally less irritating and less likely to cause allergic or photoallergic reactions, which is helpful for sensitive, oily skin; however, classic mineral formulations can feel thick or leave a white cast, so micronized or tinted versions are preferable in practice [^112690dc] [^ed1ebe96]. Chemical filters like avobenzone, octinoxate, octisalate, and octocrylene can be formulated in lightweight, non-greasy vehicles and are often well tolerated, but I need to ensure the product is labeled non-comedogenic and oil-free to reduce acne risk [^112690dc].

> I will now examine vehicle and texture, because this is where adherence hinges for oily skin. Lightweight liquids, gels, serums, and alcohol-based sprays tend to be favored for their fast absorption and matte finish; a split-face trial showed an alcohol-based spray was rated less greasy and more acceptable, supporting real-world usability for oily skin types [^3d237a8b]. Hold on, I should verify that alcohol content does not imply irritation by default; formulation context matters, and many modern gel-lotions balance alcohol with humectants to maintain barrier comfort while keeping oiliness down.
