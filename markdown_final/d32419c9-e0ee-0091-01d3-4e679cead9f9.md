...
11.2. Given a right triangle $A B C$ with legs $A C = a$ and $C B = b$. Find a) the side of the square with vertex $C$ of the largest area, entirely lying within the triangle $A B C$; б) the dimensions of the rectangle with vertex $C$ of the largest area, entirely lying within the triangle $A B C$.
...
[
\\dfrac{s}{a} + \\dfrac{s}{b} = 1 \\implies s\\left(\\dfrac{1}{a} + \\dfrac{1}{b}\\right) = 1 \\implies s = \\dfrac{ab}{a + b}
]
...
[
\\dfrac{x}{a} + \\dfrac{y}{b} = 1 \\implies y = b\\left(1 - \\dfrac{x}{a}\\right)
]

The area is (A = xy = x \\cdot b\\left(1 - \\dfrac{x}{a}\\right) = bx - \\dfrac{b}{a}x^2). To maximize, take the derivative and set it to zero:

[
\\dfrac{dA}{dx} = b - \\dfrac{2b}{a}x = 0 \\implies x = \\dfrac{a}{2}
]

Then (y = b\\left(1 - \\dfrac{1}{2}\\right) = \\dfrac{b}{2}), so the dimensions are (\\boxed{\\dfrac{a}{2} \\times \\dfrac{b}{2}}) and the area is (\\boxed{\\dfrac{ab}{4}}).
...
|-|-|-|
| Square | (\\dfrac{ab}{a + b}) | (\\dfrac{a^2b^2}{(a + b)^2}) |
| Rectangle | (\\dfrac{a}{2} \\times \\dfrac{b}{2}) | (\\dfrac{ab}{4}) |

---

The largest square has side (\\dfrac{ab}{a + b}) and area (\\dfrac{a^2b^2}{(a + b)^2}), while the largest rectangle has dimensions (\\dfrac{a}{2} \\times \\dfrac{b}{2}) and area (\\dfrac{ab}{4}).
