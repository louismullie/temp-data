...
> Final answers, with a quick verification: a) The side of the largest square is [ab/(a + b)], so its area is [a²b²/(a + b)²]. b) The dimensions of the largest rectangle are [a/2] by [b/2], so its area is [ab/4]. I should confirm once more that both far vertices lie on the hypotenuse: for the square, ([ab/(a + b)]/a) + ([ab/(a + b)]/b) = [b/(a + b)] + [a/(a + b)] = 1; for the rectangle, ([a/2]/a) + ([b/2]/b) = [1/2] + [1/2] = 1. Both constraints are satisfied, so the solutions are consistent with the geometry.

---

The largest square that fits inside right triangle ABC with vertex C has side length ([ab/(a + b)]) and area ([a²b²/(a + b)²]).

The largest rectangle that fits inside right triangle ABC with vertex C has dimensions ([a/2] × [b/2]) and area ([ab/4]).

---

## Largest square with vertex C

Let the square have side length (s), with one vertex at (C) and the opposite vertex on the hypotenuse (AB). The hypotenuse has equation ([x/a] + [y/b] = 1). For the square to fit, the point ((s, s)) must lie on the hypotenuse, so:

[s/a] + [s/b] = 1 = > s([1/a] + [1/b]) = 1 = > s = [ab/(a + b)]

Thus, the side length is ([ab/(a + b)]) and the area is ([a²b²/(a + b)²]).
...
### Subicular neurons encode concave and convex geometries [^116FTf3s]. Nature (2024). Excellent credibility.
...
### Detecting the ultra low dimensionality of real networks [^1142FZB6]. Nature Communications (2022). High credibility.
...
### Archimedes' law explains penetration of solids into granular media [^114sBUC4]. Nature Communications (2018). Medium credibility.
...
### Stability criteria for complex microbial communities [^1161puPw]. Nature Communications (2018). Medium credibility.
...
### Nanotomy-based production of transferable and dispersible graphene nanostructures of controlled shape and size [^113mctqN]. Nature Communications (2012). Medium credibility.
...
### Covalently-assembled single-chain protein nanostructures with ultra-high stability [^1176RJst]. Nature Communications (2019). High credibility.
...
### Universal non-hermitian skin effect in two and higher dimensions [^114qXVdn]. Nature Communications (2022). High credibility.
...
### Archimedes' law explains penetration of solids into granular media [^11327hH1]. Nature Communications (2018). Medium credibility.
...
### FDA oral history interview, eisenberg… [^1179bS2r]. FDA (2025). Medium credibility.
...
### Collective self-caging of active filaments in virtual confinement [^116xyEzw]. Nature Communications (2024). High credibility.
...
### Automated sequence design of 2D wireframe DNA origami with honeycomb edges [^114oowt6]. Nature Communications (2019). High credibility.
...
### On-site growth of perovskite nanocrystal arrays for integrated nanodevices [^1152LEZh]. Nature Communications (2023). High credibility.
...
### Intrinsic cell rheology drives junction maturation [^115HMu1N]. Nature Communications (2022). High credibility.
...
### The oval female facial shape – A study in beauty [^115dfVdq]. Dermatologic Surgery (2015). Low credibility.
...
### Egocentric neural representation of geometric vertex in the retrosplenial cortex [^111GPKfc]. Nature Communications (2024). High credibility.
...
### Do alterations in vertebral and disc dimensions affect an elliptical model of thoracic kyphosis? [^114M1tVc]. Spine (2003). Low credibility.
...
### Biphasic growth of orbital volume in Chinese children [^11485Yuq]. The British Journal of Ophthalmology (2017). Low credibility.
...
### Unlocking surface octahedral tilt in two-dimensional ruddlesden-popper perovskites [^113RoqMy]. Nature Communications (2022). High credibility.
...
### Spatially fractionated stereotactic body radiation therapy (lattice) for large tumors [^117Ck8S7]. Advances in Radiation Oncology (2021). Medium credibility.
...
### Boundary curvature guided programmable shape-morphing kirigami sheets [^116ABkXj]. Nature Communications (2022). High credibility.
...
### EACTS / STS guidelines for diagnosing and treating acute and chronic syndromes of the aortic organ [^111VP5qf]. European Journal of Cardio-Thoracic Surgery (2024). High credibility.
...
### Coherent movement of error-prone individuals through mechanical coupling [^1115uZiE]. Nature Communications (2023). High credibility.
...
### Simulating hyperbolic space on a circuit board [^1118ujiB]. Nature Communications (2022). High credibility.
...
### High-dimensional topographic organization of visual features in the primate temporal lobe [^112pjUSf]. Nature Communications (2023). High credibility.
...
### Guidelines for the use of transesophageal echocardiography to assist with surgical decision-making in the operating room: a surgery-based approach: from the American Society of Echocardiography in collaboration with the Society of Cardiovascular Anesthesiologists and the Society of Thoracic Surgeons [^115mDqm2]. Journal of the American Society of Echocardiography (2020). High credibility.
...
### Essential information on surgical heart valve characteristics for optimal valve prosthesis selection: expert consensus document from the European Association for Cardio-thoracic Surgery (EACTS)-the Society of Thoracic Surgeons (STS)-American Association for Thoracic Surgery (AATS) valve labelling task force [^113Nxyxe]. The Journal of Thoracic and Cardiovascular Surgery (2021). High credibility.
...
### Seeing around corners with edge-resolved transient imaging [^111TjRrG]. Nature Communications (2020). High credibility.
...
### Compass-model physics on the hyperhoneycomb lattice in the extreme spin-orbit regime [^113uJLD2]. Nature Communications (2024). High credibility.
...
### Automatic left and right lung separation using free-formed surface fitting on volumetric CT [^114hSCMG]. Journal of Digital Imaging (2014). Low credibility.
...
### Biomechanics of the rhombic transposition flap [^112deHct]. Otolaryngology — Head and Neck Surgery (2014). Low credibility.
...
### International consensus statement on nomenclature and classification of the congenital bicuspid aortic valve and its aortopathy, for clinical, surgical, interventional and research purposes [^112yVdNK]. European Journal of Cardio-Thoracic Surgery (2021). High credibility.
...
### The shape of the distal femur: a geometrical study using MRI [^111FVrkv]. The Bone & Joint Journal (2014). Low credibility.
...
### A refined hemispheric model of normal human aortic valve and root geometry [^116irH4s]. The Journal of Thoracic and Cardiovascular Surgery (2013). Low credibility.
...
### Four-dimensional computed tomography analysis of bicuspid aortic valves [^117QB1Sh]. JTCVS Techniques (2024). Medium credibility.
...
### Monolithically integrated micro-supercapacitors with high areal number density produced by surface adhesive-directed electrolyte assembly [^1176V422]. Nature Communications (2024). High credibility.
...
### Measuring central venous structures in humans: implications for central-vein catheter dimensions [^111KDCjy]. The Journal of Vascular Access (2007). Low credibility.
...
### A transient contractile seam promotes epithelial sealing and sequential assembly of body segments [^1179Z6JP]. Nature Communications (2025). High credibility.
...
### Genetic, morphometric, and molecular analyses of interspecies differences in head shape and hybrid developmental defects in the wasp genus nasonia [^114Fa2HB]. G3 (2021). Medium credibility.
...
### Anatomic predictors of phrenic nerve injury in the setting of pulmonary vein isolation using the 28-mm second-generation cryoballoon [^112qR17P]. Heart Rhythm (2016). Low credibility.
...
### Automatic colon segmentation with dual scan CT colonography [^113UVwdS]. Journal of Digital Imaging (2005). Low credibility.
...
### Recommendations for cardiac chamber quantification by echocardiography in adults: an update from the American Society of Echocardiography and the European association of cardiovascular imaging [^114yjma7]. Journal of the American Society of Echocardiography (2015). Medium credibility.
...
### Atypical co-development of the thalamus and cortex in autism: evidence from age-related white-gray contrast change [^111hs9uR]. Human Brain Mapping (2024). Medium credibility.
...
### Landslide topology uncovers failure movements [^112vQppt]. Nature Communications (2024). High credibility.
...
### Angle κ and its effect on the corneal elevation maps in refractive surgery candidates [^114VfNBR]. Journal of Cataract and Refractive Surgery (2022). Medium credibility.
...
### AIUM practice parameter for the performance of diagnostic and screening ultrasound examinations of the abdominal aorta in adults [^1166p2VH]. Journal of Ultrasound in Medicine (2021). High credibility.
...
### Failings in treatment advice, SPCs and black triangles [^115bZYrS]. Drug and Therapeutics Bulletin (2001). Low credibility.
...
### Geometric characteristics of bicuspid aortic valves [^114yhEUu]. JTCVS Techniques (2021). Medium credibility.
...
### Cartography and topographic mapping: the historical basis for the standardization of anatomical analysis and surgical mark-making to improve outcomes in body contouring [^1121dUQ2]. Plastic and Reconstructive Surgery (2022). Medium credibility.
...
### Recommendations for cardiac chamber quantification by echocardiography in adults: an update from the American Society of Echocardiography and the European association of cardiovascular imaging [^113sxptS]. Journal of the American Society of Echocardiography (2015). Medium credibility.
...
### Interplay between spherical confinement and particle shape on the self-assembly of rounded cubes [^112XoyyM]. Nature Communications (2018). Medium credibility.
...
### Larmor frequency shift from magnetized cylinders with arbitrary orientation distribution [^112GNh78]. NMR in Biomedicine (2023). Medium credibility.
...
### Salvage of the condylar fracture: complication management of mandibular angle ostectomy [^115nuW5d]. The Journal of Craniofacial Surgery (2014). Low credibility.
...
### Upper limb dimensions in adults presenting for elective surgery-implications for blood pressure measurement [^111kcWyx]. BMC Anesthesiology (2020). Medium credibility.
...
### Barrier protection use by adolescents during sexual activity [^112uRwUV]. Pediatrics (2020). High credibility.
...
### AIUM / IUGA practice parameter for the performance of urogynecological ultrasound examinations: developed in collaboration with the ACR, the AUGS, the AUA, and the SRU [^114Uj865]. Journal of Ultrasound in Medicine (2019). High credibility.
...
### Guidelines for performing a comprehensive transesophageal echocardiographic examination: recommendations from the American Society of Echocardiography and the Society of Cardiovascular Anesthesiologists [^113Fa8tG]. Journal of the American Society of Echocardiography (2013). Medium credibility.
