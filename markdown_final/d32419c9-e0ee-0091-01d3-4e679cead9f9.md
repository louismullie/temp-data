...
### [ PDF ] FDA oral history interview, eisenberg (...) [^f0872c7f]. FDA (2025). Medium credibility.
...
The coaptation angles α and β were significantly different ( P < .001). We found a significant correlation of α with the length of the raphe ( P = .008), whereas β was dependent on the position of the commissures. Both γ 1 and γ 2 ( P = .04), or ε 1 and ε 2 ( P < .001) significantly differed from each other and ε 2 was the most constant angle, although its size geometrically depends on β. The noncoronary was the largest sinus, and β was the primary determinant of its increased size in bicuspid aortic valves with righ/left fusion pattern.
