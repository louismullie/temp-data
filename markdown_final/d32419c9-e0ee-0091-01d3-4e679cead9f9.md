...
11.2. Given a right triangle ABC with legs AC = a and CB = b. Find a) the side of the square with vertex $C$ of the largest area, entirely lying within the triangle $A B C$; б) the dimensions of the rectangle with vertex $C$ of the largest area, entirely lying within the triangle $A B C$.
