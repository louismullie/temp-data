...
> Let me first confirm the historical benchmark. Traditionally, castration has been defined as serum testosterone less than 50 ng/dL (1.7 nmol/L), a threshold derived from older immunoassays and embedded in major guidelines, including NCCN, which still anchor castration at less than 50 ng/dL and recommend intensifying therapy if this level is not achieved [^1173ZWyW] [^114PP6qm] [^112qN1jC].
