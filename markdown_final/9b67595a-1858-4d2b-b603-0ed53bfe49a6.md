...
[
\\text{Number of combinations} = \\frac{(n + r - 1)!}{r!(n - 1)!}
]
...
[
\\text{Number of tiles} = \\frac{(13 + 2–1)!}{2!(13–1)!} = \\frac{14!}{2! \\times 12!} = \\frac{14 \\times 13}{2} = 91
]
...
[
\\text{Number of tiles} = \\frac{(7 + 2–1)!}{2!(7–1)!} = \\frac{8!}{2! \\times 6!} = \\frac{8 \\times 7}{2} = 28
]
...
A domino set with values ranging from 0 to 12 contains **91 tiles**. This is calculated using the combinations-with-repetition formula, which generalizes to any maximum value (n) as (\\frac{(n + 1)(n + 2)}{2}).
