...
> For non-albicans VVC, I need to check species-specific nuances. C. glabrata often has reduced fluconazole susceptibility, so if azoles fail, topical boric acid 600 mg daily for 14 days is a recommended alternative with approximately 70% response; nystatin suppositories are another option, and flucytosine with or without amphotericin B may be considered in refractory cases, ideally with culture guidance [^114PwZrL] [^notfound] [^112gYPN8]. Hold on, I should verify that routine susceptibility testing is not required for uncomplicated cases; it is reserved for recurrent or refractory disease where non-albicans is more likely or azole failure occurs [^11311eR9].
