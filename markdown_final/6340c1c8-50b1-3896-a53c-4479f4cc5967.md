...
- **Palpable lump**: A new or changing lump detected by the patient or clinician [^115JBhqQ].
- **Abnormal screening mammogram**: Suspicious findings on a screening mammogram require further evaluation [^117Hocbd].
- **Breast symptoms**: Nipple discharge, skin changes (dimpling, retraction), persistent breast pain, or other clinical concerns [^111ZJnM4].
- **Short-interval follow-up**: Monitoring probably benign (BI-RADS 3) lesions identified on previous imaging [^117Hocbd] [^116KPsoF].
- **Post-biopsy or post-surgical evaluation**: Assessing surgical sites, scar tissue, or recurrence [^115k5UEg].
...
- **Clinical history**: The radiologist reviews symptoms, prior imaging, and medical history [^1135DFMj].
- **Additional imaging**: Spot compression, magnification views, or digital breast tomosynthesis (DBT) are used to better visualize the area of concern [^1179un4v].
- **Immediate interpretation**: The radiologist reviews images in real-time, often correlating with clinical findings [^1179un4v].
- **Further evaluation**: If suspicious findings are identified, ultrasound or image-guided biopsy may be recommended [^117CzBg3].
...
- **Characterizing abnormalities**: Differentiating benign from malignant lesions [^117CzBg3].
- **Guiding interventions**: Identifying the exact location and extent of suspicious areas for biopsy or surgical planning [^11654nVQ].
- **Reducing unnecessary biopsies**: Helping avoid unnecessary procedures by identifying benign features [^116YhCXj].
- **Facilitating early detection**: Enabling timely diagnosis and treatment of breast cancer [^113iy6CH].
...
- **False negatives**: Some cancers, particularly in dense breasts, may not be visible on mammography [^111ZJnM4].
- **False positives**: Benign lesions may appear suspicious, leading to additional testing or biopsy [^113iy6CH].
- **Radiation exposure**: Minimal but cumulative with repeated exposures [^113iy6CH].
- **Patient anxiety**: Waiting for results or undergoing additional testing can cause stress [^113iy6CH].
...
- **Immediate results**: Results are often provided the same day, reducing anxiety and enabling prompt follow-up [^113w9pFQ].
- **Clear communication**: Radiologists explain findings and recommend next steps, including any need for additional imaging or biopsy [^1162zib7].
...
### ACR practice parameter for the performance of screening and diagnostic mammography [^115qCpbA]. ACR (2023). High credibility.
...
### ACR practice parameter for the performance of screening and diagnostic mammography [^1135DFMj]. ACR (2023). High credibility.
...
### Prioritizing screening mammograms for immediate interpretation and diagnostic evaluation on the basis of risk for recall [^116NxbLM]. Journal of the American College of Radiology (2023). Medium credibility.
...
### Communicating results of diagnostic mammography: what do patients think? [^113w9pFQ]. Academic Radiology (2000). Low credibility.
...
### ACR practice parameter for the performance of screening and diagnostic mammography [^111767Xm]. ACR (2023). High credibility.
...
### Diagnostic mammography [^111NpSYR]. Radiologic Clinics of North America (2004). Low credibility.
...
### Prioritizing screening mammograms for immediate interpretation and diagnostic evaluation on the basis of risk for recall [^111jMfLQ]. Journal of the American College of Radiology (2023). Medium credibility.
...
### Breast imaging: mammography and ultrasonography [^115wZxvq]. Magnetic Resonance Imaging Clinics of North America (2001). Low credibility.
...
### Radiologists' interpretive skills in screening vs. diagnostic mammography: are they related? [^115diZ8g]. Clinical Imaging (2016). Low credibility.
...
### ACR practice parameter for the performance of screening and diagnostic mammography [^111N2TMi]. ACR (2023). High credibility.
...
### ACR practice parameter for the performance of screening and diagnostic mammography [^117Hocbd]. ACR (2023). High credibility.
...
### In the setting of negative mammogram, is additional breast ultrasound necessary for evaluation of breast pain? [^111kHJeE]. Current Problems in Diagnostic Radiology (2018). Low credibility.
...
### Mammography: an update of the EUSOBI recommendations on information for women [^111hiyAu]. Insights Into Imaging (2017). Low credibility.
...
### A survey by the European society of breast imaging on radiologists' preferences regarding quality assurance measures of image interpretation in screening and diagnostic mammography [^115knPCk]. European Radiology (2023). Medium credibility.
...
### Overdiagnosis and risks of breast cancer screening [^113iy6CH]. Radiologic Clinics of North America (2021). Medium credibility.
...
### ACR practice parameter for the performance of screening and diagnostic mammography [^1154gyPf]. ACR (2023). High credibility.
...
### ACR practice parameter for the performance of screening and diagnostic mammography [^112mh4sR]. ACR (2023). High credibility.
...
### Prioritizing screening mammograms for immediate interpretation and diagnostic evaluation on the basis of risk for recall [^117Mf8RB]. Journal of the American College of Radiology (2023). Medium credibility.
...
### ACR practice parameter for the performance of screening and diagnostic mammography [^1179un4v]. ACR (2023). High credibility.
...
### ACR practice parameter for the performance of screening and diagnostic mammography [^113gqLB6]. ACR (2023). High credibility.
...
### A bimodal nomogram: a non-invasive tool to assist breast radiologists in decision-making [^116YhCXj]. European Radiology (2024). Medium credibility.
...
### An assessment of the likelihood, frequency, and content of verbal communication between radiologists and women receiving screening and diagnostic mammography [^1162zib7]. Academic Radiology (2009). Low credibility.
...
### ACR practice parameter for the performance of screening and diagnostic mammography [^1126kmSo]. ACR (2023). High credibility.
...
### Positive predictive value of mammography: comparison of interpretations of screening and diagnostic images by the same radiologist and by different radiologists [^111JfVeF]. AJR: American Journal of Roentgenology (2010). Low credibility.
...
### Screening, imaging, and image-guided biopsy techniques for breast cancer [^115B3rWc]. The Surgical Clinics of North America (2013). Low credibility.
...
### Patient and radiologist characteristics associated with accuracy of two types of diagnostic mammograms [^116QMJ1F]. AJR: American Journal of Roentgenology (2015). Low credibility.
...
### Disparities in same-day diagnostic imaging in breast cancer screening: impact of an immediate-read screening mammography program implemented during the COVID-19 pandemic [^116cxSNM]. AJR: American Journal of Roentgenology (2022). Medium credibility.
...
### Screening for breast cancer [^111mDBau]. Radiologic Clinics of North America (2017). Low credibility.
...
### Cancer screening test receipt-United States, 2018 [^1132Ew69]. MMWR: Morbidity and Mortality Weekly Report (2021). Medium credibility.
...
### ACR appropriateness criteriaBreast cancer screening [^117LahsN]. Journal of the American College of Radiology (2017). Low credibility.
...
### Effect of specialized diagnostic assessment units on the time to diagnosis in screen-detected breast cancer patients [^111zQpGr]. British Journal of Cancer (2015). Low credibility.
...
### Effect of using the same vs different order for second readings of screening mammograms on rates of breast cancer detection: a randomized clinical trial [^117PdHWN]. JAMA (2016). Excellent credibility.
...
### Screen-detected breast cancer outcomes by mammography participation in immediate past screening [^11252tKQ]. JAMA Network Open (2025). High credibility.
...
### ACR practice parameter for the performance of screening and diagnostic mammography [^116CaoCo]. ACR (2023). High credibility.
...
### Utilization and cancer yield of probably benign assessment category in the national mammography database: 2009 to 2018 [^116KPsoF]. Journal of the American College of Radiology (2022). Medium credibility.
...
### ACR practice parameter for the performance of screening and diagnostic mammography [^1148ZL5u]. ACR (2023). High credibility.
...
### Timeliness of breast diagnostic imaging and biopsy in practice: 15 years of collecting, comparing, and defining quality breast cancer care [^117Luy1t]. Annals of Surgical Oncology (2023). Medium credibility.
...
### ACR practice parameter for the performance of screening and diagnostic mammography [^116ZXAnr]. ACR (2023). High credibility.
...
### Accuracy of short-interval follow-up mammograms by patient and radiologist characteristics [^114vyjrv]. AJR: American Journal of Roentgenology (2008). Low credibility.
...
### ACR practice parameter for the performance of screening and diagnostic mammography [^112JJjSw]. ACR (2023). High credibility.
...
### Definition of diagnostic mammogram-NCI dictionary… [^115qgDEG]. NCI (2011). Low credibility.
...
### ACR practice parameter for the performance of screening and diagnostic mammography [^11177eA7]. ACR (2023). High credibility.
...
### Diagnosing breast cancer… [^111QT5MN]. CDC (2025). Medium credibility.
...
### Prioritizing screening mammograms for immediate interpretation and diagnostic evaluation on the basis of risk for recall [^1134dR45]. Journal of the American College of Radiology (2023). Medium credibility.
...
### The evolving role of new imaging methods in breast screening [^116cBFmX]. Preventive Medicine (2011). Low credibility.
...
### Effect of specialized diagnostic assessment units on the time to diagnosis in screen-detected breast cancer patients [^113mJBDr]. British Journal of Cancer (2015). Low credibility.
...
### False-negative screening and diagnostic mammograms in the national mammography database from 2010 to 2022 [^114idvnH]. AJR: American Journal of Roentgenology (2025). Medium credibility.
...
### Access to diagnostic mammography in the San Francisco bay area [^113ESntZ]. Journal of Women's Health (2008). Low credibility.
...
### ACR practice parameter for the performance of screening and diagnostic mammography [^113Lg53Z]. ACR (2023). High credibility.
...
### Is there a role for magnetic resonance imaging in diagnosing palpable breast masses when mammogram and ultrasound are negative? [^1145qDhB]. Journal of Women's Health (2012). Low credibility.
...
### Reactions to uncertainty and the accuracy of diagnostic mammography [^116rUdfk]. Journal of General Internal Medicine (2007). Low credibility.
...
### Practice bulletin no. 164: diagnosis and management of benign breast disorders [^116z2Tcm]. Obstetrics and Gynecology (2016). Medium credibility.
...
### Prioritizing screening mammograms for immediate interpretation and diagnostic evaluation on the basis of risk for recall [^117UA7GC]. Journal of the American College of Radiology (2023). Medium credibility.
