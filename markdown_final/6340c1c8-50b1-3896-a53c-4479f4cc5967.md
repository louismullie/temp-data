...
A moderate correlation was noted for radiologists' accuracy when interpreting screening versus their accuracy on diagnostic examinations: sensitivity (r spearman =0.51, 95% CI: 0.22, 0.80; P=.0006) and specificity (r spearman =0.40, 95% CI: 0.30, 0.49; P<.0001).
