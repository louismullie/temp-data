...
> Hold on, let's not jump to conclusions about toxic ingestions behaving the same way. Toxic alcohols like methanol and ethylene glycol initially increase the osmolal gap due to parent alcohol accumulation, while the anion gap rises later as toxic metabolites (formate, glycolate/oxalate) accumulate; thus, early after ingestion the osmolal gap may be high with a normal or only mildly elevated anion gap, whereas later the anion gap becomes markedly elevated as metabolism proceeds, which is why timing matters for interpretation [^notfound] [^111nUvXC].
