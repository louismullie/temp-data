...
> Hold on, let's not jump to conclusions about toxic ingestions behaving the same way. Toxic alcohols like methanol and ethylene glycol initially increase the osmolal gap due to parent alcohol accumulation, while the anion gap rises later as toxic metabolites (formate, glycolate/oxalate) accumulate; thus, early after ingestion the osmolal gap may be high with a normal or only mildly elevated anion gap, whereas later the anion gap becomes markedly elevated as metabolism proceeds, which is why timing matters for interpretation [^115BQ8FH] [^111nUvXC].
...
Lactic acidosis typically shows a **moderate-to-severe anion gap** of 20–30 mEq/L, reflecting lactate accumulation [^113kkZht]. Toxic ingestions (ethylene glycol, methanol, salicylates) often produce a **more severe anion gap** > 30 mEq/L due to multiple organic acids [^115BQ8FH]. The anion gap alone cannot reliably distinguish lactic acidosis from toxic ingestions; always interpret the anion gap alongside clinical context, osmolal gap, and specific assays [^111QBddX] [^117NvMU7].
