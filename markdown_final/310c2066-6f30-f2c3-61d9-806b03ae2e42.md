...
> Next, I should translate the two conditions into math. Disjointness means the domain and range have no overlap: ((−a, ∞) ∩ (−∞, a² + a − 3] = ∅). Union covering (\\mathbb{R}) means ((−a, ∞) ∪ (−∞, a² + a − 3] = ℝ). Let me consider what this implies geometrically: the right endpoint of the range must abut the left endpoint of the domain, so (a² + a − 3 = −a). If I solve that, I should get the candidate value(s) of (a).
