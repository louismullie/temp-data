...
### The great oxygenation event as a consequence of ecological dynamics modulated by planetary change [^113im3Fs]. Nature Communications (2021). High credibility.
...
### Multidimensional cerebellar computations for flexible kinematic control of movements [^113RjvJi]. Nature Communications (2023). High credibility.
...
### Topological phase locking in stochastic oscillators [^115sweYi]. Nature Communications (2025). High credibility.
...
### Model-free tracking control of complex dynamical trajectories with machine learning [^111LyYux]. Nature Communications (2023). High credibility.
...
### Damage dynamics and the role of chance in the timing of E. coli cell death [^115dh2LS]. Nature Communications (2023). High credibility.
...
### Quantum measurement arrow of time and fluctuation relations for measuring spin of ultracold atoms [^112b8Dom]. Nature Communications (2021). High credibility.
...
### Accelerating compressed sensing in parallel imaging reconstructions using an efficient circulant preconditioner for cartesian trajectories [^112So5bH]. Magnetic Resonance in Medicine (2019). Medium credibility.
...
### Optimal experimental design and estimation for q-space trajectory imaging [^111H77cU]. Human Brain Mapping (2023). Medium credibility.
...
### A topological fluctuation theorem [^111VYS8v]. Nature Communications (2022). High credibility.
...
### Observation of quantum criticality of a four-dimensional phase transition [^116riBKn]. Nature Communications (2025). High credibility.
...
### Ultra-high dynamic range quantum measurement retaining its sensitivity [^113rUDR7]. Nature Communications (2021). High credibility.
...
### Insight into human pubertal growth by applying the QEPS growth model [^111ADi6U]. BMC Pediatrics (2017). Low credibility.
...
### K-space trajectory mapping and its application for ultrashort echo time imaging [^111tqUGj]. Magnetic Resonance Imaging (2017). Low credibility.
...
### Simple method for MR gradient system characterization and k-space trajectory estimation [^116Lg1u2]. Magnetic Resonance in Medicine (2012). Low credibility.
...
### Improved k-space trajectory measurement with signal shifting [^115dCxo3]. Magnetic Resonance in Medicine (2007). Low credibility.
...
### Early life growth is related to pubertal growth and adult height-a QEPS-model analysis [^114XxvwK]. Pediatric Research (2025). Medium credibility.
...
### Learning emergent partial differential equations in a learned emergent space [^11592YQd]. Nature Communications (2022). High credibility.
...
### Exploring replay [^116kGgcZ]. Nature Communications (2025). High credibility.
...
### Quantitative evaluation of methods to analyze motion changes in single-particle experiments [^116ZZZer]. Nature Communications (2025). High credibility.
...
### Abstract representations of events arise from mental errors in learning and memory [^115177bA]. Nature Communications (2020). High credibility.
...
### Global strategy for the diagnosis, management, and prevention of chronic obstructive pulmonary disease (2025 report) [^112DZV9m]. GOLD (2025). High credibility.
...
### Multiple tipping points and optimal repairing in interacting networks [^116ZFBAm]. Nature Communications (2016). Medium credibility.
...
### Geographic population structure analysis of worldwide human populations infers their biogeographical origins [^1137T9co]. Nature Communications (2014). Medium credibility.
...
### Single-shot magnetic field mapping embedded in echo-planar time-course imaging [^11492mqQ]. Magnetic Resonance in Medicine (2003). Low credibility.
...
### Interfering trajectories in experimental quantum-enhanced stochastic simulation [^1112xSsc]. Nature Communications (2019). High credibility.
...
### Mean first-passage times of non-markovian random walkers in confinement [^112Ryord]. Nature (2016). Excellent credibility.
...
### Meta-reinforcement learning via orbitofrontal cortex [^112Pm8b6]. Nature Neuroscience (2023). High credibility.
...
### Versatile whole-organ / body staining and imaging based on electrolyte-gel properties of biological tissues [^117VprGA]. Nature Communications (2020). High credibility.
...
### Free-hand insertion of S2AI screw: what can we learn from O-arm navigation? [^114jQdVn]. European Spine Journal (2025). Medium credibility.
...
### Simple spatial scaling rules behind complex cities [^112HMGDu]. Nature Communications (2017). Medium credibility.
...
### The anti-distortive polaron as an alternative mechanism for lattice-mediated charge trapping [^114pfVXb]. Nature Communications (2025). High credibility.
...
### Nonlinear wave propagation governed by a fractional derivative [^116cCxPQ]. Nature Communications (2025). High credibility.
...
### Dimensionless learning based on information [^114hufTg]. Nature Communications (2025). High credibility.
...
### Abstract representations of events arise from mental errors in learning and memory [^113LyJPr]. Nature Communications (2020). High credibility.
...
### Localization by nonlinear phase preparation and k-space trajectory design [^113SbcZo]. Magnetic Resonance in Medicine (2012). Low credibility.
...
### Phase informed model for motion and susceptibility [^114MdmKN]. Human Brain Mapping (2013). Low credibility.
...
### Haplotype probabilities in advanced intercross populations [^115Xv7a3]. G3 (2012). Low credibility.
...
### Inflection points in magnetic resonance imaging technology-35 years of collaborative research and development [^117Jcp5w]. Investigative Radiology (2015). Low credibility.
...
### The evolution of the temporal program of genome replication [^11613tjU]. Nature Communications (2018). Medium credibility.
...
### Electrocardiographic repolarization-related variables as predictors of coronary heart disease death in the women's health initiative study [^1176REwS]. Journal of the American Heart Association (2014). Low credibility.
...
### Abstract representations of events arise from mental errors in learning and memory [^111V8Pqa]. Nature Communications (2020). High credibility.
...
### Predicting the direction of phenotypic difference [^113Q6Vvq]. Nature Communications (2025). High credibility.
...
### The force-velocity profile for jumping: what It is and what It is not [^1169fwWr]. Medicine and Science in Sports and Exercise (2023). Medium credibility.
...
### Electrocardiographic predictors of coronary heart disease and sudden cardiac deaths in men and women free from cardiovascular disease in the atherosclerosis risk in communities study [^114gcVxn]. Journal of the American Heart Association (2013). Low credibility.
...
### DNA replication origins retain mobile licensing proteins [^115L43m8]. Nature Communications (2021). High credibility.
...
### Folic acid [^114uUmp6]. FDA (2025). Medium credibility.
...
### Obesity trajectories and risk of dementia: 28 years of follow-up in the whitehall II study [^116BMwTy]. Alzheimer's & Dementia (2018). Low credibility.
...
### Cryptic transmission of SARS-CoV-2 and the first COVID-19 wave [^111Z49bY]. Nature (2021). Excellent credibility.
...
### The long lives of primates and the 'invariant rate of ageing' hypothesis [^113hjp9y]. Nature Communications (2021). High credibility.
...
### Evaluating the evidence for exponential quantum advantage in ground-state quantum chemistry [^1116iY6o]. Nature Communications (2023). High credibility.
...
### Syrian national growth references for children and adolescents aged 2–20 years [^116L28eX]. BMC Pediatrics (2022). Medium credibility.
...
### Hippocampal firing fields anchored to a moving object predict homing direction during path-integration-based behavior [^113kBuGv]. Nature Communications (2023). High credibility.
...
### Systematic errors in connectivity inferred from activity in strongly recurrent networks [^117CoENR]. Nature Neuroscience (2020). High credibility.
...
### Phase informed model for motion and susceptibility [^112bmx29]. Human Brain Mapping (2013). Low credibility.
...
### Guidelines for the early management of patients with acute ischemic stroke: 2019 update to the 2018 guidelines for the early management of acute ischemic stroke: a guideline for healthcare professionals from the American Heart Association / American stroke association [^1158a4cw]. Stroke (2019). High credibility.
