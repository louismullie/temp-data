...
### Beginnings of place value: how preschoolers write three-digit numbers [^114LjfPU]. Child Development (2013). Low credibility.
...
### A new documentation system for congenital absent digits [^1144iWZz]. Hand (2012). Low credibility.
...
### Dynamics of specialization in neural modules under resource constraints [^112izkWs]. Nature Communications (2025). High credibility.
...
### Giving science the finger-is the second-to-fourth digit ratio (2D: 4D) a biomarker of good luck? A cross sectional study [^114P6SqG]. BMJ (2021). Excellent credibility.
...
### Genome sequence: a framework for meta-analysis of wheat QTLs [^114GqgzD]. G3 (2019). Medium credibility.
...
### Dyscalculia and the calculating brain [^115wQMDE]. Pediatric Neurology (2016). Low credibility.
...
### Evidence against tetrapod-wide digit identities and for a limited frame shift in bird wings [^115agXy4]. Nature Communications (2019). High credibility.
...
### Children's arithmetic skills do not transfer between applied and academic mathematics [^115HJM23]. Nature (2025). Excellent credibility.
...
### A systematic review of T cell epitopes defined from the proteome of human immunodeficiency virus [^114erNRw]. Virus Research (2025). Medium credibility.
...
### In silico prediction and screening of modular crystal structures via a high-throughput genomic approach [^115ULAQW]. Nature Communications (2015). Medium credibility.
...
### Early-onset schizophrenia is associated with impaired adolescent development of attentional capacity using the identical pairs continuous performance test [^116bbaiL]. Schizophrenia Research (2006). Low credibility.
...
### Running shoe cushioning properties at the rearfoot and forefoot and their relationship to injury: study protocol for a randomised controlled trial on leisure-time runners [^116hrjHU]. BMJ Open Sport & Exercise Medicine (2024). High credibility.
...
### Evidence against tetrapod-wide digit identities and for a limited frame shift in bird wings [^117E16Ab]. Nature Communications (2019). High credibility.
...
### Pediatric application of coding and valuation systems [^115PHr89]. Pediatrics (2019). High credibility.
...
### Evidence against tetrapod-wide digit identities and for a limited frame shift in bird wings [^117NrAkg]. Nature Communications (2019). High credibility.
...
### Evidence against tetrapod-wide digit identities and for a limited frame shift in bird wings [^117L2B4Z]. Nature Communications (2019). High credibility.
...
### Insights into bird wing evolution and digit specification from polarizing region fate maps [^114mWSJ6]. Nature Communications (2011). Medium credibility.
...
### Routineness of social interactions is associated with higher affective well-being in older adults [^114dvDMA]. The Journals of Gerontology: Series B, Psychological Sciences and Social Sciences (2024). Medium credibility.
...
### Shared and distinct neural circuitry for nonsymbolic and symbolic double-digit addition [^116qF1f7]. Human Brain Mapping (2019). Medium credibility.
...
### Standardizing the use of the continuous performance test in schizophrenia research: a validation study [^1166Dzjy]. Schizophrenia Research (2012). Low credibility.
...
### Comprehension of acoustically degraded speech in Alzheimer's disease and primary progressive aphasia [^115UcrrG]. Brain (2023). Medium credibility.
...
### Shared polygenic risk for ADHD, executive dysfunction and other psychiatric disorders [^112TbBXa]. Translational Psychiatry (2020). Medium credibility.
...
### An interdigit signalling centre instructs coordinate phalanx-joint formation governed by 5' hoxd-gli3 antagonism [^117R84w1]. Nature Communications (2016). Medium credibility.
...
### Shh and gli3 are dispensable for limb skeleton formation but regulate digit number and identity [^1176qLPi]. Nature (2002). Excellent credibility.
...
### Lateralized neural responses to letters and digits in first graders [^1145bCdX]. Child Development (2019). Medium credibility.
...
### Characterizing intraindividual variability in bipolar disorder: links to cognition, white matter microstructure, and clinical variables [^114esGQp]. Psychological Medicine (2025). Medium credibility.
...
### Evidence against tetrapod-wide digit identities and for a limited frame shift in bird wings [^114q1U8z]. Nature Communications (2019). High credibility.
...
### Lateralized neural responses to letters and digits in first graders [^115Nq8Tq]. Child Development (2019). Medium credibility.
...
### Evidence against tetrapod-wide digit identities and for a limited frame shift in bird wings [^113d5Apt]. Nature Communications (2019). High credibility.
...
### Renal outcomes and all-cause death associated with sodium-glucose co-transporter-2 inhibitors versus other glucose-lowering drugs (CVD-REAL 3 Korea) [^114Tw2E6]. Diabetes, Obesity & Metabolism (2021). Medium credibility.
...
### Engaging communities in emerging infectious disease mitigation to improve public health and safety [^114fL9tp]. Emerging Infectious Diseases (2024). Medium credibility.
...
### Probiotics-induced changes in gut microbial composition and its effects on cognitive performance after stress: exploratory analyses [^114AmX66]. Translational Psychiatry (2021). Medium credibility.
...
### Smartphone-based symbol-digit modalities test reliably captures brain damage in multiple sclerosis [^1154bdAP]. NPJ Digital Medicine (2021). Medium credibility.
...
### Examining the effectiveness of a video-based parent-child program on executive functions for children 5 to 6 years old: a randomized controlled trial [^113abwJj]. Child Development (2024). Medium credibility.
...
### Lateralized neural responses to letters and digits in first graders [^1154H4gi]. Child Development (2019). Medium credibility.
...
### Evidence against tetrapod-wide digit identities and for a limited frame shift in bird wings [^115itYNm]. Nature Communications (2019). High credibility.
...
### Evidence against tetrapod-wide digit identities and for a limited frame shift in bird wings [^114v3Xd4]. Nature Communications (2019). High credibility.
...
### Neural representations of the perception of handwritten digits and visual objects from a convolutional neural network compared to humans [^117XkDPQ]. Human Brain Mapping (2023). Medium credibility.
...
### Evidence against tetrapod-wide digit identities and for a limited frame shift in bird wings [^117Q169s]. Nature Communications (2019). High credibility.
...
### Similar somatotopy for active and passive digit representation in primary somatosensory cortex [^117KDRKy]. Human Brain Mapping (2023). Medium credibility.
...
### Similar somatotopy for active and passive digit representation in primary somatosensory cortex [^114h9CFb]. Human Brain Mapping (2023). Medium credibility.
...
### Neural representation precision of distance predicts children's arithmetic performance [^114UJquw]. Human Brain Mapping (2025). Medium credibility.
...
### Evidence against tetrapod-wide digit identities and for a limited frame shift in bird wings [^111EwSui]. Nature Communications (2019). High credibility.
...
T-box family genes are predicted to regulate the identities of posterior digits. Our data provide some support for the hypothesis that this function is conserved across amniotes (Fig. 4c). Tbx2, which was previously shown to regulate posterior digit identity in the chicken hindlimb, shows divergent patterns of expression in the posterior digits of other species. Tbx3 differentiates D3 from D4 in mouse, alligator, and chicken hindlimb, and the likelihood that it was recovered by chance alone is 7.2 × 10⁻⁶ (binomial test); however, it is not differentially expressed at this position in Anolis forelimb. Tbx15 differentiates D4 from D5 among pentadactyl limbs (Fig. 3), and the likelihood that it was recovered by chance alone is 1.9 × 10⁻⁵ (binomial test).

---

### Allergy diagnostic testing: an updated practice parameter [^114TigLQ]. Annals of Allergy, Asthma & Immunology (2008). Medium credibility.
...
### Children exhibit superior memory for attended but outdated information compared to adults [^111s68dK]. Nature Communications (2024). High credibility.
...
The results are shown in Table 1. The location report accuracy on the pre-surprise trials for adults and children were 99% and 94% respectively, indicating that both adults and children could accurately locate the target letter presented among the distractor numbers. For the question in the surprise trial, only 10 of 20 (50% correct) adults correctly reported the identity of the target letter, which was significantly worse than the accuracy in the first control trial (50% vs. 90%), χ²(1, N = 40) = 7.619, p = 0.006, φ = 0.436. As a contrast, 16 of 20 (80% correct) children correctly reported the identity of the target letter, which showed no statistically significant difference from that in the first control trial (80% vs. 65%), χ²(1, N = 40) = 1.129, p = 0.288, φ = 0.168, BF 10 = 0.572; as well as from that in the following control trials (80% vs. 80%; 80%; 95%), χ²(1, N = 40) ≤ 2.057, p s ≥ 0.151, φ ≤ 0.227, BF 10 ≤ 0.631. Importantly, children performed significantly better than adults in reporting the identity of the target letter (80% vs. 50%), χ²(1, N = 40) = 3.956, p = 0.047, φ = 0.314. Notably, as both adults and children had to attend to and use the target identity to locate the target in this task set, this finding indicated that children had not yet developed the ability of memory selection for the attended yet outdated information.

---

### Is the control of applied digital forces during natural five-digit grasping affected by carpal tunnel syndrome? [^1154KGth]. Clinical Orthopaedics and Related Research (2015). Low credibility.
...
### Bidirectional associations between cognitive functions and walking performance among middle-aged women [^115JM6DF]. Menopause (2021). Medium credibility.
...
### Association of prenatal depression with second to fourth digit ratio in children aged 4 and 6 years [^113nz8a2]. Depression and Anxiety (2025). Medium credibility.
...
### Functional annotation of enzyme-encoding genes using deep learning with transformer layers [^111eB6ex]. Nature Communications (2023). High credibility.
...
### Lateralized neural responses to letters and digits in first graders [^113U49we]. Child Development (2019). Medium credibility.
...
### An unusual case of preaxial polydactyly of the hands and feet: a case report [^114wkETo]. The Journal of Hand Surgery (2002). Low credibility.
...
### Evidence against tetrapod-wide digit identities and for a limited frame shift in bird wings [^116Kz5oP]. Nature Communications (2019). High credibility.
...
### Similar somatotopy for active and passive digit representation in primary somatosensory cortex [^113pv1Ve]. Human Brain Mapping (2023). Medium credibility.
...
### Lateralized neural responses to letters and digits in first graders [^115mv14P]. Child Development (2019). Medium credibility.
...
### Lateralized neural responses to letters and digits in first graders [^113m3d55]. Child Development (2019). Medium credibility.

The emergence of visual cortex specialization for culturally acquired characters like letters and digits, both arbitrary shapes related to specific cognitive domains, is yet unclear. Here, 20 young children (6.12 years old) were tested with a frequency‐tagging paradigm coupled with electroencephalogram recordings to assess discrimination responses of letters from digits and vice‐versa. One category of stimuli (e.g. letters) was periodically inserted (1/5) in streams of the other category (e.g. digits) presented at a fast rate (6 Hz). Results show clear right‐lateralized discrimination responses at 6 Hz/5 for digits within letters, and a trend for left‐lateralization for letters. These results support an early developmental emergence of ventral occipito‐temporal cortex specialization for visual recognition of digits and letters, potentially in relation with relevant coactivated brain networks.

---

### The big finger: the second to fourth digit ratio is a predictor of sporting ability in women [^116caqEj]. British Journal of Sports Medicine (2006). Low credibility.
...
### Similar somatotopy for active and passive digit representation in primary somatosensory cortex [^114GgNLG]. Human Brain Mapping (2023). Medium credibility.
...
### Spatial acuity after digit amputation [^112KUbpk]. Brain (2002). Low credibility.
...
### Reversal of subjective temporal order due to arm crossing [^116Yaofz]. Nature Neuroscience (2001). Medium credibility.
...
### Standards of care for the health of transgender and gender diverse people, version 8 [^1144oGKH]. International Journal of Transgender Health (2022). High credibility.
...
### Ethynodiol diacetate and ethinyl estradiol (kelnor 1 / 50) [^115Kp6Ao]. FDA (2021). Medium credibility.
...
### Finger counting training enhances addition performance in kindergarteners [^111mEdYY]. Child Development (2024). Medium credibility.
...
### Photonic neuromorphic computing using symmetry-protected zero modes in coupled nanolaser arrays [^1155CW7f]. Nature Communications (2025). High credibility.
...
### Dextrose 5% [^111ZgSKZ]. FDA (2025). Medium credibility.
