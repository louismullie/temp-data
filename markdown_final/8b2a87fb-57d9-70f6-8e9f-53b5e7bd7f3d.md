...
The U.S. murder rate **rose sharply in 2020** [^112CpnRm] to its highest level since the mid-1990s, driven largely by firearm homicides [^113wayoz] and concentrated among Black and Hispanic males and in urban areas [^115eLeLi]. After peaking in 2020, the rate **declined modestly in 2021** [^notfound] and **further in 2022** [^117GeSfS], but remains well above pre-2020 levels [^117GeSfS]. Long-term, the murder rate remains far below the peaks of the early 1990s, but the recent surge reversed years of decline and exposed persistent racial and geographic disparities [^115eLeLi] [^115RU3aX].
