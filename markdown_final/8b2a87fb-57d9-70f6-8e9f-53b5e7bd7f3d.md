...
The U.S. murder rate **rose sharply in 2020** [^2f18e798] to its highest level since the mid-1990s, driven largely by firearm homicides [^7310164d] and concentrated among Black and Hispanic males and in urban areas [^de030ead]. After peaking in 2020, the rate **declined modestly in 2021** [^d9a2b947] and **further in 2022** [^f548deb1], but remains well above pre-2020 levels [^f548deb1]. Long-term, the murder rate remains far below the peaks of the early 1990s, but the recent surge reversed years of decline and exposed persistent racial and geographic disparities [^b5ac5573] [^acfd9418].
