...
> Let me first confirm the core principle: age alone should not dictate stopping screening. Decisions should be individualized based on health status, comorbidities, and life expectancy, with shared decision-making emphasized by WPSI and ACOG, and reflected in USPSTF's I statement for women 75 and older, which signals insufficient evidence for a blanket recommendation to continue or stop beyond 74 years [^116FTBAX] [^111VgZPM] [^111v445a].
