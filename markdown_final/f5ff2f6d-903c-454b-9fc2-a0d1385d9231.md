...
> Next, I should review pediatric asthma. Let me verify the direction of effect. Multiple meta-analyses show that IV magnesium reduces hospital admissions in children with moderate to severe exacerbations, with a number needed to treat around 4–7, and improves pulmonary function, supporting its selective use when initial therapy fails. However, nebulized magnesium does not reduce hospitalization or severity scores despite small improvements in peak flow, so routine nebulized use is not supported by current evidence even though some guidelines mention it as a consideration in severe cases [^114nqCHR] [^1158Ev1L] [^1149UHwk] [^114Su83D]. Hmm, wait a minute, I initially thought nebulized magnesium might reduce admissions based on older narrative summaries, but the most recent pediatric meta-analyses do not show a clinical outcome benefit, so I should correct that assumption and align with the stronger negative evidence base [^1149UHwk].
