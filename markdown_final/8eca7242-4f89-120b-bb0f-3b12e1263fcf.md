...
Trimethoprim/sulfamethoxazole (TMP-SMX) is **effective for UTIs** when the pathogen is susceptible, with high clinical and microbiologic cure rates in uncomplicated cystitis [^84b85fd1] and comparable outcomes to ciprofloxacin in pyelonephritis [^3fbb3013]. However, **resistance exceeds 20% in many regions**, so empiric use should be guided by local antibiograms [^cbb88f68] [^e529bdde]. For uncomplicated cystitis, a 3-day course is standard [^a764f114]; for complicated UTI or pyelonephritis, 7–14 days is recommended [^f56c04c2] [^eae55c88]. TMP-SMX is not recommended in the first trimester of pregnancy or in patients with severe sulfa allergy, and dose adjustments are needed in renal impairment [^1a6865f8] [^d6fd6090].
