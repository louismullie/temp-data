...
Testicular torsion presents with **sudden severe unilateral scrotal pain** [^d09fde52] often accompanied by nausea and vomiting [^3d9f8e5f], and an **absent or decreased cremasteric reflex** [^006200bb] is a key physical finding [^b38b4c1d]. The affected testis is typically high-riding, tender, and swollen [^d09fde52], and may lie horizontally [^e354f44c]; scrotal erythema and edema can develop later [^d09fde52]. Prehn's sign is unreliable and should not be used to rule out torsion [^6f31f287]. Prompt recognition is critical because salvage drops sharply after 6–12 hours [^c294a2a5]; if torsion is suspected, **immediate urology consultation and surgical exploration are indicated** [^f4600cf1], even if imaging is normal [^3d9f8e5f].
