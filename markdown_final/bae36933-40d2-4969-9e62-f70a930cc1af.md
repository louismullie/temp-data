...
> Let me first confirm the labeled dosing so I don't jump to conclusions. For adults with GERD and erosive esophagitis, the standard dose is 40 mg once daily for both IV and oral formulations, typically for 7–10 days IV and up to 8 weeks orally, which already suggests dose parity across routes for this indication [^1149AB2i] [^111EVXZG] [^117UvqFM]. For pathological hypersecretory conditions including Zollinger–Ellison syndrome, IV dosing is 80 mg every 12 hours and can be increased to every 8 hours if needed, whereas oral maintenance is commonly 40 mg twice daily, indicating that the oral-to-IV ratio is not 1:1 in this special case, so I need to keep that exception in mind [^1118mANZ] [^11794LtY].
