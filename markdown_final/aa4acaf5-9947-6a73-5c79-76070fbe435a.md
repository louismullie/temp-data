...
Mice have highly flexible skeletons and can compress their bodies to fit through very small openings. The **minimum hole size** mice can pass through is about 6–7 mm (0.24–0.28 inches) [^116tY1TV]. This flexibility allows them to exploit gaps far smaller than their apparent body size.
...
### Regionalized tissue fluidization is required for epithelial gap closure during insect gastrulation [^1119B7Na]. Nature Communications (2020). High credibility.
...
### Single-cycle surface plasmon polaritons on a bare metal wire excited by relativistic electrons [^114K3Vhs]. Nature Communications (2016). Medium credibility.
...
### Intense equatorial flux spots on the surface of the earth's core [^1114yfoR]. Nature (2003). Excellent credibility.
...
### Meridional flows in the disk around a young star [^112Lehmz]. Nature (2019). Excellent credibility.
...
### Topologically cloaked magnetic colloidal transport [^111aeE9n]. Nature Communications (2025). High credibility.
...
### Cylindrical compression of thin wires by irradiation with a joule-class short-pulse laser [^111mdtZa]. Nature Communications (2024). High credibility.
...
### Mapping the ionosphere with millions of phones [^113JrGHA]. Nature (2024). Excellent credibility.
...
### A distinct ripple-formation regime on mars revealed by the morphometrics of barchan dunes [^113A5Qc5]. Nature Communications (2022). High credibility.
...
### Ripples formed in low-pressure wind tunnels suggest mars's large windblown ripples are not impact ripples [^112vDfMa]. Nature Communications (2025). High credibility.
...
### Two earth-sized planets orbiting kepler-20 [^117PdANG]. Nature (2011). Excellent credibility.
...
### A sensitive electrometer based on a rydberg atom in a schrödinger-cat state [^113LR65x]. Nature (2016). Excellent credibility.
...
### MRI-based transfer function determination through the transfer matrix by jointly fitting the incident and scatteredfield [^113yVxnF]. Magnetic Resonance in Medicine (2020). Medium credibility.
...
### Minimum entropy production by microswimmers with internal dissipation [^115eFY9g]. Nature Communications (2023). High credibility.
...
### Topologically cloaked magnetic colloidal transport [^117V229A]. Nature Communications (2025). High credibility.
...
### Simultaneous polydirectional transport of colloidal bipeds [^114S1z2L]. Nature Communications (2020). High credibility.
...
### A perspective on surfaces and interfaces [^111TJaC1]. Nature (2005). Excellent credibility.
...
### Four-channel surface coil array for 300-MHz pulsed EPR imaging: proof-of-concept experiments [^116co21X]. Magnetic Resonance in Medicine (2014). Low credibility.
...
### Synchronously wired infrared antennas for resonant single-quantum-well photodetection up to room temperature [^1174DqX8]. Nature Communications (2020). High credibility.
...
### Recurrent pattern completion drives the neocortical representation of sensory inference [^111AfQGB]. Nature Neuroscience (2025). High credibility.
...
### Closing the gap towards super-long suspension bridges using computational morphogenesis [^111zUdZ4]. Nature Communications (2020). High credibility.
...
### Melting of the earth's inner core [^112mGfdd]. Nature (2011). Excellent credibility.
...
### Prediction of the strength and timing of sunspot cycle 25 reveal decadal-scale space environmental conditions [^114MK4hV]. Nature Communications (2018). Medium credibility.
...
### Beaded metamaterials [^112x5qAd]. Nature Communications (2025). High credibility.
...
### Elastic spheres can walk on water [^1119tJME]. Nature Communications (2016). Medium credibility.
...
### A rocky composition for an earth-sized exoplanet [^113PjBYz]. Nature (2013). Excellent credibility.
...
### Observations of discrete harmonics emerging from equatorial noise [^116woUuP]. Nature Communications (2015). Medium credibility.
...
### Cylindrical compression of thin wires by irradiation with a joule-class short-pulse laser [^116AMPnT]. Nature Communications (2024). High credibility.
...
### Mice alternate between discrete strategies during perceptual decision-making [^1122qHsn]. Nature Neuroscience (2022). High credibility.
...
### Human mobility is well described by closed-form gravity-like models learned automatically from data [^117CiMuP]. Nature Communications (2025). High credibility.
...
### Nonlinear spatiotemporal integration by electrical and chemical synapses in the retina [^117TECW7]. Neuron (2016). Low credibility.
...
### Atomic layer lithography of wafer-scale nanogap arrays for extreme confinement of electromagnetic waves [^115bAdnZ]. Nature Communications (2013). Medium credibility.
...
### Healthy housing reference manual [^114exEtF]. CDC (2006). Medium credibility.
...
### One-third of sun-like stars are born with misaligned planet-forming disks [^1164ZNbi]. Nature (2025). Excellent credibility.
...
### Rotational breakup as the origin of small binary asteroids [^11162L6Z]. Nature (2008). Excellent credibility.
...
### Carbonate formation and fluctuating habitability on mars [^112QQCTa]. Nature (2025). Excellent credibility.
...
### An on-chip phased array for non-classical light [^113FYmGk]. Nature Communications (2025). High credibility.
...
### Simulations of the formation, evolution and clustering of galaxies and quasars [^114FMFHE]. Nature (2005). Excellent credibility.
...
### Lateral competition for cortical space by layer-specific horizontal circuits [^115EStKx]. Nature (2010). Excellent credibility.
...
### An earth-sized planet with an earth-like density [^113hTE8k]. Nature (2013). Excellent credibility.
...
### Aviation effects on already-existing cirrus clouds [^114orEDC]. Nature Communications (2016). Medium credibility.
...
### Wavefront shaping through emulated curved space in waveguide settings [^114CPjpH]. Nature Communications (2016). Medium credibility.
...
### Modeling and measurement of lead tip heating and resonant length for implanted, insulated wires [^111VG2iL]. Magnetic Resonance in Medicine (2024). Medium credibility.
...
### Centimeter-scale nanomechanical resonators with low dissipation [^111RqWHN]. Nature Communications (2024). High credibility.
...
### Sample size matters: a guide for surgeons [^1177dtEP]. World Journal of Surgery (2005). Low credibility.
...
### Force-bearing phagocytic adhesion rings mediate the phagocytosis of surface-bound particles [^1111P29f]. Nature Communications (2025). High credibility.
...
### Observation and control of casimir effects in a sphere-plate-sphere system [^113QB2yJ]. Nature Communications (2022). High credibility.
...
### Mouse visual cortex areas represent perceptual and semantic features of learned visual categories [^114a1Dmx]. Nature Neuroscience (2021). High credibility.
...
### Biskyrmion States and their current-driven motion in a layered manganite [^112rJBoG]. Nature Communications (2014). Medium credibility.
...
### Directed self-assembly of a colloidal kagome lattice [^114F3iXX]. Nature (2011). Excellent credibility.
...
### PulseRider 2018 executive summary… [^115Gz4Rw]. FDA (2025). Medium credibility.
...
### Recommendations for the use of antiretroviral drugs during pregnancy and interventions to reduce perinatal HIV transmission in the United States [^112RqLz1]. HIV.gov (2025). High credibility.
...
### MRI-based transfer function determination through the transfer matrix by jointly fitting the incident and scatteredfield [^1179LtSG]. Magnetic Resonance in Medicine (2020). Medium credibility.
...
### Three regimes of extrasolar planet radius inferred from host star metallicities [^116yytZc]. Nature (2014). Excellent credibility.
...
### Adjuvant and salvage radiotherapy after prostatectomy: ASTRO / AUA guideline amendment 2018–2019 [^116244wm]. The Journal of Urology (2019). High credibility.
...
### Precise surface patches on active particles of arbitrary shape through microstenciling [^112SZBpR]. Nature Communications (2025). High credibility.
...
### Healthy housing reference manual [^115VNpcK]. CDC (2006). Medium credibility.
...
### Heterogeneous encoding of temporal stimuli in the cerebellar cortex [^112J2VCv]. Nature Communications (2023). High credibility.
...
### Environmental assessment and exposure reduction of rodents: a practice parameter [^115ELWYr]. Annals of Allergy, Asthma & Immunology (2012). Medium credibility.
...
### Physical networks as network-of-networks [^115byKXD]. Nature Communications (2024). High credibility.
...
### Structured multimaterial filaments for 3D printing of optoelectronics [^114AihRf]. Nature Communications (2019). High credibility.
...
### An earth-mass planet orbiting α centauri B [^113yDNya]. Nature (2012). Excellent credibility.
...
### Mouse lens stiffness measurements [^111anZks]. Experimental Eye Research (2010). Low credibility.
...
### Grid cells accurately track movement during path integration-based navigation despite switching reference frames [^117WhEtS]. Nature Neuroscience (2025). High credibility.
...
### Characterization of extrasolar terrestrial planets from diurnal photometric variability [^114NdUpb]. Nature (2001). Excellent credibility.
...
### Ginzburg-landau-type theory of spin superconductivity [^1127ZUk9]. Nature Communications (2013). Medium credibility.
...
### Observation of bose-einstein condensates in an earth-orbiting research lab [^116FrNTQ]. Nature (2020). Excellent credibility.
...
### Closed platysmotomy: a new procedure for the treatment of platysma bands without skin dissection [^114ZStHU]. Aesthetic Plastic Surgery (2011). Low credibility.
...
### Recommendations for tumor mutational burden assay validation and reporting: a joint consensus recommendation of the Association for Molecular Pathology, college of American pathologists, and Society for Immunotherapy of Cancer [^112MY9qC]. The Journal of Molecular Diagnostics (2024). High credibility.
