...
[
R' = \\frac{C'}{2\\pi} = \\frac{2\\pi R + 1}{2\\pi} = R + \\frac{1}{2\\pi}
]

The gap (h) is the difference in radii:

[
h = R' - R = \\frac{1}{2\\pi} \\approx 0.159 \\text{ meters} \\approx 15.9 \\text{ cm}
]
