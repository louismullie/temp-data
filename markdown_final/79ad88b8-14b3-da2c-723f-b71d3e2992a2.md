...
The preferred first-line therapy for asthma exacerbation in the emergency department is **short-acting beta-agonists (SABA)** [^feae4a2d] (e.g. albuterol) delivered by metered-dose inhaler with spacer or nebulizer, repeated every 20 minutes for the first hour as needed [^5ff0ef99]. SABA rapidly reverses bronchospasm and is the cornerstone of acute management [^b80b10a6]; systemic corticosteroids should be added early to reduce inflammation and prevent relapse [^04b03156] [^d0103655], and ipratropium may be added for moderate-to-severe cases [^ffe4805f]. Theophylline, antihistamines, and cromolyn sodium are not recommended as first-line therapy in the ED [^notfound].
