...
These are the only integer solutions, as confirmed by algebraic factorization and verification against known results for Mordell's equation (y² = x³ + k) [^notfound].
