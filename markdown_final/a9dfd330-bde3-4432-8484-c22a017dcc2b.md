...
**Sample ID**: a9dfd330-bde3-4432-8484-c22a017dcc2b
**Dataset Index**: 3717
...
> Let's see… What do we have here? The user is asking how long naltrexone should be used for a patient who is trying to stop drinking alcohol, including what evidence-based durations exist, whether there is a standard minimum, how to extend treatment beyond that minimum, and what special situations change duration decisions. Let's break this down step-by-step. First, I need to think about what the FDA label says for oral naltrexone. Then, I should verify the pivotal trial durations that shaped the evidence base. Next, I will review contemporary guidelines to see if they endorse longer treatment. After that, I should examine extended-release naltrexone data for treatment windows and effect sizes. Finally, I will consider special populations, discontinuation principles, and how to translate this into a practical clinical recommendation with monitoring checkpoints.

> Let me first confirm the labeled, evidence-aligned duration for oral naltrexone. The FDA labeling indicates that the dose of 50 mg once daily for alcohol dependence is supported by placebo-controlled trials that evaluated 12 weeks of therapy, and that other dose regimens or durations were not evaluated in those pivotal trials, establishing 12 weeks as the labeled treatment period for oral naltrexone in AUD [^113SAJbJ] [^114dBh2M] [^117ST9XK].

> Wait, let me verify whether this 12-week minimum translates into a standard of care. The pivotal COMBINE trial used 16 weeks of naltrexone with medical management and demonstrated benefits during treatment, reinforcing that a 12–16 week course is reasonable as an initial phase, while noting that benefits waned after treatment ended, which is a key reason many clinicians extend beyond 12 weeks in practice [^114zK4Ko] [^111WKhfV]. Hold on, I should also note a common misconception: some older reviews said naltrexone showed no benefit beyond 3–6 months, but more recent high-quality syntheses and meta-analyses demonstrate sustained benefits with adequate duration and adherence, so I need to correct that outdated view here [^112LY4p1] [^115VWcqA].

> Next, I should review what major guidelines recommend about duration. The VA/DoD guideline advises offering naltrexone for moderate-to-severe AUD but does not specify a fixed duration, emphasizing individualized care and that longer treatment participation is associated with better outcomes, often well beyond 90 days [^111zTVqR] [^114uLgJT]. The Canadian CRISM guideline similarly recommends naltrexone as first-line therapy and ties duration to patient-identified goals and clinical judgment rather than a fixed endpoint, which supports extending therapy when beneficial [^116t6QHX]. The AAFP endorses naltrexone as first-line and stresses integrating pharmacotherapy with psychosocial care, again implying that duration should be driven by ongoing clinical need and response rather than a rigid stop date [^114yDfTU].

> I will now examine extended-release naltrexone (XR-NTX) to see if longer, fixed-duration courses are evidence-based. Randomized trials and meta-analyses show XR-NTX 380 mg monthly for 24 weeks (approximately 6 months) reduces heavy drinking days and drinking days compared with placebo, with benefits emerging within the first month and persisting through 6 months, and some analyses suggesting larger effects with longer courses and without a required lead-in abstinence [^113njsb4] [^114iM4rT]. Let me double-check onset data: a post hoc analysis showed significant reductions in drinks per day by day 2 and fewer heavy drinking days by day 3 after the first injection, which can help with early engagement and motivation to continue treatment [^116yhZZr].

> Hold on, I should verify real-world extension beyond trials. Observational and preference-driven extensions suggest that many patients benefit from 6–12 months or more of XR-NTX, with some studies and practice patterns extending to a year or longer based on clinical response and relapse risk, although this extrapolates from opioid-dependence cohorts and expert opinion rather than randomized data in AUD, so I need to be cautious and individualize [^112mceoe] [^114uLgJT]. Hmm, wait a minute, I initially thought the longest randomized AUD XR-NTX trials were 12 months; let me reconsider — most pivotal AUD trials are 24 weeks, and while longer observational follow-ups exist, they do not substitute for randomized evidence, so any extension beyond 6 months should be framed as individualized maintenance rather than a fixed-duration standard [^113njsb4] [^114iM4rT].

> Next, I should review special populations that modify duration decisions. In compensated alcohol-related liver disease, naltrexone appears safe and may improve liver outcomes, supporting continued use when clinically indicated, though decompensated cirrhosis remains a contraindication in some guidance and liver monitoring is prudent [^115D6xtJ] [^117LP6Ah]. For people with HIV, naltrexone reduces heavy drinking without significant drug–drug interactions and can be continued as long as clinically helpful, again with attention to hepatic status and ART considerations [^112CVTVd]. In older adults, I should confirm there are no specific duration modifications beyond standard monitoring; there are none established, so decisions remain response-driven [^114yDfTU].

> I need to ensure we address discontinuation and what to do when stopping. Because naltrexone has no physiologic withdrawal, it can be stopped abruptly without tapering; however, patients may lose pharmacologic blockade and experience renewed craving and relapse risk, so counseling and close follow-up are essential, and for those on XR-NTX, the blockade can persist for weeks after the last injection, which should be factored into transition planning [^114uLgJT] [^1157E1ZK]. Let me verify one more thing: there is no consensus "optimal" duration beyond which all patients should stop; instead, many experts support continuation for 6–12 months in responders, with some advocating up to a year or more in those with high relapse risk or ongoing heavy drinking exposure, always reassessing goals, adherence, and side effects at regular intervals [^111zTVqR] [^114uLgJT].

> Putting this together, my practical, evidence-based recommendation is as follows. Start with an initial course of oral naltrexone 50 mg daily for 12 weeks, aligning with FDA labeling and core efficacy trials, and reassess response at 12–16 weeks to decide on continuation or switch to XR-NTX if adherence is a concern or if the patient prefers monthly injections [^113SAJbJ] [^114zK4Ko] [^115zbagW]. If the patient is benefiting, extend treatment to 6 months with XR-NTX 380 mg every 4 weeks when feasible, given the 24-week RCT evidence base and the advantage of improved adherence with the injectable formulation, and consider maintenance beyond 6 months for those with persistent risk factors, prior relapse, or high craving, with shared decision-making about goals and monitoring of liver function and adverse effects [^113njsb4] [^114iM4rT] [^111zTVqR]. But wait, what if the patient is actively drinking at initiation? The XR-NTX trials enrolled actively drinking participants and still showed benefit, so abstinence at initiation is not mandatory, though counseling on expectations and early effect onset can improve engagement and outcomes [^113njsb4] [^116yhZZr].

> In summary, the standard minimum evidence-based duration is 12 weeks for oral naltrexone, but contemporary guidelines and extended-release data support extending treatment to 6 months or longer based on clinical response, relapse risk, and patient preference, with individualized duration and ongoing psychosocial support as integral to sustained benefit [^113SAJbJ] [^114iM4rT] [^114yDfTU] [^111zTVqR].

---

The typical course of naltrexone for alcohol use disorder is **12 weeks at 50 mg/day** [^113SAJbJ], based on FDA-labeled trials [^114dBh2M]. Many clinicians extend therapy to **3–6 months or longer** [^116t6QHX] if effective and tolerated, as benefits persist with continued use [^114iM4rT] [^114aQX4V]. For patients with adherence issues, **extended-release injectable naltrexone** (380 mg every 4 weeks) [^113njsb4] is often preferred [^115zbagW] and can be continued for 6–12 months or more, individualized to response and goals [^114aQX4V] [^111zTVqR]. Treatment should be combined with psychosocial support [^114Sw4YZ] and reassessed regularly for efficacy, adherence, and adverse effects [^notfound].

---

## Standard duration of naltrexone treatment

The **FDA-approved duration** is 12 weeks (84 days) at 50 mg/day for alcohol dependence, the regimen used in pivotal trials [^114dBh2M] [^117ST9XK]. The **clinical practice** approach commonly extends therapy to 3–6 months or longer [^notfound] if effective and tolerated, as sustained use maintains benefits [^114iM4rT].
...
|-|-|-|
| FDA trials | 12 weeks | 50 mg/day reduced heavy drinking and relapse vs placebo [^117ST9XK] [^115VWcqA] |
| COMBINE study | 16 weeks | naltrexone + medical management reduced heavy drinking and improved abstinence vs placebo [^114zK4Ko] [^111WKhfV] |
| Extended-release naltrexone trials | 24 weeks | 380 mg every 4 weeks reduced heavy drinking and sustained effects over 6 months [^113njsb4] [^114iM4rT] |

---

## Factors influencing treatment duration

Treatment length is **individualized** based on:

- **Severity of AUD**: More severe cases may need longer treatment [^notfound].
- **Treatment response**: Continue if reducing heavy drinking and craving [^notfound].
- **Adherence**: Nonadherent patients may benefit from extended-release formulations [^115zbagW].
- **Patient preference**: Shared decision-making guides duration [^notfound].
- **Comorbidities**: Co-occurring conditions may require longer or modified treatment [^112CVTVd].

---

## Extended-release injectable naltrexone

- **Duration**: 380 mg IM every 4 weeks [^113njsb4]; some benefit from every 3 weeks [^113AzgUE].
- **Evidence**: 24-week trials show sustained reductions in heavy drinking and craving [^116yhZZr].
- **Adherence**: Improved vs oral; suitable for adherence challenges [^115y5ko4] [^113kwJRe].

---

## Clinical guidelines and expert recommendations

Guidelines support individualized duration: **APA 2018** advises offering naltrexone for moderate-to-severe AUD, tailoring duration to response and preferences [^116vLf6i], and **VA/DoD 2021** recommends offering naltrexone with psychosocial treatment and individualizing duration [^111zTVqR].

---

## Monitoring and follow-up

Regular monitoring should track **efficacy** (heavy drinking, craving, and adherence) [^1111ptfT], **adverse effects** (notably hepatotoxicity and GI symptoms) [^112zQdWJ], and **ongoing need**, with treatment plans adjusted accordingly [^111zTVqR].

---

## Summary of recommendations

- **Initial course**: 12 weeks (50 mg/day) [^113SAJbJ].
- **Extension**: Continue 3–6 months or longer if effective and tolerated [^notfound].
- **Extended-release**: 380 mg every 4 weeks for 6–12 months or more, individualized [^113njsb4].
- **Adjunctive therapy**: Combine with psychosocial support [^114Sw4YZ].
- **Monitoring**: Regularly reassess efficacy, adherence, and adverse effects [^notfound].

---

The **typical naltrexone course is 12 weeks** [^113SAJbJ], but many patients benefit from 3–6 months or longer, especially with extended-release formulations and psychosocial support [^114iM4rT] [^114Sw4YZ]. Duration should be **individualized** based on response, adherence, and patient preference [^111zTVqR].

---

## References

### ACG clinical guideline: alcohol-associated liver disease [^115D6xtJ]. The American Journal of Gastroenterology (2024). High credibility.
...
### Naltrexone vs placebo for the treatment of alcohol dependence: a randomized clinical trial [^113gz29D]. JAMA Psychiatry (2015). Medium credibility.
...
### Topiramate versus naltrexone for alcohol use disorder: a genotype-stratified double-blind randomized controlled trial [^114Ps8Nf]. The American Journal of Psychiatry (2024). Medium credibility.
...
### The ASAM national practice guideline for the treatment of opioid use disorder: 2020 focused update [^114uLgJT]. Journal of Addiction Medicine (2020). High credibility.
...
### Naltrexone hydrochloride [^113ENc8o]. FDA (2025). Medium credibility.
...
### Naltrexone versus acamprosate in the treatment of alcohol dependence: a multi-centre, randomized, double-blind, placebo-controlled trial [^114RrVyj]. Addiction (2006). Low credibility.
...
### Antagonist models for treating persons with substance use disorders [^113RcEbi]. Current Psychiatry Reports (2014). Low credibility.
...
### Emergency department-initiated oral naltrexone for patients with moderate to severe alcohol use disorder: a pilot feasibility study [^114MAoi2]. Academic Emergency Medicine (2025). Medium credibility.
...
### Naltrexone [^1126PLUC]. FDA (2018). Low credibility.
...
### Opioid antagonists in the treatment of alcohol dependence [^117DBew5]. Current Psychiatry Reports (2001). Low credibility.
...
### The management of substance use disorders: synopsis of the 2021 U.S. department of veterans affairs and U.S. department of defense clinical practice guideline [^115zbagW]. Annals of Internal Medicine (2022). High credibility.
...
### Follow-up and reasons for extended-release naltrexone discontinuation for alcohol use disorder after hospital initiation [^1117v1JF]. BMJ Open Quality (2024). High credibility.
...
### The management of substance use disorders: synopsis of the 2021 U.S. department of veterans affairs and U.S. department of defense clinical practice guideline [^1135Dc9i]. Annals of Internal Medicine (2022). High credibility.

VA/DoD Clinical Practice Guideline for the Management of Substance Use Disorders — disulfiram use, supervision, and monitoring states that patients taking disulfiram should avoid ingestion of alcohol due to the expectation of a toxic reaction if alcohol is consumed, and because the action of disulfiram depends on the expectation of adverse effects, it should not be given to patients who are unable to consider the consequences of alcohol consumption while taking disulfiram. Disulfiram is thus best suited for patients who have made an informed choice of this type of treatment, are highly compliant, and are under close medical supervision, and because of the risk of significant toxicity when disulfiram is combined with alcohol, the risks and benefits of disulfiram should be carefully considered. Low quality evidence suggests there are potential harms associated with disulfiram, including increased risk of adverse events, and there are rare but serious adverse effects associated with disulfiram, including hepatitis or fulminant liver failure; thus, indices of liver health must be monitored regularly during the first several months of disulfiram treatment. Implementation guidance specifies that disulfiram should only be used when abstinence is the goal, established with patient concurrence, and when initiated with addiction-focused counseling; enlisting clinic personnel or a supportive significant other to observe daily disulfiram doses will optimize disulfiram treatment outcomes, and providers should document verification of alcohol abstinence and the informed consent discussion with patients before initiating disulfiram. Some RCTs directly comparing disulfiram to naltrexone, acamprosate, and topiramate also favored disulfiram.
...
### Naltrexone for alcohol dependence: a randomized controlled trial [^114N4dfk]. Addiction (2001). Low credibility.
...
### Evaluation in alcohol use disorders-insights from the nalmefene experience [^116Lhu6Y]. BMC Medicine (2016). Low credibility.
...
### Association of the sweet-liking phenotype and craving for alcohol with the response to naltrexone treatment in alcohol dependence: a randomized clinical trial [^113JPyGE]. JAMA Psychiatry (2016). Medium credibility.
...
### Effect of extended-release naltrexone on alcohol consumption: a systematic review and meta-analysis [^114iM4rT]. Addiction (2022). Medium credibility.
...
### Emergency department-initiated oral naltrexone for patients with moderate to severe alcohol use disorder: a pilot feasibility study [^112tUNdR]. Academic Emergency Medicine (2025). Medium credibility.

DISCUSSION

Despite recent recommendationsfor ED providers to identify AUD and initiation medication treatment, a recent systematic review performed as part of the Society for Academic Emergency Medicines (SAEM) Guidelines for Reasonable and Appropriate Care in the Emergency Department (GRACE) concluded that, "there is relatively little evidence addressing the initiation of anticraving medications for AUD in the ED". This prospective, single‐arm, open‐label, nonrandomized clinical trial adds to the limited literature on ED‐initiated medications for AUD and adds several important findings to the literature.

The primary outcome, engagement in comprehensive addiction care at 14 and 30 days post–ED‐initiated oral naltrexone, was better than in earlier studies. The proportion of participants engaged in care at 14 days was 29% at 14 days and 33% at 30 days. This proportion is higher than reported by Anderson et al.in a study of ED‐initiated oral and injectable naltrexone where the proportion of participants attending an addiction medicine follow‐up was 9.1% for those prescribed oral naltrexone and 27.8% for those receiving long‐acting injectable naltrexone. This discrepancy could be attributed to differences in study design, as their intervention did not include daily surveys or multiple follow‐ups but rather a prescription for naltrexone alongside a single follow‐up at a bridge clinic. Conversely, in another open‐label single‐arm clinical trial examining a series of long‐acting injectable naltrexone, Murphy et al.found that 84% of participants attended their 4‐week follow‐up visit. There are several possible reasons for these observed differences between studies beyond simple differences in population characteristics. Our study involved daily interactions with participants through daily surveys, which may have kept participants more engaged. We also have an on‐site comprehensive addiction treatment program that likely made it easier for patients to make follow‐up appointments. While we did provide a follow‐up incentive for participants that could have inflated our engagement numbers, the incentive was only given for completing survey measures and was not tied to follow‐up care.

---

### Naltrexone (Vivitrol) [^113njsb4]. FDA (2024). Medium credibility.
...
### Alcohol abuse and alcoholism: an overview [^112jehiE]. The Journal of Clinical Psychiatry (2001). Low credibility.
...
### The ASAM national practice guideline for the treatment of opioid use disorder: 2020 focused update [^113AdZZG]. Journal of Addiction Medicine (2020). High credibility.
...
### Concurrent naltrexone and prolonged exposure therapy for patients with comorbid alcohol dependence and PTSD: a randomized clinical trial [^114oeeGa]. JAMA (2013). Excellent credibility.
...
### Efficacy of combining varenicline and naltrexone for smoking cessation and drinking reduction: a randomized clinical trial [^116k9Gw8]. The American Journal of Psychiatry (2021). Medium credibility.
...
### Adapting treatment length to opioid-dependent individuals' needs and preferences: a 2-year follow-up to a 1-year study of extended-release naltrexone [^11787NmD]. Addiction (2020). Medium credibility.
...
### Emergency department-initiated oral naltrexone for patients with moderate to severe alcohol use disorder: a pilot feasibility study [^115gU4Jq]. Academic Emergency Medicine (2025). Medium credibility.
...
### Naltrexone [^1113F4zH]. FDA (2018). Low credibility.
...
### Clinical relevance of nalmefene versus placebo in alcohol treatment: reduction in mortality risk [^1135jwVU]. Journal of Psychopharmacology (2015). Low credibility.
...
### Evaluation in alcohol use disorders-insights from the nalmefene experience [^116gb4JR]. BMC Medicine (2016). Low credibility.
...
### Emergency department-initiated oral naltrexone for patients with moderate to severe alcohol use disorder: a pilot feasibility study [^117EPmv3]. Academic Emergency Medicine (2025). Medium credibility.
...
### Relapse rates in patients… [^1124Sh15]. AAFP (2020). Medium credibility.
...
### Guidelines for the use of antiretroviral agents in adults and adolescents with HIV [^113Yqx9g]. HIV.gov (2025). High credibility.

Alcohol use disorder (AUD) in people with HIV — interventions and ART considerations: Individuals provided depot naltrexone upon release from prison were more likely to achieve viral suppression at 6 months than placebo (56.7% vs. 30.3%). A randomized controlled trial of 128 individuals with HIV and AUD in Veterans Administration HIV clinics tested integrated stepped‑care versus treatment as usual; at the end of treatment (24 weeks) more participants received pharmacotherapy for AUD and counseling, and although differences in alcohol use and viral suppression were not seen at 24 weeks, at 52 weeks stepped‑care was associated with more alcohol‑abstinent days, fewer drinks per drinking day, fewer heavy drinking episodes, and increased odds of achieving viral suppression (odds ratio [OR] 5.58; 95% CI, 1.11–27.99). Data on the use of disulfiram and acamprosate among people with HIV are lacking. Liver dysfunction related to chronic heavy alcohol use, viral hepatitis, or metabolic dysfunction–associated steatotic liver disease can alter antiretroviral (ARV) metabolism, and for hepatic impairment due to alcohol‑related liver disease, ART dosing should follow the recommendations in Appendix B, which are based on Child‑Pugh classifications.
...
### Vibration of effects from diverse inclusion / exclusion criteria and analytical choices: 9216 different ways to perform an indirect comparison meta-analysis [^1139ax4t]. BMC Medicine (2019). Medium credibility.
...
### Use of naltrexone to maintain sobriety in alcoholics… [^114FnmNs]. AAFP (2025). Medium credibility.

Initial enthusiasm for the use of naltrexone to maintain sobriety in patients with alcohol dependence has been complicated by inconsistent results from smaller studies conducted at single trial sites. Krystal and colleagues conducted a multi-center, randomized, placebo-controlled study of naltrexone administered as an adjunct to psychosocial treatment in 627 patients with alcohol dependence. Study participants were enrolled from Veterans Affairs outpatient alcohol treatment programs. After five days of sobriety, study participants were randomized to receive either 12 months of naltrexone, placebo for 12 months, or naltrexone for three months followed by placebo for nine months. All participants received individual psychotherapy for 13 months and were encouraged to attend Alcoholics Anonymous meetings.

Compliance with medication was monitored by use of electronic bottle caps that recorded the date and time of each opening and that showed the number of hours that had elapsed since the previous opening. Almost all of the participants were male, and approximately 35 percent were from minority ethnic groups. Overall, 73 percent of the participants completed the study, with no significant differences in dropout rates among the three treatment groups. Pain, flu-like symptoms, and headache were the most commonly reported adverse events occurring with use of naltrexone, but the rates of these symptoms did not differ significantly from placebo rates. Neither short- nor long-term use of naltrexone significantly improved the ability of participants to maintain sobriety. At 13 weeks, relapse in drinking occurred in 44 percent of participants taking placebo versus 38 percent of those taking naltrexone.

The total number of days when drinking occurred and the number of drinks per day in participants who relapsed was not significantly improved in the groups taking naltrexone. Compliance with medication was poor in all groups by completion of the study. The authors concluded that naltrexone combined with psychosocial therapy was not effective in treating men with chronic, severe alcohol dependence.
...
### Naltrexone and counseling reduce alcohol dependence… [^111WKhfV]. AAFP (2025). Medium credibility.
...
### Emergency department-initiated oral naltrexone for patients with moderate to severe alcohol use disorder: a pilot feasibility study [^1124KPDq]. Academic Emergency Medicine (2025). Medium credibility.
...
### Naltrexone in the treatment of alcohol dependence [^115XCXjv]. The New England Journal of Medicine (2001). Excellent credibility.
...
### Clinical relevance of nalmefene versus placebo in alcohol treatment: reduction in mortality risk [^114kyd5p]. Journal of Psychopharmacology (2015). Low credibility.
...
### Oral vs extended-release injectable naltrexone for hospitalized patients with alcohol use disorder: a randomized clinical trial [^113BGM7W]. JAMA Internal Medicine (2025). High credibility.
...
### The management of substance use disorders: synopsis of the 2021 U.S. department of veterans affairs and U.S. department of defense clinical practice guideline [^113kwJRe]. Annals of Internal Medicine (2022). High credibility.
...
### Early treatment response in alcohol dependence with extended-release naltrexone [^116yhZZr]. The Journal of Clinical Psychiatry (2008). Low credibility.
...
### Efficacy and tolerability of long-acting injectable naltrexone for alcohol dependence: a randomized controlled trial [^114aQX4V]. JAMA (2005). Excellent credibility.
...
### Follow-up and reasons for extended-release naltrexone discontinuation for alcohol use disorder after hospital initiation [^1173e4jQ]. BMJ Open Quality (2024). High credibility.
...
### Adapting treatment length to opioid-dependent individuals' needs and preferences: a 2-year follow-up to a 1-year study of extended-release naltrexone [^111m1S37]. Addiction (2020). Medium credibility.

Measurements and outcomes

Every 4 weeks during their time in treatment, the participants reported substance use, opioid craving, treatment satisfaction and recommendation of XR‐NTX treatment to others. We used the same inventories as in the parent study, and only actual assessments were used in the analyses. The primary outcome variable was time in XR‐NTX treatment, defined as the number of weeks participants chose to receive XR‐NTX injections. If they wanted to end the treatment, they were asked about the reason for this. Participants were not excluded if they relapsed to opioid use or used other illicit substances while in the study.

Secondary outcome variables were use of opioids or other illicit substances such as cannabis, amphetamines, benzodiazepines and alcohol for intoxication within the 4 weeks preceding each interview. The assessment of substances was based on: 0 = no use; 1 = yes, on 1 or 2 days in 4 weeks; 2 = yes, weekly; and 3 = yes, daily or almost daily.

The degrees of opioid craving, satisfaction with treatment and recommendation of treatment to others were assessed using a validated visual analog scale (0–10).

Research ethics

The study was approved by the Regional Committee for Medical and Health Research Ethics Southeast Norway, the Norwegian Medicines Agency and the boards of research ethics at the participating hospitals. Monitoring of the study was conducted by the publicly funded Regional Monitoring Authorities, according to Good Clinical Practice standards. Before inclusion in the parent study, participants provided a written informed consent. The treatment carried no cost for the participants. They were not paid or compensated for taking part in the study, with the exception of reimbursement of travel expenses for using public transportation.
...
### Comparing topiramate with naltrexone in the treatment of alcohol dependence [^114x8MZY]. Addiction (2008). Low credibility.
...
### Naltrexone hydrochloride [^113SAJbJ]. FDA (2024). Medium credibility.

The dosage of naltrexone hydrochloride PO for treatment of alcohol use disorder in adults is 50 mg PO daily for 12 weeks

---

### Emergency department-initiated oral naltrexone for patients with moderate to severe alcohol use disorder: a pilot feasibility study [^1148dhdq]. Academic Emergency Medicine (2025). Medium credibility.
...
### Adapting treatment length to opioid-dependent individuals' needs and preferences: a 2-year follow-up to a 1-year study of extended-release naltrexone [^112mceoe]. Addiction (2020). Medium credibility.
...
### Opioid antagonists for alcohol dependence [^1146oAhg]. The Cochrane Database of Systematic Reviews (2005). Low credibility.
...
### A double-blind, placebo-controlled trial combining sertraline and naltrexone for treating co-occurring depression and alcohol dependence [^111ESoxu]. The American Journal of Psychiatry (2010). Low credibility.
