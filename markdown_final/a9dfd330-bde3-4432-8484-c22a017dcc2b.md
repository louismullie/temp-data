...
There was no evidence of a genotype × treatment interaction on the primary outcome of heavy drinking (P = .32). In the Asn40 group, the observed effect of naltrexone was similar to that in previous trials (odds ratio, 0.69; 95% CI, 0.41–1.18; p = 0.17), with a very small naltrexone effect in the Asp40 group (odds ratio, 1.10; 95% CI, 0.52–2.31; p = 0.80), contrary to the pattern expected a priori. A significant reduction in heavy drinking occurred across all groups (P = .001). Other drinking outcomes, and all secondary outcomes, demonstrated similar time effects, with no genotype × treatment interaction.
