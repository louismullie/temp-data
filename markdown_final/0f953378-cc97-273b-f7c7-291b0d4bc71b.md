...
A série de leucócitos mais depletada pela clozapina é a **série neutrofílica (neutrófilos)** [^115jxivL], causando neutropenia ou agranulocitose [^114q7AhA]. Essa depleção é imprevisível, não dose-dependente [^115jxivL] e pode levar a infecções graves, sendo o motivo pelo qual o monitoramento regular do **contagem absoluta de neutrófilos (ANC)** é obrigatório [^115ZBHja] [^116DYejS]. Outras linhagens, como linfócitos e monócitos, não são afetadas de forma consistente ou clinicamente significativa [^115jxivL].
