...
> Next, I should review the molecular basis. Hold on, let's not jump to conclusions — I should verify the implicated proteins. The primary lesion in hereditary spherocytosis is defective vertical linkage between the membrane skeleton and the lipid bilayer, most commonly due to mutations in ankyrin (ANK1), band 3 (SLC4A1), β-spectrin (SPTB), α-spectrin (SPTA1), or protein 4.2 (EPB42), with ankyrin and spectrin defects being particularly frequent; these defects cause membrane loss, reduced deformability, and spherocyte formation that are trapped and destroyed in the spleen [^111JJubt] [^114juAPB] [^111JJubt].
