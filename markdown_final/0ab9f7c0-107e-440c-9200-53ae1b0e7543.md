...
The most likely defective protein in this patient with autosomal dominant hereditary spherocytosis is **spectrin** [^114xKdf7], as mutations in spectrin or other membrane-cytoskeleton proteins (ankyrin, band 3, protein 4.2) cause membrane instability, spherocyte formation, and extravascular hemolysis [^111JJubt]. Splenectomy is effective because spherocytes are trapped and destroyed in the spleen [^111JJubt]. Iron absorption (A) is not the cause, G6PD deficiency (B) causes intravascular hemolysis, and GPI anchor defects (D) cause paroxysmal nocturnal hemoglobinuria, not spherocytosis [^115DmKz2].
