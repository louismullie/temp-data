...
> Let me first confirm the clinical context and current quetiapine use. Quetiapine is FDA-approved for schizophrenia, bipolar disorder, and adjunctive treatment of major depressive disorder; insomnia is an off-label use, and when used for sleep, typical doses are much lower than for psychiatric indications, often in the 12.5–100 mg range, though evidence remains limited and mixed [^1128WzL8] [^115pk3ma] [^115pk3ma]. I should also confirm formulation and timing, because Seroquel XR is generally dosed once daily in the evening, which can influence sedation timing and next-day effects, and abrupt discontinuation can precipitate withdrawal insomnia, so any dose changes must be gradual [^112WNG5A] [^112wZWHy].
