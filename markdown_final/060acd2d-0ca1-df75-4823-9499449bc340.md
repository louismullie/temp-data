...
> I need to check pharmacovigilance and real-world signals next. A disproportionality analysis of amivantamab reported chills with a reporting odds ratio around 4.5, but wait, I should verify whether that pertains to osimertinib; on re-reading, that signal is for amivantamab, not osimertinib, so I should not conflate the two. Separately, a Japanese post-marketing cohort of osimertinib did not identify chills as a prominent toxicity, which aligns with the notion that chills, if they occur, are not a defining or frequent adverse effect of osimertinib in routine practice [^49d6eaee].
