...
|-|-|
| Perceived brightness is context-dependent | The same object can appear brighter or darker depending on the surround [^112J6zWe] |
| Simultaneous contrast | A perceptual illusion where brightness is altered by background contrast [^notfound] |
| Neural mechanism | Center-surround antagonism in retina and cortex enhances contrast [^117JXR61] |
...
### Perceived luminance depends on temporal context [^113QnDoB]. Nature (2004). Excellent credibility.
...
### Influence of scene statistics on colour constancy [^111BqPHR]. Nature (2002). Excellent credibility.
...
### Brightness illusions drive a neuronal response in the primary visual cortex under top-down modulation [^1141zsGz]. Nature Communications (2024). High credibility.
...
### Photonic thermal management of coloured objects [^113TDjyf]. Nature Communications (2018). Medium credibility.
...
### Perceptography unveils the causal contribution of inferior temporal cortex to visual perception [^115A6zQt]. Nature Communications (2024). High credibility.
...
### Memory modulates color appearance [^112eZXUB]. Nature Neuroscience (2006). Medium credibility.
...
### Context information supports serial dependence of multiple visual objects across memory episodes [^111tCGn2]. Nature Communications (2020). High credibility.
...
### Image segmentation and lightness perception [^112J6zWe]. Nature (2005). Excellent credibility.
...
### Neural adjustments to image blur [^115z3kZt]. Nature Neuroscience (2002). Medium credibility.
...
### Why pictures look right when viewed from the wrong place [^1172r7yh]. Nature Neuroscience (2005). Medium credibility.
...
### Temporal stability of stimulus representation increases along rodent visual cortical hierarchies [^113NRhUM]. Nature Communications (2021). High credibility.
...
### ACR-AAPM-SIIM practice parameter for determinants of image quality in mammography [^1153giFG]. ACR/AAPM/SIIM (2022). High credibility.
...
### Tomographic near-eye displays [^116XvEFw]. Nature Communications (2019). High credibility.
...
### The dark side of gloss [^115hwJrz]. Nature Neuroscience (2012). Medium credibility.
...
### The representation of perceived angular size in human primary visual cortex [^114jp5sK]. Nature Neuroscience (2006). Medium credibility.
...
### Form vision from melanopsin in humans [^1158ExEY]. Nature Communications (2019). High credibility.
...
### A reduction in self-reported confidence accompanies the recall of memories distorted by prototypes [^115B4Trg]. Communications Psychology (2024). Medium credibility.
...
### Large shifts in color appearance from patterned chromatic backgrounds [^114Efd8B]. Nature Neuroscience (2003). Medium credibility.
...
### The influence of cortical activity on perception depends on behavioral state and sensory context [^112qimVT]. Nature Communications (2024). High credibility.
...
### Implicit attentional selection of bound visual features [^112HAVFr]. Neuron (2005). Low credibility.
...
### Color brings relief to human vision [^113tfiJ3]. Nature Neuroscience (2003). Medium credibility.
...
### Long-term priors influence visual perception through recruitment of long-range feedback [^114bHuBq]. Nature Communications (2021). High credibility.
...
### Photonic thermal management of coloured objects [^1174rKQ5]. Nature Communications (2018). Medium credibility.
...
### Serial dependence in visual perception [^112j4rpq]. Nature Neuroscience (2014). Medium credibility.
...
### Adaptation to brightness perception in patients implanted with a small aperture [^111JWsfx]. American Journal of Ophthalmology (2019). Medium credibility.
...
### Quantifying quality in DNA self-assembly [^114HNhKJ]. Nature Communications (2014). Medium credibility.
...
### Viewer-centered object representation in the human visual system revealed by viewpoint aftereffects [^111bMcnR]. Neuron (2005). Low credibility.
...
### Current understanding of photophobia, visual networks and headaches [^116m84yr]. Cephalalgia (2019). Medium credibility.
...
### The role of perception in imaging: past and future [^112pzNUV]. Seminars in Nuclear Medicine (2011). Low credibility.
...
### Weight illusions explained by efficient coding based on correlated natural statistics [^114EXDdS]. Communications Psychology (2024). Medium credibility.
...
### Self-motion and the perception of stationary objects [^116aktrK]. Nature (2001). Excellent credibility.
...
### What constitutes an efficient reference frame for vision? [^112wGkyn]. Nature Neuroscience (2002). Medium credibility.
...
### Behavioural determinants of physiologically-relevant light exposure [^115wUgUe]. Communications Psychology (2024). Medium credibility.
...
### Vision-driven metasurfaces for perception enhancement [^112tg5pE]. Nature Communications (2024). High credibility.
...
### Perceptually unidentifiable stimuli influence cortical processing and behavioral performance [^112Q748a]. Nature Communications (2020). High credibility.
...
### Cortical and subcortical signatures of conscious object recognition [^112VfXVa]. Nature Communications (2021). High credibility.
...
### Diagnosis and care of children with cerebral / cortical visual impairment: clinical report [^115jRu1i]. Pediatrics (2024). High credibility.
...
### Crowding results from optimal integration of visual targets with contextual information [^113DC9zE]. Nature Communications (2022). High credibility.
...
### Object-based attention determines dominance in binocular rivalry [^115Uyy4a]. Nature (2004). Excellent credibility.
...
### A statistical explanation of visual space [^1163FBgk]. Nature Neuroscience (2003). Medium credibility.
...
### Minimal exposure durations reveal visual processing priorities for different stimulus attributes [^111fTzE8]. Nature Communications (2024). High credibility.
...
### Perceptual straightening of natural videos [^111WCzVu]. Nature Neuroscience (2019). High credibility.
...
### Neural correlates reveal separate stages of spontaneous face perception [^112544kb]. Communications Psychology (2025). Medium credibility.
...
### Perceptually unidentifiable stimuli influence cortical processing and behavioral performance [^117GHAut]. Nature Communications (2020). High credibility.
...
### Structural absorption by barbule microstructures of super black bird of paradise feathers [^116umExr]. Nature Communications (2018). Medium credibility.
...
### Primate retina trades single-photon detection for high-fidelity contrast encoding [^114RpK8u]. Nature Communications (2024). High credibility.
...
### Opposing effects of selectivity and invariance in peripheral vision [^114byHao]. Nature Communications (2021). High credibility.
...
### Passive sensing around the corner using spatial coherence [^116aWWLZ]. Nature Communications (2018). Medium credibility.
...
### The challenges natural images pose for visual adaptation [^114JtJHy]. Neuron (2009). Low credibility.
...
### The influence of cortical activity on perception depends on behavioral state and sensory context [^111WTwjV]. Nature Communications (2024). High credibility.
...
### Passive sensing around the corner using spatial coherence [^114GYP5d]. Nature Communications (2018). Medium credibility.
...
### Neural bases of self-and object-motion in a naturalistic vision [^113AtTyw]. Human Brain Mapping (2020). Medium credibility.
...
### Outcome measure for the treatment of cone photoreceptor diseases: orientation to a scene with cone-only contrast [^112zBMf8]. BMC Ophthalmology (2015). Low credibility.
...
### Prior experience of rotation is not required for recognizing objects seen from different angles [^113FFnUM]. Nature Neuroscience (2005). Medium credibility.
...
### Behavioural determinants of physiologically-relevant light exposure [^117XJBZr]. Communications Psychology (2024). Medium credibility.
...
### Living histopathology-interrogation of ocular tissues by light: a celebration of the slit-lamp and a repertoire of clinical techniques [^111wzefQ]. Eye (2025). Medium credibility.
...
### Perceiving visual expansion without optic flow [^115himB9]. Nature (2001). Excellent credibility.
...
### Where infants look determines how they see: eye movements and object perception performance in 3-month-olds [^115xSfEZ]. Infancy (2004). Low credibility.
...
### The lazy shadow: a monocular counterpart to the pulfrich stereo phenomenon [^111NJnsG]. The British Journal of Ophthalmology (2007). Low credibility.
...
### Motion-dependent representation of space in area MT + [^111vvon7]. Neuron (2013). Low credibility.
...
### Neurobiology and the humanities [^113iJVHr]. Neuron (2014). Low credibility.
...
### Perceptually unidentifiable stimuli influence cortical processing and behavioral performance [^112QVBXB]. Nature Communications (2020). High credibility.
...
### A disinhibitory circuit for contextual modulation in primary visual cortex [^117JXR61]. Neuron (2020). Medium credibility.
...
### Comment on' domestic light at night and breast cancer risk: a prospective analysis of 105000 UK women in the generations study' [^1121PqRo]. British Journal of Cancer (2019). Medium credibility.
...
### How does it look? Level 2 perspective-taking at 36 months of age [^112rBxZd]. Child Development (2011). Low credibility.
...
### Neuronal variability reflects probabilistic inference tuned to natural image statistics [^114pvrHF]. Nature Communications (2021). High credibility.
...
### Innate preferences affect results of object recognition task in wild type and Alzheimer's disease mouse models [^116d7Uj9]. Journal of Alzheimer's Disease (2022). Medium credibility.
...
### Direct detection of a single photon by humans [^114syw4b]. Nature Communications (2016). Medium credibility.
...
### Image transmission through an opaque material [^115W52zj]. Nature Communications (2010). Medium credibility.
...
### ACR-AAPM-SIIM practice parameter for determinants of image quality in mammography [^116ucmoE]. ACR/AAPM/SIIM (2022). High credibility.
...
### Pediatric eye evaluations preferred practice pattern [^114mUua4]. Ophthalmology (2023). High credibility.
...
### Double fault! [^117VkWT3]. JAMA Network (2001). Excellent credibility.
...
### Perceptual learning without perception [^117KBjcj]. Nature (2001). Excellent credibility.
...
### Paradoxical impact of memory on color appearance of faces [^116dM7JV]. Nature Communications (2019). High credibility.
...
### Form vision from melanopsin in humans [^115pzHSX]. Nature Communications (2019). High credibility.
...
### Form vision from melanopsin in humans [^115XUiKE]. Nature Communications (2019). High credibility.
...
### An interactive method of assessing the characteristics of softcopy display using observer performance tests [^111epW7L]. Journal of Digital Imaging (2002). Low credibility.
...
### Optimal speed estimation in natural image movies predicts human performance [^116j2QtT]. Nature Communications (2015). Medium credibility.
...
### Finding any waldo with zero-shot invariant and efficient visual search [^1172KwgN]. Nature Communications (2018). Medium credibility.
...
### Optimal speed estimation in natural image movies predicts human performance [^115dunCj]. Nature Communications (2015). Medium credibility.
...
### Flexible gating of contextual influences in natural vision [^114twAQc]. Nature Neuroscience (2015). Medium credibility.
...
### Vision rehabilitation preferred practice pattern ® [^116Tmoe7]. Ophthalmology (2023). High credibility.
...
### The size and albedo of the kuiper-belt object (20000) varuna [^114mbQww]. Nature (2001). Excellent credibility.
...
### Scaling models of visual working memory to natural images [^112V5esz]. Communications Psychology (2024). Medium credibility.
...
### Optimal speed estimation in natural image movies predicts human performance [^111emYT5]. Nature Communications (2015). Medium credibility.
...
### Objective assessment of nose tip light reflections in rhinoplasty [^113FsUjk]. Aesthetic Plastic Surgery (2019). Medium credibility.
...
### Geriatric emergency department guidelines [^1112pP24]. Annals of Emergency Medicine (2014). Medium credibility.
