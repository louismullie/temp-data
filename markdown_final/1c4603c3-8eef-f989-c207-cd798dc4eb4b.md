...
### On convex decision regions in deep network representations [^1153oytE]. Nature Communications (2025). High credibility.
...
### On convex decision regions in deep network representations [^114ibFr3]. Nature Communications (2025). High credibility.
...
### On convex decision regions in deep network representations [^111qCPBm]. Nature Communications (2025). High credibility.
...
### On convex decision regions in deep network representations [^1151bwqb]. Nature Communications (2025). High credibility.
...
### Alterations in white matter network dynamics in patients with schizophrenia and bipolar disorder [^113nvkEs]. Human Brain Mapping (2022). Medium credibility.
...
### The human brain reactivates context-specific past information at event boundaries of naturalistic experiences [^116LY97n]. Nature Neuroscience (2023). High credibility.
...
### On convex decision regions in deep network representations [^1177VCkm]. Nature Communications (2025). High credibility.
...
### Controlled packing and single-droplet resolution of 3D-printed functional synthetic tissues [^114v4Ss8]. Nature Communications (2020). High credibility.
...
### Relative, local and global dimension in complex networks [^111vKeey]. Nature Communications (2022). High credibility.
...
### Feedbacks between sea-floor spreading, trade winds and precipitation in the Southern red sea [^113QxChG]. Nature Communications (2022). High credibility.
...
### Daily forecasting of regional epidemics of coronavirus disease with Bayesian uncertainty quantification, United States [^111pHmuj]. Emerging Infectious Diseases (2021). Medium credibility.
...
### The dissipation theory of aging: a quantitative analysis using a cellular aging map [^113e85MS]. Npj Aging (2025). Medium credibility.
...
### Non-stationary statistics and formation jitter in transient photon condensation [^115k7AJW]. Nature Communications (2020). High credibility.
...
### Relative, local and global dimension in complex networks [^1115tPiH]. Nature Communications (2022). High credibility.
...
### Dispersal-induced instability in complex ecosystems [^112wmGqc]. Nature Communications (2020). High credibility.
...
### Diverse and asymmetric patterns of single-neuron projectome in regulating interhemispheric connectivity [^111YwXZ1]. Nature Communications (2024). High credibility.
...
### How does hemispheric specialization contribute to human-defining cognition? [^112uRVXm]. Neuron (2021). Medium credibility.
...
### Hierarchical structure and the prediction of missing links in networks [^111LtWxV]. Nature (2008). Excellent credibility.
...
### Quantitative imaging metrics for the assessment of pulmonary pathophysiology: an official American Thoracic Society and Fleischner society joint workshop report [^113oEiDn]. Annals of the American Thoracic Society (2023). High credibility.
...
### Overall survival analysis of the phase III codeBreaK 300 study of sotorasib plus panitumumab versus investigator's choice in chemorefractory KRAS G12C colorectal cancer… [^114FWNHV]. ASCO (2025). Medium credibility.
...
### Space-time clustering analyses of childhood acute lymphoblastic leukaemia by immunophenotype [^114j9dgZ]. British Journal of Cancer (2002). Low credibility.
...
### Symmetry group factorization reveals the structure-function relation in the neural connectome of caenorhabditis elegans [^116vygX9]. Nature Communications (2019). High credibility.
...
### A structural and functional subdivision in central orbitofrontal cortex [^111KhVcV]. Nature Communications (2022). High credibility.
...
### Bone cancer, version 2.2025, NCCN clinical practice guidelines in oncology [^113ZPNVg]. Journal of the National Comprehensive Cancer Network (2025). High credibility.
...
### Dual communities in spatial networks [^113SwXPp]. Nature Communications (2022). High credibility.
...
### Machine learning in spectral domain [^115NwuK6]. Nature Communications (2021). High credibility.
...
### Effect of mild hypothermia on lung injury after cardiac arrest in swine based on lung ultrasound [^114rncJq]. BMC Pulmonary Medicine (2019). Medium credibility.
...
### NCCN guidelines® insights: bladder cancer, version 3.2024 [^116vG3tp]. Journal of the National Comprehensive Cancer Network (2024). High credibility.
...
### Three-dimensional echocardiography in congenital heart disease: an expert consensus document from the European association of Cardiovascular imaging and the American Society of Echocardiography [^116Mz8iG]. Journal of the American Society of Echocardiography (2017). Medium credibility.
...
### EACTS / STS guidelines for diagnosing and treating acute and chronic syndromes of the aortic organ [^117DuNqN]. European Journal of Cardio-Thoracic Surgery (2024). High credibility.
