...
### Interpreting the results of noninferiority trials-a review [^115b8FVA]. British Journal of Cancer (2022). Medium credibility.
...
### Interpreting the results of noninferiority trials-a review [^11297MGC]. British Journal of Cancer (2022). Medium credibility.
...
### Kevin M. krudys, PhD… [^113LWs3j]. FDA (2025). Medium credibility.
...
### Interpreting the results of noninferiority trials-a review [^116uZHa3]. British Journal of Cancer (2022). Medium credibility.
...
### Interpreting the results of noninferiority trials-a review [^114guZ9s]. British Journal of Cancer (2022). Medium credibility.
...
### Interpreting the results of noninferiority trials-a review [^111DgUNG]. British Journal of Cancer (2022). Medium credibility.
...
### Interpreting the results of noninferiority trials-a review [^116sjazy]. British Journal of Cancer (2022). Medium credibility.
...
### The clinical interpretation of noninferiority trials [^112LEqeU]. Inflammatory Bowel Diseases (2024). Medium credibility.
...
### Evaluating intermittent androgen-deprivation therapy phase III clinical trials: the devil is in the details… [^111Z9sad]. ASCO (2016). Low credibility.
...
### Interpreting the results of noninferiority trials-a review [^116abEu6]. British Journal of Cancer (2022). Medium credibility.
...
### Interpreting the results of noninferiority trials-a review [^114zHto7]. British Journal of Cancer (2022). Medium credibility.
...
### Noninferiority trial design: opportunities and challenges [^113NA8Pg]. The Journal of Hand Surgery (2022). Medium credibility.
...
### Interpreting the results of noninferiority trials-a review [^115T3Tu9]. British Journal of Cancer (2022). Medium credibility.
...
### Interpreting the results of noninferiority trials-a review [^115DLChY]. British Journal of Cancer (2022). Medium credibility.
...
### Active-control clinical trials to establish equivalence or noninferiority: methodological and statistical concepts linked to quality [^1178VeMM]. American Heart Journal (2003). Low credibility.
...
### Interpreting the results of noninferiority trials-a review [^1115euHM]. British Journal of Cancer (2022). Medium credibility.
...
### An orwellian discourse on the meaning and measurement of noninferiority [^111QMm3j]. The American Journal of Cardiology (2007). Low credibility.
...
### Misleading reporting (spin) in noninferiority randomized clinical trials in oncology with statistically not significant results: a systematic review [^1169vZW3]. JAMA Network Open (2021). High credibility.
...
### Empirical consequences of current recommendations for the design and interpretation of noninferiority trials [^111BxZaQ]. Journal of General Internal Medicine (2018). Low credibility.
...
### Good enough: a primer on the analysis and interpretation of noninferiority trials [^115P5zrt]. Annals of Internal Medicine (2006). Low credibility.
...
### Reporting of noninferiority margins on clinicalTrials.gov: a systematic review [^116BKgDL]. JAMA Network Open (2025). High credibility.
...
### The role of noninferiority studies in orthopaedic surgery: determining whether outcomes are the same, No worse, or simply not different [^111J4X96]. The Journal of Bone and Joint Surgery: American Volume (2025). Medium credibility.
...
### Empirical consequences of current recommendations for the design and interpretation of noninferiority trials [^111hPtjq]. Journal of General Internal Medicine (2018). Low credibility.
...
### Addendum: estimands and sensitivity analysis in clinical trials… [^1172XBXX]. FDA (2025). Medium credibility.
...
### Empirical consequences of current recommendations for the design and interpretation of noninferiority trials [^116P4Q3N]. Journal of General Internal Medicine (2018). Low credibility.
...
### Empirical consequences of current recommendations for the design and interpretation of noninferiority trials [^111gy8ym]. Journal of General Internal Medicine (2018). Low credibility.
...
### Misleading reporting (spin) in noninferiority randomized clinical trials in oncology with statistically not significant results: a systematic review [^111YbdaG]. JAMA Network Open (2021). High credibility.
...
### Hypothesis testing in superiority, noninferiority, and equivalence clinical trials: implications in physical medicine and rehabilitation [^1148JUjc]. American Journal of Physical Medicine & Rehabilitation (2019). Medium credibility.
...
### Understanding equivalence and noninferiority testing [^114LCqPh]. Journal of General Internal Medicine (2011). Low credibility.
...
### Quality of reporting of noninferiority and equivalence randomized trials [^114f4iyo]. JAMA (2006). Excellent credibility.
...
### Reporting of noninferiority trials… [^1126cfV9]. JAMA Network (2015). Excellent credibility.
...
### Assessment of noninferiority margins in cardiovascular medicine trials [^117PwFKB]. JACC: Advances (2024). Medium credibility.
...
### Reporting of noninferiority margins on clinicalTrials.gov: a systematic review [^114EoHqm]. JAMA Network Open (2025). High credibility.
...
### Assessment of noninferiority margins in cardiovascular medicine trials [^113z7o2C]. JACC: Advances (2024). Medium credibility.
...
### Randomized clinical trial design for assessing noninferiority when superiority is expected [^113fYQKr]. Journal of Clinical Oncology (2007). Low credibility.
...
### Ensuring superior reporting of radiation therapy noninferiority trials: a systematic review [^113hkKBN]. Advances in Radiation Oncology (2023). Medium credibility.
...
### A case for using relative rather than absolute noninferiority margins in clinical trials [^113pXbpD]. JACC: Advances (2024). Medium credibility.
...
### Ensuring superior reporting of radiation therapy noninferiority trials: a systematic review [^1125bgFM]. Advances in Radiation Oncology (2023). Medium credibility.
...
### Justification of noninferiority margin: methodology considerations in an exposure-response analysis [^115ms9RP]. Clinical Pharmacology and Therapeutics (2015). Low credibility.
...
### Assessment of noninferiority margins in cardiovascular medicine trials [^111nJb23]. JACC: Advances (2024). Medium credibility.
...
### Non-inferiority trials: a systematic review on methodological quality and reporting standards [^11373yfD]. Journal of General Internal Medicine (2024). Medium credibility.
...
### Assessment of noninferiority margins in cardiovascular medicine trials [^1154p1uB]. JACC: Advances (2024). Medium credibility.
...
### Comparative effectiveness clinical trials in psychiatry: superiority, noninferiority, and the role of active comparators [^115MMjoS]. The Journal of Clinical Psychiatry (2011). Low credibility.
...
### Assessment of noninferiority margins in cardiovascular medicine trials [^113dhSre]. JACC: Advances (2024). Medium credibility.
...
### Reporting of noninferiority margins on clinicalTrials.gov: a systematic review [^112BzRfa]. JAMA Network Open (2025). High credibility.
...
### Assessment of noninferiority margins in cardiovascular medicine trials [^1157Xz81]. JACC: Advances (2024). Medium credibility.
...
### A case for using relative rather than absolute noninferiority margins in clinical trials [^115sjtnt]. JACC: Advances (2024). Medium credibility.
...
### Interpreting adverse signals in diabetes drug development programs [^111Gb7N1]. Diabetes Care (2013). Low credibility.
...
### Reporting of noninferiority margins on clinicalTrials.gov: a systematic review [^113Zepxt]. JAMA Network Open (2025). High credibility.
...
### The need for combined assessment of multiple outcomes in noninferiority trials in oncology [^113WsNNq]. JAMA Oncology (2020). High credibility.
...
### Reducing inferiority in the design, conduct, analysis, reporting, and interpretation of noninferiority trials [^113yEPdA]. JACC: Advances (2024). Medium credibility.
...
### Oral linezolid compared with benzathine penicillin G for treatment of early syphilis in adults (trep-AB study) in Spain: a prospective, open-label, non-inferiority, randomised controlled trial [^116Qukkw]. The Lancet: Infectious Diseases (2024). High credibility.
...
### Rethinking noninferiority [^115UB1ou]. JACC: Advances (2025). Medium credibility.
...
### Misleading reporting (spin) in noninferiority randomized clinical trials in oncology with statistically not significant results: a systematic review [^116z5u8Z]. JAMA Network Open (2021). High credibility.
...
### Non-inferiority trials in cardiology: what clinicians need to know [^113wHXFt]. Heart (2020). Medium credibility.
...
### Non-inferiority trials: a systematic review on methodological quality and reporting standards [^11587E7K]. Journal of General Internal Medicine (2024). Medium credibility.
...
### Non-inferiority trials in cardiology: what clinicians need to know [^1117dCS2]. Heart (2020). Medium credibility.
...
### New concepts of clinical trials in rheumatoid arthritis: a boom of noninferiority trials [^114t4pde]. Current Opinion in Rheumatology (2016). Low credibility.
...
### A phase 3, randomized, double-blind study comparing tedizolid phosphate and linezolid for treatment of ventilated Gram-Positive hospital-acquired or ventilator-associated bacterial pneumonia [^116YgARY]. Clinical Infectious Diseases (2021). Medium credibility.
...
### Current issues in conduct and reporting of noninferiority randomized controlled trials in surgical management of cancer patients [^116JBL1d]. Annals of Surgical Oncology (2021). Medium credibility.
...
### Design of HIV noninferiority trials: where are we going? [^115PBXUJ]. AIDS (2013). Low credibility.
...
### Exploring different objectives in non-inferiority trials [^116LymHc]. BMJ (2024). Excellent credibility.
...
### Efficacy and safety of risankizumab vs. secukinumab in patients with moderate-to-severe plaque psoriasis (IMMerge): results from a phase III, randomized, open-label, efficacy-assessor-blinded clinical trial [^114HUjcL]. The British Journal of Dermatology (2021). Medium credibility.
...
### Efficacy and safety of risankizumab vs. secukinumab in patients with moderate-to-severe plaque psoriasis (IMMerge): results from a phase III, randomized, open-label, efficacy-assessor-blinded clinical trial [^112SQ5Th]. The British Journal of Dermatology (2021). Medium credibility.
...
### Photodynamic therapy vs. topical imiquimod for treatment of superficial basal cell carcinoma: a subgroup analysis within a noninferiority randomized controlled trial [^114sANpE]. The British Journal of Dermatology (2015). Low credibility.
...
### Non-inferiority trials: a systematic review on methodological quality and reporting standards [^1169GVe3]. Journal of General Internal Medicine (2024). Medium credibility.
...
### Efficacy and safety of risankizumab vs. secukinumab in patients with moderate-to-severe plaque psoriasis (IMMerge): results from a phase III, randomized, open-label, efficacy-assessor-blinded clinical trial [^1151zery]. The British Journal of Dermatology (2021). Medium credibility.
...
### Reporting of noninferiority margins on clinicalTrials.gov: a systematic review [^113EZZhH]. JAMA Network Open (2025). High credibility.
...
### Non-inferiority clinical trials to establish effectiveness… [^1173qRMb]. FDA (2025). Medium credibility.
...
### Noninferiority margins in trials of thrombectomy devices for acute ischemic stroke: is the bar being set too low? [^1151RMEg]. Stroke (2019). Medium credibility.
