...
> Let me first confirm the base side length. The base is a square with area 1440 cm², so each side is √1440 cm. Wait, let me verify that simplification: √1440 = √(144 × 10) = 12√10 cm, so the side length is 12√10 cm, and half the side length is 6√10 cm, which will be the apothem distance from the center to the midpoint of a base edge.

> Next, I should review the triangular faces. Each triangular face has area 840 cm² and base equal to the side of the square, 12√10 cm. The area of a triangle is [1/2] × base × height, so the slant height l satisfies 840 = [1/2] × 12√10 × l, which simplifies to l = [140/√10]. Hold on, I should rationalize that: l = [140√10/10] = 14√10 cm, so the slant height is 14√10 cm.

> Now, I need to relate slant height, pyramid height, and the apothem. The slant height forms the hypotenuse of a right triangle whose legs are the pyramid height h and the apothem 6√10 cm. By the Pythagorean theorem, h² + (6√10)² = (14√10)². Let me compute that carefully: (6√10)² = 36 × 10 = 360, and (14√10)² = 196 × 10 = 1960, so h² = 1960 − 360 = 1600, which means h = √1600 = 40 cm.

> I should double-check the options. The calculated height is 40 cm, which corresponds to option B. Wait, let me verify the alternatives to ensure there's no misinterpretation: 30√2 ≈ 42.4, 20√6 ≈ 49.0, 20√3 ≈ 34.6, and 30 is just 30, so 40 cm is indeed option B and matches our derivation precisely.
