...
A pyramid has a square base which has an area of $1440 \mathrm{~cm}^{2}$. Each of the pyramid's triangular faces is identical and each has an area of $840 \mathrm{~cm}^{2}$. The height of the pyramid, in $\mathrm{cm}$, is
(A) $30 \sqrt{2}$
(B) 40
(C) $20 \sqrt{6}$
(D) $20 \sqrt{3}$
...
Each triangular face has area 840 cm² and base (s = 12\\sqrt{10}) cm. The area of a triangle is (\\frac{1}{2} \\times \\text{base} \\times \\text{height}), so the slant height (l) is:

[
l = \\frac{2 \\times 840}{12\\sqrt{10}} = \\frac{1680}{12\\sqrt{10}} = \\frac{140}{\\sqrt{10}} = 14\\sqrt{10} \\text{ cm}
]
...
[
\\text{apothem} = \\frac{s}{2} = 6\\sqrt{10} \\text{ cm}
]

By the Pythagorean theorem:

[
h^2 + (6\\sqrt{10})^2 = (14\\sqrt{10})^2
]
...
ACC/AHA 2022 aortic size normalization—indices and cross-sectional area/height thresholds: Aortic size index (ASI) is defined as aortic diameter (cm)/BSA(m^2) and was reported as a better predictor of adverse aortic events than diameter alone; aortic height index (AHI) is defined as aortic diameter (cm)/patient height (m) and was reported to perform at least as well as ASI while being simpler to calculate. For cross-sectional area to height ratio, initial studies used >10 cm^2/m as a threshold for intervention due to increased risk of adverse events, and more contemporary reports from the same group have used ≥10 cm^2/m (rather than >10 cm^2/m) as the threshold predictive of increased risk.
...
Patient characteristics recorded for this PET myocardial perfusion imaging study included age 53, sex F, height 171.6 cm, weight 154 kg, body surface area 2.56 m^2, and body mass index 52.3 kg/m^2.
...
Algorithm 3—diagnosis: anthropometric component—anthropometric screening and classification include measuring body mass index (BMI) using World Health Organization (WHO) classes (Overweight 25.0 – 29.9 kg/m^2; Class I Obesity 30.0 – 34.9 kg/m^2; Class II Obesity 35.0 – 39.9 kg/m^2; Class III Obesity ≥40.0 kg/m^2), “Measure Waist Circumference for BMI <35.0 kg/m^2 and Calculate Waist-to-Height Ratio for classifying abdominal obesity and cardiometabolic risk,” and “Assess Body Composition Using, for example, bioelectrical impedance analysis or DXA if clinically needed and available”; waist circumference (WC) cutoffs linked to increased cardiometabolic risk include, in the United States and Canada, men ≥102 cm and women ≥88 cm, in Europe, sub-Saharan African, and the Middle East, men ≥94 cm and women ≥80 cm, and in East and South Asia and South and Central America, men ≥90 cm and women ≥80 cm; evidence indicates that waist-to-height ratio (WHtR) is a superior indicator of cardiovascular disease risk compared with WC and the threshold value of ≥0.5 is indicative of increased risk.
