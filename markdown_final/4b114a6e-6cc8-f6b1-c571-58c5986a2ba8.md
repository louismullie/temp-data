...
> Let me consider alternatives if topiramate is not tolerated. Propranolol, metoprolol, divalproex/valproate, and CGRP monoclonal antibodies are guideline-supported options. Head-to-head and comparative data suggest propranolol has similar efficacy to topiramate 100 mg/day in chronic migraine, and CGRP mAbs have better tolerability but are generally reserved after oral failures due to cost and access considerations [^114ehpes] [^113oSXq8] [^117MPUFF].
