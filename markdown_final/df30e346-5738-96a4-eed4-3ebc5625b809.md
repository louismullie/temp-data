...
- **Global Initiative for Asthma (GINA) 2024**: Annual updates integrating new evidence; widely adopted internationally [^1145JhZb] [^11133V4n].
- **National Asthma Education and Prevention Program (NAEPP) 2020 Focused Updates**: U.S.-specific, evidence-based updates using GRADE methodology [^116GSdob] [^114N84ew].
...
- **Stepwise therapy**: Adjust treatment intensity to symptom control and exacerbation risk [^112CysyE] [^114P9Uja].
- **ICS-containing therapy**: Foundation for persistent asthma to reduce exacerbations [^116GSdob] [^114P9Uja].
- **Individualized care**: Tailor to phenotype, comorbidities, preferences, and access [^113HdDzZ] [^115Qbc6X].
- **Regular monitoring**: Reassess control, adherence, and inhaler technique at 3–6 month intervals [^117WXWT7] [^116ggyuk].
...
A major shift is **away from SABA-only** rescue in mild asthma [^114x5XfX]. GINA and ERS recommend **as-needed low-dose ICS-formoterol** for adults and adolescents with mild asthma, which reduces exacerbations versus SABA-only or daily ICS plus SABA [^114xajvq] [^112QLoSx]. NAEPP 2020 supports either daily low-dose ICS plus as-needed SABA or as-needed ICS-SABA for mild persistent asthma, reflecting evolving evidence [^116GSdob] [^111KPxZK].

---

### Moderate-to-severe asthma management

- **SMART therapy**: Preferred for patients ≥ 12 years with moderate-to-severe asthma; reduces exacerbations and steroid exposure versus higher-dose ICS-LABA plus SABA [^116GSdob] [^115znEFm].
- **Add-on LAMA**: Consider triple therapy (ICS-LABA-LAMA) when control remains suboptimal despite optimized ICS-LABA [^111pT1nV] [^1152R4k2].
- **Biologics**: For severe, uncontrolled Type 2 asthma (eosinophilic, allergic); agents include anti-IgE, anti-IL5/5R, and anti-IL4/13 [^116pkF4Q].

---

### Special populations and considerations

- **Children**: GINA recommends ICS-containing therapy for all children; SMART is preferred in those ≥ 12 years, with as-needed ICS-SABA for 6–11 years due to device constraints [^114P9Uja] [^111EWLkH].
- **Pregnancy**: ICS are first-line; maintain control to reduce maternal and fetal risks.
- **Elderly**: Address comorbidities, polypharmacy, and inhaler technique; consider LAMA cautiously due to anticholinergic effects [^111La6fG].
...
- **Education**: Teach inhaler technique and adherence at every visit [^113trePa].
- **Action plans**: Provide written, individualized plans for self-management [^116XzVR2].
- **Shared decision-making**: Engage patients in treatment choices to improve adherence [^117DP1Z1].

---

## Emerging trends and future directions

- **Precision medicine**: Biomarker-guided therapy (FeNO, blood eosinophils) is expanding, especially in severe asthma [^116GedJP] [^113n8tf8].
- **Digital health**: Telemedicine and digital monitoring are increasingly integrated into care pathways.
- **Remission goals**: Some guidelines now target remission (no symptoms, no exacerbations, no steroids) as an aspirational endpoint [^1148ypwe].
...
The 2024 GINA and 2020 NAEPP updates converge on a **control-based, ICS-centered strategy**, with SMART and biologics as key advances. Individualized care, regular monitoring, and shared decision-making remain essential to reduce exacerbations and improve quality of life [^1145JhZb] [^116GSdob].
...
### Mild persistent asthma: is any treatment needed? [^1112i8WF]. The Journal of Allergy and Clinical Immunology (2006). Low credibility.
...
### Updated guidelines from the National Heart, Lung, and Blood Institute… [^112jZGiR]. AAFP (2021). Medium credibility.
...
### International ERS / ATS guidelines on definition, evaluation and treatment of severe asthma [^111tM8KF]. The European Respiratory Journal (2014). Medium credibility.
...
### It is time to change the way we manage mild asthma: an update in GINA 2019 [^114x5XfX]. Respiratory Research (2019). Medium credibility.
...
### Remission in asthma [^1148ypwe]. Current Opinion in Pulmonary Medicine (2024). Medium credibility.
...
### VA / DoD clinical practice guideline for the primary care management of asthma [^111rDGq3]. DoD/VA (2025). High credibility.
