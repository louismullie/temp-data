...
The most specific ICD-10-CM code for "hystrix-like ichthyosis with deafness" is **Q80.9** (Congenital ichthyosis, unspecified), as there is no dedicated code for this subtype. If the hearing loss is documented, add **H90.5** (sensorineural hearing loss, unspecified) as a secondary code. Use **Q80.9** when the exact ichthyosis subtype is unknown or unspecified, and document the clinical features to support medical necessity and future care planning [^116SAXmM].
