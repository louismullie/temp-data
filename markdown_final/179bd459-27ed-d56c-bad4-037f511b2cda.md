...
> Hold on, I should verify whether to code the associated features separately. Hearing loss and keratitis are integral to KID/HID, but ICD-10-CM requires coding the etiologic diagnosis first and then adding manifestations; therefore, I should code Q80.9 for the ichthyosis, then add H90.5 for sensorineural hearing loss and H16.8- for the keratitis with appropriate laterality and seventh-character placeholders as needed, ensuring each code is complete and correctly formatted [^116SAXmM].
...
- **Diffuse spiky hyperkeratosis**: Generalized, spiky or hystrix-like scaling of the skin, often present at birth or early infancy [^116yPR12].

- **Sensorineural deafness**: Progressive hearing loss, typically bilateral, requiring early audiological evaluation and management [^113f1Jfv].

- **Associated features**: May include erythrokeratoderma, nail dystrophy, and increased susceptibility to infections and malignancies, particularly squamous cell carcinoma [^112L1ifC].
...
- **Document specific clinical features**: Clearly describe the skin findings (e.g. diffuse spiky hyperkeratosis), presence of deafness, and any associated anomalies [^1163QN9m].

- **Use unspecified codes appropriately**: When a specific ICD-10-CM code is unavailable, use the unspecified code (e.g. Q80.9) and document the clinical reasoning supporting this choice [^116SAXmM].

- **Consider genetic testing**: Molecular diagnosis can refine classification and may guide future coding updates or specific code requests [^1149tsJV].
...
- **Medical necessity**: Supports the need for specialized dermatologic care, audiological evaluation, and genetic counseling [^1163QN9m].

- **Reimbursement**: Facilitates appropriate insurance coverage for diagnostic tests, treatments, and follow-up care [^116FM4wi].

- **Epidiological tracking**: Contributes to data collection on rare congenital ichthyoses, potentially informing future coding updates and research initiatives [^112jDLPm].
...
### Clinical, etiopathogenic, and therapeutic aspects of KID syndrome [^114S5zz9]. Dermatologic Therapy (2020). Medium credibility.
...
### Keratitis-ichthyosis-deafness syndrome: a comprehensive review of cutaneous and systemic manifestations [^113f1Jfv]. Pediatric Dermatology (2023). Medium credibility.
...
### Prevalence of rare diseases: bibliographic data [^111S2yuP]. Orphanet Report Series (2024). Medium credibility.
...
### Ichthyosis [^1163QN9m]. Nature Reviews: Disease Primers (2023). High credibility.
...
### Keratitis-ichthyosis-deafness syndrome and hidradenitis suppurativa [^112L1ifC]. JAAD Case Reports (2023). Medium credibility.
...
### Prevalence of rare diseases: bibliographic data [^114itZQL]. Orphanet Report Series (2024). Medium credibility.
...
### Prevalence of rare diseases: bibliographic data [^116yDyu5]. Orphanet Report Series (2024). Medium credibility.
...
### Prevalence of rare diseases: bibliographic data [^1161vWNG]. Orphanet Report Series (2024). Medium credibility.

In Europe, the prevalence of autosomal recessive congenital ichthyosis in 2021 was 0.5 per 100,000 population.

---

### Inherited nonsyndromic ichthyoses: an update on pathophysiology, diagnosis and treatment [^111nK6mh]. American Journal of Clinical Dermatology (2018). Low credibility.
...
### Management of ichthyosis and related conditions gene-based diagnosis and emerging gene-based therapy [^112aoKCK]. Dermatologic Therapy (2013). Low credibility.
...
### Prevalence of rare diseases: bibliographic data [^112CTCcX]. Orphanet Report Series (2024). Medium credibility.
...
### Prevalence of rare diseases: bibliographic data [^113HbrUG]. Orphanet Report Series (2024). Medium credibility.
...
### Keratitis, ichthyosis and deafness syndrome with development of multiple hair follicle tumours [^116a1SM9]. The British Journal of Dermatology (2002). Low credibility.
...
### Prevalence of rare diseases: bibliographic data [^114xU117]. Orphanet Report Series (2024). Medium credibility.
...
### Prevalence of rare diseases: bibliographic data [^115dzZXg]. Orphanet Report Series (2024). Medium credibility.
...
### Fatal septicemia in an infant with keratitis, ichthyosis, and deafness (KID) syndrome [^1179AFqD]. Pediatric Dermatology (2002). Low credibility.
...
### Prevalence of rare diseases: bibliographic data [^116otM1H]. Orphanet Report Series (2024). Medium credibility.

In Europe, the prevalence of nonbullous congenital ichthyosiform erythroderma in 2021 was 0.3 per 100,000 population.

---

### Keratitis, ichthyosis, and deafness (KID) syndrome [^111zHChc]. Pediatric Dermatology (2002). Low credibility.
...
### Care of the newborn with ichthyosis [^1121c3cc]. Dermatologic Therapy (2013). Low credibility.
...
### A novel homozygous mutation of – A new variant of keratitis-ichthyosis-deafness syndrome? [^111cF5XR]. JAAD Case Reports (2019). Medium credibility.
...
### A case of HDR syndrome and ichthyosis: dual diagnosis by whole-genome sequencing of novel mutations in GATA3 and STS genes [^113zzRnE]. The Journal of Clinical Endocrinology and Metabolism (2016). Low credibility.
...
### Prevalence of rare diseases: bibliographic data [^113A1QQ1]. Orphanet Report Series (2024). Medium credibility.
...
### Ichthyosis prematurity syndrome: a systematic review of the literature [^117G4YpX]. Pediatric Dermatology (2025). Medium credibility.
...
### HID and KID syndromes are associated with the same connexin 26 mutation [^117UDzd4]. The British Journal of Dermatology (2002). Low credibility.
...
### A three-year follow-up study evaluating clinical utility of exome sequencing and diagnostic potential of reanalysis [^114ijY7w]. NPJ Genomic Medicine (2020). Medium credibility.
...
### Increased prevalence of hearing loss, tinnitus and sudden deafness among patients with Sjögren's syndrome [^116owCXw]. RMD Open (2024). Medium credibility.
...
### Genodermatoses with hearing impairment [^112hSuJ9]. Journal of the American Academy of Dermatology (2021). Medium credibility.
...
### Parental mosaic cutaneous-gonadal GJB2 mutation: from epidermal nevus to inherited ichthyosis-deafness syndrome [^115Q4zRh]. The Journal of Dermatology (2022). Medium credibility.
...
### Revertant mosaicism repairs skin lesions in a patient with keratitis-ichthyosis-deafness syndrome by second-site mutations in connexin 26 [^116yPR12]. Human Molecular Genetics (2017). Low credibility.
...
### Bullying in children with congenital ichthyosis [^115818VL]. Pediatric Dermatology (2025). Medium credibility.
...
### The rendering of human phenotype and rare diseases in ICD-11 [^116F7RL9]. Journal of Inherited Metabolic Disease (2018). Low credibility.
...
### Malignant skin tumours in patients with inherited ichthyosis [^111rHr9g]. The British Journal of Dermatology (2011). Low credibility.
...
### Keratitis-ichthyosis-deafness syndrome and hidradenitis suppurativa [^113AR3ui]. JAAD Case Reports (2023). Medium credibility.
...
### A case of keratitis, ichthyosis, and deafness syndrome with rickets [^111QsKH9]. JAAD Case Reports (2020). Medium credibility.
...
### Inherited ichthyosis as a paradigm of rare skin disorders: genomic medicine, pathogenesis, and management [^1149tsJV]. Journal of the American Academy of Dermatology (2023). Medium credibility.
...
### Harlequin ichthyosis, prenatal diagnosis: the ultrasound recognition [^11351fxr]. BMJ Case Reports (2024). High credibility.
...
### Evolving phenotypes of non-hospitalized patients that indicate long COVID [^11492RxH]. BMC Medicine (2021). Medium credibility.
