...
> Hold on, I should verify whether to code the associated features separately. Hearing loss and keratitis are integral to KID/HID, but ICD-10-CM requires coding the etiologic diagnosis first and then adding manifestations; therefore, I should code Q80.9 for the ichthyosis, then add H90.5 for sensorineural hearing loss and H16.8- for the keratitis with appropriate laterality and seventh-character placeholders as needed, ensuring each code is complete and correctly formatted [^cd799048].
