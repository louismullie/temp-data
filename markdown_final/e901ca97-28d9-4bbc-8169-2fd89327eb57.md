...
> Next, I should review which medications are used for suppression. The nucleoside analogues acyclovir, valacyclovir, and famciclovir are the established agents for HSV suppression, with decades of safety and efficacy data and multiple guideline endorsements for this purpose, while topical antivirals are not effective for suppression and are discouraged for routine genital HSV management [^114Yb6rv] [^116hQWg4] [^114Yb6rv].
