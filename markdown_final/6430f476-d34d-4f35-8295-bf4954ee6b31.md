...
Iron deficiency anemia (IDA) is classically **microcytic** [^111sFJG3], but macrocytosis can occur due to **coexisting B12/folate deficiency** [^111bDP7o], liver disease [^1114iuj8], alcohol use and medications [^111bDP7o], or reticulocytosis [^111etdk1]. Macrocytosis in IDA is uncommon and should **prompt evaluation for these causes** [^117Fk92E]. Management includes confirming iron deficiency with ferritin and transferrin saturation [^112knLuE], treating the cause, and correcting deficiencies; if macrocytosis persists, assess for myelodysplastic syndrome or other marrow disorders [^116UL4QN].
