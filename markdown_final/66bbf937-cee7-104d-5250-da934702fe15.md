...
> Next, I should review practical protocol choices and timing, and I need to ensure they align with guidelines. For suspected MS, obtain brain and spinal cord MRI with contrast when feasible to establish DIS/DIT and exclude mimics. For established MS, annual brain MRI with 3D FLAIR and 3D T2, plus pre- and post-contrast 3D T1 when clinically indicated, is reasonable, with spinal cord MRI every 1–2 years or when new myelopathic symptoms arise. Re-baseline imaging 4–6 months after starting or changing therapy helps interpret early treatment effects, and standardized 3D acquisitions with thin slices and no gap improve comparability across time points [^912a55cb] [^c1a1c357] [^bb14681b].
